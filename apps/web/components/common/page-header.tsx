...
function PageHeaderHeading({
  ...
  return (
    <h1
      className={cn(
        "font-bold tracking-tighter uppercase font-mono text-4xl md:text-5xl xl:text-6xl",
        className
      )}
      {...props}
    />
...
function PageHeaderDescription({
  ...
  return (
    <p
      className={cn(
        "text-muted-foreground max-w-4xl text-sm",
        className
      )}
      {...props}
    />
...
function SectionHeader({
  ...
  return (
    <section className={cn("border-grid", className)} {...props}>
      <div className="container-wrapper">
        <div className="container gap-2 py-8 text-center md:pt-14 xl:gap-4">
          {children}
        </div>
      </div>
    </section>
...
function SectionHeaderHeading({
  ...
  return (
    <h1
      className={cn(
        "text-3xl font-medium tracking-tighter uppercase font-mono xl:text-3xl",
        className
      )}
      {...props}
    />
