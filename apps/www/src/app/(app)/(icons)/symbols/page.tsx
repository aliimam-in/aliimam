...
export default function About() {
  ...
  const getSizeClasses = (type: "symbols") => {
    switch (type) { 
      case "symbols":
        return "h-12 w-16"; 
      default:
  ...
  const renderIcons = (type: "symbols") => {
    ...
    return (
      <div className="flex relative -mt-2 items-stretch xl:w-full">
        ...
        <div className="sticky w-60 top-32 z-30 ml-auto hidden h-[calc(100svh-var(--footer-height))] flex-col gap-3 pb-3 overflow-hidden overscroll-none xl:flex">
          <LogoPreviewPanel
