  ...
  const renderIcons = (type: "vectors") => {
    ...
    return (
      <div className="relative -mt-2 flex items-stretch xl:w-full">
        <div className="flex min-w-0 flex-1 flex-col border-x p-2">
        ...
        <div className="sticky top-38 z-30 ml-auto hidden h-[calc(100svh-var(--footer-height)-2rem)] w-60 flex-col gap-3 overflow-hidden overscroll-none pb-3 xl:flex">
          <LogoPreviewPanel
