...
export default function About() {
  ...
  const getFilteredIconsByCategory = (
    type: "icon" | "wordmark" | "flags" | "stickers" | "shapes"
  ) => {
  ...
  const getSizeClasses = (type: "shapes") => {
    switch (type) { 
      case "shapes":
        return "h-12 w-16"; 
      default:
  ...
  const renderIcons = (type: "shapes") => {
    ...
    return (
      <div className="flex relative items-stretch -mt-2 xl:w-full">
        ...
        <div className="sticky w-60 top-32 z-30 ml-auto hidden h-[calc(100svh-var(--footer-height))] flex-col gap-3 overflow-hidden overscroll-none pb-3 xl:flex">
          <LogoPreviewPanel
