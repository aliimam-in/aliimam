...
export function Tools() {
  return (
    <section className="container hidden">
      <div className="border-x bg-black dark:bg-white border-t p-6 md:p-3">
        <div className="mx-auto grid gap-3 sm:grid-cols-5">
          <Card className="group overflow-hidden shadow-none sm:col-span-3 rounded-none">
            <CardHeader>
          ...
          <Card className="group overflow-hidden shadow-none sm:col-span-2 rounded-none">
          ...
          <Card className="group relative shadow-none sm:col-span-3 rounded-none">
