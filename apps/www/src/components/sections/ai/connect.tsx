...
export function Connect() {
  return (
    <section className="container">
      <div className="flex border-x  justify-center">
      <div className="max-w-5xl pb-20">
        ...
        <div className="[mask-image:radial-gradient(ellipse_100%_100%_at_50%_0%,#000_70%,transparent_100%)]">
          <div className="bg-background gap-x-6 grid md:grid-cols-2 dark:bg-muted/50 border px-6 pb-10 pt-6">
            <Integration
              icon={<X />}
              name="X"
...
const Integration = ({
  ...
  return (
    <Link
      target="_blank"
      href={links}
      className="grid hover:bg-secondary grid-cols-[auto_1fr_auto] items-center gap-3 border-b border-dashed p-3 last:border-b-0"
    >
