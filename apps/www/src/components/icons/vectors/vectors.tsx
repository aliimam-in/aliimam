...
interface IconProps extends React.SVGProps<SVGSVGElement> {
  ...
  size?: number
  color?: string 
  variant?: "default" | "shapes" | "sketch" | "pattern" | "texture"
}
...
export function Vectors({
  ...
  // 1. Exact id match
  outer: for (const icons of (Object.values(allVectors) as Record<string, any>[])) {
      ...
      for (const entry of Object.values(icons)) {
        ...
        const matches =
          ...
          (metaVariant === targetVariant ||
            (targetVariant === "default" && (metaVariant === "shapes" || metaVariant === "")))
        if (matches) {
          match = e
          break outer
        }
