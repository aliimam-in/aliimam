    ...
    <section className="py-10">
      <div className="container">
        ...
        <div className="relative flex flex-col items-center px-4 pt-24 pb-32 text-center">
          ...
          <h2 className="font-display max-w-lg text-4xl font-medium text-balance sm:text-5xl">
            Transform your creative workflow
          </h2>
          <p className="text-muted-foreground mt-6 max-w-[560px] text-lg font-medium sm:text-xl">
            Start designing with ease and see how Ali Imam&apos;s tools
            streamline your creative process for stunning results.
          </p>
