...
import { Globe, Link, Monitor, Receipt, UserCheck, Users } from "@aliimam/icons"
    ...
    <section className="pt-10">
      <div className="mx-6">
        <div className="flex w-full flex-col items-center px-4 text-center">
          ...
          <h2 className="font-display mt-3 text-3xl font-medium text-pretty sm:text-4xl md:text-5xl">
            Understand Your Design Impact
          </h2>
          <p className="mt-3 text-base text-pretty sm:text-lg">
        ...
        <div className="-mx-px mt-12 mb-8">
          <div className="xs:[mask-image:linear-gradient(90deg,transparent,black_15%,black_85%,transparent),linear-gradient(black_65%,transparent)] relative h-[520px] w-full overflow-clip [mask-image:linear-gradient(90deg,transparent,black_5%,black_95%,transparent),linear-gradient(black_75%,transparent)] [mask-composite:intersect]">
            <div
              className="absolute top-0 left-1/2 grid -translate-x-1/2 gap-4"
              style={{
                gridTemplateColumns:
            ...
            >
              ...
              >
                {[
                  ...
                  <div key={index}>
                    <div className="bg-card flex flex-col rounded-md border p-4 text-sm">
                    ...
                    <div className="mt-2 space-y-1 font-medium">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div className="bg-secondary flex min-w-0 items-center gap-2 rounded-lg px-1.5 py-1 font-mono text-xs">
                          ...
                          <span className="min-w-0 truncate">aliimam.in</span>
                        </div>
                      </div>
                    </div>
              ...
              >
                <div>
                  <div className="bg-card flex flex-col rounded-xl border p-2 text-sm shadow-xl">
                    <div className="relative h-[260px] overflow-hidden rounded-sm border">
                      <img
