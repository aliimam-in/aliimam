      ...
      <div className="mx-6">
        <div className="grid w-full gap-10 lg:grid-cols-2 lg:border-y">
              ...
              <div className="mb-10 space-y-10 lg:flex lg:flex-col">
                ...
                <div className="space-y-4 border p-8">
                  <p className="font-semibold">
                    &quot;With Shadcnblocks, my team has created stunning
                    visuals 10x faster. We deliver impactful designs by
                    iterating quickly and with precision.&quot;
                  </p>
                  <p className="font-semibold">
                    Creative Director /{" "}
          ...
          <div className="relative">
            ...
            />
            <div className="relative z-10 border-t p-2 lg:border-t-0 lg:border-l xl:p-20">
