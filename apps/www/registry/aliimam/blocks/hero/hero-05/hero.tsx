  ...
  return (
    <div className="min-h-screen py-12">
      <div
        ...
        style={{
          background:
            "radial-gradient(125% 125% at 50% 90%, transparent 60%, var(--primary) 100%)",
        }}
      />
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(125% 125% at 50% 10%, transparent 60%, var(--primary) 100%)",
        }}
      />
      <div className="relative z-20 mx-auto max-w-7xl rounded-md border shadow-2xl">
