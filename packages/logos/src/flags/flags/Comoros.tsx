...
>(function Comoros(
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M4.957 16.5351C4.661 14.0731 6.417 11.8371 8.879 11.5401C8.07 11.3161 7.216 11.3161 6.407 11.5401C3.945 12.2231 2.502 14.7721 3.185 17.2351C3.868 19.6971 6.417 21.1401 8.88 20.4571C6.825 20.2101 5.205 18.5901 4.958 16.5351H4.957Z"
        fill="#fff"
      />
      <path
