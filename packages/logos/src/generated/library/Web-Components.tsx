...
export const WebComponents = React.forwardRef<SVGSVGElement, WebComponentsProps>(
  ({ size = 24, className = '', ...props }, ref) => (
    <svg
      ...
      {...props}
    >
      <path d="M5.8125 2.25L5.625 2.4375L0.375 11.8125L5.8125 21.375H18.375L21.1875 16.5V16.125L23.8125 11.8125L21 7.3125V6.9375L18.375 2.25H5.8125ZM9.75 7.875H13.6875L16.125 11.8125L13.6875 15.75H9.75L7.5 11.8125L9.75 7.875Z" fill="black"/>
...
<path d="M11.8125 20.625L6.5625 11.8125L11.8125 3H6.1875L1.125 11.8125L6.1875 20.625H11.8125Z" fill="black"/>
