...
export interface ExpressJsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const ExpressJs = React.forwardRef<SVGSVGElement, ExpressJsProps>(
...
export const ExpressJsMetadata = {
  id: "Express-js",
  baseId: "Express-js",
  variant: "default",
  name: "Express Js",
