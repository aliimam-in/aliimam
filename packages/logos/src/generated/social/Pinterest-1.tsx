...
export interface Pinterest1Props extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Pinterest1 = React.forwardRef<SVGSVGElement, Pinterest1Props>(
  ({ size = 24, className = '', ...props }, ref) => (
    <svg
      ...
      {...props}
    >
      <g clipPath="url(#clip0_2066_1347)">
...
Pinterest1.displayName = "Pinterest1";

export const Pinterest1Metadata = {
  id: "Pinterest-1",
  baseId: "Pinterest-1",
  variant: "default",
  name: "Pinterest 1",
