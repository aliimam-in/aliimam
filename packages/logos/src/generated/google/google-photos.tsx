...
export interface GooglePhotosProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const GooglePhotos = React.forwardRef<SVGSVGElement, GooglePhotosProps>(
...
export const GooglePhotosMetadata = {
  id: "google-photos",
  baseId: "google-photos",
  variant: "default",
  name: "Google Photos",
  category: "google",
  tags: [],
