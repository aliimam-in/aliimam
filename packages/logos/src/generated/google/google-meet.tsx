...
export interface GoogleMeetProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const GoogleMeet = React.forwardRef<SVGSVGElement, GoogleMeetProps>(
...
export const GoogleMeetMetadata = {
  id: "google-meet",
  baseId: "google-meet",
  variant: "default",
  name: "Google Meet",
