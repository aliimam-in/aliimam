...
export interface GooglePlayProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const GooglePlay = React.forwardRef<SVGSVGElement, GooglePlayProps>(
...
export const GooglePlayMetadata = {
  id: "google-play",
  baseId: "google-play",
  variant: "default",
  name: "Google Play",
