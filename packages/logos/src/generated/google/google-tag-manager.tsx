...
export interface GoogleTagManagerProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const GoogleTagManager = React.forwardRef<SVGSVGElement, GoogleTagManagerProps>(
...
export const GoogleTagManagerMetadata = {
  id: "google-tag-manager",
  baseId: "google-tag-manager",
  variant: "default",
