...
export interface MarkdownProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Markdown = React.forwardRef<SVGSVGElement, MarkdownProps>(
