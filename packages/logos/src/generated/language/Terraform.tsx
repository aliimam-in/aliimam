...
export const Terraform = React.forwardRef<SVGSVGElement, TerraformProps>(
  ({ size = 24, className = '', ...props }, ref) => (
    <svg
      ...
      {...props}
    >
      <path d="M8.848 5.83333L14.118 8.83333V14.8333L8.848 11.8333V5.83333ZM14.73 8.83333V14.8333L20 11.8333V5.83333L14.73 8.83333ZM3 2.5V8.5L8.27 11.5V5.5L3 2.5ZM8.848 18.5L14.118 21.5V15.5L8.848 12.5V18.5Z" fill="black"/>
    </svg>
  )
);
