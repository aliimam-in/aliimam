/**
 * Auto-generated logo component: Pandas Icon (default)
...
export interface PandasIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const PandasIcon = React.forwardRef<SVGSVGElement, PandasIconProps>(
...
PandasIcon.displayName = "PandasIcon";

export const PandasIconMetadata = {
  id: "pandas-icon",
  baseId: "pandas-icon",
  variant: "default",
  name: "Pandas Icon",
