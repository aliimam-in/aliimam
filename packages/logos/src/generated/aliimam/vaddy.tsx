/**
 * Auto-generated logo component: Vaddy (default)
...
export interface VaddyProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Vaddy = React.forwardRef<SVGSVGElement, VaddyProps>(
  ({ size = 24, className = '', ...props }, ref) => (
    ...
    >
      <defs>
        <linearGradient x1="50%" y1="-1.01957259%" x2="50%" y2="100%" id="linearGradient-1">
            <stop stopColor="#8FC53B" offset="0%"></stop>
            <stop stopColor="#48A23C" offset="100%"></stop>
        </linearGradient>
    </defs>
    <g>
...
Vaddy.displayName = "Vaddy";

export const VaddyMetadata = {
  id: "vaddy",
  baseId: "vaddy",
  variant: "default",
  name: "Vaddy",
