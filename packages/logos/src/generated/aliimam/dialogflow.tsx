/**
 * Auto-generated logo component: Dialogflow (default)
...
export interface DialogflowProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Dialogflow = React.forwardRef<SVGSVGElement, DialogflowProps>(
...
export const DialogflowMetadata = {
  id: "dialogflow",
  baseId: "dialogflow",
  variant: "default",
  name: "Dialogflow",
