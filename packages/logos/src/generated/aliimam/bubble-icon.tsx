/**
 * Auto-generated logo component: Bubble Icon (default)
...
export interface BubbleIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const BubbleIcon = React.forwardRef<SVGSVGElement, BubbleIconProps>(
...
export const BubbleIconMetadata = {
  id: "bubble-icon",
  baseId: "bubble-icon",
  variant: "default",
  name: "Bubble Icon",
