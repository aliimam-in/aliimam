/**
 * Auto-generated logo component: Middleman (default)
...
export interface MiddlemanProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Middleman = React.forwardRef<SVGSVGElement, MiddlemanProps>(
  ({ size = 24, className = '', ...props }, ref) => (
    ...
    >
      <g>
		...
		<g transform="translate(19.561462, 32.318937)" fill="#000000" fillOpacity="0.35">
...
Middleman.displayName = "Middleman";

export const MiddlemanMetadata = {
  id: "middleman",
  baseId: "middleman",
  variant: "default",
  name: "Middleman",
