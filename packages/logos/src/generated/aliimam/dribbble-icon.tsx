/**
 * Auto-generated logo component: Dribbble Icon (default)
...
export interface DribbbleIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const DribbbleIcon = React.forwardRef<SVGSVGElement, DribbbleIconProps>(
...
export const DribbbleIconMetadata = {
  id: "dribbble-icon",
  baseId: "dribbble-icon",
  variant: "default",
  name: "Dribbble Icon",
  category: "aliimam",
  tags: [],
