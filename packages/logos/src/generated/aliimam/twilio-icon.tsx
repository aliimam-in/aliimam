/**
 * Auto-generated logo component: Twilio Icon (default)
...
export interface TwilioIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const TwilioIcon = React.forwardRef<SVGSVGElement, TwilioIconProps>(
...
export const TwilioIconMetadata = {
  id: "twilio-icon",
  baseId: "twilio-icon",
  variant: "default",
  name: "Twilio Icon",
