/**
 * Auto-generated logo component: Django Icon (default)
...
export interface DjangoIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const DjangoIcon = React.forwardRef<SVGSVGElement, DjangoIconProps>(
...
export const DjangoIconMetadata = {
  id: "django-icon",
  baseId: "django-icon",
  variant: "default",
  name: "Django Icon",
