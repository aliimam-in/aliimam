/**
 * Auto-generated logo component: Ycombinator (default)
...
export interface YcombinatorProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Ycombinator = React.forwardRef<SVGSVGElement, YcombinatorProps>(
...
export const YcombinatorMetadata = {
  id: "ycombinator",
  baseId: "ycombinator",
  variant: "default",
  name: "Ycombinator",
