/**
 * Auto-generated logo component: Blueprint (default)
...
export interface BlueprintProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Blueprint = React.forwardRef<SVGSVGElement, BlueprintProps>(
  ({ size = 24, className = '', ...props }, ref) => (
    ...
    >
      <g>
		...
		<polygon fillOpacity="0.2" fill="#10161A" style={{mixBlendMode:"soft-light"}} points="256 224.768 192 186.825143 256 150.345143 256 224.768"></polygon>
...
export const BlueprintMetadata = {
  id: "blueprint",
  baseId: "blueprint",
  variant: "default",
  name: "Blueprint",
