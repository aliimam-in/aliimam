/**
 * Auto-generated logo component: Cube Icon (default)
...
export interface CubeIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const CubeIcon = React.forwardRef<SVGSVGElement, CubeIconProps>(
