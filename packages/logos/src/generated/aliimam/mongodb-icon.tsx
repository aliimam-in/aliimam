/**
 * Auto-generated logo component: Mongodb Icon (default)
...
export interface MongodbIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const MongodbIcon = React.forwardRef<SVGSVGElement, MongodbIconProps>(
...
export const MongodbIconMetadata = {
  id: "mongodb-icon",
  baseId: "mongodb-icon",
  variant: "default",
  name: "Mongodb Icon",
