/**
 * Auto-generated logo component: Vuetifyjs (default)
...
export interface VuetifyjsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Vuetifyjs = React.forwardRef<SVGSVGElement, VuetifyjsProps>(
...
Vuetifyjs.displayName = "Vuetifyjs";

export const VuetifyjsMetadata = {
  id: "vuetifyjs",
  baseId: "vuetifyjs",
  variant: "default",
  name: "Vuetifyjs",
