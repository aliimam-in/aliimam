/**
 * Auto-generated logo component: Stackoverflow Icon (default)
...
export interface StackoverflowIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const StackoverflowIcon = React.forwardRef<SVGSVGElement, StackoverflowIconProps>(
...
export const StackoverflowIconMetadata = {
  id: "stackoverflow-icon",
  baseId: "stackoverflow-icon",
  variant: "default",
