/**
 * Auto-generated logo component: Eventbrite Icon (default)
...
export interface EventbriteIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const EventbriteIcon = React.forwardRef<SVGSVGElement, EventbriteIconProps>(
...
export const EventbriteIconMetadata = {
  id: "eventbrite-icon",
  baseId: "eventbrite-icon",
  variant: "default",
