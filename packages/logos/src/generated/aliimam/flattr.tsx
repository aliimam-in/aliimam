/**
 * Auto-generated logo component: Flattr (default)
...
export interface FlattrProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Flattr = React.forwardRef<SVGSVGElement, FlattrProps>(
    ...
    >
      <defs>
        <linearGradient x1="50.000371%" y1="2.10915516e-14%" x2="50.000371%" y2="99.9970316%" id="linearGradient-1">
            <stop stopColor="#EA5F29" offset="0%"></stop>
            <stop stopColor="#FABD1F" offset="100%"></stop>
        </linearGradient>
        <linearGradient x1="49.9966606%" y1="99.9985158%" x2="49.9966606%" y2="0.000742098506%" id="linearGradient-2">
            <stop stopColor="#ABD33C" offset="0%"></stop>
            <stop stopColor="#6CB02F" offset="100%"></stop>
        </linearGradient>
    </defs>
	<g>
