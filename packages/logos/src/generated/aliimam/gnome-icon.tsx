/**
 * Auto-generated logo component: Gnome Icon (default)
...
export interface GnomeIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const GnomeIcon = React.forwardRef<SVGSVGElement, GnomeIconProps>(
...
export const GnomeIconMetadata = {
  id: "gnome-icon",
  baseId: "gnome-icon",
  variant: "default",
  name: "Gnome Icon",
