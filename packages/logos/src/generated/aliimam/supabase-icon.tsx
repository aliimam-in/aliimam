/**
 * Auto-generated logo component: Supabase Icon (default)
...
export interface SupabaseIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const SupabaseIcon = React.forwardRef<SVGSVGElement, SupabaseIconProps>(
...
export const SupabaseIconMetadata = {
  id: "supabase-icon",
  baseId: "supabase-icon",
  variant: "default",
  name: "Supabase Icon",
  category: "aliimam",
  tags: [],
