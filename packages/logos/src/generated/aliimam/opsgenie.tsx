/**
 * Auto-generated logo component: Opsgenie (default)
...
export interface OpsgenieProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Opsgenie = React.forwardRef<SVGSVGElement, OpsgenieProps>(
