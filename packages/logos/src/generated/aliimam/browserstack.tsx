/**
 * Auto-generated logo component: Browserstack (default)
...
export interface BrowserstackProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Browserstack = React.forwardRef<SVGSVGElement, BrowserstackProps>(
...
export const BrowserstackMetadata = {
  id: "browserstack",
  baseId: "browserstack",
  variant: "default",
  name: "Browserstack",
