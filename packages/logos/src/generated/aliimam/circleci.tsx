/**
 * Auto-generated logo component: Circleci (default)
...
export interface CircleciProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Circleci = React.forwardRef<SVGSVGElement, CircleciProps>(
