/**
 * Auto-generated logo component: Zulip Icon (default)
...
export interface ZulipIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const ZulipIcon = React.forwardRef<SVGSVGElement, ZulipIconProps>(
    ...
    >
      <defs>
        <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="linearGradient-1">
            <stop stopColor="#24ADFF" offset="0%"></stop>
            <stop stopColor="#7B71FF" offset="100%"></stop>
        </linearGradient>
    </defs>
    <g>
...
export const ZulipIconMetadata = {
  id: "zulip-icon",
  baseId: "zulip-icon",
  variant: "default",
  name: "Zulip Icon",
