/**
 * Auto-generated logo component: Cloudflare Workers Icon (default)
...
export interface CloudflareWorkersIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const CloudflareWorkersIcon = React.forwardRef<SVGSVGElement, CloudflareWorkersIconProps>(
    ...
    >
      <defs>
        <linearGradient x1="50%" y1="100%" x2="25.7%" y2="8.7%" id="cfWorkersLinearGradient-1">
            <stop stopColor="#EB6F07" offset="0%"></stop>
            <stop stopColor="#FAB743" offset="100%"></stop>
        </linearGradient>
        <linearGradient x1="81%" y1="83.7%" x2="40.5%" y2="29.5%" id="cfWorkersLinearGradient-2">
            <stop stopColor="#D96504" offset="0%"></stop>
            <stop stopColor="#D96504" stopOpacity="0" offset="100%"></stop>
        </linearGradient>
        <linearGradient x1="42%" y1="8.7%" x2="84%" y2="79.9%" id="cfWorkersLinearGradient-3">
            <stop stopColor="#EB6F07" offset="0%"></stop>
            <stop stopColor="#EB720A" stopOpacity="0" offset="100%"></stop>
        </linearGradient>
        <linearGradient x1="50%" y1="100%" x2="25.7%" y2="8.7%" id="cfWorkersLinearGradient-4">
            <stop stopColor="#EE6F05" offset="0%"></stop>
            <stop stopColor="#FAB743" offset="100%"></stop>
        </linearGradient>
        <linearGradient x1="-33.2%" y1="100%" x2="91.7%" y2="0%" id="cfWorkersLinearGradient-5">
            <stop stopColor="#D96504" stopOpacity="0.8" offset="0%"></stop>
            <stop stopColor="#D96504" stopOpacity="0.2" offset="49.8%"></stop>
            <stop stopColor="#D96504" stopOpacity="0" offset="100%"></stop>
        </linearGradient>
        <linearGradient x1="50%" y1="100%" x2="25.7%" y2="8.7%" id="cfWorkersLinearGradient-6">
            <stop stopColor="#FFA95F" offset="0%"></stop>
            <stop stopColor="#FFEBC8" offset="100%"></stop>
        </linearGradient>
        <linearGradient x1="8.1%" y1="1.1%" x2="96.5%" y2="48.8%" id="cfWorkersLinearGradient-7">
            ...
            <stop stopColor="#FFFFFF" stopOpacity="0.1" offset="100%"></stop>
        </linearGradient>
...
CloudflareWorkersIcon.displayName = "CloudflareWorkersIcon";

export const CloudflareWorkersIconMetadata = {
  id: "cloudflare-workers-icon",
  baseId: "cloudflare-workers-icon",
  variant: "default",
...
export default CloudflareWorkersIcon;
