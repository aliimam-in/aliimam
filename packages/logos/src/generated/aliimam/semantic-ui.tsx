/**
 * Auto-generated logo component: Semantic Ui (default)
...
export interface SemanticUiProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const SemanticUi = React.forwardRef<SVGSVGElement, SemanticUiProps>(
...
SemanticUi.displayName = "SemanticUi";

export const SemanticUiMetadata = {
  id: "semantic-ui",
  baseId: "semantic-ui",
  variant: "default",
  name: "Semantic Ui",
