/**
 * Auto-generated logo component: Tensorflow (default)
...
export interface TensorflowProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Tensorflow = React.forwardRef<SVGSVGElement, TensorflowProps>(
...
export const TensorflowMetadata = {
  id: "tensorflow",
  baseId: "tensorflow",
  variant: "default",
  name: "Tensorflow",
