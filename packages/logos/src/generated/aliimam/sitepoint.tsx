/**
 * Auto-generated logo component: Sitepoint (default)
...
export interface SitepointProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Sitepoint = React.forwardRef<SVGSVGElement, SitepointProps>(
...
export const SitepointMetadata = {
  id: "sitepoint",
  baseId: "sitepoint",
  variant: "default",
  name: "Sitepoint",
