/**
 * Auto-generated logo component: Marko (default)
...
export interface MarkoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Marko = React.forwardRef<SVGSVGElement, MarkoProps>(
...
Marko.displayName = "Marko";

export const MarkoMetadata = {
  id: "marko",
  baseId: "marko",
  variant: "default",
  name: "Marko",
