/**
 * Auto-generated logo component: Compose (default)
...
export interface ComposeProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Compose = React.forwardRef<SVGSVGElement, ComposeProps>(
  ({ size = 24, className = '', ...props }, ref) => (
    ...
    >
      <g>
        ...
        <g fill="#038DC8" opacity="0.5" transform="translate(7.424000, 39.168000)">
