/**
 * Auto-generated logo component: Gravatar Icon (default)
...
export interface GravatarIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const GravatarIcon = React.forwardRef<SVGSVGElement, GravatarIconProps>(
...
GravatarIcon.displayName = "GravatarIcon";

export const GravatarIconMetadata = {
  id: "gravatar-icon",
  baseId: "gravatar-icon",
  variant: "default",
  name: "Gravatar Icon",
  category: "aliimam",
  tags: [],
