...
export interface SourcegraphProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Sourcegraph = React.forwardRef<SVGSVGElement, SourcegraphProps>(
...
export const SourcegraphMetadata = {
  id: "sourcegraph",
  baseId: "sourcegraph",
  variant: "default",
  name: "Sourcegraph",
