/**
 * Auto-generated logo component: Ethereum (default)
...
export interface EthereumProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Ethereum = React.forwardRef<SVGSVGElement, EthereumProps>(
