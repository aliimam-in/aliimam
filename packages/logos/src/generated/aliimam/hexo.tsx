/**
 * Auto-generated logo component: Hexo (default)
...
export interface HexoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Hexo = React.forwardRef<SVGSVGElement, HexoProps>(
