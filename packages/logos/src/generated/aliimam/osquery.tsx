/**
 * Auto-generated logo component: Osquery (default)
...
export interface OsqueryProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Osquery = React.forwardRef<SVGSVGElement, OsqueryProps>(
...
Osquery.displayName = "Osquery";

export const OsqueryMetadata = {
  id: "osquery",
  baseId: "osquery",
  variant: "default",
  name: "Osquery",
