/**
 * Auto-generated logo component: Expo Icon (default)
...
export interface ExpoIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const ExpoIcon = React.forwardRef<SVGSVGElement, ExpoIconProps>(
