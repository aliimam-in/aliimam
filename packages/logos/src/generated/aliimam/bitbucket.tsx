/**
 * Auto-generated logo component: Bitbucket (default)
...
export interface BitbucketProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Bitbucket = React.forwardRef<SVGSVGElement, BitbucketProps>(
...
export const BitbucketMetadata = {
  id: "bitbucket",
  baseId: "bitbucket",
  variant: "default",
  name: "Bitbucket",
