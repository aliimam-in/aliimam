/**
 * Auto-generated logo component: Appveyor (default)
...
export interface AppveyorProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Appveyor = React.forwardRef<SVGSVGElement, AppveyorProps>(
