...
export interface MessengerProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Messenger = React.forwardRef<SVGSVGElement, MessengerProps>(
...
export const MessengerMetadata = {
  id: "messenger",
  baseId: "messenger",
  variant: "default",
  name: "Messenger",
