...
export interface SwiftProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Swift = React.forwardRef<SVGSVGElement, SwiftProps>(
