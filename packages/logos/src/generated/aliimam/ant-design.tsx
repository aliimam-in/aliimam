/**
 * Auto-generated logo component: Ant Design (default)
...
export interface AntDesignProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const AntDesign = React.forwardRef<SVGSVGElement, AntDesignProps>(
...
export const AntDesignMetadata = {
  id: "ant-design",
  baseId: "ant-design",
  variant: "default",
  name: "Ant Design",
