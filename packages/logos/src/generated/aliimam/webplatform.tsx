/**
 * Auto-generated logo component: Webplatform (default)
...
export interface WebplatformProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Webplatform = React.forwardRef<SVGSVGElement, WebplatformProps>(
...
export const WebplatformMetadata = {
  id: "webplatform",
  baseId: "webplatform",
  variant: "default",
  name: "Webplatform",
