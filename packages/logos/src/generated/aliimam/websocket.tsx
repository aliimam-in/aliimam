/**
 * Auto-generated logo component: Websocket (default)
...
export interface WebsocketProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Websocket = React.forwardRef<SVGSVGElement, WebsocketProps>(
