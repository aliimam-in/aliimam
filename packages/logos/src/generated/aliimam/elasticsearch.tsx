/**
 * Auto-generated logo component: Elasticsearch (default)
...
export interface ElasticsearchProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Elasticsearch = React.forwardRef<SVGSVGElement, ElasticsearchProps>(
...
export const ElasticsearchMetadata = {
  id: "elasticsearch",
  baseId: "elasticsearch",
  variant: "default",
  name: "Elasticsearch",
  category: "aliimam",
  tags: [],
