/**
 * Auto-generated logo component: Appium (default)
...
export interface AppiumProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Appium = React.forwardRef<SVGSVGElement, AppiumProps>(
