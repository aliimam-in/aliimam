/**
 * Auto-generated logo component: Opencollective (default)
...
export interface OpencollectiveProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Opencollective = React.forwardRef<SVGSVGElement, OpencollectiveProps>(
...
export const OpencollectiveMetadata = {
  id: "opencollective",
  baseId: "opencollective",
  variant: "default",
  name: "Opencollective",
  category: "aliimam",
  tags: [],
