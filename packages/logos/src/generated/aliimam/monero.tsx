...
export interface MoneroProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Monero = React.forwardRef<SVGSVGElement, MoneroProps>(
