/**
 * Auto-generated logo component: Gradio Icon (default)
...
export interface GradioIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const GradioIcon = React.forwardRef<SVGSVGElement, GradioIconProps>(
    ...
    >
      <defs>
        <linearGradient x1="-6.4516129%" y1="49.7835498%" x2="85.235732%" y2="49.7835498%" id="linearGradient-1">
            <stop stopColor="#F9D100" offset="0%"></stop>
            <stop stopColor="#F97700" offset="100%"></stop>
        </linearGradient>
...
export const GradioIconMetadata = {
  id: "gradio-icon",
  baseId: "gradio-icon",
  variant: "default",
  name: "Gradio Icon",
