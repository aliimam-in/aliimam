...
export interface GatsbyProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Gatsby = React.forwardRef<SVGSVGElement, GatsbyProps>(
