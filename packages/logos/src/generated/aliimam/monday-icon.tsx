/**
 * Auto-generated logo component: Monday Icon (default)
...
export interface MondayIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const MondayIcon = React.forwardRef<SVGSVGElement, MondayIconProps>(
...
export const MondayIconMetadata = {
  id: "monday-icon",
  baseId: "monday-icon",
  variant: "default",
  name: "Monday Icon",
