/**
 * Auto-generated logo component: Microsoft Power Bi (default)
...
export interface MicrosoftPowerBiProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const MicrosoftPowerBi = React.forwardRef<SVGSVGElement, MicrosoftPowerBiProps>(
    ...
    >
      <defs>
        ...
        <linearGradient x1="42.5926042%" y1="-9.35203125e-07%" x2="57.2448958%" y2="93.1735417%" id="power-bi-linearGradient-1">
            <stop stopColor="#E6AD10" offset="0%"></stop>
            <stop stopColor="#C87E0E" offset="100%"></stop>
        </linearGradient>
        <linearGradient x1="40.1218519%" y1="0%" x2="62.0283333%" y2="95.5919444%" id="power-bi-linearGradient-2">
            <stop stopColor="#F6D751" offset="0%"></stop>
            <stop stopColor="#E6AD10" offset="100%"></stop>
        </linearGradient>
        <linearGradient x1="27.7741667%" y1="0%" x2="55.0115278%" y2="96.828125%" id="power-bi-linearGradient-3">
            <stop stopColor="#F9E589" offset="0%"></stop>
            <stop stopColor="#F6D751" offset="100%"></stop>
        </linearGradient>
    </defs>
    <g>
				...
				<path d="M184.888889,100.977778 L184.888889,342.755556 L71.1111111,342.755556 L71.1111111,86.7555556 L170.666667,86.7555556 C178.521244,86.7555556 184.888889,93.1232 184.888889,100.977778 Z" fillOpacity="0.2" fill="#000000" mask="url(#mask-2)"></path>
				<path d="M184.888889,106.666667 L184.888889,348.444444 L71.1111111,348.444444 L71.1111111,92.4444444 L170.666667,92.4444444 C178.521244,92.4444444 184.888889,98.8120889 184.888889,106.666667 Z" fillOpacity="0.18" fill="#000000" mask="url(#mask-2)"></path>
...
MicrosoftPowerBi.displayName = "MicrosoftPowerBi";

export const MicrosoftPowerBiMetadata = {
  id: "microsoft-power-bi",
  baseId: "microsoft-power-bi",
  variant: "default",
