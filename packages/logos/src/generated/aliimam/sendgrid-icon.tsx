/**
 * Auto-generated logo component: Sendgrid Icon (default)
...
export interface SendgridIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const SendgridIcon = React.forwardRef<SVGSVGElement, SendgridIconProps>(
...
export const SendgridIconMetadata = {
  id: "sendgrid-icon",
  baseId: "sendgrid-icon",
  variant: "default",
  name: "Sendgrid Icon",
  category: "aliimam",
  tags: [],
