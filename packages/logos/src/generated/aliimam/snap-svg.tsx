/**
 * Auto-generated logo component: Snap Svg (default)
...
export interface SnapSvgProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const SnapSvg = React.forwardRef<SVGSVGElement, SnapSvgProps>(
...
SnapSvg.displayName = "SnapSvg";

export const SnapSvgMetadata = {
  id: "snap-svg",
  baseId: "snap-svg",
  variant: "default",
  name: "Snap Svg",
