/**
 * Auto-generated logo component: R Lang (default)
...
export interface RLangProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const RLang = React.forwardRef<SVGSVGElement, RLangProps>(
    ...
    >
      <defs>
        <linearGradient x1="37.9725688%" y1="16.9988952%" x2="91.1208363%" y2="76.3260008%" id="linearGradient-1">
            <stop stopColor="#C9CBCE" offset="0%"></stop>
            <stop stopColor="#7B7A81" offset="100%"></stop>
        </linearGradient>
    </defs>
	<g>
