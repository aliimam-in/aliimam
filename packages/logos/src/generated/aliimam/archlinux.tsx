/**
 * Auto-generated logo component: Archlinux (default)
...
export interface ArchlinuxProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Archlinux = React.forwardRef<SVGSVGElement, ArchlinuxProps>(
...
export const ArchlinuxMetadata = {
  id: "archlinux",
  baseId: "archlinux",
  variant: "default",
  name: "Archlinux",
