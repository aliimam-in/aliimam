/**
 * Auto-generated logo component: Akka (default)
...
export interface AkkaProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Akka = React.forwardRef<SVGSVGElement, AkkaProps>(
