/**
 * Auto-generated logo component: Prisma (default)
...
export interface PrismaProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Prisma = React.forwardRef<SVGSVGElement, PrismaProps>(
