/**
 * Auto-generated logo component: Github Octocat (default)
...
export interface GithubOctocatProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const GithubOctocat = React.forwardRef<SVGSVGElement, GithubOctocatProps>(
...
GithubOctocat.displayName = "GithubOctocat";

export const GithubOctocatMetadata = {
  id: "github-octocat",
  baseId: "github-octocat",
  variant: "default",
  name: "Github Octocat",
  category: "aliimam",
  tags: [],
