/**
 * Auto-generated logo component: Qdrant Icon (default)
...
export interface QdrantIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const QdrantIcon = React.forwardRef<SVGSVGElement, QdrantIconProps>(
    ...
    >
      <defs>
        <linearGradient x1="81.5619048%" y1="44.8421053%" x2="-18.0857143%" y2="44.8421053%" id="linearGradient-1">
            <stop stopColor="#FF3364" offset="0%"></stop>
            <stop stopColor="#C91540" stopOpacity="0" offset="100%"></stop>
        </linearGradient>
    </defs>
    <g>
...
export const QdrantIconMetadata = {
  id: "qdrant-icon",
  baseId: "qdrant-icon",
  variant: "default",
  name: "Qdrant Icon",
