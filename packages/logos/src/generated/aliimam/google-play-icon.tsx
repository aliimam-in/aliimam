/**
 * Auto-generated logo component: Google Play Icon (default)
...
export interface GooglePlayIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const GooglePlayIcon = React.forwardRef<SVGSVGElement, GooglePlayIconProps>(
...
export const GooglePlayIconMetadata = {
  id: "google-play-icon",
  baseId: "google-play-icon",
  variant: "default",
