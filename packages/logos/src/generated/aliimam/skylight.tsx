/**
 * Auto-generated logo component: Skylight (default)
...
export interface SkylightProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Skylight = React.forwardRef<SVGSVGElement, SkylightProps>(
  ({ size = 24, className = '', ...props }, ref) => (
    ...
    >
      <g>
		...
		<g transform="translate(68.000000, 84.000000)">
