/**
 * Auto-generated logo component: Vitejs (default)
...
export interface VitejsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Vitejs = React.forwardRef<SVGSVGElement, VitejsProps>(
...
Vitejs.displayName = "Vitejs";

export const VitejsMetadata = {
  id: "vitejs",
  baseId: "vitejs",
  variant: "default",
  name: "Vitejs",
