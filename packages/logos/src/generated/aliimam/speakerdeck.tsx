/**
 * Auto-generated logo component: Speakerdeck (default)
...
export interface SpeakerdeckProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Speakerdeck = React.forwardRef<SVGSVGElement, SpeakerdeckProps>(
...
export const SpeakerdeckMetadata = {
  id: "speakerdeck",
  baseId: "speakerdeck",
  variant: "default",
  name: "Speakerdeck",
