/**
 * Auto-generated logo component: Yeoman (default)
...
export interface YeomanProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Yeoman = React.forwardRef<SVGSVGElement, YeomanProps>(
    ...
    >
      <g>
        ...
        <g>
            ...
            <clipPath id="SVGID_2">
                <use href="#SVGID_1" overflow="visible" />
            </clipPath>
            <g clipPath="url(#SVGID_2)">
...
Yeoman.displayName = "Yeoman";

export const YeomanMetadata = {
  id: "yeoman",
  baseId: "yeoman",
  variant: "default",
  name: "Yeoman",
