/**
 * Auto-generated logo component: V8 (default)
...
export interface V8Props extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const V8 = React.forwardRef<SVGSVGElement, V8Props>(
