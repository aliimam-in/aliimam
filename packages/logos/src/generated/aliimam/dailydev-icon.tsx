/**
 * Auto-generated logo component: Dailydev Icon (default)
...
export interface DailydevIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const DailydevIcon = React.forwardRef<SVGSVGElement, DailydevIconProps>(
...
export const DailydevIconMetadata = {
  id: "dailydev-icon",
  baseId: "dailydev-icon",
  variant: "default",
  name: "Dailydev Icon",
  category: "aliimam",
  tags: [],
