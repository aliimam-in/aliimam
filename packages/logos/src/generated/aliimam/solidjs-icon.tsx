/**
 * Auto-generated logo component: Solidjs Icon (default)
...
export interface SolidjsIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const SolidjsIcon = React.forwardRef<SVGSVGElement, SolidjsIconProps>(
...
export const SolidjsIconMetadata = {
  id: "solidjs-icon",
  baseId: "solidjs-icon",
  variant: "default",
  name: "Solidjs Icon",
