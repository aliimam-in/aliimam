/**
 * Auto-generated logo component: Apollostack (default)
...
export interface ApollostackProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Apollostack = React.forwardRef<SVGSVGElement, ApollostackProps>(
...
export const ApollostackMetadata = {
  id: "apollostack",
  baseId: "apollostack",
  variant: "default",
  name: "Apollostack",
