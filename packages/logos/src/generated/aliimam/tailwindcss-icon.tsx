/**
 * Auto-generated logo component: Tailwindcss Icon (default)
...
export interface TailwindcssIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const TailwindcssIcon = React.forwardRef<SVGSVGElement, TailwindcssIconProps>(
...
export const TailwindcssIconMetadata = {
  id: "tailwindcss-icon",
  baseId: "tailwindcss-icon",
  variant: "default",
