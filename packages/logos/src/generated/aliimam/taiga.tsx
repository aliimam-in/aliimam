/**
 * Auto-generated logo component: Taiga (default)
...
export interface TaigaProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Taiga = React.forwardRef<SVGSVGElement, TaigaProps>(
...
Taiga.displayName = "Taiga";

export const TaigaMetadata = {
  id: "taiga",
  baseId: "taiga",
  variant: "default",
  name: "Taiga",
