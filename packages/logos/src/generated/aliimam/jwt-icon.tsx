/**
 * Auto-generated logo component: Jwt Icon (default)
...
export interface JwtIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const JwtIcon = React.forwardRef<SVGSVGElement, JwtIconProps>(
