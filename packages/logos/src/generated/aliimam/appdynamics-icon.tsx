/**
 * Auto-generated logo component: Appdynamics Icon (default)
...
export interface AppdynamicsIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const AppdynamicsIcon = React.forwardRef<SVGSVGElement, AppdynamicsIconProps>(
...
export default AppdynamicsIcon;
