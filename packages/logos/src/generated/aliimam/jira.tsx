/**
 * Auto-generated logo component: Jira (default)
...
export interface JiraProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Jira = React.forwardRef<SVGSVGElement, JiraProps>(
