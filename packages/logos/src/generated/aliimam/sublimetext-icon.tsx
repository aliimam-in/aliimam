/**
 * Auto-generated logo component: Sublimetext Icon (default)
...
export interface SublimetextIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const SublimetextIcon = React.forwardRef<SVGSVGElement, SublimetextIconProps>(
    ...
    >
      <defs>
        <linearGradient x1="55.1170996%" y1="58.6795405%" x2="63.6801778%" y2="39.5971572%" id="linearGradient-1">
            <stop stopColor="#FF9700" offset="0%"></stop>
            <stop stopColor="#F48E00" offset="53%"></stop>
            <stop stopColor="#D06F00" offset="100%"></stop>
        </linearGradient>
    </defs>
    <g>
...
SublimetextIcon.displayName = "SublimetextIcon";

export const SublimetextIconMetadata = {
  id: "sublimetext-icon",
  baseId: "sublimetext-icon",
  variant: "default",
