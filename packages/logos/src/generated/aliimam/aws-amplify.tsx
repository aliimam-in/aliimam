/**
 * Auto-generated logo component: Aws Amplify (default)
...
export interface AwsAmplifyProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const AwsAmplify = React.forwardRef<SVGSVGElement, AwsAmplifyProps>(
...
AwsAmplify.displayName = "AwsAmplify";

export const AwsAmplifyMetadata = {
  id: "aws-amplify",
  baseId: "aws-amplify",
  variant: "default",
  name: "Aws Amplify",
