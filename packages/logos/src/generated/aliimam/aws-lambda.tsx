/**
 * Auto-generated logo component: Aws Lambda (default)
...
export interface AwsLambdaProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const AwsLambda = React.forwardRef<SVGSVGElement, AwsLambdaProps>(
...
export const AwsLambdaMetadata = {
  id: "aws-lambda",
  baseId: "aws-lambda",
  variant: "default",
  name: "Aws Lambda",
