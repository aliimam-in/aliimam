...
export interface OperaProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Opera = React.forwardRef<SVGSVGElement, OperaProps>(
    ...
    >
      <defs>
        <linearGradient x1="50.0025785%" y1="1.63039062%" x2="50.0025785%" y2="98.5448437%" id="linearGradient-1">
            <stop stopColor="#FF1B2D" offset="30%"></stop>
            <stop stopColor="#FA1A2C" offset="43.81%"></stop>
            <stop stopColor="#ED1528" offset="59.39%"></stop>
            <stop stopColor="#D60E21" offset="75.81%"></stop>
            <stop stopColor="#B70519" offset="92.72%"></stop>
            <stop stopColor="#A70014" offset="100%"></stop>
        </linearGradient>
        <linearGradient x1="49.9902998%" y1="0.852967626%" x2="49.9902998%" y2="99.5189748%" id="linearGradient-2">
            <stop stopColor="#9C0000" offset="0%"></stop>
            <stop stopColor="#FF4B4B" offset="70%"></stop>
        </linearGradient>
    </defs>
	<g>
