/**
 * Auto-generated logo component: Meilisearch (default)
...
export interface MeilisearchProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Meilisearch = React.forwardRef<SVGSVGElement, MeilisearchProps>(
    ...
    >
      <defs>
        <linearGradient x1="153.820608%" y1="-7.63826138%" x2="19.1721041%" y2="89.2387581%" id="meilisearchLinearGradient-1">
            <stop stopColor="#FF5CAA" offset="0%"></stop>
            <stop stopColor="#FF4E62" offset="100%"></stop>
        </linearGradient>
...
export const MeilisearchMetadata = {
  id: "meilisearch",
  baseId: "meilisearch",
  variant: "default",
  name: "Meilisearch",
