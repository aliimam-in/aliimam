/**
 * Auto-generated logo component: Asana Icon (default)
...
export interface AsanaIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const AsanaIcon = React.forwardRef<SVGSVGElement, AsanaIconProps>(
