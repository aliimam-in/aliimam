/**
 * Auto-generated logo component: Namecheap (default)
...
export interface NamecheapProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Namecheap = React.forwardRef<SVGSVGElement, NamecheapProps>(
...
Namecheap.displayName = "Namecheap";

export const NamecheapMetadata = {
  id: "namecheap",
  baseId: "namecheap",
  variant: "default",
  name: "Namecheap",
