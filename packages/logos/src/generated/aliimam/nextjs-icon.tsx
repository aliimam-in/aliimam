/**
 * Auto-generated logo component: Nextjs Icon (default)
...
export interface NextjsIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const NextjsIcon = React.forwardRef<SVGSVGElement, NextjsIconProps>(
...
export const NextjsIconMetadata = {
  id: "nextjs-icon",
  baseId: "nextjs-icon",
  variant: "default",
  name: "Nextjs Icon",
