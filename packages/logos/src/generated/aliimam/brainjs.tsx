/**
 * Auto-generated logo component: Brainjs (default)
...
export interface BrainjsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Brainjs = React.forwardRef<SVGSVGElement, BrainjsProps>(
