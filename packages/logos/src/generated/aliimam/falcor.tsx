/**
 * Auto-generated logo component: Falcor (default)
...
export interface FalcorProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Falcor = React.forwardRef<SVGSVGElement, FalcorProps>(
  ({ size = 24, className = '', ...props }, ref) => (
    ...
    >
      <g>
		<g transform="translate(7.000000, 191.000000)">
...
Falcor.displayName = "Falcor";

export const FalcorMetadata = {
  id: "falcor",
  baseId: "falcor",
  variant: "default",
  name: "Falcor",
