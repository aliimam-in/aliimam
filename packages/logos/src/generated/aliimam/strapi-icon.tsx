/**
 * Auto-generated logo component: Strapi Icon (default)
...
export interface StrapiIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const StrapiIcon = React.forwardRef<SVGSVGElement, StrapiIconProps>(
...
export const StrapiIconMetadata = {
  id: "strapi-icon",
  baseId: "strapi-icon",
  variant: "default",
  name: "Strapi Icon",
