/**
 * Auto-generated logo component: Apiary (default)
...
export interface ApiaryProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Apiary = React.forwardRef<SVGSVGElement, ApiaryProps>(
    ...
    >
      <defs>
        <linearGradient x1="100.011588%" y1="49.9905059%" x2="-6.48195737e-10%" y2="49.9905059%" id="linearGradient-1">
            <stop stopColor="#37BDA6" offset="0%"></stop>
            <stop stopColor="#8AD3B8" offset="100%"></stop>
        </linearGradient>
        <linearGradient x1="100.011588%" y1="49.9980936%" x2="-3.88862804e-09%" y2="49.9980936%" id="linearGradient-2">
            <stop stopColor="#4BB6AD" offset="50%"></stop>
            <stop stopColor="#78BBC1" offset="100%"></stop>
        </linearGradient>
        <linearGradient x1="-0.0184384384%" y1="49.9980936%" x2="100.023183%" y2="49.9980936%" id="linearGradient-3">
            <stop stopColor="#4379A7" offset="0%"></stop>
            <stop stopColor="#7CC9B8" offset="100%"></stop>
        </linearGradient>
    </defs>
	<g>
...
Apiary.displayName = "Apiary";

export const ApiaryMetadata = {
  id: "apiary",
  baseId: "apiary",
  variant: "default",
  name: "Apiary",
