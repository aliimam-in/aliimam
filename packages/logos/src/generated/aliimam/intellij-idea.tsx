/**
 * Auto-generated logo component: Intellij Idea (default)
...
export interface IntellijIdeaProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const IntellijIdea = React.forwardRef<SVGSVGElement, IntellijIdeaProps>(
    ...
    >
      <defs>
        <linearGradient x1="37.0363882%" y1="51.0173323%" x2="178.130095%" y2="41.8613414%" id="intellijLinearGradient-1">
            <stop stopColor="#FC801D" offset="9%"></stop>
            <stop stopColor="#B07F61" offset="23%"></stop>
            <stop stopColor="#577DB3" offset="41%"></stop>
            <stop stopColor="#1E7CE6" offset="53%"></stop>
            <stop stopColor="#087CFA" offset="59%"></stop>
        </linearGradient>
        <linearGradient x1="73.5573972%" y1="114.759971%" x2="35.5746707%" y2="1.07475519%" id="intellijLinearGradient-2">
            ...
            <stop stopColor="#CB3979" offset="8%"></stop>
            <stop stopColor="#9E4997" offset="16%"></stop>
            <stop stopColor="#7557B2" offset="25%"></stop>
            <stop stopColor="#5362C8" offset="34%"></stop>
            <stop stopColor="#386CDA" offset="44%"></stop>
            <stop stopColor="#2373E8" offset="54%"></stop>
            <stop stopColor="#1478F2" offset="66%"></stop>
        ...
        <linearGradient x1="28.5510351%" y1="23.6142262%" x2="81.8011925%" y2="129.75542%" id="intellijLinearGradient-3">
            <stop stopColor="#FE2857" offset="0%"></stop>
            <stop stopColor="#FE295F" offset="8%"></stop>
            <stop stopColor="#FF2D76" offset="21%"></stop>
            <stop stopColor="#FF318C" offset="30%"></stop>
            <stop stopColor="#EA3896" offset="38%"></stop>
            <stop stopColor="#B248AE" offset="55%"></stop>
            <stop stopColor="#5A63D6" offset="79%"></stop>
            <stop stopColor="#087CFA" offset="100%"></stop>
        </linearGradient>
    </defs>
    <g>
...
export const IntellijIdeaMetadata = {
  id: "intellij-idea",
  baseId: "intellij-idea",
  variant: "default",
  name: "Intellij Idea",
  category: "aliimam",
  tags: [],
