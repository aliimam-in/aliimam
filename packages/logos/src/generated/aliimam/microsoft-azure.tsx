/**
 * Auto-generated logo component: Microsoft Azure (default)
...
export interface MicrosoftAzureProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const MicrosoftAzure = React.forwardRef<SVGSVGElement, MicrosoftAzureProps>(
...
export const MicrosoftAzureMetadata = {
  id: "microsoft-azure",
  baseId: "microsoft-azure",
  variant: "default",
