/**
 * Auto-generated logo component: Liftweb (default)
...
export interface LiftwebProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Liftweb = React.forwardRef<SVGSVGElement, LiftwebProps>(
...
Liftweb.displayName = "Liftweb";

export const LiftwebMetadata = {
  id: "liftweb",
  baseId: "liftweb",
  variant: "default",
  name: "Liftweb",
