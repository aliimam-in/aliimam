/**
 * Auto-generated logo component: Swiftype (default)
...
export interface SwiftypeProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Swiftype = React.forwardRef<SVGSVGElement, SwiftypeProps>(
