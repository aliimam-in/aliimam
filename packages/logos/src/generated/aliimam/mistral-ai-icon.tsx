/**
 * Auto-generated logo component: Mistral Ai Icon (default)
...
export interface MistralAiIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const MistralAiIcon = React.forwardRef<SVGSVGElement, MistralAiIconProps>(
...
MistralAiIcon.displayName = "MistralAiIcon";

export const MistralAiIconMetadata = {
  id: "mistral-ai-icon",
  baseId: "mistral-ai-icon",
  variant: "default",
