/**
 * Auto-generated logo component: Rsmq (default)
...
export interface RsmqProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Rsmq = React.forwardRef<SVGSVGElement, RsmqProps>(
...
Rsmq.displayName = "Rsmq";

export const RsmqMetadata = {
  id: "rsmq",
  baseId: "rsmq",
  variant: "default",
  name: "Rsmq",
