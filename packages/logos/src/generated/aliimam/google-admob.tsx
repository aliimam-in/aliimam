...
export interface GoogleAdmobProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const GoogleAdmob = React.forwardRef<SVGSVGElement, GoogleAdmobProps>(
