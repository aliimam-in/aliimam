/**
 * Auto-generated logo component: Cyclejs (default)
...
export interface CyclejsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Cyclejs = React.forwardRef<SVGSVGElement, CyclejsProps>(
  ({ size = 24, className = '', ...props }, ref) => (
    ...
    >
      <defs>
        <linearGradient x1="29.1842525%" y1="99.591125%" x2="86.4835855%" y2="0.354484375%" id="linearGradient-1">
            <stop stopColor="#51D3D9" offset="41.47%"></stop>
            <stop stopColor="#C8FF8C" offset="100%"></stop>
        </linearGradient>
        <linearGradient x1="34.1175797%" y1="106.866256%" x2="94.6503472%" y2="20.5520801%" id="linearGradient-2">
            <stop stopColor="#51D3D9" offset="41.47%"></stop>
            <stop stopColor="#5A919B" offset="100%"></stop>
        </linearGradient>
    </defs>
	<g>
...
Cyclejs.displayName = "Cyclejs";

export const CyclejsMetadata = {
  id: "cyclejs",
  baseId: "cyclejs",
  variant: "default",
  name: "Cyclejs",
