/**
 * Auto-generated logo component: Medusa Icon (default)
...
export interface MedusaIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const MedusaIcon = React.forwardRef<SVGSVGElement, MedusaIconProps>(
    ...
    >
      <defs>
        <linearGradient x1="-66.6972559%" y1="81.8702074%" x2="108.629506%" y2="34.4186803%" id="medusaLinearGradient-1">
            <stop stopColor="#592EE1" offset="26.5625%"></stop>
            <stop stopColor="#B836D9" offset="100%"></stop>
        </linearGradient>
    </defs>
    <g>
...
export const MedusaIconMetadata = {
  id: "medusa-icon",
  baseId: "medusa-icon",
  variant: "default",
  name: "Medusa Icon",
