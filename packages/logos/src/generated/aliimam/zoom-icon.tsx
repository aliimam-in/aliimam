/**
 * Auto-generated logo component: Zoom Icon (default)
...
export const ZoomIcon = React.forwardRef<SVGSVGElement, ZoomIconProps>(
  ({ size = 24, className = '', ...props }, ref) => (
    ...
    >
      <defs>
        <linearGradient x1="23.666%" y1="95.6118%" x2="76.334%" y2="4.3882%" id="zoomLinearGradient-1">
