/**
 * Auto-generated logo component: Helpscout Icon (default)
...
export interface HelpscoutIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const HelpscoutIcon = React.forwardRef<SVGSVGElement, HelpscoutIconProps>(
...
HelpscoutIcon.displayName = "HelpscoutIcon";

export const HelpscoutIconMetadata = {
  id: "helpscout-icon",
  baseId: "helpscout-icon",
  variant: "default",
  name: "Helpscout Icon",
  category: "aliimam",
  tags: [],
