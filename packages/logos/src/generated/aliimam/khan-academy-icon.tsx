/**
 * Auto-generated logo component: Khan Academy Icon (default)
...
export interface KhanAcademyIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const KhanAcademyIcon = React.forwardRef<SVGSVGElement, KhanAcademyIconProps>(
...
KhanAcademyIcon.displayName = "KhanAcademyIcon";

export const KhanAcademyIconMetadata = {
  id: "khan-academy-icon",
  baseId: "khan-academy-icon",
  variant: "default",
