/**
 * Auto-generated logo component: Hume Ai (default)
...
export interface HumeAiProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const HumeAi = React.forwardRef<SVGSVGElement, HumeAiProps>(
