/**
 * Auto-generated logo component: Anthropic Wordmark (light)
...
export interface AnthropicWordmarkLightProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const AnthropicWordmarkLight = React.forwardRef<SVGSVGElement, AnthropicWordmarkLightProps>(
...
AnthropicWordmarkLight.displayName = "AnthropicWordmarkLight";

export const AnthropicWordmarkLightMetadata = {
  id: "Anthropic-wordmark_light",
  baseId: "Anthropic-wordmark",
  variant: "light",
...
export default AnthropicWordmarkLight;
