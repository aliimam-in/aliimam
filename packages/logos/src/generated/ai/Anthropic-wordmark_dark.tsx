/**
 * Auto-generated logo component: Anthropic Wordmark (dark)
...
export interface AnthropicWordmarkDarkProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const AnthropicWordmarkDark = React.forwardRef<SVGSVGElement, AnthropicWordmarkDarkProps>(
...
AnthropicWordmarkDark.displayName = "AnthropicWordmarkDark";

export const AnthropicWordmarkDarkMetadata = {
  id: "Anthropic-wordmark_dark",
...
export default AnthropicWordmarkDark;
