...
export interface RwandaFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const RwandaFlags = React.forwardRef<SVGSVGElement, RwandaFlagsProps>(
