...
export interface BoliviaFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const BoliviaFlags = React.forwardRef<SVGSVGElement, BoliviaFlagsProps>(
...
BoliviaFlags.displayName = "BoliviaFlags";

export const BoliviaFlagsMetadata = {
  id: "Bolivia_flags",
  baseId: "Bolivia",
  variant: "flags",
  name: "Bolivia",
