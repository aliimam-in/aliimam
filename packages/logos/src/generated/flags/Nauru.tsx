/**
 * Auto-generated logo component: Nauru (default)
...
export interface NauruProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Nauru = React.forwardRef<SVGSVGElement, NauruProps>(
