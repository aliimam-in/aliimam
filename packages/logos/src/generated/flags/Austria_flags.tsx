...
export interface AustriaFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const AustriaFlags = React.forwardRef<SVGSVGElement, AustriaFlagsProps>(
...
AustriaFlags.displayName = "AustriaFlags";

export const AustriaFlagsMetadata = {
  id: "Austria_flags",
  baseId: "Austria",
  variant: "flags",
  name: "Austria",
