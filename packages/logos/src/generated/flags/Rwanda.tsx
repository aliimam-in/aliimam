/**
 * Auto-generated logo component: Rwanda (default)
...
export interface RwandaProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Rwanda = React.forwardRef<SVGSVGElement, RwandaProps>(
