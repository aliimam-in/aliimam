...
export interface BotswanaFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const BotswanaFlags = React.forwardRef<SVGSVGElement, BotswanaFlagsProps>(
...
BotswanaFlags.displayName = "BotswanaFlags";

export const BotswanaFlagsMetadata = {
  id: "Botswana_flags",
  baseId: "Botswana",
  variant: "flags",
  name: "Botswana",
