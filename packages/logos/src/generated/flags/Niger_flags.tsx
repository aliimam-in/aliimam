...
export interface NigerFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const NigerFlags = React.forwardRef<SVGSVGElement, NigerFlagsProps>(
...
NigerFlags.displayName = "NigerFlags";

export const NigerFlagsMetadata = {
  id: "Niger_flags",
  baseId: "Niger",
  variant: "flags",
  name: "Niger",
