...
export interface SierraLeoneFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const SierraLeoneFlags = React.forwardRef<SVGSVGElement, SierraLeoneFlagsProps>(
...
SierraLeoneFlags.displayName = "SierraLeoneFlags";

export const SierraLeoneFlagsMetadata = {
  id: "Sierra-Leone_flags",
  baseId: "Sierra-Leone",
  variant: "flags",
  name: "Sierra Leone",
  category: "flags",
...
export default SierraLeoneFlags;
