...
export interface CentralAfricanRepuFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const CentralAfricanRepuFlags = React.forwardRef<SVGSVGElement, CentralAfricanRepuFlagsProps>(
...
CentralAfricanRepuFlags.displayName = "CentralAfricanRepuFlags";

export const CentralAfricanRepuFlagsMetadata = {
  id: "Central-African-Repu_flags",
...
export default CentralAfricanRepuFlags;
