/**
 * Auto-generated logo component: Uruguay (default)
...
export interface UruguayProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Uruguay = React.forwardRef<SVGSVGElement, UruguayProps>(
