/**
 * Auto-generated logo component: Bolivia (default)
...
export interface BoliviaProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Bolivia = React.forwardRef<SVGSVGElement, BoliviaProps>(
