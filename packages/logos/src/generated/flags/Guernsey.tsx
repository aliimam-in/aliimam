/**
 * Auto-generated logo component: Guernsey (default)
...
export interface GuernseyProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Guernsey = React.forwardRef<SVGSVGElement, GuernseyProps>(
