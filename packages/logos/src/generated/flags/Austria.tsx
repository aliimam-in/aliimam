/**
 * Auto-generated logo component: Austria (default)
...
export interface AustriaProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Austria = React.forwardRef<SVGSVGElement, AustriaProps>(
