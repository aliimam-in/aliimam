/**
 * Auto-generated logo component: Vietnam (default)
...
export interface VietnamProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Vietnam = React.forwardRef<SVGSVGElement, VietnamProps>(
