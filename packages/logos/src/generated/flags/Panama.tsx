/**
 * Auto-generated logo component: Panama (default)
...
export interface PanamaProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Panama = React.forwardRef<SVGSVGElement, PanamaProps>(
