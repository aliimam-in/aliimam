...
export interface AalandIslandsFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const AalandIslandsFlags = React.forwardRef<SVGSVGElement, AalandIslandsFlagsProps>(
...
AalandIslandsFlags.displayName = "AalandIslandsFlags";

export const AalandIslandsFlagsMetadata = {
  id: "Aaland-Islands_flags",
...
export default AalandIslandsFlags;
