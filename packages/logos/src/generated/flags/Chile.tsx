/**
 * Auto-generated logo component: Chile (default)
...
export interface ChileProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Chile = React.forwardRef<SVGSVGElement, ChileProps>(
