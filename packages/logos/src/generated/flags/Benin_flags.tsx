...
export interface BeninFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const BeninFlags = React.forwardRef<SVGSVGElement, BeninFlagsProps>(
...
BeninFlags.displayName = "BeninFlags";

export const BeninFlagsMetadata = {
  id: "Benin_flags",
  baseId: "Benin",
  variant: "flags",
  name: "Benin",
