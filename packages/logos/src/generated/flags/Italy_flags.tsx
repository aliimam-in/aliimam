...
export interface ItalyFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const ItalyFlags = React.forwardRef<SVGSVGElement, ItalyFlagsProps>(
...
ItalyFlags.displayName = "ItalyFlags";

export const ItalyFlagsMetadata = {
  id: "Italy_flags",
  baseId: "Italy",
  variant: "flags",
  name: "Italy",
