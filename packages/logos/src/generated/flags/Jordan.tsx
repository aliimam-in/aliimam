/**
 * Auto-generated logo component: Jordan (default)
...
export interface JordanProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Jordan = React.forwardRef<SVGSVGElement, JordanProps>(
