...
export interface GuernseyFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const GuernseyFlags = React.forwardRef<SVGSVGElement, GuernseyFlagsProps>(
...
GuernseyFlags.displayName = "GuernseyFlags";

export const GuernseyFlagsMetadata = {
  id: "Guernsey_flags",
  baseId: "Guernsey",
  variant: "flags",
  name: "Guernsey",
