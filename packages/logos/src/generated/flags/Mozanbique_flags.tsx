...
export interface MozanbiqueFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const MozanbiqueFlags = React.forwardRef<SVGSVGElement, MozanbiqueFlagsProps>(
...
MozanbiqueFlags.displayName = "MozanbiqueFlags";

export const MozanbiqueFlagsMetadata = {
  id: "Mozanbique_flags",
  baseId: "Mozanbique",
  variant: "flags",
  name: "Mozanbique",
...
export default MozanbiqueFlags;
