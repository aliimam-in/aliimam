...
export interface SyriaFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const SyriaFlags = React.forwardRef<SVGSVGElement, SyriaFlagsProps>(
...
SyriaFlags.displayName = "SyriaFlags";

export const SyriaFlagsMetadata = {
  id: "Syria_flags",
  baseId: "Syria",
  variant: "flags",
  name: "Syria",
