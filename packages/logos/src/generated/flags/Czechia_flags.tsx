...
export interface CzechiaFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const CzechiaFlags = React.forwardRef<SVGSVGElement, CzechiaFlagsProps>(
...
CzechiaFlags.displayName = "CzechiaFlags";

export const CzechiaFlagsMetadata = {
  id: "Czechia_flags",
  baseId: "Czechia",
  variant: "flags",
  name: "Czechia",
