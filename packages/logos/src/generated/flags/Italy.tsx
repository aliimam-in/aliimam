/**
 * Auto-generated logo component: Italy (default)
...
export interface ItalyProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Italy = React.forwardRef<SVGSVGElement, ItalyProps>(
