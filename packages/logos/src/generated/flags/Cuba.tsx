/**
 * Auto-generated logo component: Cuba (default)
...
export interface CubaProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Cuba = React.forwardRef<SVGSVGElement, CubaProps>(
