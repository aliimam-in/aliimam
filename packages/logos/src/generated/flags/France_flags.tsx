...
export interface FranceFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const FranceFlags = React.forwardRef<SVGSVGElement, FranceFlagsProps>(
...
FranceFlags.displayName = "FranceFlags";

export const FranceFlagsMetadata = {
  id: "France_flags",
  baseId: "France",
  variant: "flags",
  name: "France",
