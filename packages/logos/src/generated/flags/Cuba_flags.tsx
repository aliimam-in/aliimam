...
export interface CubaFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const CubaFlags = React.forwardRef<SVGSVGElement, CubaFlagsProps>(
...
CubaFlags.displayName = "CubaFlags";

export const CubaFlagsMetadata = {
  id: "Cuba_flags",
  baseId: "Cuba",
  variant: "flags",
  name: "Cuba",
