...
export interface SwedenFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const SwedenFlags = React.forwardRef<SVGSVGElement, SwedenFlagsProps>(
...
SwedenFlags.displayName = "SwedenFlags";

export const SwedenFlagsMetadata = {
  id: "Sweden_flags",
  baseId: "Sweden",
  variant: "flags",
  name: "Sweden",
