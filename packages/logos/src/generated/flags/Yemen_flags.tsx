...
export interface YemenFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const YemenFlags = React.forwardRef<SVGSVGElement, YemenFlagsProps>(
...
YemenFlags.displayName = "YemenFlags";

export const YemenFlagsMetadata = {
  id: "Yemen_flags",
  baseId: "Yemen",
  variant: "flags",
  name: "Yemen",
