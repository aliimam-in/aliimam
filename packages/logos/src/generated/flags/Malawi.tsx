/**
 * Auto-generated logo component: Malawi (default)
...
export interface MalawiProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Malawi = React.forwardRef<SVGSVGElement, MalawiProps>(
