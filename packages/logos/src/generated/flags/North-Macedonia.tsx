/**
 * Auto-generated logo component: North Macedonia (default)
...
export interface NorthMacedoniaProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const NorthMacedonia = React.forwardRef<SVGSVGElement, NorthMacedoniaProps>(
...
export const NorthMacedoniaMetadata = {
  id: "North-Macedonia",
