/**
 * Auto-generated logo component: Kurdistan (default)
...
export interface KurdistanProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Kurdistan = React.forwardRef<SVGSVGElement, KurdistanProps>(
...
export const KurdistanMetadata = {
  id: "Kurdistan",
  baseId: "Kurdistan",
  variant: "default",
  name: "Kurdistan",
