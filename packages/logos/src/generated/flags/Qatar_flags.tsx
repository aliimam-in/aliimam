...
export interface QatarFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const QatarFlags = React.forwardRef<SVGSVGElement, QatarFlagsProps>(
...
QatarFlags.displayName = "QatarFlags";

export const QatarFlagsMetadata = {
  id: "Qatar_flags",
  baseId: "Qatar",
  variant: "flags",
  name: "Qatar",
