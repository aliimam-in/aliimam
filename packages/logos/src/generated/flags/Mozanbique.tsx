/**
 * Auto-generated logo component: Mozanbique (default)
...
export interface MozanbiqueProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Mozanbique = React.forwardRef<SVGSVGElement, MozanbiqueProps>(
...
export const MozanbiqueMetadata = {
  id: "Mozanbique",
  baseId: "Mozanbique",
  variant: "default",
  name: "Mozanbique",
