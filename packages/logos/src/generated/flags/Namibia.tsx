/**
 * Auto-generated logo component: Namibia (default)
...
export interface NamibiaProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Namibia = React.forwardRef<SVGSVGElement, NamibiaProps>(
