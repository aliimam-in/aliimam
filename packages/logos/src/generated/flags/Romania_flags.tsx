...
export interface RomaniaFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const RomaniaFlags = React.forwardRef<SVGSVGElement, RomaniaFlagsProps>(
...
RomaniaFlags.displayName = "RomaniaFlags";

export const RomaniaFlagsMetadata = {
  id: "Romania_flags",
  baseId: "Romania",
  variant: "flags",
  name: "Romania",
