/**
 * Auto-generated logo component: Barbados (default)
...
export interface BarbadosProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Barbados = React.forwardRef<SVGSVGElement, BarbadosProps>(
