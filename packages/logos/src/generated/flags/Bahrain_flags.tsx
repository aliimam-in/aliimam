...
export interface BahrainFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const BahrainFlags = React.forwardRef<SVGSVGElement, BahrainFlagsProps>(
...
BahrainFlags.displayName = "BahrainFlags";

export const BahrainFlagsMetadata = {
  id: "Bahrain_flags",
  baseId: "Bahrain",
  variant: "flags",
  name: "Bahrain",
