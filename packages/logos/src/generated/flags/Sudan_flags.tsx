...
export interface SudanFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const SudanFlags = React.forwardRef<SVGSVGElement, SudanFlagsProps>(
...
SudanFlags.displayName = "SudanFlags";

export const SudanFlagsMetadata = {
  id: "Sudan_flags",
  baseId: "Sudan",
  variant: "flags",
  name: "Sudan",
