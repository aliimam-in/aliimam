...
export interface BangladeshFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const BangladeshFlags = React.forwardRef<SVGSVGElement, BangladeshFlagsProps>(
...
BangladeshFlags.displayName = "BangladeshFlags";

export const BangladeshFlagsMetadata = {
  id: "Bangladesh_flags",
  baseId: "Bangladesh",
  variant: "flags",
  name: "Bangladesh",
...
export default BangladeshFlags;
