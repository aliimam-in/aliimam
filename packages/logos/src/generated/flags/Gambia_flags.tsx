...
export interface GambiaFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const GambiaFlags = React.forwardRef<SVGSVGElement, GambiaFlagsProps>(
...
GambiaFlags.displayName = "GambiaFlags";

export const GambiaFlagsMetadata = {
  id: "Gambia_flags",
  baseId: "Gambia",
  variant: "flags",
  name: "Gambia",
