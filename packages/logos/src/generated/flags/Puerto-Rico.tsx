/**
 * Auto-generated logo component: Puerto Rico (default)
...
export interface PuertoRicoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const PuertoRico = React.forwardRef<SVGSVGElement, PuertoRicoProps>(
...
export const PuertoRicoMetadata = {
  id: "Puerto-Rico",
  baseId: "Puerto-Rico",
  variant: "default",
  name: "Puerto Rico",
