...
export interface TongaFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const TongaFlags = React.forwardRef<SVGSVGElement, TongaFlagsProps>(
...
TongaFlags.displayName = "TongaFlags";

export const TongaFlagsMetadata = {
  id: "Tonga_flags",
  baseId: "Tonga",
  variant: "flags",
  name: "Tonga",
