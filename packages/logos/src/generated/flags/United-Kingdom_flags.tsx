...
export interface UnitedKingdomFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const UnitedKingdomFlags = React.forwardRef<SVGSVGElement, UnitedKingdomFlagsProps>(
...
UnitedKingdomFlags.displayName = "UnitedKingdomFlags";

export const UnitedKingdomFlagsMetadata = {
  id: "United-Kingdom_flags",
...
export default UnitedKingdomFlags;
