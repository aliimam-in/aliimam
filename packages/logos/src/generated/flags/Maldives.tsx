/**
 * Auto-generated logo component: Maldives (default)
...
export interface MaldivesProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Maldives = React.forwardRef<SVGSVGElement, MaldivesProps>(
