/**
 * Auto-generated logo component: Basque (default)
...
export interface BasqueProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Basque = React.forwardRef<SVGSVGElement, BasqueProps>(
