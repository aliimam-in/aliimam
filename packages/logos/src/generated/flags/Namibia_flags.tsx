...
export interface NamibiaFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const NamibiaFlags = React.forwardRef<SVGSVGElement, NamibiaFlagsProps>(
...
NamibiaFlags.displayName = "NamibiaFlags";

export const NamibiaFlagsMetadata = {
  id: "Namibia_flags",
  baseId: "Namibia",
  variant: "flags",
  name: "Namibia",
