/**
 * Auto-generated logo component: Central African Repu (default)
...
export interface CentralAfricanRepuProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const CentralAfricanRepu = React.forwardRef<SVGSVGElement, CentralAfricanRepuProps>(
...
export const CentralAfricanRepuMetadata = {
  id: "Central-African-Repu",
