...
export interface GreeceFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const GreeceFlags = React.forwardRef<SVGSVGElement, GreeceFlagsProps>(
...
GreeceFlags.displayName = "GreeceFlags";

export const GreeceFlagsMetadata = {
  id: "Greece_flags",
  baseId: "Greece",
  variant: "flags",
  name: "Greece",
