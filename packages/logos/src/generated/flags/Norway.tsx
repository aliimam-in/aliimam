/**
 * Auto-generated logo component: Norway (default)
...
export interface NorwayProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Norway = React.forwardRef<SVGSVGElement, NorwayProps>(
