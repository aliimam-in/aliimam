...
export interface NorthMacedoniaFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const NorthMacedoniaFlags = React.forwardRef<SVGSVGElement, NorthMacedoniaFlagsProps>(
...
NorthMacedoniaFlags.displayName = "NorthMacedoniaFlags";

export const NorthMacedoniaFlagsMetadata = {
  id: "North-Macedonia_flags",
...
export default NorthMacedoniaFlags;
