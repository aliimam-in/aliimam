...
export interface LesothoSymbolsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const LesothoSymbols = React.forwardRef<SVGSVGElement, LesothoSymbolsProps>(
...
LesothoSymbols.displayName = "LesothoSymbols";

export const LesothoSymbolsMetadata = {
  id: "Lesotho_symbols",
  baseId: "Lesotho",
  variant: "symbols",
  name: "Lesotho",
