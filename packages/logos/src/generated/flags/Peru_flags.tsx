...
export interface PeruFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const PeruFlags = React.forwardRef<SVGSVGElement, PeruFlagsProps>(
...
PeruFlags.displayName = "PeruFlags";

export const PeruFlagsMetadata = {
  id: "Peru_flags",
  baseId: "Peru",
  variant: "flags",
  name: "Peru",
