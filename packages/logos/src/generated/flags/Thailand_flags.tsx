...
export interface ThailandFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const ThailandFlags = React.forwardRef<SVGSVGElement, ThailandFlagsProps>(
...
ThailandFlags.displayName = "ThailandFlags";

export const ThailandFlagsMetadata = {
  id: "Thailand_flags",
  baseId: "Thailand",
  variant: "flags",
  name: "Thailand",
