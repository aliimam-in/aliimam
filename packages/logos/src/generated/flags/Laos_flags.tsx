...
export interface LaosFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const LaosFlags = React.forwardRef<SVGSVGElement, LaosFlagsProps>(
...
LaosFlags.displayName = "LaosFlags";

export const LaosFlagsMetadata = {
  id: "Laos_flags",
  baseId: "Laos",
  variant: "flags",
  name: "Laos",
