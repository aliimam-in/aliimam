...
export interface TurkeyFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const TurkeyFlags = React.forwardRef<SVGSVGElement, TurkeyFlagsProps>(
...
TurkeyFlags.displayName = "TurkeyFlags";

export const TurkeyFlagsMetadata = {
  id: "Turkey_flags",
  baseId: "Turkey",
  variant: "flags",
  name: "Turkey",
