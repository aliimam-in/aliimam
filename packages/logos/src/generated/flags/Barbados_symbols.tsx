...
export interface BarbadosSymbolsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const BarbadosSymbols = React.forwardRef<SVGSVGElement, BarbadosSymbolsProps>(
...
export default BarbadosSymbols;
