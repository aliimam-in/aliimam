/**
 * Auto-generated logo component: Northen Ireland (default)
...
export interface NorthenIrelandProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const NorthenIreland = React.forwardRef<SVGSVGElement, NorthenIrelandProps>(
...
export const NorthenIrelandMetadata = {
  id: "Northen-Ireland",
