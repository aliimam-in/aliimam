...
export interface TogoFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const TogoFlags = React.forwardRef<SVGSVGElement, TogoFlagsProps>(
...
TogoFlags.displayName = "TogoFlags";

export const TogoFlagsMetadata = {
  id: "Togo_flags",
  baseId: "Togo",
  variant: "flags",
  name: "Togo",
