...
export interface ComorosFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const ComorosFlags = React.forwardRef<SVGSVGElement, ComorosFlagsProps>(
...
ComorosFlags.displayName = "ComorosFlags";

export const ComorosFlagsMetadata = {
  id: "Comoros_flags",
  baseId: "Comoros",
  variant: "flags",
  name: "Comoros",
