/**
 * Auto-generated logo component: Palau (default)
...
export interface PalauProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Palau = React.forwardRef<SVGSVGElement, PalauProps>(
