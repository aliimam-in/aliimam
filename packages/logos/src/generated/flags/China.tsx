/**
 * Auto-generated logo component: China (default)
...
export interface ChinaProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const China = React.forwardRef<SVGSVGElement, ChinaProps>(
