/**
 * Auto-generated logo component: France (default)
...
export interface FranceProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const France = React.forwardRef<SVGSVGElement, FranceProps>(
