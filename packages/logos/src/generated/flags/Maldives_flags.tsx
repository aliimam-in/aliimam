...
export interface MaldivesFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const MaldivesFlags = React.forwardRef<SVGSVGElement, MaldivesFlagsProps>(
...
MaldivesFlags.displayName = "MaldivesFlags";

export const MaldivesFlagsMetadata = {
  id: "Maldives_flags",
  baseId: "Maldives",
  variant: "flags",
  name: "Maldives",
