...
export interface MalawiFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const MalawiFlags = React.forwardRef<SVGSVGElement, MalawiFlagsProps>(
...
MalawiFlags.displayName = "MalawiFlags";

export const MalawiFlagsMetadata = {
  id: "Malawi_flags",
  baseId: "Malawi",
  variant: "flags",
  name: "Malawi",
