/**
 * Auto-generated logo component: United Kingdom (default)
...
export interface UnitedKingdomProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const UnitedKingdom = React.forwardRef<SVGSVGElement, UnitedKingdomProps>(
...
export const UnitedKingdomMetadata = {
  id: "United-Kingdom",
