...
export interface VietnamFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const VietnamFlags = React.forwardRef<SVGSVGElement, VietnamFlagsProps>(
...
VietnamFlags.displayName = "VietnamFlags";

export const VietnamFlagsMetadata = {
  id: "Vietnam_flags",
  baseId: "Vietnam",
  variant: "flags",
  name: "Vietnam",
