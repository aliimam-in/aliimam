/**
 * Auto-generated logo component: Mauritius (default)
...
export interface MauritiusProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Mauritius = React.forwardRef<SVGSVGElement, MauritiusProps>(
...
export const MauritiusMetadata = {
  id: "Mauritius",
  baseId: "Mauritius",
  variant: "default",
  name: "Mauritius",
