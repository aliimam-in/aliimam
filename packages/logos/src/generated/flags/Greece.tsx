/**
 * Auto-generated logo component: Greece (default)
...
export interface GreeceProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Greece = React.forwardRef<SVGSVGElement, GreeceProps>(
