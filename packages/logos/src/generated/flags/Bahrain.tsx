/**
 * Auto-generated logo component: Bahrain (default)
...
export interface BahrainProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Bahrain = React.forwardRef<SVGSVGElement, BahrainProps>(
