...
export interface GreenlandFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const GreenlandFlags = React.forwardRef<SVGSVGElement, GreenlandFlagsProps>(
...
GreenlandFlags.displayName = "GreenlandFlags";

export const GreenlandFlagsMetadata = {
  id: "Greenland_flags",
  baseId: "Greenland",
  variant: "flags",
  name: "Greenland",
