...
export interface MauritiusFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const MauritiusFlags = React.forwardRef<SVGSVGElement, MauritiusFlagsProps>(
...
MauritiusFlags.displayName = "MauritiusFlags";

export const MauritiusFlagsMetadata = {
  id: "Mauritius_flags",
  baseId: "Mauritius",
  variant: "flags",
  name: "Mauritius",
