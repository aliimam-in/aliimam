/**
 * Auto-generated logo component: Finland (default)
...
export interface FinlandProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Finland = React.forwardRef<SVGSVGElement, FinlandProps>(
