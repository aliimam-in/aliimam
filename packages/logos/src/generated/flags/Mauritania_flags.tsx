...
export interface MauritaniaFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const MauritaniaFlags = React.forwardRef<SVGSVGElement, MauritaniaFlagsProps>(
...
MauritaniaFlags.displayName = "MauritaniaFlags";

export const MauritaniaFlagsMetadata = {
  id: "Mauritania_flags",
  baseId: "Mauritania",
  variant: "flags",
  name: "Mauritania",
...
export default MauritaniaFlags;
