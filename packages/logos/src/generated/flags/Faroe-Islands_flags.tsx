...
export interface FaroeIslandsFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const FaroeIslandsFlags = React.forwardRef<SVGSVGElement, FaroeIslandsFlagsProps>(
...
FaroeIslandsFlags.displayName = "FaroeIslandsFlags";

export const FaroeIslandsFlagsMetadata = {
  id: "Faroe-Islands_flags",
...
export default FaroeIslandsFlags;
