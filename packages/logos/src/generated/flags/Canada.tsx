/**
 * Auto-generated logo component: Canada (default)
...
export interface CanadaProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Canada = React.forwardRef<SVGSVGElement, CanadaProps>(
