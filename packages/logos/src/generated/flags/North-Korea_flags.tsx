...
export interface NorthKoreaFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const NorthKoreaFlags = React.forwardRef<SVGSVGElement, NorthKoreaFlagsProps>(
...
NorthKoreaFlags.displayName = "NorthKoreaFlags";

export const NorthKoreaFlagsMetadata = {
  id: "North-Korea_flags",
  baseId: "North-Korea",
  variant: "flags",
  name: "North Korea",
  category: "flags",
...
export default NorthKoreaFlags;
