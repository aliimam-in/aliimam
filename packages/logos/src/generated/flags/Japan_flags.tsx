...
export interface JapanFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const JapanFlags = React.forwardRef<SVGSVGElement, JapanFlagsProps>(
...
JapanFlags.displayName = "JapanFlags";

export const JapanFlagsMetadata = {
  id: "Japan_flags",
  baseId: "Japan",
  variant: "flags",
  name: "Japan",
