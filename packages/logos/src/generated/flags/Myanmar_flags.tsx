...
export interface MyanmarFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const MyanmarFlags = React.forwardRef<SVGSVGElement, MyanmarFlagsProps>(
...
MyanmarFlags.displayName = "MyanmarFlags";

export const MyanmarFlagsMetadata = {
  id: "Myanmar_flags",
  baseId: "Myanmar",
  variant: "flags",
  name: "Myanmar",
