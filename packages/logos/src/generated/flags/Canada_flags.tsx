...
export interface CanadaFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const CanadaFlags = React.forwardRef<SVGSVGElement, CanadaFlagsProps>(
...
CanadaFlags.displayName = "CanadaFlags";

export const CanadaFlagsMetadata = {
  id: "Canada_flags",
  baseId: "Canada",
  variant: "flags",
  name: "Canada",
