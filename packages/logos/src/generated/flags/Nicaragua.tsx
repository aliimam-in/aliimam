/**
 * Auto-generated logo component: Nicaragua (default)
...
export interface NicaraguaProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Nicaragua = React.forwardRef<SVGSVGElement, NicaraguaProps>(
...
export const NicaraguaMetadata = {
  id: "Nicaragua",
  baseId: "Nicaragua",
  variant: "default",
  name: "Nicaragua",
