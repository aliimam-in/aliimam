...
export interface NauruFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const NauruFlags = React.forwardRef<SVGSVGElement, NauruFlagsProps>(
...
NauruFlags.displayName = "NauruFlags";

export const NauruFlagsMetadata = {
  id: "Nauru_flags",
  baseId: "Nauru",
  variant: "flags",
  name: "Nauru",
