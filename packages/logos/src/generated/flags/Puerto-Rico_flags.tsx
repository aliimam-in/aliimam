...
export interface PuertoRicoFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const PuertoRicoFlags = React.forwardRef<SVGSVGElement, PuertoRicoFlagsProps>(
...
PuertoRicoFlags.displayName = "PuertoRicoFlags";

export const PuertoRicoFlagsMetadata = {
  id: "Puerto-Rico_flags",
  baseId: "Puerto-Rico",
  variant: "flags",
  name: "Puerto Rico",
  category: "flags",
...
export default PuertoRicoFlags;
