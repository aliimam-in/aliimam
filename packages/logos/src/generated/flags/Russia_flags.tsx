...
export interface RussiaFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const RussiaFlags = React.forwardRef<SVGSVGElement, RussiaFlagsProps>(
...
RussiaFlags.displayName = "RussiaFlags";

export const RussiaFlagsMetadata = {
  id: "Russia_flags",
  baseId: "Russia",
  variant: "flags",
  name: "Russia",
