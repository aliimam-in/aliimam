...
export interface BasqueFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const BasqueFlags = React.forwardRef<SVGSVGElement, BasqueFlagsProps>(
...
BasqueFlags.displayName = "BasqueFlags";

export const BasqueFlagsMetadata = {
  id: "Basque_flags",
  baseId: "Basque",
  variant: "flags",
  name: "Basque",
