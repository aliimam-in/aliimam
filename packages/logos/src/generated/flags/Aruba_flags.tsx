...
export interface ArubaFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const ArubaFlags = React.forwardRef<SVGSVGElement, ArubaFlagsProps>(
...
ArubaFlags.displayName = "ArubaFlags";

export const ArubaFlagsMetadata = {
  id: "Aruba_flags",
  baseId: "Aruba",
  variant: "flags",
  name: "Aruba",
