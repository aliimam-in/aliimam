/**
 * Auto-generated logo component: Lesotho (default)
...
export interface LesothoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Lesotho = React.forwardRef<SVGSVGElement, LesothoProps>(
