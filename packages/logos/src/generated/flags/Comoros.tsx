/**
 * Auto-generated logo component: Comoros (default)
...
export interface ComorosProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Comoros = React.forwardRef<SVGSVGElement, ComorosProps>(
