...
export interface ChinaFlagsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const ChinaFlags = React.forwardRef<SVGSVGElement, ChinaFlagsProps>(
...
ChinaFlags.displayName = "ChinaFlags";

export const ChinaFlagsMetadata = {
  id: "China_flags",
  baseId: "China",
  variant: "flags",
  name: "China",
