/**
 * Auto-generated logo component: Gabon (default)
...
export interface GabonProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const Gabon = React.forwardRef<SVGSVGElement, GabonProps>(
