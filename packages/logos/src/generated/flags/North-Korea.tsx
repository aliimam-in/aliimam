/**
 * Auto-generated logo component: North Korea (default)
...
export interface NorthKoreaProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const NorthKorea = React.forwardRef<SVGSVGElement, NorthKoreaProps>(
...
export const NorthKoreaMetadata = {
  id: "North-Korea",
  baseId: "North-Korea",
  variant: "default",
  name: "North Korea",
