...
export interface WeChatPayCardsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const WeChatPayCards = React.forwardRef<SVGSVGElement, WeChatPayCardsProps>(
