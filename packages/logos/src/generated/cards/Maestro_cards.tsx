...
export interface MaestroCardsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const MaestroCards = React.forwardRef<SVGSVGElement, MaestroCardsProps>(
...
MaestroCards.displayName = "MaestroCards";

export const MaestroCardsMetadata = {
  id: "Maestro_cards",
  baseId: "Maestro",
  variant: "cards",
  name: "Maestro",
