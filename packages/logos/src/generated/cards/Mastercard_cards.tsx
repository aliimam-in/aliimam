...
export interface MastercardCardsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const MastercardCards = React.forwardRef<SVGSVGElement, MastercardCardsProps>(
...
MastercardCards.displayName = "MastercardCards";

export const MastercardCardsMetadata = {
  id: "Mastercard_cards",
  baseId: "Mastercard",
  variant: "cards",
  name: "Mastercard",
...
export default MastercardCards;
