...
export interface Visa1CardsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Visa1Cards = React.forwardRef<SVGSVGElement, Visa1CardsProps>(
...
Visa1Cards.displayName = "Visa1Cards";

export const Visa1CardsMetadata = {
  id: "Visa-1_cards",
  baseId: "Visa-1",
  variant: "cards",
  name: "Visa 1",
