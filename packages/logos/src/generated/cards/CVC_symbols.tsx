...
export interface CVCSymbolsProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const CVCSymbols = React.forwardRef<SVGSVGElement, CVCSymbolsProps>(
...
CVCSymbols.displayName = "CVCSymbols";

export const CVCSymbolsMetadata = {
  id: "CVC_symbols",
  baseId: "CVC",
  variant: "symbols",
  name: "CVC",
