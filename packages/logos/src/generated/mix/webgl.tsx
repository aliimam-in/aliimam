/**
 * Auto-generated logo component: Webgl (default)
...
export interface WebglLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const WebglLogo = React.forwardRef<SVGSVGElement, WebglLogoProps>(
