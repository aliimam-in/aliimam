/**
 * Auto-generated logo component: Vim (default)
...
export interface VimLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const VimLogo = React.forwardRef<SVGSVGElement, VimLogoProps>(
...
VimLogo.displayName = "VimLogo";

export const VimLogoMetadata = {
  id: "vim",
  baseId: "vim",
  variant: "default",
  name: "Vim",
