...
export interface JestLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const JestLogo = React.forwardRef<SVGSVGElement, JestLogoProps>(
...
JestLogo.displayName = "JestLogo";

export const JestLogoMetadata = {
  id: "jest",
  baseId: "jest",
  variant: "default",
  name: "Jest",
