/**
 * Auto-generated logo component: Headlessui (default)
...
export interface HeadlessuiLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const HeadlessuiLogo = React.forwardRef<SVGSVGElement, HeadlessuiLogoProps>(
