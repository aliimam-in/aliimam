...
export interface MariadbLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const MariadbLogo = React.forwardRef<SVGSVGElement, MariadbLogoProps>(
...
export const MariadbLogoMetadata = {
  id: "mariadb",
  baseId: "mariadb",
  variant: "default",
  name: "Mariadb",
