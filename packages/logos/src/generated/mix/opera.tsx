...
export interface OperaLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const OperaLogo = React.forwardRef<SVGSVGElement, OperaLogoProps>(
...
OperaLogo.displayName = "OperaLogo";

export const OperaLogoMetadata = {
  id: "opera",
  baseId: "opera",
  variant: "default",
  name: "Opera",
