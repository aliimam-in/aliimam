/**
 * Auto-generated logo component: Windsurf Light (default)
...
export interface WindsurfLightLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const WindsurfLightLogo = React.forwardRef<SVGSVGElement, WindsurfLightLogoProps>(
...
WindsurfLightLogo.displayName = "WindsurfLightLogo";

export const WindsurfLightLogoMetadata = {
  id: "windsurf-light",
  baseId: "windsurf-light",
  variant: "default",
  name: "Windsurf Light",
  category: "mix",
  tags: [],
...
export default WindsurfLightLogo;
