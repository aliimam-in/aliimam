/**
 * Auto-generated logo component: Github (wordmark_light)
...
export interface GithubWordmarkLightProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const GithubWordmarkLight = React.forwardRef<SVGSVGElement, GithubWordmarkLightProps>(
  ({ size = 24, className = '', ...props }, ref) => (
    <svg
      ...
      {...props}
    >
      <path fill="#1B1F24" d="M103.4,55.9h-0.1C103.3,55.9,103.3,56,103.4,55.9L103.4,55.9L103.4,55.9z M103.4,56c-0.5,0-1.8,0.3-3.2,0.3
...
GithubWordmarkLight.displayName = "GithubWordmarkLight";

export const GithubWordmarkLightMetadata = {
  id: "github_wordmark_light",
  baseId: "github",
...
export default GithubWordmarkLight;
