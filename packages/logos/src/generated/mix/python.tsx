/**
 * Auto-generated logo component: Python (default)
...
export interface PythonLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const PythonLogo = React.forwardRef<SVGSVGElement, PythonLogoProps>(
...
export const PythonLogoMetadata = {
  id: "python",
  baseId: "python",
  variant: "default",
  name: "Python",
