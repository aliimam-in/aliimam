/**
 * Auto-generated logo component: Heptabase (default)
...
export interface HeptabaseLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const HeptabaseLogo = React.forwardRef<SVGSVGElement, HeptabaseLogoProps>(
