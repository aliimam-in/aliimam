/**
 * Auto-generated logo component: Ahooks Wordmark Dark (default)
...
export interface AhooksWordmarkDarkLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const AhooksWordmarkDarkLogo = React.forwardRef<SVGSVGElement, AhooksWordmarkDarkLogoProps>(
...
AhooksWordmarkDarkLogo.displayName = "AhooksWordmarkDarkLogo";

export const AhooksWordmarkDarkLogoMetadata = {
  id: "ahooks-wordmark-dark",
  baseId: "ahooks-wordmark-dark",
  variant: "default",
  name: "Ahooks Wordmark Dark",
  category: "mix",
  tags: [],
  viewBox: "0 0 139 44",
} as const;

export default AhooksWordmarkDarkLogo;
