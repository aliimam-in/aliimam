/**
 * Auto-generated logo component: Hcaptcha (default)
...
export interface HcaptchaLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const HcaptchaLogo = React.forwardRef<SVGSVGElement, HcaptchaLogoProps>(
