/**
 * Auto-generated logo component: Yarn (default)
...
export interface YarnLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const YarnLogo = React.forwardRef<SVGSVGElement, YarnLogoProps>(
