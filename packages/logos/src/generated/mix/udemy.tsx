/**
 * Auto-generated logo component: Udemy (default)
...
export interface UdemyLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const UdemyLogo = React.forwardRef<SVGSVGElement, UdemyLogoProps>(
...
UdemyLogo.displayName = "UdemyLogo";

export const UdemyLogoMetadata = {
  id: "udemy",
  baseId: "udemy",
  variant: "default",
  name: "Udemy",
