/**
 * Auto-generated logo component: Datadog (default)
...
export interface DatadogLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const DatadogLogo = React.forwardRef<SVGSVGElement, DatadogLogoProps>(
...
export const DatadogLogoMetadata = {
  id: "datadog",
  baseId: "datadog",
  variant: "default",
  name: "Datadog",
