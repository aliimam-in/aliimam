/**
 * Auto-generated logo component: Windsurf Dark (default)
...
export interface WindsurfDarkLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const WindsurfDarkLogo = React.forwardRef<SVGSVGElement, WindsurfDarkLogoProps>(
...
WindsurfDarkLogo.displayName = "WindsurfDarkLogo";

export const WindsurfDarkLogoMetadata = {
  id: "windsurf-dark",
  baseId: "windsurf-dark",
  variant: "default",
  name: "Windsurf Dark",
  category: "mix",
  tags: [],
...
export default WindsurfDarkLogo;
