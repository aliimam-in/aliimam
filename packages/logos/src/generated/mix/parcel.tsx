/**
 * Auto-generated logo component: Parcel (default)
...
export interface ParcelLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const ParcelLogo = React.forwardRef<SVGSVGElement, ParcelLogoProps>(
  ({ size = 24, className = '', ...props }, ref) => (
    ...
    <linearGradient x1="50.9%" y1="51.1%" x2="49.2%" y2="49.3%" id="e">
      ...
      <stop stopColor="#DEA167" offset="50.2%" />
      <stop stopColor="#E8AF73" offset="69.7%" />
    ...
    <linearGradient x1="49.6%" y1="50.5%" x2="50.7%" y2="49.2%" id="h">
      ...
      <stop stopColor="#D59C66" offset="58.3%" />
    ...
    <linearGradient x1="45.7%" y1="62.6%" x2="50.5%" y2="33.5%" id="n">
      ...
      <stop stopColor="#A9794B" offset="62.4%" />
...
ParcelLogo.displayName = "ParcelLogo";

export const ParcelLogoMetadata = {
  id: "parcel",
  baseId: "parcel",
  variant: "default",
  name: "Parcel",
