...
export interface TelegramLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const TelegramLogo = React.forwardRef<SVGSVGElement, TelegramLogoProps>(
...
export const TelegramLogoMetadata = {
  id: "telegram",
  baseId: "telegram",
  variant: "default",
  name: "Telegram",
