/**
 * Auto-generated logo component: Svg (wordmark)
...
export interface SvgWordmarkProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const SvgWordmark = React.forwardRef<SVGSVGElement, SvgWordmarkProps>(
