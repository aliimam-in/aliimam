/**
 * Auto-generated logo component: Reflex Dark (default)
...
export interface ReflexDarkLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const ReflexDarkLogo = React.forwardRef<SVGSVGElement, ReflexDarkLogoProps>(
...
ReflexDarkLogo.displayName = "ReflexDarkLogo";

export const ReflexDarkLogoMetadata = {
  id: "reflex-dark",
  baseId: "reflex-dark",
  variant: "default",
  name: "Reflex Dark",
