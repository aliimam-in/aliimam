/**
 * Auto-generated logo component: Ebay (default)
...
export interface EbayLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const EbayLogo = React.forwardRef<SVGSVGElement, EbayLogoProps>(
  ({ size = 24, className = '', ...props }, ref) => (
    <svg
      ref={ref}
      width={size}
      height={size}
      viewBox=".1 .1 299.8 120.125"
      className={className}
