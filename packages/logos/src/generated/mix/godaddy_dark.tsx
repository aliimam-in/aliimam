/**
 * Auto-generated logo component: Godaddy (dark)
...
export interface GodaddyDarkProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const GodaddyDark = React.forwardRef<SVGSVGElement, GodaddyDarkProps>(
