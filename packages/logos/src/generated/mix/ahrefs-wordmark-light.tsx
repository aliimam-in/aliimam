/**
 * Auto-generated logo component: Ahrefs Wordmark Light (default)
...
export interface AhrefsWordmarkLightLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const AhrefsWordmarkLightLogo = React.forwardRef<SVGSVGElement, AhrefsWordmarkLightLogoProps>(
