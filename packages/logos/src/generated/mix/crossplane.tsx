/**
 * Auto-generated logo component: Crossplane (default)
...
export interface CrossplaneLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const CrossplaneLogo = React.forwardRef<SVGSVGElement, CrossplaneLogoProps>(
