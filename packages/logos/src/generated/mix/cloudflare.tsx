/**
 * Auto-generated logo component: Cloudflare (default)
...
export interface CloudflareLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const CloudflareLogo = React.forwardRef<SVGSVGElement, CloudflareLogoProps>(
...
export const CloudflareLogoMetadata = {
  id: "cloudflare",
  baseId: "cloudflare",
  variant: "default",
  name: "Cloudflare",
