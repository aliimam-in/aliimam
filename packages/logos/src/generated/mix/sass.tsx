...
export interface SassLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const SassLogo = React.forwardRef<SVGSVGElement, SassLogoProps>(
...
SassLogo.displayName = "SassLogo";

export const SassLogoMetadata = {
  id: "sass",
  baseId: "sass",
  variant: "default",
  name: "Sass",
