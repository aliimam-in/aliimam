/**
 * Auto-generated logo component: Apidog (default)
...
export interface ApidogLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const ApidogLogo = React.forwardRef<SVGSVGElement, ApidogLogoProps>(
