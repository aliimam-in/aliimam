/**
 * Auto-generated logo component: Hostgator (default)
...
export interface HostgatorLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const HostgatorLogo = React.forwardRef<SVGSVGElement, HostgatorLogoProps>(
...
HostgatorLogo.displayName = "HostgatorLogo";

export const HostgatorLogoMetadata = {
  id: "hostgator",
  baseId: "hostgator",
  variant: "default",
  name: "Hostgator",
