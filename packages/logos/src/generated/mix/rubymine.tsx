...
export interface RubymineLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const RubymineLogo = React.forwardRef<SVGSVGElement, RubymineLogoProps>(
...
RubymineLogo.displayName = "RubymineLogo";

export const RubymineLogoMetadata = {
  id: "rubymine",
  baseId: "rubymine",
  variant: "default",
  name: "Rubymine",
