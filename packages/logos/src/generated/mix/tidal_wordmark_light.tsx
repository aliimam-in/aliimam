/**
 * Auto-generated logo component: Tidal (wordmark_light)
...
export interface TidalWordmarkLightProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const TidalWordmarkLight = React.forwardRef<SVGSVGElement, TidalWordmarkLightProps>(
...
TidalWordmarkLight.displayName = "TidalWordmarkLight";

export const TidalWordmarkLightMetadata = {
  id: "tidal_wordmark_light",
  baseId: "tidal",
...
export default TidalWordmarkLight;
