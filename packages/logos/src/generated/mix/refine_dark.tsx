/**
 * Auto-generated logo component: Refine (dark)
...
export interface RefineDarkProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const RefineDark = React.forwardRef<SVGSVGElement, RefineDarkProps>(
...
RefineDark.displayName = "RefineDark";

export const RefineDarkMetadata = {
  id: "refine_dark",
  baseId: "refine",
  variant: "dark",
  name: "Refine",
