/**
 * Auto-generated logo component: Loom (default)
...
export interface LoomLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const LoomLogo = React.forwardRef<SVGSVGElement, LoomLogoProps>(
...
LoomLogo.displayName = "LoomLogo";

export const LoomLogoMetadata = {
  id: "loom",
  baseId: "loom",
  variant: "default",
  name: "Loom",
