...
export interface MotionLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const MotionLogo = React.forwardRef<SVGSVGElement, MotionLogoProps>(
...
MotionLogo.displayName = "MotionLogo";

export const MotionLogoMetadata = {
  id: "motion",
  baseId: "motion",
  variant: "default",
  name: "Motion",
