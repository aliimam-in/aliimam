/**
 * Auto-generated logo component: Redis (default)
...
export interface RedisLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const RedisLogo = React.forwardRef<SVGSVGElement, RedisLogoProps>(
...
export const RedisLogoMetadata = {
  id: "redis",
  baseId: "redis",
  variant: "default",
  name: "Redis",
