/**
 * Auto-generated logo component: Deno (dark)
...
export interface DenoDarkProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const DenoDark = React.forwardRef<SVGSVGElement, DenoDarkProps>(
