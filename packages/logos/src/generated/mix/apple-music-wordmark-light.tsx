/**
 * Auto-generated logo component: Apple Music Wordmark Light (default)
...
export interface AppleMusicWordmarkLightLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const AppleMusicWordmarkLightLogo = React.forwardRef<SVGSVGElement, AppleMusicWordmarkLightLogoProps>(
