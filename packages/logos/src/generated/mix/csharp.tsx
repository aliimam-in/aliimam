/**
 * Auto-generated logo component: Csharp (default)
...
export interface CsharpLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const CsharpLogo = React.forwardRef<SVGSVGElement, CsharpLogoProps>(
...
export const CsharpLogoMetadata = {
  id: "csharp",
  baseId: "csharp",
  variant: "default",
  name: "Csharp",
