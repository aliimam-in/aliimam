...
export interface PaypalLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const PaypalLogo = React.forwardRef<SVGSVGElement, PaypalLogoProps>(
...
export const PaypalLogoMetadata = {
  id: "paypal",
  baseId: "paypal",
  variant: "default",
  name: "Paypal",
