/**
 * Auto-generated logo component: Discourse (default)
...
export interface DiscourseLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const DiscourseLogo = React.forwardRef<SVGSVGElement, DiscourseLogoProps>(
...
DiscourseLogo.displayName = "DiscourseLogo";

export const DiscourseLogoMetadata = {
  id: "discourse",
  baseId: "discourse",
  variant: "default",
  name: "Discourse",
