...
export interface SvelteLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const SvelteLogo = React.forwardRef<SVGSVGElement, SvelteLogoProps>(
...
SvelteLogo.displayName = "SvelteLogo";

export const SvelteLogoMetadata = {
  id: "svelte",
  baseId: "svelte",
  variant: "default",
  name: "Svelte",
