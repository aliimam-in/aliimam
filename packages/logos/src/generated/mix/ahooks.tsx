...
export interface AhooksLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const AhooksLogo = React.forwardRef<SVGSVGElement, AhooksLogoProps>(
...
AhooksLogo.displayName = "AhooksLogo";

export const AhooksLogoMetadata = {
  id: "ahooks",
  baseId: "ahooks",
  variant: "default",
  name: "Ahooks",
