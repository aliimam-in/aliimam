...
export interface JasmineLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const JasmineLogo = React.forwardRef<SVGSVGElement, JasmineLogoProps>(
...
JasmineLogo.displayName = "JasmineLogo";

export const JasmineLogoMetadata = {
  id: "jasmine",
  baseId: "jasmine",
  variant: "default",
  name: "Jasmine",
