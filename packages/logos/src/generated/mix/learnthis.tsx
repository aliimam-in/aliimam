/**
 * Auto-generated logo component: Learnthis (default)
...
export interface LearnthisLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const LearnthisLogo = React.forwardRef<SVGSVGElement, LearnthisLogoProps>(
