/**
 * Auto-generated logo component: Afordin (dark)
...
export interface AfordinDarkProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const AfordinDark = React.forwardRef<SVGSVGElement, AfordinDarkProps>(
