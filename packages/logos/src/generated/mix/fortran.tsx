...
export interface FortranLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const FortranLogo = React.forwardRef<SVGSVGElement, FortranLogoProps>(
