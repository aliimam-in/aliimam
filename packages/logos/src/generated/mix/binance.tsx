...
export interface BinanceLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const BinanceLogo = React.forwardRef<SVGSVGElement, BinanceLogoProps>(
...
export const BinanceLogoMetadata = {
  id: "binance",
  baseId: "binance",
  variant: "default",
  name: "Binance",
