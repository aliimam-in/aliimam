/**
 * Auto-generated logo component: Ngrok Dark (default)
...
export interface NgrokDarkLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const NgrokDarkLogo = React.forwardRef<SVGSVGElement, NgrokDarkLogoProps>(
...
NgrokDarkLogo.displayName = "NgrokDarkLogo";

export const NgrokDarkLogoMetadata = {
  id: "ngrok-dark",
  baseId: "ngrok-dark",
  variant: "default",
  name: "Ngrok Dark",
