/**
 * Auto-generated logo component: Heroku (default)
...
export interface HerokuLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const HerokuLogo = React.forwardRef<SVGSVGElement, HerokuLogoProps>(
...
export const HerokuLogoMetadata = {
  id: "heroku",
  baseId: "heroku",
  variant: "default",
  name: "Heroku",
