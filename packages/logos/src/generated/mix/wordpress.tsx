...
export interface WordpressLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const WordpressLogo = React.forwardRef<SVGSVGElement, WordpressLogoProps>(
...
export const WordpressLogoMetadata = {
  id: "wordpress",
  baseId: "wordpress",
  variant: "default",
  name: "Wordpress",
