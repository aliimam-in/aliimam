/**
 * Auto-generated logo component: Fleet (default)
...
export interface FleetLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const FleetLogo = React.forwardRef<SVGSVGElement, FleetLogoProps>(
