/**
 * Auto-generated logo component: Nginx (default)
...
export interface NginxLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const NginxLogo = React.forwardRef<SVGSVGElement, NginxLogoProps>(
...
export const NginxLogoMetadata = {
  id: "nginx",
  baseId: "nginx",
  variant: "default",
  name: "Nginx",
