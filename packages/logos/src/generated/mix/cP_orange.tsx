/**
 * Auto-generated logo component: CP (orange)
...
export interface CPOrangeProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const CPOrange = React.forwardRef<SVGSVGElement, CPOrangeProps>(
