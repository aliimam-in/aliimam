...
export interface StoryblokLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const StoryblokLogo = React.forwardRef<SVGSVGElement, StoryblokLogoProps>(
...
StoryblokLogo.displayName = "StoryblokLogo";

export const StoryblokLogoMetadata = {
  id: "storyblok",
  baseId: "storyblok",
  variant: "default",
  name: "Storyblok",
