...
export interface ZoomLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const ZoomLogo = React.forwardRef<SVGSVGElement, ZoomLogoProps>(
