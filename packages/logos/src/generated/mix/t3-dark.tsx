/**
 * Auto-generated logo component: T3 Dark (default)
...
export interface T3DarkLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const T3DarkLogo = React.forwardRef<SVGSVGElement, T3DarkLogoProps>(
  ({ size = 24, className = '', ...props }, ref) => (
    <svg
      ...
      {...props}
    >
      <path fillRule="evenodd" clipRule="evenodd" d="M165.735 25.0701L188.947 0.972412H0.465994V25.0701H165.735Z" fill="black" />
...
<path fillRule="evenodd" clipRule="evenodd" d="M88.2625 192.669L88.2626 45.6459H64.1648L64.1648 192.669H88.2625Z" fill="black" />
    </svg>
  )
);

T3DarkLogo.displayName = "T3DarkLogo";

export const T3DarkLogoMetadata = {
  id: "t3-dark",
  baseId: "t3-dark",
  variant: "default",
  name: "T3 Dark",
