/**
 * Auto-generated logo component: Tidal (wordmark_dark)
...
export interface TidalWordmarkDarkProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const TidalWordmarkDark = React.forwardRef<SVGSVGElement, TidalWordmarkDarkProps>(
...
TidalWordmarkDark.displayName = "TidalWordmarkDark";

export const TidalWordmarkDarkMetadata = {
  id: "tidal_wordmark_dark",
  baseId: "tidal",
...
export default TidalWordmarkDark;
