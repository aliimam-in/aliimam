/**
 * Auto-generated logo component: Coinbase Wordmark Dark (default)
...
export interface CoinbaseWordmarkDarkLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const CoinbaseWordmarkDarkLogo = React.forwardRef<SVGSVGElement, CoinbaseWordmarkDarkLogoProps>(
...
CoinbaseWordmarkDarkLogo.displayName = "CoinbaseWordmarkDarkLogo";

export const CoinbaseWordmarkDarkLogoMetadata = {
  id: "coinbase-wordmark-dark",
  baseId: "coinbase-wordmark-dark",
  variant: "default",
  name: "Coinbase Wordmark Dark",
  category: "mix",
  tags: [],
  viewBox: "0 0 24 24",
} as const;

export default CoinbaseWordmarkDarkLogo;
