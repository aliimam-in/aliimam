/**
 * Auto-generated logo component: Tembo Dark (default)
...
export interface TemboDarkLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const TemboDarkLogo = React.forwardRef<SVGSVGElement, TemboDarkLogoProps>(
...
TemboDarkLogo.displayName = "TemboDarkLogo";

export const TemboDarkLogoMetadata = {
  id: "tembo-dark",
  baseId: "tembo-dark",
  variant: "default",
  name: "Tembo Dark",
