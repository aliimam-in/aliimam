/**
 * Auto-generated logo component: Nvidia Wordmark Dark (default)
...
export interface NvidiaWordmarkDarkLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const NvidiaWordmarkDarkLogo = React.forwardRef<SVGSVGElement, NvidiaWordmarkDarkLogoProps>(
...
NvidiaWordmarkDarkLogo.displayName = "NvidiaWordmarkDarkLogo";

export const NvidiaWordmarkDarkLogoMetadata = {
  id: "nvidia-wordmark-dark",
  baseId: "nvidia-wordmark-dark",
  variant: "default",
  name: "Nvidia Wordmark Dark",
  category: "mix",
  tags: [],
  viewBox: "0 0 164 30",
} as const;

export default NvidiaWordmarkDarkLogo;
