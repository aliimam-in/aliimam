...
export interface AdobeXdLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const AdobeXdLogo = React.forwardRef<SVGSVGElement, AdobeXdLogoProps>(
...
AdobeXdLogo.displayName = "AdobeXdLogo";

export const AdobeXdLogoMetadata = {
  id: "adobe-xd",
  baseId: "adobe-xd",
  variant: "default",
  name: "Adobe Xd",
