/**
 * Auto-generated logo component: Afordin (default)
...
export interface AfordinLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const AfordinLogo = React.forwardRef<SVGSVGElement, AfordinLogoProps>(
