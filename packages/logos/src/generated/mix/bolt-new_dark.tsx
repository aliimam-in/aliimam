/**
 * Auto-generated logo component: Bolt New (dark)
...
export interface BoltNewDarkProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const BoltNewDark = React.forwardRef<SVGSVGElement, BoltNewDarkProps>(
...
BoltNewDark.displayName = "BoltNewDark";

export const BoltNewDarkMetadata = {
  id: "bolt-new_dark",
  baseId: "bolt-new",
  variant: "dark",
  name: "Bolt New",
