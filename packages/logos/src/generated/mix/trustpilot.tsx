/**
 * Auto-generated logo component: Trustpilot (default)
...
export interface TrustpilotLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const TrustpilotLogo = React.forwardRef<SVGSVGElement, TrustpilotLogoProps>(
...
TrustpilotLogo.displayName = "TrustpilotLogo";

export const TrustpilotLogoMetadata = {
  id: "trustpilot",
  baseId: "trustpilot",
  variant: "default",
  name: "Trustpilot",
