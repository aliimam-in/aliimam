/**
 * Auto-generated logo component: Coinbase Wordmark Light (default)
...
export interface CoinbaseWordmarkLightLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const CoinbaseWordmarkLightLogo = React.forwardRef<SVGSVGElement, CoinbaseWordmarkLightLogoProps>(
...
CoinbaseWordmarkLightLogo.displayName = "CoinbaseWordmarkLightLogo";

export const CoinbaseWordmarkLightLogoMetadata = {
  id: "coinbase-wordmark-light",
  baseId: "coinbase-wordmark-light",
  variant: "default",
  name: "Coinbase Wordmark Light",
  category: "mix",
  tags: [],
  viewBox: "0 0 24 24",
} as const;

export default CoinbaseWordmarkLightLogo;
