...
export interface BlueskyLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const BlueskyLogo = React.forwardRef<SVGSVGElement, BlueskyLogoProps>(
...
BlueskyLogo.displayName = "BlueskyLogo";

export const BlueskyLogoMetadata = {
  id: "bluesky",
  baseId: "bluesky",
  variant: "default",
  name: "Bluesky",
