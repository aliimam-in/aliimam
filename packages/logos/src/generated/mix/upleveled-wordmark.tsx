/**
 * Auto-generated logo component: Upleveled Wordmark (default)
...
export interface UpleveledWordmarkLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const UpleveledWordmarkLogo = React.forwardRef<SVGSVGElement, UpleveledWordmarkLogoProps>(
