/**
 * Auto-generated logo component: Nhost (default)
...
export interface NhostLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const NhostLogo = React.forwardRef<SVGSVGElement, NhostLogoProps>(
