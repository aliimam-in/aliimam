/**
 * Auto-generated logo component: Refine (light)
...
export interface RefineLightProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const RefineLight = React.forwardRef<SVGSVGElement, RefineLightProps>(
...
RefineLight.displayName = "RefineLight";

export const RefineLightMetadata = {
  id: "refine_light",
  baseId: "refine",
  variant: "light",
  name: "Refine",
