/**
 * Auto-generated logo component: Qdrant Icon Light (default)
...
export interface QdrantIconLightLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const QdrantIconLightLogo = React.forwardRef<SVGSVGElement, QdrantIconLightLogoProps>(
...
QdrantIconLightLogo.displayName = "QdrantIconLightLogo";

export const QdrantIconLightLogoMetadata = {
  id: "qdrant-icon-light",
  baseId: "qdrant-icon-light",
  variant: "default",
  name: "Qdrant Icon Light",
  category: "mix",
  tags: [],
  viewBox: "0 0 57 64",
} as const;

export default QdrantIconLightLogo;
