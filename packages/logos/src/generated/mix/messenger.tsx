/**
 * Auto-generated logo component: Messenger (default)
...
export interface MessengerLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const MessengerLogo = React.forwardRef<SVGSVGElement, MessengerLogoProps>(
...
export const MessengerLogoMetadata = {
  id: "messenger",
  baseId: "messenger",
  variant: "default",
  name: "Messenger",
