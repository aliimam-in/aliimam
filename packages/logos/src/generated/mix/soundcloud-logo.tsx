/**
 * Auto-generated logo component: Soundcloud Logo (default)
...
export interface SoundcloudLogoLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const SoundcloudLogoLogo = React.forwardRef<SVGSVGElement, SoundcloudLogoLogoProps>(
...
export default SoundcloudLogoLogo;
