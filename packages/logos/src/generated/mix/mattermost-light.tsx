/**
 * Auto-generated logo component: Mattermost Light (default)
...
export interface MattermostLightLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const MattermostLightLogo = React.forwardRef<SVGSVGElement, MattermostLightLogoProps>(
