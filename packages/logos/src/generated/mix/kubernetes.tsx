/**
 * Auto-generated logo component: Kubernetes (default)
...
export interface KubernetesLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const KubernetesLogo = React.forwardRef<SVGSVGElement, KubernetesLogoProps>(
