/**
 * Auto-generated logo component: Kick Dark (default)
...
export interface KickDarkLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const KickDarkLogo = React.forwardRef<SVGSVGElement, KickDarkLogoProps>(
...
KickDarkLogo.displayName = "KickDarkLogo";

export const KickDarkLogoMetadata = {
  id: "kick-dark",
  baseId: "kick-dark",
  variant: "default",
  name: "Kick Dark",
