/**
 * Auto-generated logo component: Javascript (default)
...
export interface JavascriptLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const JavascriptLogo = React.forwardRef<SVGSVGElement, JavascriptLogoProps>(
...
export const JavascriptLogoMetadata = {
  id: "javascript",
  baseId: "javascript",
  variant: "default",
  name: "Javascript",
