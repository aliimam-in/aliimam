/**
 * Auto-generated logo component: T3 Light (default)
...
export interface T3LightLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const T3LightLogo = React.forwardRef<SVGSVGElement, T3LightLogoProps>(
...
T3LightLogo.displayName = "T3LightLogo";

export const T3LightLogoMetadata = {
  id: "t3-light",
  baseId: "t3-light",
  variant: "default",
  name: "T3 Light",
