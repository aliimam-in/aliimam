/**
 * Auto-generated logo component: Turso Wordmark Light (default)
...
export interface TursoWordmarkLightLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const TursoWordmarkLightLogo = React.forwardRef<SVGSVGElement, TursoWordmarkLightLogoProps>(
