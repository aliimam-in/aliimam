/**
 * Auto-generated logo component: Disneyplus (default)
...
export interface DisneyplusLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const DisneyplusLogo = React.forwardRef<SVGSVGElement, DisneyplusLogoProps>(
  ({ size = 24, className = '', ...props }, ref) => (
    ...
    >
      <g>
	<path fill="#01147B" d="M241.7,203.4c0.3,0,0.3,0,0.6,0.1c4.6,0.6,9.1,1.4,12.5,3c3.2,1.4,5.1,3.2,6.8,6.4c2.6,4.8,2.8,11.5,0.4,16.6
		...
		<stop offset="0" style={{stopColor:"#01147B"}} />
		<stop offset="2.549020e-02" style={{stopColor:"#011098"}} />
		<stop offset="6.430855e-02" style={{stopColor:"#010ABD"}} />
		<stop offset="0.1032" style={{stopColor:"#0006DA"}} />
		<stop offset="0.1416" style={{stopColor:"#0003EE"}} />
		<stop offset="0.1794" style={{stopColor:"#0001FB"}} />
		<stop offset="0.2159" style={{stopColor:"#0000FF"}} />
		<stop offset="1" style={{stopColor:"#00FFFF",stopOpacity:"0"}} />
	</radialGradient>
	<path fill="url(#SVGID_1_)" d="M476.8,150.3c-15.8-39-42.7-72.3-77.5-96.1c-35.7-24.5-77.5-37.4-121-37.4c-71.9,0-138.5,35.7-178.3,95.5
...
DisneyplusLogo.displayName = "DisneyplusLogo";

export const DisneyplusLogoMetadata = {
  id: "disneyplus",
  baseId: "disneyplus",
  variant: "default",
  name: "Disneyplus",
