/**
 * Auto-generated logo component: Ghostty (default)
...
export interface GhosttyLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const GhosttyLogo = React.forwardRef<SVGSVGElement, GhosttyLogoProps>(
