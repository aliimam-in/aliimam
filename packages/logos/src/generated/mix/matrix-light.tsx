/**
 * Auto-generated logo component: Matrix Light (default)
...
export interface MatrixLightLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const MatrixLightLogo = React.forwardRef<SVGSVGElement, MatrixLightLogoProps>(
...
MatrixLightLogo.displayName = "MatrixLightLogo";

export const MatrixLightLogoMetadata = {
  id: "matrix-light",
  baseId: "matrix-light",
  variant: "default",
  name: "Matrix Light",
...
export default MatrixLightLogo;
