/**
 * Auto-generated logo component: Voicemod (dark)
...
export interface VoicemodDarkProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const VoicemodDark = React.forwardRef<SVGSVGElement, VoicemodDarkProps>(
