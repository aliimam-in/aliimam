/**
 * Auto-generated logo component: Intello Dark (default)
...
export interface IntelloDarkLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const IntelloDarkLogo = React.forwardRef<SVGSVGElement, IntelloDarkLogoProps>(
...
IntelloDarkLogo.displayName = "IntelloDarkLogo";

export const IntelloDarkLogoMetadata = {
  id: "intello-dark",
  baseId: "intello-dark",
  variant: "default",
  name: "Intello Dark",
...
export default IntelloDarkLogo;
