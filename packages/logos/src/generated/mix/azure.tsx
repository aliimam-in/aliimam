/**
 * Auto-generated logo component: Azure (default)
...
export interface AzureLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const AzureLogo = React.forwardRef<SVGSVGElement, AzureLogoProps>(
...
AzureLogo.displayName = "AzureLogo";

export const AzureLogoMetadata = {
  id: "azure",
  baseId: "azure",
  variant: "default",
  name: "Azure",
