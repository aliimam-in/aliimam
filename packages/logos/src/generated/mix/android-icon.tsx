/**
 * Auto-generated logo component: Android Icon (default)
...
export interface AndroidIconLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const AndroidIconLogo = React.forwardRef<SVGSVGElement, AndroidIconLogoProps>(
...
AndroidIconLogo.displayName = "AndroidIconLogo";

export const AndroidIconLogoMetadata = {
  id: "android-icon",
  baseId: "android-icon",
  variant: "default",
  name: "Android Icon",
...
export default AndroidIconLogo;
