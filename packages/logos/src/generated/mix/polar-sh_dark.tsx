/**
 * Auto-generated logo component: Polar Sh (dark)
...
export interface PolarShDarkProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const PolarShDark = React.forwardRef<SVGSVGElement, PolarShDarkProps>(
