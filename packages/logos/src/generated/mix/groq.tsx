/**
 * Auto-generated logo component: Groq (default)
...
export interface GroqLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const GroqLogo = React.forwardRef<SVGSVGElement, GroqLogoProps>(
