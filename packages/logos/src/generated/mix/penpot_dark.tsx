/**
 * Auto-generated logo component: Penpot (dark)
...
export interface PenpotDarkProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const PenpotDark = React.forwardRef<SVGSVGElement, PenpotDarkProps>(
