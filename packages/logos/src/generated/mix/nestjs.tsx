/**
 * Auto-generated logo component: Nestjs (default)
...
export interface NestjsLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const NestjsLogo = React.forwardRef<SVGSVGElement, NestjsLogoProps>(
...
export const NestjsLogoMetadata = {
  id: "nestjs",
  baseId: "nestjs",
  variant: "default",
  name: "Nestjs",
