/**
 * Auto-generated logo component: Kick Light (default)
...
export interface KickLightLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const KickLightLogo = React.forwardRef<SVGSVGElement, KickLightLogoProps>(
...
KickLightLogo.displayName = "KickLightLogo";

export const KickLightLogoMetadata = {
  id: "kick-light",
  baseId: "kick-light",
  variant: "default",
  name: "Kick Light",
