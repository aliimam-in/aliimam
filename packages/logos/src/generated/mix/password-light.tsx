/**
 * Auto-generated logo component: Password Light (default)
...
export interface PasswordLightLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const PasswordLightLogo = React.forwardRef<SVGSVGElement, PasswordLightLogoProps>(
...
export default PasswordLightLogo;
