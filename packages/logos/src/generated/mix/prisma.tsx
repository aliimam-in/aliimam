...
export interface PrismaLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const PrismaLogo = React.forwardRef<SVGSVGElement, PrismaLogoProps>(
...
export const PrismaLogoMetadata = {
  id: "prisma",
  baseId: "prisma",
  variant: "default",
  name: "Prisma",
