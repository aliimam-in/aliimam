...
export interface SpotifyLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const SpotifyLogo = React.forwardRef<SVGSVGElement, SpotifyLogoProps>(
...
export const SpotifyLogoMetadata = {
  id: "spotify",
  baseId: "spotify",
  variant: "default",
  name: "Spotify",
