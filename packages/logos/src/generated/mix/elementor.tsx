/**
 * Auto-generated logo component: Elementor (default)
...
export interface ElementorLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const ElementorLogo = React.forwardRef<SVGSVGElement, ElementorLogoProps>(
...
ElementorLogo.displayName = "ElementorLogo";

export const ElementorLogoMetadata = {
  id: "elementor",
  baseId: "elementor",
  variant: "default",
  name: "Elementor",
