...
export interface BlenderLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const BlenderLogo = React.forwardRef<SVGSVGElement, BlenderLogoProps>(
