/**
 * Auto-generated logo component: Expressjs (default)
...
export interface ExpressjsLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const ExpressjsLogo = React.forwardRef<SVGSVGElement, ExpressjsLogoProps>(
...
ExpressjsLogo.displayName = "ExpressjsLogo";

export const ExpressjsLogoMetadata = {
  id: "expressjs",
  baseId: "expressjs",
  variant: "default",
  name: "Expressjs",
