/**
 * Auto-generated logo component: Coursera (default)
...
export interface CourseraLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const CourseraLogo = React.forwardRef<SVGSVGElement, CourseraLogoProps>(
...
CourseraLogo.displayName = "CourseraLogo";

export const CourseraLogoMetadata = {
  id: "coursera",
  baseId: "coursera",
  variant: "default",
  name: "Coursera",
