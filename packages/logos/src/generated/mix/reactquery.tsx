/**
 * Auto-generated logo component: Reactquery (default)
...
export interface ReactqueryLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const ReactqueryLogo = React.forwardRef<SVGSVGElement, ReactqueryLogoProps>(
...
ReactqueryLogo.displayName = "ReactqueryLogo";

export const ReactqueryLogoMetadata = {
  id: "reactquery",
  baseId: "reactquery",
  variant: "default",
  name: "Reactquery",
