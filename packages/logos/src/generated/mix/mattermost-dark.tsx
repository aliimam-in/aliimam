/**
 * Auto-generated logo component: Mattermost Dark (default)
...
export interface MattermostDarkLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const MattermostDarkLogo = React.forwardRef<SVGSVGElement, MattermostDarkLogoProps>(
...
MattermostDarkLogo.displayName = "MattermostDarkLogo";

export const MattermostDarkLogoMetadata = {
  id: "mattermost-dark",
  baseId: "mattermost-dark",
  variant: "default",
  name: "Mattermost Dark",
  category: "mix",
  tags: [],
  viewBox: "0 0 501 501",
} as const;

export default MattermostDarkLogo;
