...
export interface BuilderLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const BuilderLogo = React.forwardRef<SVGSVGElement, BuilderLogoProps>(
