/**
 * Auto-generated logo component: Pdf (default)
...
export interface PdfLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const PdfLogo = React.forwardRef<SVGSVGElement, PdfLogoProps>(
