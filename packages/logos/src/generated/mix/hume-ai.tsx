...
export interface HumeAiLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const HumeAiLogo = React.forwardRef<SVGSVGElement, HumeAiLogoProps>(
...
HumeAiLogo.displayName = "HumeAiLogo";

export const HumeAiLogoMetadata = {
  id: "hume-ai",
  baseId: "hume-ai",
  variant: "default",
  name: "Hume Ai",
