...
export interface LottiefilesLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const LottiefilesLogo = React.forwardRef<SVGSVGElement, LottiefilesLogoProps>(
...
LottiefilesLogo.displayName = "LottiefilesLogo";

export const LottiefilesLogoMetadata = {
  id: "lottiefiles",
  baseId: "lottiefiles",
  variant: "default",
  name: "Lottiefiles",
...
export default LottiefilesLogo;
