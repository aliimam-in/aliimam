/**
 * Auto-generated logo component: V0 (light)
...
export interface V0LightProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const V0Light = React.forwardRef<SVGSVGElement, V0LightProps>(
