/**
 * Auto-generated logo component: Dodo Payments (default)
...
export interface DodoPaymentsLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const DodoPaymentsLogo = React.forwardRef<SVGSVGElement, DodoPaymentsLogoProps>(
...
DodoPaymentsLogo.displayName = "DodoPaymentsLogo";

export const DodoPaymentsLogoMetadata = {
  id: "dodo-payments",
  baseId: "dodo-payments",
  variant: "default",
  name: "Dodo Payments",
  category: "mix",
  tags: [],
...
export default DodoPaymentsLogo;
