/**
 * Auto-generated logo component: Nvidia Wordmark Light (default)
...
export interface NvidiaWordmarkLightLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const NvidiaWordmarkLightLogo = React.forwardRef<SVGSVGElement, NvidiaWordmarkLightLogoProps>(
...
NvidiaWordmarkLightLogo.displayName = "NvidiaWordmarkLightLogo";

export const NvidiaWordmarkLightLogoMetadata = {
  id: "nvidia-wordmark-light",
  baseId: "nvidia-wordmark-light",
  variant: "default",
  name: "Nvidia Wordmark Light",
  category: "mix",
  tags: [],
  viewBox: "0 0 164 30",
} as const;

export default NvidiaWordmarkLightLogo;
