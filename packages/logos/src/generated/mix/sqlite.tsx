...
export interface SqliteLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const SqliteLogo = React.forwardRef<SVGSVGElement, SqliteLogoProps>(
...
SqliteLogo.displayName = "SqliteLogo";

export const SqliteLogoMetadata = {
  id: "sqlite",
  baseId: "sqlite",
  variant: "default",
  name: "Sqlite",
