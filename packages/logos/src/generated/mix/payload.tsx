...
export interface PayloadLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const PayloadLogo = React.forwardRef<SVGSVGElement, PayloadLogoProps>(
...
PayloadLogo.displayName = "PayloadLogo";

export const PayloadLogoMetadata = {
  id: "payload",
  baseId: "payload",
  variant: "default",
  name: "Payload",
