/**
 * Auto-generated logo component: Cohere (wordmark)
...
export interface CohereWordmarkProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const CohereWordmark = React.forwardRef<SVGSVGElement, CohereWordmarkProps>(
