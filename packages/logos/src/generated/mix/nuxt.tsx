...
export interface NuxtLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const NuxtLogo = React.forwardRef<SVGSVGElement, NuxtLogoProps>(
...
NuxtLogo.displayName = "NuxtLogo";

export const NuxtLogoMetadata = {
  id: "nuxt",
  baseId: "nuxt",
  variant: "default",
  name: "Nuxt",
