...
export interface BootstrapLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const BootstrapLogo = React.forwardRef<SVGSVGElement, BootstrapLogoProps>(
...
BootstrapLogo.displayName = "BootstrapLogo";

export const BootstrapLogoMetadata = {
  id: "bootstrap",
  baseId: "bootstrap",
  variant: "default",
  name: "Bootstrap",
