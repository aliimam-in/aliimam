/**
 * Auto-generated logo component: Reflex Light (default)
...
export interface ReflexLightLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const ReflexLightLogo = React.forwardRef<SVGSVGElement, ReflexLightLogoProps>(
...
ReflexLightLogo.displayName = "ReflexLightLogo";

export const ReflexLightLogoMetadata = {
  id: "reflex-light",
  baseId: "reflex-light",
  variant: "default",
  name: "Reflex Light",
...
export default ReflexLightLogo;
