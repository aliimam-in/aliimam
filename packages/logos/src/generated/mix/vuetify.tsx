...
export interface VuetifyLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const VuetifyLogo = React.forwardRef<SVGSVGElement, VuetifyLogoProps>(
...
VuetifyLogo.displayName = "VuetifyLogo";

export const VuetifyLogoMetadata = {
  id: "vuetify",
  baseId: "vuetify",
  variant: "default",
  name: "Vuetify",
