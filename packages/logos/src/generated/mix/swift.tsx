/**
 * Auto-generated logo component: Swift (default)
...
export interface SwiftLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const SwiftLogo = React.forwardRef<SVGSVGElement, SwiftLogoProps>(
...
export const SwiftLogoMetadata = {
  id: "swift",
  baseId: "swift",
  variant: "default",
  name: "Swift",
