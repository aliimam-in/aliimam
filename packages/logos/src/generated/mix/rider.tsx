...
export interface RiderLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const RiderLogo = React.forwardRef<SVGSVGElement, RiderLogoProps>(
...
RiderLogo.displayName = "RiderLogo";

export const RiderLogoMetadata = {
  id: "rider",
  baseId: "rider",
  variant: "default",
  name: "Rider",
