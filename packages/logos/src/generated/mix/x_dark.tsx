/**
 * Auto-generated logo component: X (dark)
...
export interface XDarkProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const XDark = React.forwardRef<SVGSVGElement, XDarkProps>(
...
XDark.displayName = "XDark";

export const XDarkMetadata = {
  id: "x_dark",
  baseId: "x",
  variant: "dark",
  name: "X",
