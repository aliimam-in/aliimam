/**
 * Auto-generated logo component: Doge (default)
...
export interface DogeLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const DogeLogo = React.forwardRef<SVGSVGElement, DogeLogoProps>(
