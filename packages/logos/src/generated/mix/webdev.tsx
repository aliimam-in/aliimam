/**
 * Auto-generated logo component: Webdev (default)
...
export interface WebdevLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const WebdevLogo = React.forwardRef<SVGSVGElement, WebdevLogoProps>(
