/**
 * Auto-generated logo component: Shopify Wordmark Light (default)
...
export interface ShopifyWordmarkLightLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const ShopifyWordmarkLightLogo = React.forwardRef<SVGSVGElement, ShopifyWordmarkLightLogoProps>(
  ...
  <path d="M21.2 5.2C21.1 5.2 19 5 19 5s-1.5-1.5-1.7-1.6c-.1-.1-.1-.1-.2-.1l-1.2 24.6 8.6-1.9s-3-20.4-3-20.6c0-.1-.2-.2-.3-.2" style={{fill:"#5a863e"}} />
  <path d="m13 10-1.1 3.2s-.9-.5-2.1-.5c-1.7 0-1.8 1-1.8 1.3 0 1.4 3.8 2 3.8 5.4 0 2.7-1.7 4.4-4 4.4-2.7 0-4.1-1.7-4.1-1.7l.7-2.4s1.4 1.2 2.6 1.2c.8 0 1.1-.6 1.1-1.1 0-1.9-3.1-2-3.1-5.1 0-2.6 1.9-5.1 5.6-5.1 1.7-.1 2.4.4 2.4.4" style={{fill:"#fffffe"}} />
...
ShopifyWordmarkLightLogo.displayName = "ShopifyWordmarkLightLogo";

export const ShopifyWordmarkLightLogoMetadata = {
  id: "shopify-wordmark-light",
  baseId: "shopify-wordmark-light",
  variant: "default",
  name: "Shopify Wordmark Light",
  category: "mix",
  tags: [],
  viewBox: "0 0 100 28.6",
} as const;

export default ShopifyWordmarkLightLogo;
