...
export interface GatsbyLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const GatsbyLogo = React.forwardRef<SVGSVGElement, GatsbyLogoProps>(
...
export const GatsbyLogoMetadata = {
  id: "gatsby",
  baseId: "gatsby",
  variant: "default",
  name: "Gatsby",
