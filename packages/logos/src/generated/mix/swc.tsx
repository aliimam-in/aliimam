/**
 * Auto-generated logo component: Swc (default)
...
export interface SwcLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const SwcLogo = React.forwardRef<SVGSVGElement, SwcLogoProps>(
  ({ size = 24, className = '', ...props }, ref) => (
    <svg
      ...
      {...props}
    >
      <linearGradient id="a" gradientUnits="userSpaceOnUse" x1="2.9644" x2="973.6517" y1="172.8813" y2="172.8813">
...
SwcLogo.displayName = "SwcLogo";

export const SwcLogoMetadata = {
  id: "swc",
  baseId: "swc",
  variant: "default",
  name: "Swc",
