/**
 * Auto-generated logo component: Roblox (default)
...
export interface RobloxLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const RobloxLogo = React.forwardRef<SVGSVGElement, RobloxLogoProps>(
