/**
 * Auto-generated logo component: Vscodium (default)
...
export interface VscodiumLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const VscodiumLogo = React.forwardRef<SVGSVGElement, VscodiumLogoProps>(
