/**
 * Auto-generated logo component: Convex (wordmark_dark)
...
export interface ConvexWordmarkDarkProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const ConvexWordmarkDark = React.forwardRef<SVGSVGElement, ConvexWordmarkDarkProps>(
...
export default ConvexWordmarkDark;
