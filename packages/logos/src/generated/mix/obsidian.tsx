/**
 * Auto-generated logo component: Obsidian (default)
...
export interface ObsidianLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const ObsidianLogo = React.forwardRef<SVGSVGElement, ObsidianLogoProps>(
