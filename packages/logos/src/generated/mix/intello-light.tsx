/**
 * Auto-generated logo component: Intello Light (default)
...
export interface IntelloLightLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const IntelloLightLogo = React.forwardRef<SVGSVGElement, IntelloLightLogoProps>(
...
IntelloLightLogo.displayName = "IntelloLightLogo";

export const IntelloLightLogoMetadata = {
  id: "intello-light",
  baseId: "intello-light",
  variant: "default",
  name: "Intello Light",
  category: "mix",
  tags: [],
...
export default IntelloLightLogo;
