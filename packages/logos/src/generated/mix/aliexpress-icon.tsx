/**
 * Auto-generated logo component: Aliexpress Icon (default)
...
export interface AliexpressIconLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const AliexpressIconLogo = React.forwardRef<SVGSVGElement, AliexpressIconLogoProps>(
...
export default AliexpressIconLogo;
