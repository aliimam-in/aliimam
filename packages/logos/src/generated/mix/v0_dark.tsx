/**
 * Auto-generated logo component: V0 (dark)
...
export interface V0DarkProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const V0Dark = React.forwardRef<SVGSVGElement, V0DarkProps>(
...
V0Dark.displayName = "V0Dark";

export const V0DarkMetadata = {
  id: "v0_dark",
  baseId: "v0",
  variant: "dark",
  name: "V0",
