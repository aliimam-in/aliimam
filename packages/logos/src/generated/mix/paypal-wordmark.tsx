/**
 * Auto-generated logo component: Paypal Wordmark (default)
...
export interface PaypalWordmarkLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const PaypalWordmarkLogo = React.forwardRef<SVGSVGElement, PaypalWordmarkLogoProps>(
...
PaypalWordmarkLogo.displayName = "PaypalWordmarkLogo";

export const PaypalWordmarkLogoMetadata = {
  id: "paypal-wordmark",
  baseId: "paypal-wordmark",
  variant: "default",
  name: "Paypal Wordmark",
  category: "mix",
  tags: [],
  viewBox: "0 0 404.65 98.18",
} as const;

export default PaypalWordmarkLogo;
