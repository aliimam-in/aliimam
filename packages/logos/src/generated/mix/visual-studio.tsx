/**
 * Auto-generated logo component: Visual Studio (default)
...
export interface VisualStudioLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const VisualStudioLogo = React.forwardRef<SVGSVGElement, VisualStudioLogoProps>(
