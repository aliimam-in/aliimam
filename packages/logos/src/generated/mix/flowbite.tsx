/**
 * Auto-generated logo component: Flowbite (default)
...
export interface FlowbiteLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const FlowbiteLogo = React.forwardRef<SVGSVGElement, FlowbiteLogoProps>(
...
FlowbiteLogo.displayName = "FlowbiteLogo";

export const FlowbiteLogoMetadata = {
  id: "flowbite",
  baseId: "flowbite",
  variant: "default",
  name: "Flowbite",
