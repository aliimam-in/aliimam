/**
 * Auto-generated logo component: Spinnaker (default)
...
export interface SpinnakerLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const SpinnakerLogo = React.forwardRef<SVGSVGElement, SpinnakerLogoProps>(
  ({ size = 24, className = '', ...props }, ref) => (
    ...
    <linearGradient x1="82.2%" y1="6%" x2="34.6%" y2="106.1%" id="a">
      ...
      <stop stopColor="#0BA1CC" offset="49%" />
      <stop stopColor="#05B4D7" offset="66%" />
  ...
  <path d="M22 218.3c98.8 9.8 178.2-48.6 198-73.7C239.8 119.6 209.8 0 209.8 0 177.2 80 118 201.1 21.9 218.4Z" fill="url(#a)" style={{mixBlendMode:"multiply"}} />
  <path d="M67.7 186.4C126 188.6 170.4 152 181 136.7c10.7-15.2-5.7-83.7-5.7-83.7-16.2 47.5-61.3 116.6-107.7 133.4Z" fill="url(#b)" style={{mixBlendMode:"multiply"}} />
...
SpinnakerLogo.displayName = "SpinnakerLogo";

export const SpinnakerLogoMetadata = {
  id: "spinnaker",
  baseId: "spinnaker",
  variant: "default",
  name: "Spinnaker",
