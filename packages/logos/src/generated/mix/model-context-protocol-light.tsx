/**
 * Auto-generated logo component: Model Context Protocol Light (default)
...
export interface ModelContextProtocolLightLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const ModelContextProtocolLightLogo = React.forwardRef<SVGSVGElement, ModelContextProtocolLightLogoProps>(
...
ModelContextProtocolLightLogo.displayName = "ModelContextProtocolLightLogo";

export const ModelContextProtocolLightLogoMetadata = {
  id: "model-context-protocol-light",
  baseId: "model-context-protocol-light",
  variant: "default",
  name: "Model Context Protocol Light",
  category: "mix",
  tags: [],
  viewBox: "0 0 24 24",
} as const;

export default ModelContextProtocolLightLogo;
