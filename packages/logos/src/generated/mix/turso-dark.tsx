/**
 * Auto-generated logo component: Turso Dark (default)
...
export interface TursoDarkLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const TursoDarkLogo = React.forwardRef<SVGSVGElement, TursoDarkLogoProps>(
...
TursoDarkLogo.displayName = "TursoDarkLogo";

export const TursoDarkLogoMetadata = {
  id: "turso-dark",
  baseId: "turso-dark",
  variant: "default",
  name: "Turso Dark",
