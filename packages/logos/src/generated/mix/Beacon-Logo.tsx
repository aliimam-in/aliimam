/**
 * Auto-generated logo component: Beacon Logo (default)
...
export interface BeaconLogoLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const BeaconLogoLogo = React.forwardRef<SVGSVGElement, BeaconLogoLogoProps>(
...
BeaconLogoLogo.displayName = "BeaconLogoLogo";

export const BeaconLogoLogoMetadata = {
  id: "Beacon-Logo",
  baseId: "Beacon-Logo",
  variant: "default",
  name: "Beacon Logo",
