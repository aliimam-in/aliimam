/**
 * Auto-generated logo component: Googleplay Wordmark Dark (default)
...
export interface GoogleplayWordmarkDarkLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const GoogleplayWordmarkDarkLogo = React.forwardRef<SVGSVGElement, GoogleplayWordmarkDarkLogoProps>(
...
GoogleplayWordmarkDarkLogo.displayName = "GoogleplayWordmarkDarkLogo";

export const GoogleplayWordmarkDarkLogoMetadata = {
  id: "googleplay-wordmark-dark",
  baseId: "googleplay-wordmark-dark",
  variant: "default",
  name: "Googleplay Wordmark Dark",
  category: "mix",
  tags: [],
  viewBox: "0 0 162.28 32",
} as const;

export default GoogleplayWordmarkDarkLogo;
