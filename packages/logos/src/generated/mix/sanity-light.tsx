/**
 * Auto-generated logo component: Sanity Light (default)
...
export interface SanityLightLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const SanityLightLogo = React.forwardRef<SVGSVGElement, SanityLightLogoProps>(
...
SanityLightLogo.displayName = "SanityLightLogo";

export const SanityLightLogoMetadata = {
  id: "sanity-light",
  baseId: "sanity-light",
  variant: "default",
  name: "Sanity Light",
...
export default SanityLightLogo;
