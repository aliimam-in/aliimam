...
export interface BunLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const BunLogo = React.forwardRef<SVGSVGElement, BunLogoProps>(
