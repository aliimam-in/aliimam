/**
 * Auto-generated logo component: Intlayer Dark (default)
...
export interface IntlayerDarkLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const IntlayerDarkLogo = React.forwardRef<SVGSVGElement, IntlayerDarkLogoProps>(
...
IntlayerDarkLogo.displayName = "IntlayerDarkLogo";

export const IntlayerDarkLogoMetadata = {
  id: "intlayer-dark",
  baseId: "intlayer-dark",
  variant: "default",
  name: "Intlayer Dark",
  category: "mix",
  tags: [],
...
export default IntlayerDarkLogo;
