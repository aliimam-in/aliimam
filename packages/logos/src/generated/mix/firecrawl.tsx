/**
 * Auto-generated logo component: Firecrawl (default)
...
export interface FirecrawlLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const FirecrawlLogo = React.forwardRef<SVGSVGElement, FirecrawlLogoProps>(
