...
export interface CoinbaseLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const CoinbaseLogo = React.forwardRef<SVGSVGElement, CoinbaseLogoProps>(
...
export const CoinbaseLogoMetadata = {
  id: "coinbase",
  baseId: "coinbase",
  variant: "default",
  name: "Coinbase",
