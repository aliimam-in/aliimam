/**
 * Auto-generated logo component: Ant Design Dark Theme (default)
...
export interface AntDesignDarkThemeLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const AntDesignDarkThemeLogo = React.forwardRef<SVGSVGElement, AntDesignDarkThemeLogoProps>(
...
AntDesignDarkThemeLogo.displayName = "AntDesignDarkThemeLogo";

export const AntDesignDarkThemeLogoMetadata = {
  id: "ant-design-dark-theme",
  baseId: "ant-design-dark-theme",
  variant: "default",
...
export default AntDesignDarkThemeLogo;
