/**
 * Auto-generated logo component: Instatus (dark)
...
export interface InstatusDarkProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const InstatusDark = React.forwardRef<SVGSVGElement, InstatusDarkProps>(
