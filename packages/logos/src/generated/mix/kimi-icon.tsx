/**
 * Auto-generated logo component: Kimi Icon (default)
...
export interface KimiIconLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const KimiIconLogo = React.forwardRef<SVGSVGElement, KimiIconLogoProps>(
