/**
 * Auto-generated logo component: Axiom Dark (default)
...
export interface AxiomDarkLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const AxiomDarkLogo = React.forwardRef<SVGSVGElement, AxiomDarkLogoProps>(
