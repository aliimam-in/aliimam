/**
 * Auto-generated logo component: Graphql (default)
...
export interface GraphqlLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const GraphqlLogo = React.forwardRef<SVGSVGElement, GraphqlLogoProps>(
...
GraphqlLogo.displayName = "GraphqlLogo";

export const GraphqlLogoMetadata = {
  id: "graphql",
  baseId: "graphql",
  variant: "default",
  name: "Graphql",
