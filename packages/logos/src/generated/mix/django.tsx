...
export interface DjangoLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const DjangoLogo = React.forwardRef<SVGSVGElement, DjangoLogoProps>(
...
DjangoLogo.displayName = "DjangoLogo";

export const DjangoLogoMetadata = {
  id: "django",
  baseId: "django",
  variant: "default",
  name: "Django",
