...
export interface StimulusLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const StimulusLogo = React.forwardRef<SVGSVGElement, StimulusLogoProps>(
