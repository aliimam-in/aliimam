...
export interface PhpLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const PhpLogo = React.forwardRef<SVGSVGElement, PhpLogoProps>(
