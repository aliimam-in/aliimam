/**
 * Auto-generated logo component: Soundcloud Wordmark (default)
...
export interface SoundcloudWordmarkLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const SoundcloudWordmarkLogo = React.forwardRef<SVGSVGElement, SoundcloudWordmarkLogoProps>(
...
export default SoundcloudWordmarkLogo;
