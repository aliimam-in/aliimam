/**
 * Auto-generated logo component: Mistral Ai (logo)
...
export interface MistralAiLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const MistralAiLogo = React.forwardRef<SVGSVGElement, MistralAiLogoProps>(
