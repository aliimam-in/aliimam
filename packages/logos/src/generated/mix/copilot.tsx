/**
 * Auto-generated logo component: Copilot (default)
...
export interface CopilotLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const CopilotLogo = React.forwardRef<SVGSVGElement, CopilotLogoProps>(
...
CopilotLogo.displayName = "CopilotLogo";

export const CopilotLogoMetadata = {
  id: "copilot",
  baseId: "copilot",
  variant: "default",
  name: "Copilot",
