/**
 * Auto-generated logo component: Nuqs (dark)
...
export interface NuqsDarkProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const NuqsDark = React.forwardRef<SVGSVGElement, NuqsDarkProps>(
