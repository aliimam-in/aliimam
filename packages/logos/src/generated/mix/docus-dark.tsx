/**
 * Auto-generated logo component: Docus Dark (default)
...
export interface DocusDarkLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const DocusDarkLogo = React.forwardRef<SVGSVGElement, DocusDarkLogoProps>(
