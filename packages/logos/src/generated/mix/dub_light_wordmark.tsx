/**
 * Auto-generated logo component: Dub (light_wordmark)
...
export interface DubLightWordmarkProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const DubLightWordmark = React.forwardRef<SVGSVGElement, DubLightWordmarkProps>(
...
DubLightWordmark.displayName = "DubLightWordmark";

export const DubLightWordmarkMetadata = {
  id: "dub_light_wordmark",
  baseId: "dub",
  variant: "light_wordmark",
  name: "Dub",
  category: "mix",
  tags: [],
  viewBox: "0 0 46 24",
...
export default DubLightWordmark;
