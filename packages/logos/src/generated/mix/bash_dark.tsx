/**
 * Auto-generated logo component: Bash (dark)
...
export interface BashDarkProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const BashDark = React.forwardRef<SVGSVGElement, BashDarkProps>(
