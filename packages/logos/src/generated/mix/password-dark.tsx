/**
 * Auto-generated logo component: Password Dark (default)
...
export interface PasswordDarkLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const PasswordDarkLogo = React.forwardRef<SVGSVGElement, PasswordDarkLogoProps>(
...
export default PasswordDarkLogo;
