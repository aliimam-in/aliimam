...
export interface RaycastLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const RaycastLogo = React.forwardRef<SVGSVGElement, RaycastLogoProps>(
...
RaycastLogo.displayName = "RaycastLogo";

export const RaycastLogoMetadata = {
  id: "raycast",
  baseId: "raycast",
  variant: "default",
  name: "Raycast",
