/**
 * Auto-generated logo component: Model Context Protocol Dark (default)
...
export interface ModelContextProtocolDarkLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const ModelContextProtocolDarkLogo = React.forwardRef<SVGSVGElement, ModelContextProtocolDarkLogoProps>(
...
ModelContextProtocolDarkLogo.displayName = "ModelContextProtocolDarkLogo";

export const ModelContextProtocolDarkLogoMetadata = {
  id: "model-context-protocol-dark",
  baseId: "model-context-protocol-dark",
  variant: "default",
  name: "Model Context Protocol Dark",
  category: "mix",
  tags: [],
  viewBox: "0 0 24 24",
} as const;

export default ModelContextProtocolDarkLogo;
