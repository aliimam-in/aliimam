/**
 * Auto-generated logo component: Copilot (dark)
...
export interface CopilotDarkProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const CopilotDark = React.forwardRef<SVGSVGElement, CopilotDarkProps>(
