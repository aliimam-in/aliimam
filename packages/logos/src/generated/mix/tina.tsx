...
export interface TinaLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const TinaLogo = React.forwardRef<SVGSVGElement, TinaLogoProps>(
...
TinaLogo.displayName = "TinaLogo";

export const TinaLogoMetadata = {
  id: "tina",
  baseId: "tina",
  variant: "default",
  name: "Tina",
