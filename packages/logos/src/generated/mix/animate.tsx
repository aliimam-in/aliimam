/**
 * Auto-generated logo component: Animate (default)
...
export interface AnimateLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const AnimateLogo = React.forwardRef<SVGSVGElement, AnimateLogoProps>(
