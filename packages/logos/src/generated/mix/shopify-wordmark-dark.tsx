/**
 * Auto-generated logo component: Shopify Wordmark Dark (default)
...
export interface ShopifyWordmarkDarkLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const ShopifyWordmarkDarkLogo = React.forwardRef<SVGSVGElement, ShopifyWordmarkDarkLogoProps>(
...
ShopifyWordmarkDarkLogo.displayName = "ShopifyWordmarkDarkLogo";

export const ShopifyWordmarkDarkLogoMetadata = {
  id: "shopify-wordmark-dark",
  baseId: "shopify-wordmark-dark",
  variant: "default",
  name: "Shopify Wordmark Dark",
  category: "mix",
  tags: [],
  viewBox: "0 0 608 173.7",
} as const;

export default ShopifyWordmarkDarkLogo;
