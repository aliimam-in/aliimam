...
export interface LuaLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const LuaLogo = React.forwardRef<SVGSVGElement, LuaLogoProps>(
  ({ size = 24, className = '', ...props }, ref) => (
	...
	<path fill="none" stroke="#808080" strokeWidth="10.8612" stroke-miterlimit="10" strokeDasharray="40.8475" d="M890.6,261   c33.5,65.8,51,138.6,51,212.5c0,258.4-209.7,468.1-468.1,468.1S5.4,731.9,5.4,473.5C5.4,215.1,215.1,5.4,473.5,5.4   c83.1,0,164.6,22.1,236.2,63.9" />
</g>
    </svg>
  )
);

LuaLogo.displayName = "LuaLogo";

export const LuaLogoMetadata = {
  id: "lua",
  baseId: "lua",
  variant: "default",
  name: "Lua",
