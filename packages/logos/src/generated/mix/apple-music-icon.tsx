/**
 * Auto-generated logo component: Apple Music Icon (default)
...
export interface AppleMusicIconLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const AppleMusicIconLogo = React.forwardRef<SVGSVGElement, AppleMusicIconLogoProps>(
...
export default AppleMusicIconLogo;
