/**
 * Auto-generated logo component: Remix (dark)
...
export interface RemixDarkProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const RemixDark = React.forwardRef<SVGSVGElement, RemixDarkProps>(
