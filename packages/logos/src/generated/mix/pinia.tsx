/**
 * Auto-generated logo component: Pinia (default)
...
export interface PiniaLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const PiniaLogo = React.forwardRef<SVGSVGElement, PiniaLogoProps>(
