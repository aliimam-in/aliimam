/**
 * Auto-generated logo component: Xstate (dark)
...
export interface XstateDarkProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const XstateDark = React.forwardRef<SVGSVGElement, XstateDarkProps>(
