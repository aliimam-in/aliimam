/**
 * Auto-generated logo component: Dart (default)
...
export interface DartLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const DartLogo = React.forwardRef<SVGSVGElement, DartLogoProps>(
