/**
 * Auto-generated logo component: Rxjs (default)
...
export interface RxjsLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const RxjsLogo = React.forwardRef<SVGSVGElement, RxjsLogoProps>(
