/**
 * Auto-generated logo component: Skype (default)
...
export interface SkypeLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const SkypeLogo = React.forwardRef<SVGSVGElement, SkypeLogoProps>(
