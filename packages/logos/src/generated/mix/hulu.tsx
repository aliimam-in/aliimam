/**
 * Auto-generated logo component: Hulu (default)
...
export interface HuluLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const HuluLogo = React.forwardRef<SVGSVGElement, HuluLogoProps>(
...
HuluLogo.displayName = "HuluLogo";

export const HuluLogoMetadata = {
  id: "hulu",
  baseId: "hulu",
  variant: "default",
  name: "Hulu",
