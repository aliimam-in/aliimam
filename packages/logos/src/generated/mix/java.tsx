...
export interface JavaLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const JavaLogo = React.forwardRef<SVGSVGElement, JavaLogoProps>(
...
JavaLogo.displayName = "JavaLogo";

export const JavaLogoMetadata = {
  id: "java",
  baseId: "java",
  variant: "default",
  name: "Java",
