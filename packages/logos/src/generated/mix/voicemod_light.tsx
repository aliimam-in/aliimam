/**
 * Auto-generated logo component: Voicemod (light)
...
export interface VoicemodLightProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const VoicemodLight = React.forwardRef<SVGSVGElement, VoicemodLightProps>(
