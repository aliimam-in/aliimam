/**
 * Auto-generated logo component: Webstorm (default)
...
export interface WebstormLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const WebstormLogo = React.forwardRef<SVGSVGElement, WebstormLogoProps>(
  ...
  <linearGradient href="#a" id="c" x1="88.27" x2="93.79" y1="25.47" y2="45.02" />
...
WebstormLogo.displayName = "WebstormLogo";

export const WebstormLogoMetadata = {
  id: "webstorm",
  baseId: "webstorm",
  variant: "default",
  name: "Webstorm",
