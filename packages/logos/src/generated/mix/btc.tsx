/**
 * Auto-generated logo component: Btc (default)
...
export interface BtcLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const BtcLogo = React.forwardRef<SVGSVGElement, BtcLogoProps>(
