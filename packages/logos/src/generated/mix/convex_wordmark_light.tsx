/**
 * Auto-generated logo component: Convex (wordmark_light)
...
export interface ConvexWordmarkLightProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const ConvexWordmarkLight = React.forwardRef<SVGSVGElement, ConvexWordmarkLightProps>(
...
export default ConvexWordmarkLight;
