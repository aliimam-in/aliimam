/**
 * Auto-generated logo component: Materialui (default)
...
export interface MaterialuiLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const MaterialuiLogo = React.forwardRef<SVGSVGElement, MaterialuiLogoProps>(
...
MaterialuiLogo.displayName = "MaterialuiLogo";

export const MaterialuiLogoMetadata = {
  id: "materialui",
  baseId: "materialui",
  variant: "default",
  name: "Materialui",
