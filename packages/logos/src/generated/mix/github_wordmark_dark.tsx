/**
 * Auto-generated logo component: Github (wordmark_dark)
...
export interface GithubWordmarkDarkProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const GithubWordmarkDark = React.forwardRef<SVGSVGElement, GithubWordmarkDarkProps>(
  ({ size = 24, className = '', ...props }, ref) => (
    <svg
      ...
      {...props}
    >
      <path fill="#FFFFFF" d="M103.4,55.9h-0.1C103.3,55.9,103.3,56,103.4,55.9L103.4,55.9L103.4,55.9z M103.4,56c-0.5,0-1.8,0.3-3.2,0.3
...
GithubWordmarkDark.displayName = "GithubWordmarkDark";

export const GithubWordmarkDarkMetadata = {
  id: "github_wordmark_dark",
  baseId: "github",
...
export default GithubWordmarkDark;
