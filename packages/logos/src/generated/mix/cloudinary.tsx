/**
 * Auto-generated logo component: Cloudinary (default)
...
export interface CloudinaryLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const CloudinaryLogo = React.forwardRef<SVGSVGElement, CloudinaryLogoProps>(
...
CloudinaryLogo.displayName = "CloudinaryLogo";

export const CloudinaryLogoMetadata = {
  id: "cloudinary",
  baseId: "cloudinary",
  variant: "default",
  name: "Cloudinary",
