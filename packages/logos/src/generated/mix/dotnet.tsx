/**
 * Auto-generated logo component: Dotnet (default)
...
export interface DotnetLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const DotnetLogo = React.forwardRef<SVGSVGElement, DotnetLogoProps>(
...
export const DotnetLogoMetadata = {
  id: "dotnet",
  baseId: "dotnet",
  variant: "default",
  name: "Dotnet",
