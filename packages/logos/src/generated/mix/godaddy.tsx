/**
 * Auto-generated logo component: Godaddy (default)
...
export interface GodaddyLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const GodaddyLogo = React.forwardRef<SVGSVGElement, GodaddyLogoProps>(
