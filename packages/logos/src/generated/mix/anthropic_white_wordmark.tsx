/**
 * Auto-generated logo component: Anthropic (white_wordmark)
...
export interface AnthropicWhiteWordmarkProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const AnthropicWhiteWordmark = React.forwardRef<SVGSVGElement, AnthropicWhiteWordmarkProps>(
...
AnthropicWhiteWordmark.displayName = "AnthropicWhiteWordmark";

export const AnthropicWhiteWordmarkMetadata = {
  id: "anthropic_white_wordmark",
  baseId: "anthropic",
  variant: "white_wordmark",
  name: "Anthropic",
  category: "mix",
  tags: [],
  viewBox: "0 0 182 24",
...
export default AnthropicWhiteWordmark;
