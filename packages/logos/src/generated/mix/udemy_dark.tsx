/**
 * Auto-generated logo component: Udemy (dark)
...
export interface UdemyDarkProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const UdemyDark = React.forwardRef<SVGSVGElement, UdemyDarkProps>(
