/**
 * Auto-generated logo component: GoogleMaps (default)
...
export interface GoogleMapsLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const GoogleMapsLogo = React.forwardRef<SVGSVGElement, GoogleMapsLogoProps>(
...
GoogleMapsLogo.displayName = "GoogleMapsLogo";

export const GoogleMapsLogoMetadata = {
  id: "googleMaps",
  baseId: "googleMaps",
  variant: "default",
  name: "GoogleMaps",
