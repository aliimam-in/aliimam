/**
 * Auto-generated logo component: Powersync (default)
...
export interface PowersyncLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const PowersyncLogo = React.forwardRef<SVGSVGElement, PowersyncLogoProps>(
