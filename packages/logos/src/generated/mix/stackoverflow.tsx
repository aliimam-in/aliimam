/**
 * Auto-generated logo component: Stackoverflow (default)
...
export interface StackoverflowLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const StackoverflowLogo = React.forwardRef<SVGSVGElement, StackoverflowLogoProps>(
...
export const StackoverflowLogoMetadata = {
  id: "stackoverflow",
  baseId: "stackoverflow",
  variant: "default",
  name: "Stackoverflow",
  category: "mix",
  tags: [],
