/**
 * Auto-generated logo component: Aws (light)
...
export interface AwsLightProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const AwsLight = React.forwardRef<SVGSVGElement, AwsLightProps>(
...
AwsLight.displayName = "AwsLight";

export const AwsLightMetadata = {
  id: "aws_light",
  baseId: "aws",
  variant: "light",
  name: "Aws",
