/**
 * Auto-generated logo component: Jetbrains (default)
...
export interface JetbrainsLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const JetbrainsLogo = React.forwardRef<SVGSVGElement, JetbrainsLogoProps>(
...
JetbrainsLogo.displayName = "JetbrainsLogo";

export const JetbrainsLogoMetadata = {
  id: "jetbrains",
  baseId: "jetbrains",
  variant: "default",
  name: "Jetbrains",
