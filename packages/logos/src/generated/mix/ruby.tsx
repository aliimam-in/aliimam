/**
 * Auto-generated logo component: Ruby (default)
...
export interface RubyLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const RubyLogo = React.forwardRef<SVGSVGElement, RubyLogoProps>(
...
RubyLogo.displayName = "RubyLogo";

export const RubyLogoMetadata = {
  id: "ruby",
  baseId: "ruby",
  variant: "default",
  name: "Ruby",
