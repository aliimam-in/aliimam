/**
 * Auto-generated logo component: Bitwarden (default)
...
export interface BitwardenLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const BitwardenLogo = React.forwardRef<SVGSVGElement, BitwardenLogoProps>(
...
BitwardenLogo.displayName = "BitwardenLogo";

export const BitwardenLogoMetadata = {
  id: "bitwarden",
  baseId: "bitwarden",
  variant: "default",
  name: "Bitwarden",
