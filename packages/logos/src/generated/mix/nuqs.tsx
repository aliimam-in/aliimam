...
export interface NuqsLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const NuqsLogo = React.forwardRef<SVGSVGElement, NuqsLogoProps>(
