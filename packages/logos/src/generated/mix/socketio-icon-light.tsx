/**
 * Auto-generated logo component: Socketio Icon Light (default)
...
export interface SocketioIconLightLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const SocketioIconLightLogo = React.forwardRef<SVGSVGElement, SocketioIconLightLogoProps>(
...
SocketioIconLightLogo.displayName = "SocketioIconLightLogo";

export const SocketioIconLightLogoMetadata = {
  id: "socketio-icon-light",
  baseId: "socketio-icon-light",
  variant: "default",
  name: "Socketio Icon Light",
  category: "mix",
  tags: [],
  viewBox: "0 0 64 64",
} as const;

export default SocketioIconLightLogo;
