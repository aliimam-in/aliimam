/**
 * Auto-generated logo component: Resend Icon White (default)
...
export interface ResendIconWhiteLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const ResendIconWhiteLogo = React.forwardRef<SVGSVGElement, ResendIconWhiteLogoProps>(
...
ResendIconWhiteLogo.displayName = "ResendIconWhiteLogo";

export const ResendIconWhiteLogoMetadata = {
  id: "resend-icon-white",
  baseId: "resend-icon-white",
  variant: "default",
  name: "Resend Icon White",
  category: "mix",
  tags: [],
  viewBox: "0 0 600 600",
} as const;

export default ResendIconWhiteLogo;
