/**
 * Auto-generated logo component: Voidzero (default)
...
export interface VoidzeroLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const VoidzeroLogo = React.forwardRef<SVGSVGElement, VoidzeroLogoProps>(
