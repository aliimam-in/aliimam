/**
 * Auto-generated logo component: Drive (default)
...
export interface DriveLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const DriveLogo = React.forwardRef<SVGSVGElement, DriveLogoProps>(
...
DriveLogo.displayName = "DriveLogo";

export const DriveLogoMetadata = {
  id: "drive",
  baseId: "drive",
  variant: "default",
  name: "Drive",
