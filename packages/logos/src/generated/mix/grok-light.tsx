/**
 * Auto-generated logo component: Grok Light (default)
...
export interface GrokLightLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const GrokLightLogo = React.forwardRef<SVGSVGElement, GrokLightLogoProps>(
...
GrokLightLogo.displayName = "GrokLightLogo";

export const GrokLightLogoMetadata = {
  id: "grok-light",
  baseId: "grok-light",
  variant: "default",
  name: "Grok Light",
