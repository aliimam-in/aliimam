/**
 * Auto-generated logo component: Fastify (dark)
...
export interface FastifyDarkProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const FastifyDark = React.forwardRef<SVGSVGElement, FastifyDarkProps>(
