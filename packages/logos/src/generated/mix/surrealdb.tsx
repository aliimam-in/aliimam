/**
 * Auto-generated logo component: Surrealdb (default)
...
export interface SurrealdbLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const SurrealdbLogo = React.forwardRef<SVGSVGElement, SurrealdbLogoProps>(
