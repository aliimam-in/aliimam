/**
 * Auto-generated logo component: Mysql Wordmark Light (default)
...
export interface MysqlWordmarkLightLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const MysqlWordmarkLightLogo = React.forwardRef<SVGSVGElement, MysqlWordmarkLightLogoProps>(
