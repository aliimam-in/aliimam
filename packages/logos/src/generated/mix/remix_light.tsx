/**
 * Auto-generated logo component: Remix (light)
...
export interface RemixLightProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const RemixLight = React.forwardRef<SVGSVGElement, RemixLightProps>(
