/**
 * Auto-generated logo component: Polar Sh (light)
...
export interface PolarShLightProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const PolarShLight = React.forwardRef<SVGSVGElement, PolarShLightProps>(
