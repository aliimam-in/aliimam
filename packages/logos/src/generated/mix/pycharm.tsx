...
export interface PycharmLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const PycharmLogo = React.forwardRef<SVGSVGElement, PycharmLogoProps>(
...
PycharmLogo.displayName = "PycharmLogo";

export const PycharmLogoMetadata = {
  id: "pycharm",
  baseId: "pycharm",
  variant: "default",
  name: "Pycharm",
