/**
 * Auto-generated logo component: Tensorflow Wordmark Dark (default)
...
export interface TensorflowWordmarkDarkLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const TensorflowWordmarkDarkLogo = React.forwardRef<SVGSVGElement, TensorflowWordmarkDarkLogoProps>(
