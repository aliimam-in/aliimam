/**
 * Auto-generated logo component: Sketch (light)
...
export interface SketchLightProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const SketchLight = React.forwardRef<SVGSVGElement, SketchLightProps>(
