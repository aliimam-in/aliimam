...
export interface LitecoinLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const LitecoinLogo = React.forwardRef<SVGSVGElement, LitecoinLogoProps>(
...
LitecoinLogo.displayName = "LitecoinLogo";

export const LitecoinLogoMetadata = {
  id: "litecoin",
  baseId: "litecoin",
  variant: "default",
  name: "Litecoin",
