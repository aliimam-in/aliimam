/**
 * Auto-generated logo component: Railway (dark)
...
export interface RailwayDarkProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const RailwayDark = React.forwardRef<SVGSVGElement, RailwayDarkProps>(
