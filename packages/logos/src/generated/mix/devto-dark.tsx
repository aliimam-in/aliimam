/**
 * Auto-generated logo component: Devto Dark (default)
...
export interface DevtoDarkLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const DevtoDarkLogo = React.forwardRef<SVGSVGElement, DevtoDarkLogoProps>(
...
DevtoDarkLogo.displayName = "DevtoDarkLogo";

export const DevtoDarkLogoMetadata = {
  id: "devto-dark",
  baseId: "devto-dark",
  variant: "default",
  name: "Devto Dark",
