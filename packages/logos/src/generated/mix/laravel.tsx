...
export interface LaravelLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const LaravelLogo = React.forwardRef<SVGSVGElement, LaravelLogoProps>(
...
export const LaravelLogoMetadata = {
  id: "laravel",
  baseId: "laravel",
  variant: "default",
  name: "Laravel",
