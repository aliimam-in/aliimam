/**
 * Auto-generated logo component: Poper (default)
...
export interface PoperLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const PoperLogo = React.forwardRef<SVGSVGElement, PoperLogoProps>(
...
PoperLogo.displayName = "PoperLogo";

export const PoperLogoMetadata = {
  id: "poper",
  baseId: "poper",
  variant: "default",
  name: "Poper",
