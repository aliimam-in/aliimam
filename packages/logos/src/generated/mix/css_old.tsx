/**
 * Auto-generated logo component: Css (old)
...
export interface CssOldProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const CssOld = React.forwardRef<SVGSVGElement, CssOldProps>(
...
CssOld.displayName = "CssOld";

export const CssOldMetadata = {
  id: "css_old",
  baseId: "css",
  variant: "old",
  name: "Css",
