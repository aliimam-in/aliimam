...
export interface NotionLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const NotionLogo = React.forwardRef<SVGSVGElement, NotionLogoProps>(
...
export const NotionLogoMetadata = {
  id: "notion",
  baseId: "notion",
  variant: "default",
  name: "Notion",
