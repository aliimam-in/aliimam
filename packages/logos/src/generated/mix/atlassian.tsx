...
export interface AtlassianLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const AtlassianLogo = React.forwardRef<SVGSVGElement, AtlassianLogoProps>(
...
export const AtlassianLogoMetadata = {
  id: "atlassian",
  baseId: "atlassian",
  variant: "default",
  name: "Atlassian",
