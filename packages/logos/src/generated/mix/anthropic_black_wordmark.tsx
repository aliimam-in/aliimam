/**
 * Auto-generated logo component: Anthropic (black_wordmark)
...
export interface AnthropicBlackWordmarkProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const AnthropicBlackWordmark = React.forwardRef<SVGSVGElement, AnthropicBlackWordmarkProps>(
...
AnthropicBlackWordmark.displayName = "AnthropicBlackWordmark";

export const AnthropicBlackWordmarkMetadata = {
  id: "anthropic_black_wordmark",
  baseId: "anthropic",
  variant: "black_wordmark",
  name: "Anthropic",
  category: "mix",
  tags: [],
  viewBox: "0 0 182 24",
...
export default AnthropicBlackWordmark;
