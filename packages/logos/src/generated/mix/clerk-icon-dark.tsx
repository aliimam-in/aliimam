/**
 * Auto-generated logo component: Clerk Icon Dark (default)
...
export interface ClerkIconDarkLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const ClerkIconDarkLogo = React.forwardRef<SVGSVGElement, ClerkIconDarkLogoProps>(
