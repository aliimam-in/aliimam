...
export interface ArcLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const ArcLogo = React.forwardRef<SVGSVGElement, ArcLogoProps>(
...
ArcLogo.displayName = "ArcLogo";

export const ArcLogoMetadata = {
  id: "arc",
  baseId: "arc",
  variant: "default",
  name: "Arc",
