/**
 * Auto-generated logo component: Ngrok Light (default)
...
export interface NgrokLightLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const NgrokLightLogo = React.forwardRef<SVGSVGElement, NgrokLightLogoProps>(
  ({ size = 24, className = '', ...props }, ref) => (
    <svg
      ref={ref}
      width={size}
      height={size}
      viewBox="0 0 200 92.11"
      className={className}
...
NgrokLightLogo.displayName = "NgrokLightLogo";

export const NgrokLightLogoMetadata = {
  id: "ngrok-light",
  baseId: "ngrok-light",
  variant: "default",
  name: "Ngrok Light",
