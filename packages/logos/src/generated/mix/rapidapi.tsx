/**
 * Auto-generated logo component: Rapidapi (default)
...
export interface RapidapiLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const RapidapiLogo = React.forwardRef<SVGSVGElement, RapidapiLogoProps>(
