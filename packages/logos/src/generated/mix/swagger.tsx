/**
 * Auto-generated logo component: Swagger (default)
...
export interface SwaggerLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const SwaggerLogo = React.forwardRef<SVGSVGElement, SwaggerLogoProps>(
...
SwaggerLogo.displayName = "SwaggerLogo";

export const SwaggerLogoMetadata = {
  id: "swagger",
  baseId: "swagger",
  variant: "default",
  name: "Swagger",
