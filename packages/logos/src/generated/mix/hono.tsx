...
export interface HonoLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const HonoLogo = React.forwardRef<SVGSVGElement, HonoLogoProps>(
...
HonoLogo.displayName = "HonoLogo";

export const HonoLogoMetadata = {
  id: "hono",
  baseId: "hono",
  variant: "default",
  name: "Hono",
