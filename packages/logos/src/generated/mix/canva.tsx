...
export interface CanvaLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const CanvaLogo = React.forwardRef<SVGSVGElement, CanvaLogoProps>(
...
CanvaLogo.displayName = "CanvaLogo";

export const CanvaLogoMetadata = {
  id: "canva",
  baseId: "canva",
  variant: "default",
  name: "Canva",
