/**
 * Auto-generated logo component: Expressjs (dark)
...
export interface ExpressjsDarkProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const ExpressjsDark = React.forwardRef<SVGSVGElement, ExpressjsDarkProps>(
...
ExpressjsDark.displayName = "ExpressjsDark";

export const ExpressjsDarkMetadata = {
  id: "expressjs_dark",
  baseId: "expressjs",
  variant: "dark",
  name: "Expressjs",
