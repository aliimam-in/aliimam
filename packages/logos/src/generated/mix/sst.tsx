...
export interface SstLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const SstLogo = React.forwardRef<SVGSVGElement, SstLogoProps>(
