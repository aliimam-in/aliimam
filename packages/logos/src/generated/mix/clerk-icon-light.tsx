/**
 * Auto-generated logo component: Clerk Icon Light (default)
...
export interface ClerkIconLightLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const ClerkIconLightLogo = React.forwardRef<SVGSVGElement, ClerkIconLightLogoProps>(
...
ClerkIconLightLogo.displayName = "ClerkIconLightLogo";

export const ClerkIconLightLogoMetadata = {
  id: "clerk-icon-light",
  baseId: "clerk-icon-light",
  variant: "default",
  name: "Clerk Icon Light",
  category: "mix",
  tags: [],
  viewBox: "0 0 128 128",
} as const;

export default ClerkIconLightLogo;
