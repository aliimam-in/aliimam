/**
 * Auto-generated logo component: Bnb (default)
...
export interface BnbLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const BnbLogo = React.forwardRef<SVGSVGElement, BnbLogoProps>(
