...
export interface XboxLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const XboxLogo = React.forwardRef<SVGSVGElement, XboxLogoProps>(
...
XboxLogo.displayName = "XboxLogo";

export const XboxLogoMetadata = {
  id: "xbox",
  baseId: "xbox",
  variant: "default",
  name: "Xbox",
