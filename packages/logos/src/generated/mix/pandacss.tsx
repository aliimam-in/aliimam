/**
 * Auto-generated logo component: Pandacss (default)
...
export interface PandacssLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const PandacssLogo = React.forwardRef<SVGSVGElement, PandacssLogoProps>(
