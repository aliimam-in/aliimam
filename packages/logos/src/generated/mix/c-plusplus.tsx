/**
 * Auto-generated logo component: C Plusplus (default)
...
export interface CPlusplusLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const CPlusplusLogo = React.forwardRef<SVGSVGElement, CPlusplusLogoProps>(
...
CPlusplusLogo.displayName = "CPlusplusLogo";

export const CPlusplusLogoMetadata = {
  id: "c-plusplus",
  baseId: "c-plusplus",
  variant: "default",
  name: "C Plusplus",
