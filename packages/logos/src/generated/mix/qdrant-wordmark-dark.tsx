/**
 * Auto-generated logo component: Qdrant Wordmark Dark (default)
...
export interface QdrantWordmarkDarkLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const QdrantWordmarkDarkLogo = React.forwardRef<SVGSVGElement, QdrantWordmarkDarkLogoProps>(
...
QdrantWordmarkDarkLogo.displayName = "QdrantWordmarkDarkLogo";

export const QdrantWordmarkDarkLogoMetadata = {
  id: "qdrant-wordmark-dark",
  baseId: "qdrant-wordmark-dark",
  variant: "default",
  name: "Qdrant Wordmark Dark",
  category: "mix",
  tags: [],
  viewBox: "0 0 241 64",
} as const;

export default QdrantWordmarkDarkLogo;
