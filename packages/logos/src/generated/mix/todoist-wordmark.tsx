/**
 * Auto-generated logo component: Todoist Wordmark (default)
...
export interface TodoistWordmarkLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const TodoistWordmarkLogo = React.forwardRef<SVGSVGElement, TodoistWordmarkLogoProps>(
  ({ size = 24, className = '', ...props }, ref) => (
    <svg
      ...
      {...props}
    >
      <path fill="#E44332" d="M285.5,341.5c0,2.4,0.4,4.8,1.2,7.1c1.6,4.5,5,8.2,9.3,10.2c2.2,1,4.8,1.6,7.6,1.6c2.8,0,5.4-0.5,7.6-1.6
...
<path fill="#E44332" d="M45.4,250.3c-10.4,0-18.9,8.5-18.9,18.9v113.5c0,10.4,8.5,18.9,18.9,18.9H159c10.4,0,18.9-8.5,18.9-18.9V269.3
	c0-10.4-8.5-18.9-18.9-18.9H45.4z" />
<path fill="#FFFFFF" d="M58.6,322l60.8-35.4c1.3-0.8,1.4-3.1-0.1-3.9c-1.5-0.8-4.2-2.4-5.3-3c-1.5-0.8-3.2-0.8-4.7,0.1
...
TodoistWordmarkLogo.displayName = "TodoistWordmarkLogo";

export const TodoistWordmarkLogoMetadata = {
  id: "todoist-wordmark",
  baseId: "todoist-wordmark",
  variant: "default",
  name: "Todoist Wordmark",
  category: "mix",
  tags: [],
  viewBox: "0 0 652 652",
} as const;

export default TodoistWordmarkLogo;
