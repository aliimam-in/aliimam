/**
 * Auto-generated logo component: Lemonsqueezy (default)
...
export interface LemonsqueezyLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const LemonsqueezyLogo = React.forwardRef<SVGSVGElement, LemonsqueezyLogoProps>(
...
LemonsqueezyLogo.displayName = "LemonsqueezyLogo";

export const LemonsqueezyLogoMetadata = {
  id: "lemonsqueezy",
  baseId: "lemonsqueezy",
  variant: "default",
  name: "Lemonsqueezy",
