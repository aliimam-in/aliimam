/**
 * Auto-generated logo component: Convex (default)
...
export interface ConvexLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const ConvexLogo = React.forwardRef<SVGSVGElement, ConvexLogoProps>(
...
ConvexLogo.displayName = "ConvexLogo";

export const ConvexLogoMetadata = {
  id: "convex",
  baseId: "convex",
  variant: "default",
  name: "Convex",
