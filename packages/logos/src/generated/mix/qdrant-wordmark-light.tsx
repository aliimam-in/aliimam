/**
 * Auto-generated logo component: Qdrant Wordmark Light (default)
...
export interface QdrantWordmarkLightLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const QdrantWordmarkLightLogo = React.forwardRef<SVGSVGElement, QdrantWordmarkLightLogoProps>(
...
QdrantWordmarkLightLogo.displayName = "QdrantWordmarkLightLogo";

export const QdrantWordmarkLightLogoMetadata = {
  id: "qdrant-wordmark-light",
  baseId: "qdrant-wordmark-light",
  variant: "default",
  name: "Qdrant Wordmark Light",
  category: "mix",
  tags: [],
  viewBox: "0 0 241 64",
} as const;

export default QdrantWordmarkLightLogo;
