/**
 * Auto-generated logo component: Resend Icon Black (default)
...
export interface ResendIconBlackLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const ResendIconBlackLogo = React.forwardRef<SVGSVGElement, ResendIconBlackLogoProps>(
...
ResendIconBlackLogo.displayName = "ResendIconBlackLogo";

export const ResendIconBlackLogoMetadata = {
  id: "resend-icon-black",
  baseId: "resend-icon-black",
  variant: "default",
  name: "Resend Icon Black",
  category: "mix",
  tags: [],
  viewBox: "0 0 600 600",
} as const;

export default ResendIconBlackLogo;
