/**
 * Auto-generated logo component: Astro Wordmark Light (default)
...
export interface AstroWordmarkLightLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const AstroWordmarkLightLogo = React.forwardRef<SVGSVGElement, AstroWordmarkLightLogoProps>(
