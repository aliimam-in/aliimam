...
export interface TrpcLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const TrpcLogo = React.forwardRef<SVGSVGElement, TrpcLogoProps>(
