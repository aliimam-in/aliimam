...
export interface BashLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const BashLogo = React.forwardRef<SVGSVGElement, BashLogoProps>(
...
BashLogo.displayName = "BashLogo";

export const BashLogoMetadata = {
  id: "bash",
  baseId: "bash",
  variant: "default",
  name: "Bash",
