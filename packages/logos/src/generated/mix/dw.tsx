/**
 * Auto-generated logo component: Dw (default)
...
export interface DwLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const DwLogo = React.forwardRef<SVGSVGElement, DwLogoProps>(
