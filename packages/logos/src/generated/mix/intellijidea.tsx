/**
 * Auto-generated logo component: Intellijidea (default)
...
export interface IntellijideaLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const IntellijideaLogo = React.forwardRef<SVGSVGElement, IntellijideaLogoProps>(
...
IntellijideaLogo.displayName = "IntellijideaLogo";

export const IntellijideaLogoMetadata = {
  id: "intellijidea",
  baseId: "intellijidea",
  variant: "default",
  name: "Intellijidea",
...
export default IntellijideaLogo;
