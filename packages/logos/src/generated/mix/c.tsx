...
export interface CLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const CLogo = React.forwardRef<SVGSVGElement, CLogoProps>(
