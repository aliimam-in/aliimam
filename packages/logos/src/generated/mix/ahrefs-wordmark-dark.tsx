/**
 * Auto-generated logo component: Ahrefs Wordmark Dark (default)
...
export interface AhrefsWordmarkDarkLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const AhrefsWordmarkDarkLogo = React.forwardRef<SVGSVGElement, AhrefsWordmarkDarkLogoProps>(
...
AhrefsWordmarkDarkLogo.displayName = "AhrefsWordmarkDarkLogo";

export const AhrefsWordmarkDarkLogoMetadata = {
  id: "ahrefs-wordmark-dark",
  baseId: "ahrefs-wordmark-dark",
  variant: "default",
  name: "Ahrefs Wordmark Dark",
  category: "mix",
  tags: [],
  viewBox: "0 0 806 206",
} as const;

export default AhrefsWordmarkDarkLogo;
