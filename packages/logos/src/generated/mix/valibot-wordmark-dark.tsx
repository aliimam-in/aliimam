/**
 * Auto-generated logo component: Valibot Wordmark Dark (default)
...
export interface ValibotWordmarkDarkLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const ValibotWordmarkDarkLogo = React.forwardRef<SVGSVGElement, ValibotWordmarkDarkLogoProps>(
