/**
 * Auto-generated logo component: Valibot Wordmark Light (default)
...
export interface ValibotWordmarkLightLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const ValibotWordmarkLightLogo = React.forwardRef<SVGSVGElement, ValibotWordmarkLightLogoProps>(
