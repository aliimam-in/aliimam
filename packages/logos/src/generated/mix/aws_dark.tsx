/**
 * Auto-generated logo component: Aws (dark)
...
export interface AwsDarkProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const AwsDark = React.forwardRef<SVGSVGElement, AwsDarkProps>(
...
AwsDark.displayName = "AwsDark";

export const AwsDarkMetadata = {
  id: "aws_dark",
  baseId: "aws",
  variant: "dark",
  name: "Aws",
