/**
 * Auto-generated logo component: JetbrainsSolid (default)
...
export interface JetbrainsSolidLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const JetbrainsSolidLogo = React.forwardRef<SVGSVGElement, JetbrainsSolidLogoProps>(
...
JetbrainsSolidLogo.displayName = "JetbrainsSolidLogo";

export const JetbrainsSolidLogoMetadata = {
  id: "jetbrainsSolid",
  baseId: "jetbrainsSolid",
  variant: "default",
  name: "JetbrainsSolid",
  category: "mix",
  tags: [],
...
export default JetbrainsSolidLogo;
