/**
 * Auto-generated logo component: Airbnb (default)
...
export interface AirbnbLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const AirbnbLogo = React.forwardRef<SVGSVGElement, AirbnbLogoProps>(
...
AirbnbLogo.displayName = "AirbnbLogo";

export const AirbnbLogoMetadata = {
  id: "airbnb",
  baseId: "airbnb",
  variant: "default",
  name: "Airbnb",
