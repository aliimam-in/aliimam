...
export interface FastifyLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const FastifyLogo = React.forwardRef<SVGSVGElement, FastifyLogoProps>(
...
FastifyLogo.displayName = "FastifyLogo";

export const FastifyLogoMetadata = {
  id: "fastify",
  baseId: "fastify",
  variant: "default",
  name: "Fastify",
