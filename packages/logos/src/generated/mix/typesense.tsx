/**
 * Auto-generated logo component: Typesense (default)
...
export interface TypesenseLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const TypesenseLogo = React.forwardRef<SVGSVGElement, TypesenseLogoProps>(
