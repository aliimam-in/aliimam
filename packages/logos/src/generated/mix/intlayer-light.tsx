/**
 * Auto-generated logo component: Intlayer Light (default)
...
export interface IntlayerLightLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const IntlayerLightLogo = React.forwardRef<SVGSVGElement, IntlayerLightLogoProps>(
...
export default IntlayerLightLogo;
