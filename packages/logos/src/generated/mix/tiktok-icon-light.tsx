/**
 * Auto-generated logo component: Tiktok Icon Light (default)
...
export interface TiktokIconLightLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const TiktokIconLightLogo = React.forwardRef<SVGSVGElement, TiktokIconLightLogoProps>(
