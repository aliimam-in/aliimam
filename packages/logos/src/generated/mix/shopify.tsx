...
export interface ShopifyLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const ShopifyLogo = React.forwardRef<SVGSVGElement, ShopifyLogoProps>(
...
export const ShopifyLogoMetadata = {
  id: "shopify",
  baseId: "shopify",
  variant: "default",
  name: "Shopify",
