/**
 * Auto-generated logo component: Xstate (default)
...
export interface XstateLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const XstateLogo = React.forwardRef<SVGSVGElement, XstateLogoProps>(
