/**
 * Auto-generated logo component: Typegpu Wordmark Dark (default)
...
export interface TypegpuWordmarkDarkLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const TypegpuWordmarkDarkLogo = React.forwardRef<SVGSVGElement, TypegpuWordmarkDarkLogoProps>(
