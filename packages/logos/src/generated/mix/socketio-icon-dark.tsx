/**
 * Auto-generated logo component: Socketio Icon Dark (default)
...
export interface SocketioIconDarkLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const SocketioIconDarkLogo = React.forwardRef<SVGSVGElement, SocketioIconDarkLogoProps>(
...
SocketioIconDarkLogo.displayName = "SocketioIconDarkLogo";

export const SocketioIconDarkLogoMetadata = {
  id: "socketio-icon-dark",
  baseId: "socketio-icon-dark",
  variant: "default",
  name: "Socketio Icon Dark",
  category: "mix",
  tags: [],
  viewBox: "0 0 64 64",
} as const;

export default SocketioIconDarkLogo;
