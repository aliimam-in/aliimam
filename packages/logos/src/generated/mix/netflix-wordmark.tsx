/**
 * Auto-generated logo component: Netflix Wordmark (default)
...
export interface NetflixWordmarkLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const NetflixWordmarkLogo = React.forwardRef<SVGSVGElement, NetflixWordmarkLogoProps>(
...
NetflixWordmarkLogo.displayName = "NetflixWordmarkLogo";

export const NetflixWordmarkLogoMetadata = {
  id: "netflix-wordmark",
  baseId: "netflix-wordmark",
  variant: "default",
...
export default NetflixWordmarkLogo;
