/**
 * Auto-generated logo component: Roblox (light)
...
export interface RobloxLightProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const RobloxLight = React.forwardRef<SVGSVGElement, RobloxLightProps>(
