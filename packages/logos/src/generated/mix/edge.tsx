...
export interface EdgeLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const EdgeLogo = React.forwardRef<SVGSVGElement, EdgeLogoProps>(
...
EdgeLogo.displayName = "EdgeLogo";

export const EdgeLogoMetadata = {
  id: "edge",
  baseId: "edge",
  variant: "default",
  name: "Edge",
