/**
 * Auto-generated logo component: Uxanarangel Dark (default)
...
export interface UxanarangelDarkLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const UxanarangelDarkLogo = React.forwardRef<SVGSVGElement, UxanarangelDarkLogoProps>(
