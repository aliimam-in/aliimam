/**
 * Auto-generated logo component: Youtube Wordmark Light (default)
...
export interface YoutubeWordmarkLightLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const YoutubeWordmarkLightLogo = React.forwardRef<SVGSVGElement, YoutubeWordmarkLightLogoProps>(
