/**
 * Auto-generated logo component: Php (dark)
...
export interface PhpDarkProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const PhpDark = React.forwardRef<SVGSVGElement, PhpDarkProps>(
...
PhpDark.displayName = "PhpDark";

export const PhpDarkMetadata = {
  id: "php_dark",
  baseId: "php",
  variant: "dark",
  name: "Php",
