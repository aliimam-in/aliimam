/**
 * Auto-generated logo component: Perspective Light (default)
...
export interface PerspectiveLightLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const PerspectiveLightLogo = React.forwardRef<SVGSVGElement, PerspectiveLightLogoProps>(
