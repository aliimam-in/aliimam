...
export interface TwitterLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const TwitterLogo = React.forwardRef<SVGSVGElement, TwitterLogoProps>(
...
export const TwitterLogoMetadata = {
  id: "twitter",
  baseId: "twitter",
  variant: "default",
  name: "Twitter",
