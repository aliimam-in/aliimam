/**
 * Auto-generated logo component: Hulu Dark (default)
...
export interface HuluDarkLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const HuluDarkLogo = React.forwardRef<SVGSVGElement, HuluDarkLogoProps>(
