/**
 * Auto-generated logo component: Tiktok Icon Dark (default)
...
export interface TiktokIconDarkLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const TiktokIconDarkLogo = React.forwardRef<SVGSVGElement, TiktokIconDarkLogoProps>(
...
TiktokIconDarkLogo.displayName = "TiktokIconDarkLogo";

export const TiktokIconDarkLogoMetadata = {
  id: "tiktok-icon-dark",
  baseId: "tiktok-icon-dark",
  variant: "default",
  name: "Tiktok Icon Dark",
  category: "mix",
  tags: [],
  viewBox: "0 0 352.28 398.67",
} as const;

export default TiktokIconDarkLogo;
