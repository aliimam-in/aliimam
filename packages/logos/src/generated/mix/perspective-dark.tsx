/**
 * Auto-generated logo component: Perspective Dark (default)
...
export interface PerspectiveDarkLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const PerspectiveDarkLogo = React.forwardRef<SVGSVGElement, PerspectiveDarkLogoProps>(
