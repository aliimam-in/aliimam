/**
 * Auto-generated logo component: Apple Music Wordmark Dark (default)
...
export interface AppleMusicWordmarkDarkLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const AppleMusicWordmarkDarkLogo = React.forwardRef<SVGSVGElement, AppleMusicWordmarkDarkLogoProps>(
...
AppleMusicWordmarkDarkLogo.displayName = "AppleMusicWordmarkDarkLogo";

export const AppleMusicWordmarkDarkLogoMetadata = {
  id: "apple-music-wordmark-dark",
  baseId: "apple-music-wordmark-dark",
  variant: "default",
  name: "Apple Music Wordmark Dark",
  category: "mix",
  tags: [],
  viewBox: "0 0 84.3 20.7",
} as const;

export default AppleMusicWordmarkDarkLogo;
