/**
 * Auto-generated logo component: Turbopack Wordmark Light (default)
...
export interface TurbopackWordmarkLightLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const TurbopackWordmarkLightLogo = React.forwardRef<SVGSVGElement, TurbopackWordmarkLightLogoProps>(
