/**
 * Auto-generated logo component: Chartjs (default)
...
export interface ChartjsLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const ChartjsLogo = React.forwardRef<SVGSVGElement, ChartjsLogoProps>(
...
ChartjsLogo.displayName = "ChartjsLogo";

export const ChartjsLogoMetadata = {
  id: "chartjs",
  baseId: "chartjs",
  variant: "default",
  name: "Chartjs",
