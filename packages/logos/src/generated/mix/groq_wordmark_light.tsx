/**
 * Auto-generated logo component: Groq (wordmark_light)
...
export interface GroqWordmarkLightProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const GroqWordmarkLight = React.forwardRef<SVGSVGElement, GroqWordmarkLightProps>(
...
export default GroqWordmarkLight;
