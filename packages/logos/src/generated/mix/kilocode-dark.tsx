/**
 * Auto-generated logo component: Kilocode Dark (default)
...
export interface KilocodeDarkLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const KilocodeDarkLogo = React.forwardRef<SVGSVGElement, KilocodeDarkLogoProps>(
...
KilocodeDarkLogo.displayName = "KilocodeDarkLogo";

export const KilocodeDarkLogoMetadata = {
  id: "kilocode-dark",
  baseId: "kilocode-dark",
  variant: "default",
  name: "Kilocode Dark",
  category: "mix",
  tags: [],
...
export default KilocodeDarkLogo;
