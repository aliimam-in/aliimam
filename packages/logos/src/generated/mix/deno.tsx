...
export interface DenoLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const DenoLogo = React.forwardRef<SVGSVGElement, DenoLogoProps>(
