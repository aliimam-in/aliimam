...
export interface PeerlistLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const PeerlistLogo = React.forwardRef<SVGSVGElement, PeerlistLogoProps>(
...
PeerlistLogo.displayName = "PeerlistLogo";

export const PeerlistLogoMetadata = {
  id: "peerlist",
  baseId: "peerlist",
  variant: "default",
  name: "Peerlist",
