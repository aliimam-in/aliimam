/**
 * Auto-generated logo component: Ahooks Wordmark Light (default)
...
export interface AhooksWordmarkLightLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const AhooksWordmarkLightLogo = React.forwardRef<SVGSVGElement, AhooksWordmarkLightLogoProps>(
