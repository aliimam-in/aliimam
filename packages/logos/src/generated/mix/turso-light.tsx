/**
 * Auto-generated logo component: Turso Light (default)
...
export interface TursoLightLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const TursoLightLogo = React.forwardRef<SVGSVGElement, TursoLightLogoProps>(
...
TursoLightLogo.displayName = "TursoLightLogo";

export const TursoLightLogoMetadata = {
  id: "turso-light",
  baseId: "turso-light",
  variant: "default",
  name: "Turso Light",
