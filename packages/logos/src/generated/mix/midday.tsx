...
export interface MiddayLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
}

export const MiddayLogo = React.forwardRef<SVGSVGElement, MiddayLogoProps>(
