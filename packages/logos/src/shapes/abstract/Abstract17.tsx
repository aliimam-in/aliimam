...
export const Abstract17: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function Abstract17(
  {
...
Abstract17.metadata = {
  ...
  tags: ["abstract", "17", "icon"],
  description: "Abstract17 icon from shapes/abstract category",
  type: ["stroke", "icon"],
} as IconMetadata;

export default Abstract17;
