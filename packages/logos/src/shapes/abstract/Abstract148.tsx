...
export const Abstract148: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function Abstract148(
  {
    color = "currentColor",
    fill,
    size = 24,
...
Abstract148.metadata = {
  name: "Abstract148",
  category: "shapes/abstract",
  tags: ["abstract", "148", "icon"],
  description: "Abstract148 icon from shapes/abstract category",
  type: ["stroke", "icon"],
} as IconMetadata;

export default Abstract148;
