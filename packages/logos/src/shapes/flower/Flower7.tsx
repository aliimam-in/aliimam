...
export const Flower7: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function Flower7(
  {
  ...
  return (
    <svg
      ...
      ref={forwardedRef}
    >
      <g clipPath="url(#undefined-clip0_2068_579)">
        <path
      ...
      <defs>
        <clipPath id="undefined-clip0_2068_579">
...
Flower7.metadata = {
  ...
  tags: ["flower", "icon"],
  description: "Flower7 icon from shapes/flower category",
  type: ["stroke", "icon"],
} as IconMetadata;
