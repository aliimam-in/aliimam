...
export const Flower16: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function Flower16(
  {
...
Flower16.metadata = {
  ...
  tags: ["flower", "16", "icon"],
  description: "Flower16 icon from shapes/flower category",
  type: ["stroke", "icon"],
} as IconMetadata;

export default Flower16;
