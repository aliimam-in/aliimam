...
export const Ellipse9: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function Ellipse9(
  {
...
Ellipse9.metadata = {
  ...
  tags: ["ellipse", "icon"],
  description: "Ellipse9 icon from shapes/ellipse category",
  type: ["stroke", "icon"],
} as IconMetadata;
