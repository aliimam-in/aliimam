...
export const Ellipse3: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function Ellipse3(
  {
...
Ellipse3.metadata = {
  ...
  tags: ["ellipse", "icon"],
  description: "Ellipse3 icon from shapes/ellipse category",
  type: ["stroke", "icon"],
} as IconMetadata;
