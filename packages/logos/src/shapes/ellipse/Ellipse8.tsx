...
export const Ellipse8: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function Ellipse8(
  {
...
Ellipse8.metadata = {
  ...
  tags: ["ellipse", "icon"],
  description: "Ellipse8 icon from shapes/ellipse category",
  type: ["stroke", "icon"],
} as IconMetadata;
