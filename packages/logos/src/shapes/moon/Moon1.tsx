...
export const Moon1: IconComponent = React.forwardRef<SVGSVGElement, IconProps>(
  function Moon1(
    {
      color = "currentColor",
      fill,
...
Moon1.metadata = {
  ...
  tags: ["moon", "icon"],
  description: "Moon1 icon from shapes/moon category",
  type: ["stroke", "icon"],
} as IconMetadata;
