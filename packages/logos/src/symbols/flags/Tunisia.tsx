...
export const Tunisia: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function Tunisia(
  {
...
Tunisia.metadata = {
  ...
  tags: ["tunisia", "icon"],
  description: "Tunisia icon from symbols/flags category",
  type: ["stroke", "icon"],
} as IconMetadata;
