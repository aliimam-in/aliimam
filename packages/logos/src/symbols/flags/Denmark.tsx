...
export const Denmark: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function Denmark(
  {
  ...
  return (
    ...
    >
      <path
        ...
        fill="#b92932"
      />
      <path d="M31 14H15V4H11V14H1V18H11V28H15V18H31V14Z" fill="#fff" />
    </svg>
  );
});
...
Denmark.metadata = {
  ...
  tags: ["denmark", "icon"],
  description: "Denmark icon from symbols/flags category",
  type: ["stroke", "icon"],
} as IconMetadata;
