...
export const Georgia: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function Georgia(
  {
...
Georgia.metadata = {
  ...
  tags: ["georgia", "icon"],
  description: "Georgia icon from symbols/flags category",
  type: ["stroke", "icon"],
} as IconMetadata;
