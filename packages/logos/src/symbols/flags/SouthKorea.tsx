...
export const SouthKorea: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function SouthKorea(
  {
...
SouthKorea.metadata = {
  ...
  tags: ["south", "korea", "icon"],
  description: "SouthKorea icon from symbols/flags category",
  type: ["stroke", "icon"],
} as IconMetadata;
