...
export const Barbados: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function Barbados(
  {
...
Barbados.metadata = {
  ...
  tags: ["barbados", "icon"],
  description: "Barbados icon from symbols/flags category",
  type: ["stroke", "icon"],
} as IconMetadata;
