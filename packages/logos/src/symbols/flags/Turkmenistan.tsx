...
export const Turkmenistan: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
...
Turkmenistan.metadata = {
  ...
  tags: ["turkmenistan", "icon"],
  description: "Turkmenistan icon from symbols/flags category",
  type: ["stroke", "icon"],
} as IconMetadata;
