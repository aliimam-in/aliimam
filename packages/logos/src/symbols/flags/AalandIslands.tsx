...
export const AalandIslands: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function AalandIslands(
  {
    color = "currentColor",
    fill,
    size = 24,
...
AalandIslands.metadata = {
  name: "AalandIslands",
  category: "symbols/flags",
  tags: ["aaland", "islands", "icon"],
  description: "AalandIslands icon from symbols/flags category",
  type: ["stroke", "icon"],
} as IconMetadata;
