...
export const Mongolia: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function Mongolia(
  {
...
Mongolia.metadata = {
  ...
  tags: ["mongolia", "icon"],
  description: "Mongolia icon from symbols/flags category",
  type: ["stroke", "icon"],
} as IconMetadata;
