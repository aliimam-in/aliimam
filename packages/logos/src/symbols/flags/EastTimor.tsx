...
>(function EastTimor(
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M7.56904 15.973L8.88304 13.74L6.50804 14.774L4.79104 12.835L5.04004 15.413L2.66504 16.447L5.19404 17.007L5.44404 19.585L6.75704 17.352L9.28704 17.912L7.56904 15.973Z"
        fill="#fff"
      />
    </svg>
  );
...
EastTimor.metadata = {
  ...
  description: "EastTimor icon from symbols/flags category",
  type: ["stroke", "icon"],
} as IconMetadata;
