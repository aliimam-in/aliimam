...
export const FaroeIslands: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
...
FaroeIslands.metadata = {
  name: "FaroeIslands",
  category: "symbols/flags",
  tags: ["faroe", "islands", "icon"],
  description: "FaroeIslands icon from symbols/flags category",
  type: ["stroke", "icon"],
} as IconMetadata;
