...
export const Storyblok: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function Storyblok(
  {
...
Storyblok.metadata = {
  ...
  category: "icon/cms",
  tags: ["storyblok", "icon"],
  description: "Storyblok icon from icon/cms category",
  type: ["stroke", "icon"],
} as IconMetadata;
