...
export const Penpot: IconComponent = React.forwardRef<SVGSVGElement, IconProps>(
  function Penpot(
    {
      color = "currentColor",
      fill,
...
Penpot.metadata = {
  ...
  tags: ["penpot", "icon"],
  description: "Penpot icon from icon/design category",
  type: ["stroke", "icon"],
} as IconMetadata;
