...
export const Litecoin: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function Litecoin(
  {
...
Litecoin.metadata = {
  ...
  tags: ["litecoin", "icon"],
  description: "Litecoin icon from icon/crypto category",
  type: ["stroke", "icon"],
} as IconMetadata;
