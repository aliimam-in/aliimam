...
export const Pinterest: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function Pinterest(
  {
...
Pinterest.metadata = {
  ...
  tags: ["pinterest", "icon"],
  description: "Pinterest icon from icon/social category",
  type: ["stroke", "icon"],
} as IconMetadata;
