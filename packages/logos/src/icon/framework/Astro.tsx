...
export const Astro: IconComponent = React.forwardRef<SVGSVGElement, IconProps>(
  function Astro(
    {
      color = "currentColor",
      fill,
...
Astro.metadata = {
  ...
  tags: ["astro", "icon"],
  description: "Astro icon from icon/framework category",
  type: ["stroke", "icon"],
} as IconMetadata;
