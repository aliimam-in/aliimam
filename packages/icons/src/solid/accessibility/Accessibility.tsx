    ...
    if (type === "stroke") {
      return (
        ...
        >
          ...
          />
          <path
            d="M13.76 17.5C14.0422 16.5769 14.0511 15.5919 13.7858 14.6639C13.5205 13.7359 12.9922 12.9045 12.2647 12.2701C11.5373 11.6356 10.6417 11.2254 9.68624 11.0887C8.73074 10.9521 7.75611 11.0949 6.88 11.5"
            stroke={color}
            strokeLinecap="round"
            strokeLinejoin="round"
          />
