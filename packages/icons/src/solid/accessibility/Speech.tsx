...
interface SpeechProps extends IconProps {
  type?: "solid" | "stroke";
}

export const Speech: IconComponent<SpeechProps> = React.forwardRef<
  SVGSVGElement,
  SpeechProps
>(function Speech(
  {
