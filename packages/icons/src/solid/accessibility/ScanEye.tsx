...
interface ScanEyeProps extends IconProps {
  type?: "solid" | "stroke";
}

export const ScanEye: IconComponent<ScanEyeProps> = React.forwardRef<
  SVGSVGElement,
  ScanEyeProps
>(function ScanEye(
  {
  ...
  if (type === "stroke") {
    return (
      ...
      >
        <path
          d="M3 7V5C3 4.47 3.211 3.961 3.586 3.586 3.961 3.211 4.47 3 5 3H7M17 3H19C19.53 3 20.039 3.211 20.414 3.586 20.789 3.961 21 4.47 21 5V7M21 17V19C21 19.53 20.789 20.039 20.414 20.414 20.039 20.789 19.53 21 19 21H17M7 21H5C4.47 21 3.961 20.789 3.586 20.414 3.211 20.039 3 19.53 3 19V17M12 13C12.552 13 13 12.552 13 12 13 11.448 12.552 11 12 11 11.448 11 11 11.448 11 12 11 12.552 11.448 13 12 13Z"
          stroke={color}
          strokeLinecap="round"
          strokeLinejoin="round"
        />
        <path
          d="M18.944 12.33C19.0187 12.1163 19.0187 11.8837 18.944 11.67C18.381 10.2904 17.4198 9.10982 16.183 8.27876C14.9463 7.44771 13.49 7.00388 12 7.00388C10.51 7.00388 9.05369 7.44771 7.81693 8.27876C6.58018 9.10982 5.619 10.2904 5.05599 11.67C4.9813 11.8837 4.9813 12.1163 5.05599 12.33C5.619 13.7096 6.58018 14.8902 7.81693 15.7212C9.05369 16.5523 10.51 16.9961 12 16.9961C13.49 16.9961 14.9463 16.5523 16.183 15.7212C17.4198 14.8902 18.381 13.7096 18.944 12.33Z"
          stroke={color}
          strokeLinecap="round"
          strokeLinejoin="round"
        />
...
ScanEye.metadata = {
  ...
  tags: ["scan", "eye", "icon"],
  description: "ScanEye icon from solid/accessibility category",
  type: ["stroke", "icon"],
} as IconMetadata;
