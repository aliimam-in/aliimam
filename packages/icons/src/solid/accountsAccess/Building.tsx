  ...
  if (type === "solid") {
    return (
      ...
      >
        ...
        />
        <path
          d="M9 23.5V19C9 18.7348 9.10536 18.4804 9.29289 18.2929C9.48043 18.1054 9.73478 18 10 18H14C14.2652 18 14.5196 18.1054 14.7071 18.2929C14.8946 18.4804 15 18.7348 15 19V23.5"
          fill="#fff"
        />
      </svg>
    );
