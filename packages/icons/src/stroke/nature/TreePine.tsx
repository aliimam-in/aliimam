...
export const TreePine: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function TreePine(
  {
...
TreePine.metadata = {
  ...
  tags: ["tree", "pine", "icon"],
  description: "TreePine icon from stroke/nature category",
  type: ["stroke", "icon"],
} as IconMetadata;
