...
Flower2.metadata = {
  ...
  tags: ["flower", "icon"],
  description: "Flower2 icon from stroke/nature category",
  type: ["stroke", "icon"],
} as IconMetadata;
