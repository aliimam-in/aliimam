...
interface AlarmSmokeProps extends IconProps {
  type?: "stroke";
}

export const AlarmSmoke: IconComponent<AlarmSmokeProps> = React.forwardRef<
  SVGSVGElement,
  AlarmSmokeProps
>(function AlarmSmoke(
  {
  ...
  console.error(`AlarmSmoke doesn't support ${type}`);
  return null;
});
...
AlarmSmoke.metadata = {
  ...
  tags: ["alarm", "smoke", "icon"],
  description: "AlarmSmoke icon from stroke/home category",
  type: ["stroke", "icon"],
} as IconMetadata;
