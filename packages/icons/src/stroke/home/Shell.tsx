...
interface ShellProps extends IconProps {
  type?: "stroke";
}

export const Shell: IconComponent<ShellProps> = React.forwardRef<
  SVGSVGElement,
  ShellProps
>(function Shell(
  {
  ...
  console.error(`Shell doesn't support ${type}`);
  return null;
});
...
Shell.metadata = {
  ...
  tags: ["shell", "icon"],
  description: "Shell icon from stroke/home category",
  type: ["stroke", "icon"],
} as IconMetadata;
