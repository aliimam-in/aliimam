...
interface BlocksProps extends IconProps {
  type?: "stroke";
}

export const Blocks: IconComponent<BlocksProps> = React.forwardRef<
  SVGSVGElement,
  BlocksProps
>(function Blocks(
  {
...
Blocks.metadata = {
  ...
  tags: ["blocks", "icon"],
  description: "Blocks icon from stroke/layout category",
  type: ["stroke", "icon"],
} as IconMetadata;
