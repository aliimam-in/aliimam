...
interface ArrowUpAZProps extends IconProps {
  type?: "stroke";
}

export const ArrowUpAZ: IconComponent<ArrowUpAZProps> = React.forwardRef<
  SVGSVGElement,
  ArrowUpAZProps
>(function ArrowUpAZ(
  {
  ...
  console.error(`ArrowUpAZ doesn't support ${type}`);
  return null;
});
...
ArrowUpAZ.metadata = {
  ...
  tags: ["arrow", "up", "icon"],
  description: "ArrowUpAZ icon from stroke/layout category",
  type: ["stroke", "icon"],
} as IconMetadata;
