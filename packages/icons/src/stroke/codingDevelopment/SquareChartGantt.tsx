...
interface SquareChartGanttProps extends IconProps {
  type?: "stroke";
}

export const SquareChartGantt: IconComponent<SquareChartGanttProps> =
  React.forwardRef<SVGSVGElement, SquareChartGanttProps>(
    function SquareChartGantt(
      ...
      console.error(`SquareChartGantt doesn't support ${type}`);
      return null;
    },
  );
...
SquareChartGantt.metadata = {
  ...
  description: "SquareChartGantt icon from stroke/codingDevelopment category",
  type: ["stroke", "icon"],
} as IconMetadata;
