...
interface ShieldPlusProps extends IconProps {
  type?: "stroke";
}

export const ShieldPlus: IconComponent<ShieldPlusProps> = React.forwardRef<
  SVGSVGElement,
  ShieldPlusProps
>(function ShieldPlus(
  {
  ...
  console.error(`ShieldPlus doesn't support ${type}`);
  return null;
});
...
ShieldPlus.metadata = {
  ...
  tags: ["shield", "plus", "icon"],
  description: "ShieldPlus icon from stroke/codingDevelopment category",
  type: ["stroke", "icon"],
} as IconMetadata;
