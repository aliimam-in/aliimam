...
export const BookOpenText: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
...
BookOpenText.metadata = {
  name: "BookOpenText",
  category: "stroke/codingDevelopment",
  tags: ["book", "open", "text", "icon"],
  description: "BookOpenText icon from stroke/codingDevelopment category",
  type: ["stroke", "icon"],
} as IconMetadata;
