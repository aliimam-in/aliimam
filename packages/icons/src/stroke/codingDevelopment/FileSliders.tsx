...
export const FileSliders: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function FileSliders(
  {
    color = "currentColor",
    fill,
    size = 24,
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M14 2V6C14 6.53 14.211 7.039 14.586 7.414 14.961 7.789 15.47 8 16 8H20M8 12H16M10 11V13M8 17H16M14 16V18"
        stroke={color}
        strokeLinecap="round"
        strokeLinejoin="round"
      />
...
FileSliders.metadata = {
  name: "FileSliders",
  category: "stroke/codingDevelopment",
  tags: ["file", "sliders", "icon"],
  description: "FileSliders icon from stroke/codingDevelopment category",
  type: ["stroke", "icon"],
} as IconMetadata;
