...
export const FileCode: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function FileCode(
  {
  ...
  return (
    ...
    >
      <path
        d="M10 12.5 8 15 10 17.5M14 12.5 16 15 14 17.5M14 2V6C14 6.53 14.211 7.039 14.586 7.414 14.961 7.789 15.47 8 16 8H20"
        stroke={color}
        strokeLinecap="round"
...
FileCode.metadata = {
  ...
  tags: ["file", "code", "icon"],
  description: "FileCode icon from stroke/codingDevelopment category",
  type: ["stroke", "icon"],
} as IconMetadata;
