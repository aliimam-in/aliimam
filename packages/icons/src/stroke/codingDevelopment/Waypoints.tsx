...
interface WaypointsProps extends IconProps {
  type?: "stroke";
}

export const Waypoints: IconComponent<WaypointsProps> = React.forwardRef<
  SVGSVGElement,
  WaypointsProps
>(function Waypoints(
  {
  ...
  console.error(`Waypoints doesn't support ${type}`);
  return null;
});
...
Waypoints.metadata = {
  ...
  tags: ["waypoints", "icon"],
  description: "Waypoints icon from stroke/codingDevelopment category",
  type: ["stroke", "icon"],
} as IconMetadata;
