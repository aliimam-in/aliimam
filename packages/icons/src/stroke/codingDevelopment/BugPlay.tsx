...
interface BugPlayProps extends IconProps {
  type?: "stroke";
}

export const BugPlay: IconComponent<BugPlayProps> = React.forwardRef<
  SVGSVGElement,
  BugPlayProps
>(function BugPlay(
  {
  ...
  console.error(`BugPlay doesn't support ${type}`);
  return null;
});
...
BugPlay.metadata = {
  ...
  tags: ["bug", "play", "icon"],
  description: "BugPlay icon from stroke/codingDevelopment category",
  type: ["stroke", "icon"],
} as IconMetadata;
