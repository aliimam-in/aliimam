...
export const FileTerminal: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function FileTerminal(
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M14 2V6C14 6.53 14.211 7.039 14.586 7.414 14.961 7.789 15.47 8 16 8H20M8 16 10 14 8 12M12 18H16"
        stroke={color}
        strokeLinecap="round"
        strokeLinejoin="round"
      />
...
FileTerminal.metadata = {
  name: "FileTerminal",
  category: "stroke/codingDevelopment",
  tags: ["file", "terminal", "icon"],
  description: "FileTerminal icon from stroke/codingDevelopment category",
  type: ["stroke", "icon"],
} as IconMetadata;
