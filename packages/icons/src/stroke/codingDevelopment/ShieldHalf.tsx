...
interface ShieldHalfProps extends IconProps {
  type?: "stroke";
}

export const ShieldHalf: IconComponent<ShieldHalfProps> = React.forwardRef<
  SVGSVGElement,
  ShieldHalfProps
>(function ShieldHalf(
  {
  ...
  console.error(`ShieldHalf doesn't support ${type}`);
  return null;
});
...
ShieldHalf.metadata = {
  ...
  tags: ["shield", "half", "icon"],
  description: "ShieldHalf icon from stroke/codingDevelopment category",
  type: ["stroke", "icon"],
} as IconMetadata;
