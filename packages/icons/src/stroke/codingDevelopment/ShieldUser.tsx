...
interface ShieldUserProps extends IconProps {
  type?: "stroke";
}

export const ShieldUser: IconComponent<ShieldUserProps> = React.forwardRef<
  SVGSVGElement,
  ShieldUserProps
>(function ShieldUser(
  {
...
ShieldUser.metadata = {
  ...
  description: "ShieldUser icon from stroke/codingDevelopment category",
  type: ["stroke", "icon"],
} as IconMetadata;
