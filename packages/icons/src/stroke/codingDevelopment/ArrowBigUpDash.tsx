...
ArrowBigUpDash.metadata = {
  ...
  description: "ArrowBigUpDash icon from stroke/codingDevelopment category",
  type: ["stroke", "icon"],
} as IconMetadata;
