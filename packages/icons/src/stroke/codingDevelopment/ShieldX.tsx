...
interface ShieldXProps extends IconProps {
  type?: "stroke";
}

export const ShieldX: IconComponent<ShieldXProps> = React.forwardRef<
  SVGSVGElement,
  ShieldXProps
>(function ShieldX(
  {
  ...
  console.error(`ShieldX doesn't support ${type}`);
  return null;
});
...
ShieldX.metadata = {
  ...
  tags: ["shield", "icon"],
  description: "ShieldX icon from stroke/codingDevelopment category",
  type: ["stroke", "icon"],
} as IconMetadata;
