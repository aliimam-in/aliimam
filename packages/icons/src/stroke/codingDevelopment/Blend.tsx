...
interface BlendProps extends IconProps {
  type?: "stroke";
}

export const Blend: IconComponent<BlendProps> = React.forwardRef<
  SVGSVGElement,
  BlendProps
>(function Blend(
  {
...
Blend.metadata = {
  ...
  tags: ["blend", "icon"],
  description: "Blend icon from stroke/codingDevelopment category",
  type: ["stroke", "icon"],
} as IconMetadata;
