...
interface ShieldMinusProps extends IconProps {
  type?: "stroke";
}

export const ShieldMinus: IconComponent<ShieldMinusProps> = React.forwardRef<
  SVGSVGElement,
  ShieldMinusProps
>(function ShieldMinus(
  {
    color = "currentColor",
    fill,
    size = 24,
  ...
  console.error(`ShieldMinus doesn't support ${type}`);
  return null;
});

ShieldMinus.displayName = "ShieldMinus";

ShieldMinus.metadata = {
  name: "ShieldMinus",
  category: "stroke/codingDevelopment",
  tags: ["shield", "minus", "icon"],
  description: "ShieldMinus icon from stroke/codingDevelopment category",
  type: ["stroke", "icon"],
} as IconMetadata;
