...
export const ServerOff: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function ServerOff(
  {
...
ServerOff.metadata = {
  ...
  tags: ["server", "off", "icon"],
  description: "ServerOff icon from stroke/codingDevelopment category",
  type: ["stroke", "icon"],
} as IconMetadata;
