...
export const Shield: IconComponent<ShieldProps> = React.forwardRef<
  SVGSVGElement,
  ShieldProps
>(function Shield(
  {
  ...
  console.error(`Shield doesn't support ${type}`);
  return null;
});
...
Shield.metadata = {
  ...
  tags: ["shield", "icon"],
  description: "Shield icon from stroke/codingDevelopment category",
  type: ["stroke", "icon"],
} as IconMetadata;
