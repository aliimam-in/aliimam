...
export const BrainCog: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function BrainCog(
  {
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M19.5049 10.294C20.3641 10.643 21.0753 11.2796 21.517 12.095C21.9586 12.9105 22.1032 13.854 21.926 14.7643C21.7488 15.6745 21.2609 16.495 20.5456 17.0852C19.8304 17.6754 18.9322 17.9988 18.0049 18"
        stroke={color}
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M4.03203 17.483C3.91165 18.4007 4.11325 19.3318 4.60248 20.1175C5.09171 20.9032 5.83829 21.4949 6.71496 21.7918C7.59163 22.0888 8.54414 22.0724 9.41013 21.7457C10.2761 21.4189 11.002 20.802 11.464 20C11.644 19.689 12.356 19.689 12.536 20C12.9981 20.8018 13.7238 21.4187 14.5897 21.7454C15.4556 22.0721 16.4079 22.0885 17.2845 21.7917C18.161 21.495 18.9076 20.9034 19.3969 20.1179C19.8863 19.3325 20.0881 18.4016 19.968 17.484"
        stroke={color}
        strokeLinecap="round"
        strokeLinejoin="round"
      />
...
BrainCog.metadata = {
  ...
  tags: ["brain", "cog", "icon"],
  description: "BrainCog icon from stroke/codingDevelopment category",
  type: ["stroke", "icon"],
} as IconMetadata;
