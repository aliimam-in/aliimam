...
export const FileJson2: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function FileJson2(
  {
...
FileJson2.metadata = {
  ...
  tags: ["file", "json", "icon"],
  description: "FileJson2 icon from stroke/codingDevelopment category",
  type: ["stroke", "icon"],
} as IconMetadata;
