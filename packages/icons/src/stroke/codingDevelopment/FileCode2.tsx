...
export const FileCode2: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function FileCode2(
  {
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M14 2V6C14 6.53 14.211 7.039 14.586 7.414 14.961 7.789 15.47 8 16 8H20M5 12 2 15 5 18M9 18 12 15 9 12"
        stroke={color}
        strokeLinecap="round"
        strokeLinejoin="round"
      />
...
FileCode2.metadata = {
  ...
  tags: ["file", "code", "icon"],
  description: "FileCode2 icon from stroke/codingDevelopment category",
  type: ["stroke", "icon"],
} as IconMetadata;
