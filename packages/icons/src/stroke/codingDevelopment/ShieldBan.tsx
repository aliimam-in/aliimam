...
interface ShieldBanProps extends IconProps {
  type?: "stroke";
}

export const ShieldBan: IconComponent<ShieldBanProps> = React.forwardRef<
  SVGSVGElement,
  ShieldBanProps
>(function ShieldBan(
  {
  ...
  console.error(`ShieldBan doesn't support ${type}`);
  return null;
});
...
ShieldBan.metadata = {
  ...
  tags: ["shield", "ban", "icon"],
  description: "ShieldBan icon from stroke/codingDevelopment category",
  type: ["stroke", "icon"],
} as IconMetadata;
