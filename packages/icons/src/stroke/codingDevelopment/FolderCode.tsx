...
export const FolderCode: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function FolderCode(
  {
  ...
  return (
    ...
    >
      <path
        d="M10 10.5 8 13 10 15.5M14 10.5 16 13 14 15.5"
        stroke={color}
        strokeLinecap="round"
...
FolderCode.metadata = {
  ...
  tags: ["folder", "code", "icon"],
  description: "FolderCode icon from stroke/codingDevelopment category",
  type: ["stroke", "icon"],
} as IconMetadata;
