...
export const BookA: IconComponent = React.forwardRef<SVGSVGElement, IconProps>(
  function BookA(
    {
      color = "currentColor",
      fill,
    ...
    return (
      ...
      >
        ...
        />
        <path
          d="M8 13 12 6 16 13M9.1 11H14.8"
          stroke={color}
          strokeLinecap="round"
          strokeLinejoin="round"
        />
...
BookA.metadata = {
  ...
  tags: ["book", "icon"],
  description: "BookA icon from stroke/gaming category",
  type: ["stroke", "icon"],
} as IconMetadata;
