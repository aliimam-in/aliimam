...
interface BookMarkedProps extends IconProps {
  type?: "stroke";
}

export const BookMarked: IconComponent<BookMarkedProps> = React.forwardRef<
  SVGSVGElement,
  BookMarkedProps
>(function BookMarked(
  {
  ...
  console.error(`BookMarked doesn't support ${type}`);
  return null;
});
...
BookMarked.metadata = {
  ...
  tags: ["book", "marked", "icon"],
  description: "BookMarked icon from stroke/gaming category",
  type: ["stroke", "icon"],
} as IconMetadata;
