...
interface BookProps extends IconProps {
  type?: "stroke";
}

export const Book: IconComponent<BookProps> = React.forwardRef<
  SVGSVGElement,
  BookProps
>(function Book(
  {
  ...
  console.error(`Book doesn't support ${type}`);
  return null;
});
...
Book.metadata = {
  ...
  tags: ["book", "icon"],
  description: "Book icon from stroke/gaming category",
  type: ["stroke", "icon"],
} as IconMetadata;
