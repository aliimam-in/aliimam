...
interface ArrowBigLeftDashProps extends IconProps {
  type?: "stroke";
}

export const ArrowBigLeftDash: IconComponent<ArrowBigLeftDashProps> =
  React.forwardRef<SVGSVGElement, ArrowBigLeftDashProps>(
    function ArrowBigLeftDash(
      {
        color = "currentColor",
        fill,
        size = 24,
...
ArrowBigLeftDash.metadata = {
  name: "ArrowBigLeftDash",
  category: "stroke/gaming",
  tags: ["arrow", "big", "left", "dash", "icon"],
  description: "ArrowBigLeftDash icon from stroke/gaming category",
  type: ["stroke", "icon"],
} as IconMetadata;
