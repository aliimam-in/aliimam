...
interface ScrollTextProps extends IconProps {
  type?: "stroke";
}

export const ScrollText: IconComponent<ScrollTextProps> = React.forwardRef<
  SVGSVGElement,
  ScrollTextProps
>(function ScrollText(
  {
  ...
  if (type === "stroke") {
    return (
      ...
      >
        <path
          d="M15 12H10M15 8H10M19 17V5C19 4.47 18.789 3.961 18.414 3.586 18.039 3.211 17.53 3 17 3H4"
          stroke={color}
          strokeLinecap="round"
  ...
  console.error(`ScrollText doesn't support ${type}`);
  return null;
});
...
ScrollText.metadata = {
  ...
  tags: ["scroll", "text", "icon"],
  description: "ScrollText icon from stroke/gaming category",
  type: ["stroke", "icon"],
} as IconMetadata;
