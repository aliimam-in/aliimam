...
interface ScrollProps extends IconProps {
  type?: "stroke";
}

export const Scroll: IconComponent<ScrollProps> = React.forwardRef<
  SVGSVGElement,
  ScrollProps
>(function Scroll(
  {
  ...
  console.error(`Scroll doesn't support ${type}`);
  return null;
});
...
Scroll.metadata = {
  ...
  tags: ["scroll", "icon"],
  description: "Scroll icon from stroke/gaming category",
  type: ["stroke", "icon"],
} as IconMetadata;
