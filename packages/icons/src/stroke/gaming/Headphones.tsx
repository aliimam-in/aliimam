...
interface HeadphonesProps extends IconProps {
  type?: "stroke";
}

export const Headphones: IconComponent<HeadphonesProps> = React.forwardRef<
  SVGSVGElement,
  HeadphonesProps
>(function Headphones(
  {
  ...
  console.error(`Headphones doesn't support ${type}`);
  return null;
});
...
Headphones.metadata = {
  ...
  tags: ["headphones", "icon"],
  description: "Headphones icon from stroke/gaming category",
  type: ["stroke", "icon"],
} as IconMetadata;
