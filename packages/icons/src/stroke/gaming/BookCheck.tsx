...
interface BookCheckProps extends IconProps {
  type?: "stroke";
}

export const BookCheck: IconComponent<BookCheckProps> = React.forwardRef<
  SVGSVGElement,
  BookCheckProps
>(function BookCheck(
  {
  ...
  console.error(`BookCheck doesn't support ${type}`);
  return null;
});
...
BookCheck.metadata = {
  ...
  tags: ["book", "check", "icon"],
  description: "BookCheck icon from stroke/gaming category",
  type: ["stroke", "icon"],
} as IconMetadata;
