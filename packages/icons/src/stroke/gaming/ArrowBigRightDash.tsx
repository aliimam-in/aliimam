...
interface ArrowBigRightDashProps extends IconProps {
  type?: "stroke";
}

export const ArrowBigRightDash: IconComponent<ArrowBigRightDashProps> =
  React.forwardRef<SVGSVGElement, ArrowBigRightDashProps>(
    function ArrowBigRightDash(
      {
        color = "currentColor",
        fill,
        size = 24,
...
ArrowBigRightDash.metadata = {
  name: "ArrowBigRightDash",
  category: "stroke/gaming",
  tags: ["arrow", "big", "right", "dash", "icon"],
  description: "ArrowBigRightDash icon from stroke/gaming category",
  type: ["stroke", "icon"],
} as IconMetadata;
