...
interface BookTypeProps extends IconProps {
  type?: "stroke";
}

export const BookType: IconComponent<BookTypeProps> = React.forwardRef<
  SVGSVGElement,
  BookTypeProps
>(function BookType(
  {
  ...
  if (type === "stroke") {
    return (
      ...
      >
        <path
          d="M10 13H14M12 6V13M16 8V6H8V8"
          stroke={color}
          strokeLinecap="round"
  ...
  console.error(`BookType doesn't support ${type}`);
  return null;
});
...
BookType.metadata = {
  ...
  tags: ["book", "type", "icon"],
  description: "BookType icon from stroke/gaming category",
  type: ["stroke", "icon"],
} as IconMetadata;
