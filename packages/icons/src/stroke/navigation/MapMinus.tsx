...
export const MapMinus: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function MapMinus(
  {
...
MapMinus.metadata = {
  ...
  tags: ["map", "minus", "icon"],
  description: "MapMinus icon from stroke/navigation category",
  type: ["stroke", "icon"],
} as IconMetadata;
