...
export const Dumbbell: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function Dumbbell(
  {
...
Dumbbell.metadata = {
  ...
  tags: ["dumbbell", "icon"],
  description: "Dumbbell icon from stroke/navigation category",
  type: ["stroke", "icon"],
} as IconMetadata;
