...
export const MapPin: IconComponent<MapPinProps> = React.forwardRef<
  SVGSVGElement,
  MapPinProps
>(function MapPin(
  {
  ...
  console.error(`MapPin doesn't support ${type}`);
  return null;
});
...
MapPin.metadata = {
  ...
  tags: ["map", "pin", "icon"],
  description: "MapPin icon from stroke/navigation category",
  type: ["stroke", "icon"],
} as IconMetadata;
