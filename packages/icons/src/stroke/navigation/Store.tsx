...
interface StoreProps extends IconProps {
  type?: "stroke";
}

export const Store: IconComponent<StoreProps> = React.forwardRef<
  SVGSVGElement,
  StoreProps
>(function Store(
  {
  ...
  console.error(`Store doesn't support ${type}`);
  return null;
});
...
Store.metadata = {
  ...
  tags: ["store", "icon"],
  description: "Store icon from stroke/navigation category",
  type: ["stroke", "icon"],
} as IconMetadata;
