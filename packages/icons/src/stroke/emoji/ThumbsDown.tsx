...
interface ThumbsDownProps extends IconProps {
  type?: "stroke";
}

export const ThumbsDown: IconComponent<ThumbsDownProps> = React.forwardRef<
  SVGSVGElement,
  ThumbsDownProps
>(function ThumbsDown(
  {
...
ThumbsDown.metadata = {
  ...
  description: "ThumbsDown icon from stroke/emoji category",
  type: ["stroke", "icon"],
} as IconMetadata;
