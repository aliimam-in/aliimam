...
export const HatGlasses: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function HatGlasses(
  {
...
HatGlasses.metadata = {
  ...
  description: "HatGlasses icon from stroke/accountsAccess category",
  type: ["stroke", "icon"],
} as IconMetadata;
