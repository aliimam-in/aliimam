...
export const Fingerprint: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function Fingerprint(
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M5 19.5C5.5 18 6 15 6 12 5.999 11.319 6.114 10.643 6.34 10M8.65 22C8.86 21.34 9.1 20.68 9.22 20M9 6.8C9.912 6.273 10.947 5.996 12.001 5.996 13.055 5.996 14.089 6.274 15.002 6.801 15.914 7.328 16.671 8.086 17.198 8.999 17.724 9.911 18.001 10.947 18 12V14"
        stroke={color}
        strokeLinecap="round"
        strokeLinejoin="round"
      />
...
Fingerprint.metadata = {
  ...
  description: "Fingerprint icon from stroke/accountsAccess category",
  type: ["stroke", "icon"],
} as IconMetadata;
