...
export const Ticket: IconComponent = React.forwardRef<SVGSVGElement, IconProps>(
  function Ticket(
    {
      color = "currentColor",
      fill,
...
Ticket.metadata = {
  ...
  tags: ["ticket", "icon"],
  description: "Ticket icon from stroke/accountsAccess category",
  type: ["stroke", "icon"],
} as IconMetadata;
