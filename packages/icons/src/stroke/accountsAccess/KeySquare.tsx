...
export const KeySquare: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function KeySquare(
  {
...
KeySquare.metadata = {
  ...
  description: "KeySquare icon from stroke/accountsAccess category",
  type: ["stroke", "icon"],
} as IconMetadata;
