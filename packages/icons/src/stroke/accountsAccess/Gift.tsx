...
export const Gift: IconComponent = React.forwardRef<SVGSVGElement, IconProps>(
  function Gift(
    {
      color = "currentColor",
      fill,
...
Gift.metadata = {
  ...
  tags: ["gift", "icon"],
  description: "Gift icon from stroke/accountsAccess category",
  type: ["stroke", "icon"],
} as IconMetadata;
