...
export const MessageCircleWarning: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function MessageCircleWarning(
  {
    color = "currentColor",
    fill,
    size = 24,
...
MessageCircleWarning.metadata = {
  name: "MessageCircleWarning",
  category: "stroke/notification",
  tags: ["message", "circle", "warning", "icon"],
  description: "MessageCircleWarning icon from stroke/notification category",
  type: ["stroke", "icon"],
} as IconMetadata;
