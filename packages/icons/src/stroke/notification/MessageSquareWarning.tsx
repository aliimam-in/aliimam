...
export const MessageSquareWarning: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function MessageSquareWarning(
  {
    color = "currentColor",
    fill,
    size = 24,
...
MessageSquareWarning.metadata = {
  name: "MessageSquareWarning",
  category: "stroke/notification",
  tags: ["message", "square", "warning", "icon"],
  description: "MessageSquareWarning icon from stroke/notification category",
  type: ["stroke", "icon"],
} as IconMetadata;
