...
interface BoxProps extends IconProps {
  type?: "stroke";
}

export const Box: IconComponent<BoxProps> = React.forwardRef<
  SVGSVGElement,
  BoxProps
>(function Box(
  {
  ...
  if (type === "stroke") {
    return (
      ...
      >
        ...
        />
        <path
          d="M3.3 7 12 12 20.7 7M12 22V12"
          stroke={color}
          strokeLinecap="round"
          strokeLinejoin="round"
        />
  ...
  console.error(`Box doesn't support ${type}`);
  return null;
});
...
Box.metadata = {
  ...
  tags: ["box", "icon"],
  description: "Box icon from stroke/mathematics category",
  type: ["stroke", "icon"],
} as IconMetadata;
