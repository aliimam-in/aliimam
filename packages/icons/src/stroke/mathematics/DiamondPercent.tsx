...
interface DiamondPercentProps extends IconProps {
  type?: "stroke";
}

export const DiamondPercent: IconComponent<DiamondPercentProps> =
  React.forwardRef<SVGSVGElement, DiamondPercentProps>(function DiamondPercent(
    {
      color = "currentColor",
      fill,
      size = 24,
    ...
    console.error(`DiamondPercent doesn't support ${type}`);
    return null;
  });

DiamondPercent.displayName = "DiamondPercent";

DiamondPercent.metadata = {
  name: "DiamondPercent",
  category: "stroke/mathematics",
  tags: ["diamond", "percent", "icon"],
  description: "DiamondPercent icon from stroke/mathematics category",
  type: ["stroke", "icon"],
} as IconMetadata;
