...
interface HeartMinusProps extends IconProps {
  type?: "stroke";
}

export const HeartMinus: IconComponent<HeartMinusProps> = React.forwardRef<
  SVGSVGElement,
  HeartMinusProps
>(function HeartMinus(
  {
...
HeartMinus.metadata = {
  ...
  description: "HeartMinus icon from stroke/multimedia category",
  type: ["stroke", "icon"],
} as IconMetadata;
