...
export const FileAxis3D: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function FileAxis3D(
  {
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M14 2V6C14 6.53 14.211 7.039 14.586 7.414 14.961 7.789 15.47 8 16 8H20M8 18 12 14M8 10V18H16"
        stroke={color}
        strokeLinecap="round"
        strokeLinejoin="round"
      />
...
FileAxis3D.metadata = {
  ...
  tags: ["file", "axis", "icon"],
  description: "FileAxis3D icon from stroke/design category",
  type: ["stroke", "icon"],
} as IconMetadata;
