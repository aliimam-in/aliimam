...
export const Layers2: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function Layers2(
  {
...
Layers2.metadata = {
  ...
  tags: ["layers", "icon"],
  description: "Layers2 icon from stroke/design category",
  type: ["stroke", "icon"],
} as IconMetadata;
