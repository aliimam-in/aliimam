...
interface RotateCcwProps extends IconProps {
  type?: "stroke";
}

export const RotateCcw: IconComponent<RotateCcwProps> = React.forwardRef<
  SVGSVGElement,
  RotateCcwProps
>(function RotateCcw(
  {
...
RotateCcw.metadata = {
  ...
  description: "RotateCcw icon from stroke/design category",
  type: ["stroke", "icon"],
} as IconMetadata;
