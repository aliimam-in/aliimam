...
export const FolderOutput: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
...
FolderOutput.metadata = {
  ...
  description: "FolderOutput icon from stroke/arrows category",
  type: ["stroke", "icon"],
} as IconMetadata;
