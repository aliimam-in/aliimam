...
export const MousePointerBan: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function MousePointerBan(
  {
    color = "currentColor",
    fill,
    size = 24,
