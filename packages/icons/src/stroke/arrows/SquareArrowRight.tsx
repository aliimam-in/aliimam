...
export const SquareArrowRight: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
...
SquareArrowRight.metadata = {
  name: "SquareArrowRight",
  category: "stroke/arrows",
  tags: ["square", "arrow", "right", "icon"],
  description: "SquareArrowRight icon from stroke/arrows category",
  type: ["stroke", "icon"],
} as IconMetadata;
