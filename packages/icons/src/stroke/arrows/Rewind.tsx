...
export const Rewind: IconComponent = React.forwardRef<SVGSVGElement, IconProps>(
  function Rewind(
    {
      color = "currentColor",
      fill,
...
Rewind.metadata = {
  ...
  tags: ["rewind", "icon"],
  description: "Rewind icon from stroke/arrows category",
  type: ["stroke", "icon"],
} as IconMetadata;
