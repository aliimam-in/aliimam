...
export const FileUp: IconComponent = React.forwardRef<SVGSVGElement, IconProps>(
  function FileUp(
    {
      color = "currentColor",
      fill,
    ...
    return (
      ...
      >
        ...
        />
        <path
          d="M14 2V6C14 6.53 14.211 7.039 14.586 7.414 14.961 7.789 15.47 8 16 8H20M12 12V18M15 15 12 12 9 15"
          stroke={color}
          strokeLinecap="round"
          strokeLinejoin="round"
        />
...
FileUp.metadata = {
  ...
  tags: ["file", "up", "icon"],
  description: "FileUp icon from stroke/arrows category",
  type: ["stroke", "icon"],
} as IconMetadata;
