...
export const PanelBottomOpen: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function PanelBottomOpen(
  {
    color = "currentColor",
    fill,
    size = 24,
...
PanelBottomOpen.metadata = {
  name: "PanelBottomOpen",
  category: "stroke/arrows",
  tags: ["panel", "bottom", "open", "icon"],
  description: "PanelBottomOpen icon from stroke/arrows category",
  type: ["stroke", "icon"],
} as IconMetadata;
