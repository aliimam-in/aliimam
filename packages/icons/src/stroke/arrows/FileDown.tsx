...
export const FileDown: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function FileDown(
  {
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M14 2V6C14 6.53 14.211 7.039 14.586 7.414 14.961 7.789 15.47 8 16 8H20M12 18V12M9 15 12 18 15 15"
        stroke={color}
        strokeLinecap="round"
        strokeLinejoin="round"
      />
...
FileDown.metadata = {
  ...
  tags: ["file", "down", "icon"],
  description: "FileDown icon from stroke/arrows category",
  type: ["stroke", "icon"],
} as IconMetadata;
