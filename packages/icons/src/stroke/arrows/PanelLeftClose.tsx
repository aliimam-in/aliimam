...
export const PanelLeftClose: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
...
PanelLeftClose.metadata = {
  name: "PanelLeftClose",
  category: "stroke/arrows",
  tags: ["panel", "left", "close", "icon"],
  description: "PanelLeftClose icon from stroke/arrows category",
  type: ["stroke", "icon"],
} as IconMetadata;
