...
interface NotebookTabsProps extends IconProps {
  type?: "stroke";
}

export const NotebookTabs: IconComponent<NotebookTabsProps> = React.forwardRef<
  SVGSVGElement,
  NotebookTabsProps
>(function NotebookTabs(
  ...
  console.error(`NotebookTabs doesn't support ${type}`);
  return null;
});
...
NotebookTabs.metadata = {
  ...
  description: "NotebookTabs icon from stroke/communication category",
  type: ["stroke", "icon"],
} as IconMetadata;
