...
interface ZapOffProps extends IconProps {
  type?: "stroke";
}

export const ZapOff: IconComponent<ZapOffProps> = React.forwardRef<
  SVGSVGElement,
  ZapOffProps
>(function ZapOff(
  {
...
ZapOff.metadata = {
  ...
  tags: ["zap", "off", "icon"],
  description: "ZapOff icon from stroke/devices category",
  type: ["stroke", "icon"],
} as IconMetadata;
