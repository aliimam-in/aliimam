...
interface CameraProps extends IconProps {
  type?: "stroke";
}

export const Camera: IconComponent<CameraProps> = React.forwardRef<
  SVGSVGElement,
  CameraProps
>(function Camera(
  {
...
Camera.metadata = {
  ...
  tags: ["camera", "icon"],
  description: "Camera icon from stroke/devices category",
  type: ["stroke", "icon"],
} as IconMetadata;
