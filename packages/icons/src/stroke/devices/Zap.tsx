...
interface ZapProps extends IconProps {
  type?: "stroke";
}

export const Zap: IconComponent<ZapProps> = React.forwardRef<
  SVGSVGElement,
  ZapProps
>(function Zap(
  {
  ...
  console.error(`Zap doesn't support ${type}`);
  return null;
});
...
Zap.metadata = {
  ...
  tags: ["zap", "icon"],
  description: "Zap icon from stroke/devices category",
  type: ["stroke", "icon"],
} as IconMetadata;
