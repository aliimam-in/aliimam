...
export const TvMinimalPlay: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function TvMinimalPlay(
  {
    color = "currentColor",
    fill,
    size = 24,
...
TvMinimalPlay.metadata = {
  name: "TvMinimalPlay",
  category: "stroke/devices",
  tags: ["tv", "minimal", "play", "icon"],
  description: "TvMinimalPlay icon from stroke/devices category",
  type: ["stroke", "icon"],
} as IconMetadata;
