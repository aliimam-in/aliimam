...
export const ReceiptText: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
...
ReceiptText.metadata = {
  name: "ReceiptText",
  category: "stroke/finance",
  tags: ["receipt", "text", "icon"],
  description: "ReceiptText icon from stroke/finance category",
  type: ["stroke", "icon"],
} as IconMetadata;
