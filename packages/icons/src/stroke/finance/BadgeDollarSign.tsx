...
export const BadgeDollarSign: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
...
BadgeDollarSign.metadata = {
  name: "BadgeDollarSign",
  category: "stroke/finance",
  tags: ["badge", "dollar", "sign", "icon"],
  description: "BadgeDollarSign icon from stroke/finance category",
  type: ["stroke", "icon"],
} as IconMetadata;
