...
export const BadgeJapaneseYen: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function BadgeJapaneseYen(
  {
    color = "currentColor",
    fill,
    size = 24,
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M9 8 12 11V18M12 11 15 8M9 12H15M9 16H15"
        stroke={color}
        strokeLinecap="round"
        strokeLinejoin="round"
      />
...
BadgeJapaneseYen.metadata = {
  name: "BadgeJapaneseYen",
  category: "stroke/finance",
  tags: ["badge", "japanese", "yen", "icon"],
  description: "BadgeJapaneseYen icon from stroke/finance category",
  type: ["stroke", "icon"],
} as IconMetadata;
