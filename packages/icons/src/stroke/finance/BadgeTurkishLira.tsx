...
export const BadgeTurkishLira: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function BadgeTurkishLira(
  {
    color = "currentColor",
    fill,
    size = 24,
  ...
  return (
    ...
    >
      <path
        d="M11 7V17C12.326 17 13.598 16.473 14.536 15.536 15.473 14.598 16 13.326 16 12M15 8 9 11"
        stroke={color}
        strokeLinecap="round"
...
BadgeTurkishLira.metadata = {
  name: "BadgeTurkishLira",
  category: "stroke/finance",
  tags: ["badge", "turkish", "lira", "icon"],
  description: "BadgeTurkishLira icon from stroke/finance category",
  type: ["stroke", "icon"],
} as IconMetadata;
