...
interface PhoneProps extends IconProps {
  type?: "stroke";
}

export const Phone: IconComponent<PhoneProps> = React.forwardRef<
  SVGSVGElement,
  PhoneProps
>(function Phone(
  {
  ...
  console.error(`Phone doesn't support ${type}`);
  return null;
});
...
Phone.metadata = {
  ...
  tags: ["phone", "icon"],
  description: "Phone icon from stroke/connectivity category",
  type: ["stroke", "icon"],
} as IconMetadata;
