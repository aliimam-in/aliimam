...
interface PhoneMissedProps extends IconProps {
  type?: "stroke";
}

export const PhoneMissed: IconComponent<PhoneMissedProps> = React.forwardRef<
  SVGSVGElement,
  PhoneMissedProps
>(function PhoneMissed(
  ...
  console.error(`PhoneMissed doesn't support ${type}`);
  return null;
});

PhoneMissed.displayName = "PhoneMissed";

PhoneMissed.metadata = {
  name: "PhoneMissed",
  category: "stroke/connectivity",
  tags: ["phone", "missed", "icon"],
  description: "PhoneMissed icon from stroke/connectivity category",
  type: ["stroke", "icon"],
} as IconMetadata;
