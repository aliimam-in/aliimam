...
interface PhoneIncomingProps extends IconProps {
  type?: "stroke";
}

export const PhoneIncoming: IconComponent<PhoneIncomingProps> =
  React.forwardRef<SVGSVGElement, PhoneIncomingProps>(function PhoneIncoming(
    {
      color = "currentColor",
      fill,
      size = 24,
    ...
    console.error(`PhoneIncoming doesn't support ${type}`);
    return null;
  });

PhoneIncoming.displayName = "PhoneIncoming";

PhoneIncoming.metadata = {
  name: "PhoneIncoming",
  category: "stroke/connectivity",
  tags: ["phone", "incoming", "icon"],
  description: "PhoneIncoming icon from stroke/connectivity category",
  type: ["stroke", "icon"],
} as IconMetadata;
