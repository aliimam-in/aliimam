...
interface PhoneOutgoingProps extends IconProps {
  type?: "stroke";
}

export const PhoneOutgoing: IconComponent<PhoneOutgoingProps> =
  React.forwardRef<SVGSVGElement, PhoneOutgoingProps>(function PhoneOutgoing(
    {
      color = "currentColor",
      fill,
      size = 24,
    ...
    console.error(`PhoneOutgoing doesn't support ${type}`);
    return null;
  });

PhoneOutgoing.displayName = "PhoneOutgoing";

PhoneOutgoing.metadata = {
  name: "PhoneOutgoing",
  category: "stroke/connectivity",
  tags: ["phone", "outgoing", "icon"],
  description: "PhoneOutgoing icon from stroke/connectivity category",
  type: ["stroke", "icon"],
} as IconMetadata;
