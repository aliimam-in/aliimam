...
interface PhoneForwardedProps extends IconProps {
  type?: "stroke";
}

export const PhoneForwarded: IconComponent<PhoneForwardedProps> =
  React.forwardRef<SVGSVGElement, PhoneForwardedProps>(function PhoneForwarded(
    {
      color = "currentColor",
      fill,
      size = 24,
    ...
    console.error(`PhoneForwarded doesn't support ${type}`);
    return null;
  });

PhoneForwarded.displayName = "PhoneForwarded";

PhoneForwarded.metadata = {
  name: "PhoneForwarded",
  category: "stroke/connectivity",
  tags: ["phone", "forwarded", "icon"],
  description: "PhoneForwarded icon from stroke/connectivity category",
  type: ["stroke", "icon"],
} as IconMetadata;
