...
interface HouseWifiProps extends IconProps {
  type?: "stroke";
}

export const HouseWifi: IconComponent<HouseWifiProps> = React.forwardRef<
  SVGSVGElement,
  HouseWifiProps
>(function HouseWifi(
  {
  ...
  if (type === "stroke") {
    return (
      ...
      >
        <path
          d="M9.5 13.866C10.211 13.299 11.093 12.992 12.002 12.994 12.911 12.995 13.792 13.307 14.5 13.876M12 17H12.01"
          stroke={color}
          strokeLinecap="round"
  ...
  console.error(`HouseWifi doesn't support ${type}`);
  return null;
});
...
HouseWifi.metadata = {
  ...
  tags: ["house", "wifi", "icon"],
  description: "HouseWifi icon from stroke/connectivity category",
  type: ["stroke", "icon"],
} as IconMetadata;
