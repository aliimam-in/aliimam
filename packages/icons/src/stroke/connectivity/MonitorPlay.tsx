...
export const MonitorPlay: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
...
MonitorPlay.metadata = {
  ...
  description: "MonitorPlay icon from stroke/connectivity category",
  type: ["stroke", "icon"],
} as IconMetadata;
