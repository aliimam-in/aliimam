...
>(function WifiOff(
  ...
  return (
    ...
    >
      <path
        d="M12 20H12.01M8.5 16.429C9.435 15.513 10.691 15 12 15 13.309 15 14.565 15.513 15.5 16.429M5 12.859C6.418 11.469 8.218 10.533 10.17 10.169M19 12.859C18.398 12.269 17.724 11.757 16.993 11.336M2 8.82C3.237 7.714 4.648 6.821 6.177 6.177M22 8.82C20.475 7.456 18.687 6.418 16.745 5.771 14.804 5.124 12.751 4.88 10.712 5.056M2 2 22 22"
        stroke={color}
        strokeLinecap="round"
