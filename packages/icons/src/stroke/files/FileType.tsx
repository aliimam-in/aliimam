...
export const FileType: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function FileType(
  {
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M14 2V6C14 6.53 14.211 7.039 14.586 7.414 14.961 7.789 15.47 8 16 8H20M9 13V12H15V13M12 12V18M11 18H13"
        stroke={color}
        strokeLinecap="round"
        strokeLinejoin="round"
      />
...
FileType.metadata = {
  ...
  tags: ["file", "type", "icon"],
  description: "FileType icon from stroke/files category",
  type: ["stroke", "icon"],
} as IconMetadata;
