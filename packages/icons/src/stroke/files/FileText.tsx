...
export const FileText: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function FileText(
  {
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M14 2V6C14 6.53 14.211 7.039 14.586 7.414 14.961 7.789 15.47 8 16 8H20M10 9H8M16 13H8M16 17H8"
        stroke={color}
        strokeLinecap="round"
        strokeLinejoin="round"
      />
...
FileText.metadata = {
  ...
  tags: ["file", "text", "icon"],
  description: "FileText icon from stroke/files category",
  type: ["stroke", "icon"],
} as IconMetadata;
