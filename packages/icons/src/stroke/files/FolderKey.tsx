...
export const FolderKey: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function FolderKey(
  {
...
FolderKey.metadata = {
  ...
  description: "FolderKey icon from stroke/files category",
  type: ["stroke", "icon"],
} as IconMetadata;
