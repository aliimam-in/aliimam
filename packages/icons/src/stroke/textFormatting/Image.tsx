...
export const Image: IconComponent<ImageProps> = React.forwardRef<
  SVGSVGElement,
  ImageProps
>(function Image(
  {
  ...
  console.error(`Image doesn't support ${type}`);
  return null;
});
...
Image.metadata = {
  ...
  tags: ["image", "icon"],
  description: "Image icon from stroke/textFormatting category",
  type: ["stroke", "icon"],
} as IconMetadata;
