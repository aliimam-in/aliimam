...
export const MessageSquareQuote: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function MessageSquareQuote(
  ...
  return (
    ...
    >
      <path
        d="M14 14C14.5304 14 15.0391 13.7893 15.4142 13.4142C15.7893 13.0391 16 12.5304 16 12V8H14"
        stroke={color}
        strokeLinecap="round"
      ...
      />
      <path
        d="M8 14C8.53043 14 9.03914 13.7893 9.41421 13.4142C9.78929 13.0391 10 12.5304 10 12V8H8"
        stroke={color}
        strokeLinecap="round"
        strokeLinejoin="round"
      />
...
MessageSquareQuote.metadata = {
  name: "MessageSquareQuote",
  category: "stroke/textFormatting",
  tags: ["message", "square", "quote", "icon"],
  description: "MessageSquareQuote icon from stroke/textFormatting category",
  type: ["stroke", "icon"],
} as IconMetadata;
