...
interface SquareMinusProps extends IconProps {
  type?: "stroke";
}

export const SquareMinus: IconComponent<SquareMinusProps> = React.forwardRef<
  SVGSVGElement,
  SquareMinusProps
>(function SquareMinus(
  ...
  console.error(`SquareMinus doesn't support ${type}`);
  return null;
});
...
SquareMinus.metadata = {
  ...
  description: "SquareMinus icon from stroke/textFormatting category",
  type: ["stroke", "icon"],
} as IconMetadata;
