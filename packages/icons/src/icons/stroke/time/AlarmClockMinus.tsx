...
export const AlarmClockMinus = React.forwardRef<SVGSVGElement, AlarmClockMinusProps>(
  ({ size = 24, ...props }, ref) => (
    <svg
      ...
      dangerouslySetInnerHTML={{ __html: `<g fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="13" r="8"/><path d="M5 3L2 6m20 0l-3-3M6.38 18.7L4 21m13.64-2.33L20 21M9 13h6"/></g>` }}
      {...props}
    />
  )
)
