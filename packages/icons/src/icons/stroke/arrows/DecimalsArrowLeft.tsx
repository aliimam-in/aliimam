...
export const DecimalsArrowLeft = React.forwardRef<SVGSVGElement, DecimalsArrowLeftProps>(
  ({ size = 24, ...props }, ref) => (
    <svg
      ...
      dangerouslySetInnerHTML={{ __html: `<g fill="none" stroke="currentColor" stroke-width="2"><path d="m13 21l-3-3l3-3m7 3H10m-7-7h.01"/><rect width="5" height="8" x="6" y="3" rx="2.5"/></g>` }}
      {...props}
    />
  )
)
