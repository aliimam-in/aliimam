...
export const AlignHorizontalJustifyCenter = React.forwardRef<SVGSVGElement, AlignHorizontalJustifyCenterProps>(
  ({ size = 24, ...props }, ref) => (
    <svg
      ...
      dangerouslySetInnerHTML={{ __html: `<g fill="none" stroke="currentColor" stroke-width="2"><rect width="6" height="14" x="2" y="5" rx="2"/><rect width="6" height="10" x="16" y="7" rx="2"/><path d="M12 2v20"/></g>` }}
      {...props}
    />
  )
)
