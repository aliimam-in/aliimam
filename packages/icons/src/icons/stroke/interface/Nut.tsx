...
export interface NutProps extends React.SVGProps<SVGSVGElement> {
  size?: number
}

export const Nut = React.forwardRef<SVGSVGElement, NutProps>(
  ({ size = 24, ...props }, ref) => (
    <svg
      ref={ref}
