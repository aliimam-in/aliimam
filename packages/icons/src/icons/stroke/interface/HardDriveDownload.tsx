...
export const HardDriveDownload = React.forwardRef<SVGSVGElement, HardDriveDownloadProps>(
  ({ size = 24, ...props }, ref) => (
    <svg
      ...
      dangerouslySetInnerHTML={{ __html: `<g fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2v8m4-4l-4 4l-4-4"/><rect width="20" height="8" x="2" y="14" rx="2"/><path d="M6 18h.01M10 18h.01"/></g>` }}
      {...props}
    />
  )
)
