...
export const AlignVerticalJustifyCenter = React.forwardRef<SVGSVGElement, AlignVerticalJustifyCenterProps>(
  ({ size = 24, ...props }, ref) => (
    <svg
      ...
      dangerouslySetInnerHTML={{ __html: `<g fill="none" stroke="currentColor" stroke-width="2"><rect width="14" height="6" x="5" y="16" rx="2"/><rect width="10" height="6" x="7" y="2" rx="2"/><path d="M2 12h20"/></g>` }}
      {...props}
    />
  )
)
