...
export interface CloudSnowRoundedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CloudSnowRounded = React.forwardRef<SVGSVGElement, CloudSnowRoundedProps>(
...
CloudSnowRounded.displayName = "CloudSnowRounded";
export const CloudSnowRoundedMetadata = { 
  id: "cloud-snow_rounded", 
  baseId: "cloud-snow", 
  variant: "rounded", 
  name: "Cloud Snow", 
  category: "weather", 
...
export default CloudSnowRounded;
