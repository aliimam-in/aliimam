...
export interface CloudLightningRoundedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CloudLightningRounded = React.forwardRef<SVGSVGElement, CloudLightningRoundedProps>(
...
CloudLightningRounded.displayName = "CloudLightningRounded";
export const CloudLightningRoundedMetadata = { 
  id: "cloud-lightning_rounded", 
...
export default CloudLightningRounded;
