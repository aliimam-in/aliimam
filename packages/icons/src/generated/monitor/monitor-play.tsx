...
export const MonitorPlayMetadata = { id: "monitor-play", baseId: "monitor-play", variant: "default", name: "Monitor Play", category: "monitor", tags: [], viewBox: "0 0 24 24" } as const;
