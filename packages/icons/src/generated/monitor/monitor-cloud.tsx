...
export const MonitorCloudMetadata = { id: "monitor-cloud", baseId: "monitor-cloud", variant: "default", name: "Monitor Cloud", category: "monitor", tags: [], viewBox: "0 0 24 24" } as const;
