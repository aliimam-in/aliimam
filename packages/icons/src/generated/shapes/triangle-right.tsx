...
export const TriangleRightMetadata = { id: "triangle-right", baseId: "triangle-right", variant: "default", name: "Triangle Right", category: "shapes", tags: [], viewBox: "0 0 24 24" } as const;
