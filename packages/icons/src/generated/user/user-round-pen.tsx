...
export const UserRoundPenMetadata = { id: "user-round-pen", baseId: "user-round-pen", variant: "default", name: "User Round Pen", category: "user", tags: [], viewBox: "0 0 24 24" } as const;
