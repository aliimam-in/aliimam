...
export const UserRoundSearchMetadata = { id: "user-round-search", baseId: "user-round-search", variant: "default", name: "User Round Search", category: "user", tags: [], viewBox: "0 0 24 24" } as const;
