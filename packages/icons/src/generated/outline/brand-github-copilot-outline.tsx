/**
 * Auto-generated logo component: Brand Github Copilot Outline (default)
 * Category: outline
...
export interface BrandGithubCopilotOutlineLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const BrandGithubCopilotOutlineLogo = React.forwardRef<SVGSVGElement, BrandGithubCopilotOutlineLogoProps>(
...
BrandGithubCopilotOutlineLogo.displayName = "BrandGithubCopilotOutlineLogo";

export const BrandGithubCopilotOutlineLogoMetadata = {
  id: "brand-github-copilot-outline",
  baseId: "brand-github-copilot-outline",
  variant: "default",
  name: "Brand Github Copilot Outline",
  category: "outline",
  tags: [],
  viewBox: "0 0 24 24",
} as const;

export default BrandGithubCopilotOutlineLogo;
