/**
 * Auto-generated logo component: Avocado Outline (default)
 * Category: outline
...
export interface AvocadoOutlineLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const AvocadoOutlineLogo = React.forwardRef<SVGSVGElement, AvocadoOutlineLogoProps>(
...
AvocadoOutlineLogo.displayName = "AvocadoOutlineLogo";

export const AvocadoOutlineLogoMetadata = {
  id: "avocado-outline",
  baseId: "avocado-outline",
  variant: "default",
  name: "Avocado Outline",
  category: "outline",
  tags: [],
  viewBox: "0 0 24 24",
} as const;

export default AvocadoOutlineLogo;
