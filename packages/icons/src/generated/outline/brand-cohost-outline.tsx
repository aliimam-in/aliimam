/**
 * Auto-generated logo component: Brand Cohost Outline (default)
 * Category: outline
...
export interface BrandCohostOutlineLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const BrandCohostOutlineLogo = React.forwardRef<SVGSVGElement, BrandCohostOutlineLogoProps>(
...
BrandCohostOutlineLogo.displayName = "BrandCohostOutlineLogo";

export const BrandCohostOutlineLogoMetadata = {
  id: "brand-cohost-outline",
  baseId: "brand-cohost-outline",
  variant: "default",
  name: "Brand Cohost Outline",
  category: "outline",
  tags: [],
  viewBox: "0 0 24 24",
} as const;

export default BrandCohostOutlineLogo;
