/**
 * Auto-generated logo component: Brand Rust Outline (default)
 * Category: outline
...
export interface BrandRustOutlineLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const BrandRustOutlineLogo = React.forwardRef<SVGSVGElement, BrandRustOutlineLogoProps>(
...
BrandRustOutlineLogo.displayName = "BrandRustOutlineLogo";

export const BrandRustOutlineLogoMetadata = {
  id: "brand-rust-outline",
  baseId: "brand-rust-outline",
  variant: "default",
  name: "Brand Rust Outline",
  category: "outline",
  tags: [],
  viewBox: "0 0 24 24",
} as const;

export default BrandRustOutlineLogo;
