/**
 * Auto-generated logo component: Cloud Star Outline (default)
 * Category: outline
...
export interface CloudStarOutlineLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const CloudStarOutlineLogo = React.forwardRef<SVGSVGElement, CloudStarOutlineLogoProps>(
...
CloudStarOutlineLogo.displayName = "CloudStarOutlineLogo";

export const CloudStarOutlineLogoMetadata = {
  id: "cloud-star-outline",
  baseId: "cloud-star-outline",
  variant: "default",
  name: "Cloud Star Outline",
  category: "outline",
  tags: [],
  viewBox: "0 0 24 24",
} as const;

export default CloudStarOutlineLogo;
