/**
 * Auto-generated logo component: Device Vision Pro Outline (default)
 * Category: outline
...
export interface DeviceVisionProOutlineLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const DeviceVisionProOutlineLogo = React.forwardRef<SVGSVGElement, DeviceVisionProOutlineLogoProps>(
...
DeviceVisionProOutlineLogo.displayName = "DeviceVisionProOutlineLogo";

export const DeviceVisionProOutlineLogoMetadata = {
  id: "device-vision-pro-outline",
  baseId: "device-vision-pro-outline",
  variant: "default",
  name: "Device Vision Pro Outline",
  category: "outline",
  tags: [],
  viewBox: "0 0 24 24",
} as const;

export default DeviceVisionProOutlineLogo;
