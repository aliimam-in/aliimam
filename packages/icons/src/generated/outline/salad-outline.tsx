/**
 * Auto-generated logo component: Salad Outline (default)
 * Category: outline
...
export interface SaladOutlineLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const SaladOutlineLogo = React.forwardRef<SVGSVGElement, SaladOutlineLogoProps>(
...
SaladOutlineLogo.displayName = "SaladOutlineLogo";

export const SaladOutlineLogoMetadata = {
  id: "salad-outline",
  baseId: "salad-outline",
  variant: "default",
  name: "Salad Outline",
  category: "outline",
  tags: [],
...
export default SaladOutlineLogo;
