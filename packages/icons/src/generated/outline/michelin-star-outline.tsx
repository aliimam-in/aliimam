/**
 * Auto-generated logo component: Michelin Star Outline (default)
 * Category: outline
...
export interface MichelinStarOutlineLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const MichelinStarOutlineLogo = React.forwardRef<SVGSVGElement, MichelinStarOutlineLogoProps>(
...
MichelinStarOutlineLogo.displayName = "MichelinStarOutlineLogo";

export const MichelinStarOutlineLogoMetadata = {
  id: "michelin-star-outline",
  baseId: "michelin-star-outline",
  variant: "default",
  name: "Michelin Star Outline",
  category: "outline",
  tags: [],
  viewBox: "0 0 24 24",
} as const;

export default MichelinStarOutlineLogo;
