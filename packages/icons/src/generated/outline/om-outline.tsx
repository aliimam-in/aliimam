/**
 * Auto-generated logo component: Om Outline (default)
 * Category: outline
...
export interface OmOutlineLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const OmOutlineLogo = React.forwardRef<SVGSVGElement, OmOutlineLogoProps>(
...
OmOutlineLogo.displayName = "OmOutlineLogo";

export const OmOutlineLogoMetadata = {
  id: "om-outline",
  baseId: "om-outline",
  variant: "default",
  name: "Om Outline",
