/**
 * Auto-generated logo component: Brand Yarn Outline (default)
 * Category: outline
...
export interface BrandYarnOutlineLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const BrandYarnOutlineLogo = React.forwardRef<SVGSVGElement, BrandYarnOutlineLogoProps>(
...
BrandYarnOutlineLogo.displayName = "BrandYarnOutlineLogo";

export const BrandYarnOutlineLogoMetadata = {
  id: "brand-yarn-outline",
  baseId: "brand-yarn-outline",
  variant: "default",
  name: "Brand Yarn Outline",
  category: "outline",
  tags: [],
  viewBox: "0 0 24 24",
} as const;

export default BrandYarnOutlineLogo;
