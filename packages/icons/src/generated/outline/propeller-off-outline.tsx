/**
 * Auto-generated logo component: Propeller Off Outline (default)
 * Category: outline
...
export interface PropellerOffOutlineLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const PropellerOffOutlineLogo = React.forwardRef<SVGSVGElement, PropellerOffOutlineLogoProps>(
...
PropellerOffOutlineLogo.displayName = "PropellerOffOutlineLogo";

export const PropellerOffOutlineLogoMetadata = {
  id: "propeller-off-outline",
  baseId: "propeller-off-outline",
  variant: "default",
  name: "Propeller Off Outline",
  category: "outline",
  tags: [],
  viewBox: "0 0 24 24",
} as const;

export default PropellerOffOutlineLogo;
