/**
 * Auto-generated logo component: Brand React Native Outline (default)
 * Category: outline
...
export interface BrandReactNativeOutlineLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const BrandReactNativeOutlineLogo = React.forwardRef<SVGSVGElement, BrandReactNativeOutlineLogoProps>(
...
BrandReactNativeOutlineLogo.displayName = "BrandReactNativeOutlineLogo";

export const BrandReactNativeOutlineLogoMetadata = {
  id: "brand-react-native-outline",
  baseId: "brand-react-native-outline",
  variant: "default",
  name: "Brand React Native Outline",
  category: "outline",
  tags: [],
  viewBox: "0 0 24 24",
} as const;

export default BrandReactNativeOutlineLogo;
