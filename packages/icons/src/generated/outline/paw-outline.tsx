/**
 * Auto-generated logo component: Paw Outline (default)
 * Category: outline
...
export interface PawOutlineLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const PawOutlineLogo = React.forwardRef<SVGSVGElement, PawOutlineLogoProps>(
...
PawOutlineLogo.displayName = "PawOutlineLogo";

export const PawOutlineLogoMetadata = {
  id: "paw-outline",
  baseId: "paw-outline",
  variant: "default",
  name: "Paw Outline",
