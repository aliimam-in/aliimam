/**
 * Auto-generated logo component: Brand Nem Outline (default)
 * Category: outline
...
export interface BrandNemOutlineLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const BrandNemOutlineLogo = React.forwardRef<SVGSVGElement, BrandNemOutlineLogoProps>(
...
BrandNemOutlineLogo.displayName = "BrandNemOutlineLogo";

export const BrandNemOutlineLogoMetadata = {
  id: "brand-nem-outline",
  baseId: "brand-nem-outline",
  variant: "default",
  name: "Brand Nem Outline",
  category: "outline",
  tags: [],
  viewBox: "0 0 24 24",
} as const;

export default BrandNemOutlineLogo;
