/**
 * Auto-generated logo component: Assembly Off Outline (default)
 * Category: outline
...
export interface AssemblyOffOutlineLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const AssemblyOffOutlineLogo = React.forwardRef<SVGSVGElement, AssemblyOffOutlineLogoProps>(
...
AssemblyOffOutlineLogo.displayName = "AssemblyOffOutlineLogo";

export const AssemblyOffOutlineLogoMetadata = {
  id: "assembly-off-outline",
  baseId: "assembly-off-outline",
  variant: "default",
  name: "Assembly Off Outline",
  category: "outline",
  tags: [],
  viewBox: "0 0 24 24",
} as const;

export default AssemblyOffOutlineLogo;
