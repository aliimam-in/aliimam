/**
 * Auto-generated logo component: Sparkles 2 Outline (default)
 * Category: outline
...
export interface Sparkles2OutlineLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const Sparkles2OutlineLogo = React.forwardRef<SVGSVGElement, Sparkles2OutlineLogoProps>(
...
Sparkles2OutlineLogo.displayName = "Sparkles2OutlineLogo";

export const Sparkles2OutlineLogoMetadata = {
  id: "sparkles-2-outline",
  baseId: "sparkles-2-outline",
  variant: "default",
  name: "Sparkles 2 Outline",
  category: "outline",
  tags: [],
  viewBox: "0 0 24 24",
} as const;

export default Sparkles2OutlineLogo;
