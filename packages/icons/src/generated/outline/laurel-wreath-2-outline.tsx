/**
 * Auto-generated logo component: Laurel Wreath 2 Outline (default)
 * Category: outline
...
export interface LaurelWreath2OutlineLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const LaurelWreath2OutlineLogo = React.forwardRef<SVGSVGElement, LaurelWreath2OutlineLogoProps>(
...
LaurelWreath2OutlineLogo.displayName = "LaurelWreath2OutlineLogo";

export const LaurelWreath2OutlineLogoMetadata = {
  id: "laurel-wreath-2-outline",
  baseId: "laurel-wreath-2-outline",
  variant: "default",
  name: "Laurel Wreath 2 Outline",
  category: "outline",
  tags: [],
  viewBox: "0 0 24 24",
} as const;

export default LaurelWreath2OutlineLogo;
