/**
 * Auto-generated logo component: Assembly Outline (default)
 * Category: outline
...
export interface AssemblyOutlineLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const AssemblyOutlineLogo = React.forwardRef<SVGSVGElement, AssemblyOutlineLogoProps>(
...
AssemblyOutlineLogo.displayName = "AssemblyOutlineLogo";

export const AssemblyOutlineLogoMetadata = {
  id: "assembly-outline",
  baseId: "assembly-outline",
  variant: "default",
  name: "Assembly Outline",
  category: "outline",
  tags: [],
  viewBox: "0 0 24 24",
} as const;

export default AssemblyOutlineLogo;
