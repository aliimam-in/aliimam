/**
 * Auto-generated logo component: Propeller Outline (default)
 * Category: outline
...
export interface PropellerOutlineLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const PropellerOutlineLogo = React.forwardRef<SVGSVGElement, PropellerOutlineLogoProps>(
...
PropellerOutlineLogo.displayName = "PropellerOutlineLogo";

export const PropellerOutlineLogoMetadata = {
  id: "propeller-outline",
  baseId: "propeller-outline",
  variant: "default",
  name: "Propeller Outline",
  category: "outline",
  tags: [],
  viewBox: "0 0 24 24",
} as const;

export default PropellerOutlineLogo;
