/**
 * Auto-generated logo component: Settings Star Outline (default)
 * Category: outline
...
export interface SettingsStarOutlineLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const SettingsStarOutlineLogo = React.forwardRef<SVGSVGElement, SettingsStarOutlineLogoProps>(
...
SettingsStarOutlineLogo.displayName = "SettingsStarOutlineLogo";

export const SettingsStarOutlineLogoMetadata = {
  id: "settings-star-outline",
  baseId: "settings-star-outline",
  variant: "default",
  name: "Settings Star Outline",
  category: "outline",
  tags: [],
  viewBox: "0 0 24 24",
} as const;

export default SettingsStarOutlineLogo;
