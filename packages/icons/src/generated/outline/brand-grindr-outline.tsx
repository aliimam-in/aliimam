/**
 * Auto-generated logo component: Brand Grindr Outline (default)
 * Category: outline
...
export interface BrandGrindrOutlineLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const BrandGrindrOutlineLogo = React.forwardRef<SVGSVGElement, BrandGrindrOutlineLogoProps>(
...
BrandGrindrOutlineLogo.displayName = "BrandGrindrOutlineLogo";

export const BrandGrindrOutlineLogoMetadata = {
  id: "brand-grindr-outline",
  baseId: "brand-grindr-outline",
  variant: "default",
  name: "Brand Grindr Outline",
  category: "outline",
  tags: [],
  viewBox: "0 0 24 24",
} as const;

export default BrandGrindrOutlineLogo;
