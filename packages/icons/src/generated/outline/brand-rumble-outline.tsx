/**
 * Auto-generated logo component: Brand Rumble Outline (default)
 * Category: outline
...
export interface BrandRumbleOutlineLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const BrandRumbleOutlineLogo = React.forwardRef<SVGSVGElement, BrandRumbleOutlineLogoProps>(
...
BrandRumbleOutlineLogo.displayName = "BrandRumbleOutlineLogo";

export const BrandRumbleOutlineLogoMetadata = {
  id: "brand-rumble-outline",
  baseId: "brand-rumble-outline",
  variant: "default",
  name: "Brand Rumble Outline",
  category: "outline",
  tags: [],
  viewBox: "0 0 24 24",
} as const;

export default BrandRumbleOutlineLogo;
