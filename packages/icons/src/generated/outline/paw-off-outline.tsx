/**
 * Auto-generated logo component: Paw Off Outline (default)
 * Category: outline
...
export interface PawOffOutlineLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const PawOffOutlineLogo = React.forwardRef<SVGSVGElement, PawOffOutlineLogoProps>(
...
PawOffOutlineLogo.displayName = "PawOffOutlineLogo";

export const PawOffOutlineLogoMetadata = {
  id: "paw-off-outline",
  baseId: "paw-off-outline",
  variant: "default",
...
export default PawOffOutlineLogo;
