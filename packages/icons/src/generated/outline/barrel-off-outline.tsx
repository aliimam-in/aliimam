/**
 * Auto-generated logo component: Barrel Off Outline (default)
 * Category: outline
...
export interface BarrelOffOutlineLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const BarrelOffOutlineLogo = React.forwardRef<SVGSVGElement, BarrelOffOutlineLogoProps>(
...
BarrelOffOutlineLogo.displayName = "BarrelOffOutlineLogo";

export const BarrelOffOutlineLogoMetadata = {
  id: "barrel-off-outline",
  baseId: "barrel-off-outline",
  variant: "default",
  name: "Barrel Off Outline",
  category: "outline",
  tags: [],
  viewBox: "0 0 24 24",
} as const;

export default BarrelOffOutlineLogo;
