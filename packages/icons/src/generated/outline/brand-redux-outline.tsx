/**
 * Auto-generated logo component: Brand Redux Outline (default)
 * Category: outline
...
export interface BrandReduxOutlineLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const BrandReduxOutlineLogo = React.forwardRef<SVGSVGElement, BrandReduxOutlineLogoProps>(
...
BrandReduxOutlineLogo.displayName = "BrandReduxOutlineLogo";

export const BrandReduxOutlineLogoMetadata = {
  id: "brand-redux-outline",
  baseId: "brand-redux-outline",
  variant: "default",
  name: "Brand Redux Outline",
  category: "outline",
  tags: [],
  viewBox: "0 0 24 24",
} as const;

export default BrandReduxOutlineLogo;
