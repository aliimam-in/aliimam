/**
 * Auto-generated logo component: Laurel Wreath Outline (default)
 * Category: outline
...
export interface LaurelWreathOutlineLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const LaurelWreathOutlineLogo = React.forwardRef<SVGSVGElement, LaurelWreathOutlineLogoProps>(
...
LaurelWreathOutlineLogo.displayName = "LaurelWreathOutlineLogo";

export const LaurelWreathOutlineLogoMetadata = {
  id: "laurel-wreath-outline",
  baseId: "laurel-wreath-outline",
  variant: "default",
  name: "Laurel Wreath Outline",
  category: "outline",
  tags: [],
  viewBox: "0 0 24 24",
} as const;

export default LaurelWreathOutlineLogo;
