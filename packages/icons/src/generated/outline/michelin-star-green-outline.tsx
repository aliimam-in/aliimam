/**
 * Auto-generated logo component: Michelin Star Green Outline (default)
 * Category: outline
...
export interface MichelinStarGreenOutlineLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const MichelinStarGreenOutlineLogo = React.forwardRef<SVGSVGElement, MichelinStarGreenOutlineLogoProps>(
...
MichelinStarGreenOutlineLogo.displayName = "MichelinStarGreenOutlineLogo";

export const MichelinStarGreenOutlineLogoMetadata = {
  id: "michelin-star-green-outline",
  baseId: "michelin-star-green-outline",
  variant: "default",
  name: "Michelin Star Green Outline",
  category: "outline",
  tags: [],
  viewBox: "0 0 24 24",
} as const;

export default MichelinStarGreenOutlineLogo;
