/**
 * Auto-generated logo component: Flower Off Outline (default)
 * Category: outline
...
export interface FlowerOffOutlineLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const FlowerOffOutlineLogo = React.forwardRef<SVGSVGElement, FlowerOffOutlineLogoProps>(
...
FlowerOffOutlineLogo.displayName = "FlowerOffOutlineLogo";

export const FlowerOffOutlineLogoMetadata = {
  id: "flower-off-outline",
  baseId: "flower-off-outline",
  variant: "default",
  name: "Flower Off Outline",
  category: "outline",
  tags: [],
  viewBox: "0 0 24 24",
} as const;

export default FlowerOffOutlineLogo;
