/**
 * Auto-generated logo component: Stars Outline (default)
 * Category: outline
...
export interface StarsOutlineLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const StarsOutlineLogo = React.forwardRef<SVGSVGElement, StarsOutlineLogoProps>(
...
StarsOutlineLogo.displayName = "StarsOutlineLogo";

export const StarsOutlineLogoMetadata = {
  id: "stars-outline",
  baseId: "stars-outline",
  variant: "default",
  name: "Stars Outline",
  category: "outline",
  tags: [],
...
export default StarsOutlineLogo;
