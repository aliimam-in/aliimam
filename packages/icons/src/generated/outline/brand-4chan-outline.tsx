/**
 * Auto-generated logo component: Brand 4chan Outline (default)
 * Category: outline
...
export interface Brand4chanOutlineLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const Brand4chanOutlineLogo = React.forwardRef<SVGSVGElement, Brand4chanOutlineLogoProps>(
...
Brand4chanOutlineLogo.displayName = "Brand4chanOutlineLogo";

export const Brand4chanOutlineLogoMetadata = {
  id: "brand-4chan-outline",
  baseId: "brand-4chan-outline",
  variant: "default",
  name: "Brand 4chan Outline",
  category: "outline",
  tags: [],
  viewBox: "0 0 24 24",
} as const;

export default Brand4chanOutlineLogo;
