/**
 * Auto-generated logo component: Brand Vivaldi Outline (default)
 * Category: outline
...
export interface BrandVivaldiOutlineLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const BrandVivaldiOutlineLogo = React.forwardRef<SVGSVGElement, BrandVivaldiOutlineLogoProps>(
...
BrandVivaldiOutlineLogo.displayName = "BrandVivaldiOutlineLogo";

export const BrandVivaldiOutlineLogoMetadata = {
  id: "brand-vivaldi-outline",
  baseId: "brand-vivaldi-outline",
  variant: "default",
  name: "Brand Vivaldi Outline",
  category: "outline",
  tags: [],
  viewBox: "0 0 24 24",
} as const;

export default BrandVivaldiOutlineLogo;
