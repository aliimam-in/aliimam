/**
 * Auto-generated logo component: Spiral Off Outline (default)
 * Category: outline
...
export interface SpiralOffOutlineLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const SpiralOffOutlineLogo = React.forwardRef<SVGSVGElement, SpiralOffOutlineLogoProps>(
...
SpiralOffOutlineLogo.displayName = "SpiralOffOutlineLogo";

export const SpiralOffOutlineLogoMetadata = {
  id: "spiral-off-outline",
  baseId: "spiral-off-outline",
  variant: "default",
  name: "Spiral Off Outline",
  category: "outline",
  tags: [],
  viewBox: "0 0 24 24",
} as const;

export default SpiralOffOutlineLogo;
