/**
 * Auto-generated logo component: Brand Arc Outline (default)
 * Category: outline
...
export interface BrandArcOutlineLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const BrandArcOutlineLogo = React.forwardRef<SVGSVGElement, BrandArcOutlineLogoProps>(
...
BrandArcOutlineLogo.displayName = "BrandArcOutlineLogo";

export const BrandArcOutlineLogoMetadata = {
  id: "brand-arc-outline",
  baseId: "brand-arc-outline",
  variant: "default",
  name: "Brand Arc Outline",
  category: "outline",
  tags: [],
  viewBox: "0 0 24 24",
} as const;

export default BrandArcOutlineLogo;
