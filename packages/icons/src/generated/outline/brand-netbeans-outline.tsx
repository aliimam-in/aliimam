/**
 * Auto-generated logo component: Brand Netbeans Outline (default)
 * Category: outline
...
export interface BrandNetbeansOutlineLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const BrandNetbeansOutlineLogo = React.forwardRef<SVGSVGElement, BrandNetbeansOutlineLogoProps>(
...
BrandNetbeansOutlineLogo.displayName = "BrandNetbeansOutlineLogo";

export const BrandNetbeansOutlineLogoMetadata = {
  id: "brand-netbeans-outline",
  baseId: "brand-netbeans-outline",
  variant: "default",
  name: "Brand Netbeans Outline",
  category: "outline",
  tags: [],
  viewBox: "0 0 24 24",
} as const;

export default BrandNetbeansOutlineLogo;
