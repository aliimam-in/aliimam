/**
 * Auto-generated logo component: Diabolo Off Outline (default)
 * Category: outline
...
export interface DiaboloOffOutlineLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const DiaboloOffOutlineLogo = React.forwardRef<SVGSVGElement, DiaboloOffOutlineLogoProps>(
...
DiaboloOffOutlineLogo.displayName = "DiaboloOffOutlineLogo";

export const DiaboloOffOutlineLogoMetadata = {
  id: "diabolo-off-outline",
  baseId: "diabolo-off-outline",
  variant: "default",
  name: "Diabolo Off Outline",
  category: "outline",
  tags: [],
  viewBox: "0 0 24 24",
} as const;

export default DiaboloOffOutlineLogo;
