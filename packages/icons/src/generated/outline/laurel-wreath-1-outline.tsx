/**
 * Auto-generated logo component: Laurel Wreath 1 Outline (default)
 * Category: outline
...
export interface LaurelWreath1OutlineLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const LaurelWreath1OutlineLogo = React.forwardRef<SVGSVGElement, LaurelWreath1OutlineLogoProps>(
...
LaurelWreath1OutlineLogo.displayName = "LaurelWreath1OutlineLogo";

export const LaurelWreath1OutlineLogoMetadata = {
  id: "laurel-wreath-1-outline",
  baseId: "laurel-wreath-1-outline",
  variant: "default",
  name: "Laurel Wreath 1 Outline",
  category: "outline",
  tags: [],
  viewBox: "0 0 24 24",
} as const;

export default LaurelWreath1OutlineLogo;
