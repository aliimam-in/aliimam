/**
 * Auto-generated logo component: Brand Among Us Outline (default)
 * Category: outline
...
export interface BrandAmongUsOutlineLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const BrandAmongUsOutlineLogo = React.forwardRef<SVGSVGElement, BrandAmongUsOutlineLogoProps>(
...
BrandAmongUsOutlineLogo.displayName = "BrandAmongUsOutlineLogo";

export const BrandAmongUsOutlineLogoMetadata = {
  id: "brand-among-us-outline",
  baseId: "brand-among-us-outline",
  variant: "default",
  name: "Brand Among Us Outline",
  category: "outline",
  tags: [],
  viewBox: "0 0 24 24",
} as const;

export default BrandAmongUsOutlineLogo;
