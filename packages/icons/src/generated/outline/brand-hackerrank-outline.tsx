/**
 * Auto-generated logo component: Brand Hackerrank Outline (default)
 * Category: outline
...
export interface BrandHackerrankOutlineLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const BrandHackerrankOutlineLogo = React.forwardRef<SVGSVGElement, BrandHackerrankOutlineLogoProps>(
...
BrandHackerrankOutlineLogo.displayName = "BrandHackerrankOutlineLogo";

export const BrandHackerrankOutlineLogoMetadata = {
  id: "brand-hackerrank-outline",
  baseId: "brand-hackerrank-outline",
  variant: "default",
  name: "Brand Hackerrank Outline",
  category: "outline",
  tags: [],
  viewBox: "0 0 24 24",
} as const;

export default BrandHackerrankOutlineLogo;
