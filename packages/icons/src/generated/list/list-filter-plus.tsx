...
export const ListFilterPlusMetadata = { id: "list-filter-plus", baseId: "list-filter-plus", variant: "default", name: "List Filter Plus", category: "list", tags: [], viewBox: "0 0 24 24" } as const;
