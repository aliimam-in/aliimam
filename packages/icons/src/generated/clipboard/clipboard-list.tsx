...
export const ClipboardListMetadata = { id: "clipboard-list", baseId: "clipboard-list", variant: "default", name: "Clipboard List", category: "clipboard", tags: [], viewBox: "0 0 24 24" } as const;
