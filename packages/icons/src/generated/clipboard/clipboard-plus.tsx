...
export const ClipboardPlusMetadata = { id: "clipboard-plus", baseId: "clipboard-plus", variant: "default", name: "Clipboard Plus", category: "clipboard", tags: [], viewBox: "0 0 24 24" } as const;
