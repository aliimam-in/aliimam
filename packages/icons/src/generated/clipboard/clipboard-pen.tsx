...
export const ClipboardPenMetadata = { id: "clipboard-pen", baseId: "clipboard-pen", variant: "default", name: "Clipboard Pen", category: "clipboard", tags: [], viewBox: "0 0 24 24" } as const;
