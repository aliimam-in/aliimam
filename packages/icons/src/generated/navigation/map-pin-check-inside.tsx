...
export const MapPinCheckInsideMetadata = { id: "map-pin-check-inside", baseId: "map-pin-check-inside", variant: "default", name: "Map Pin Check Inside", category: "navigation", tags: [], viewBox: "0 0 24 24" } as const;
