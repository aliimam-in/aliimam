...
export const MapPinHouseMetadata = { id: "map-pin-house", baseId: "map-pin-house", variant: "default", name: "Map Pin House", category: "navigation", tags: [], viewBox: "0 0 24 24" } as const;
