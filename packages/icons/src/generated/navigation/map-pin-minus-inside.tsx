...
export const MapPinMinusInsideMetadata = { id: "map-pin-minus-inside", baseId: "map-pin-minus-inside", variant: "default", name: "Map Pin Minus Inside", category: "navigation", tags: [], viewBox: "0 0 24 24" } as const;
