...
export const LocationSlashRounded = React.forwardRef<SVGSVGElement, LocationSlashRoundedProps>(
  ({ size = 24, className = '', strokeWidth = 1, ...props }, ref) => (
    <svg 
      ...
      {...props}
    >
      <path d="M10.42 13C9.5 12.46 8.88 11.46 8.88 10.31C8.88 8.59 10.27 7.19 12 7.19C13.15 7.19 14.15 7.81 14.69 8.74" stroke="#292D32" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M5.98995 17.81C4.14995 15.3 2.80995 12.09 3.62995 8.48998C5.27995 1.22998 14.57 0.0599852 18.68 4.97999" stroke="#292D32" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
