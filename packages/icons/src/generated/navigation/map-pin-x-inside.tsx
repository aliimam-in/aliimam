...
export const MapPinXInsideMetadata = { id: "map-pin-x-inside", baseId: "map-pin-x-inside", variant: "default", name: "Map Pin X Inside", category: "navigation", tags: [], viewBox: "0 0 24 24" } as const;
