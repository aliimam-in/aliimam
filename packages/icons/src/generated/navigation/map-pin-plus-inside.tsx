...
export const MapPinPlusInsideMetadata = { id: "map-pin-plus-inside", baseId: "map-pin-plus-inside", variant: "default", name: "Map Pin Plus Inside", category: "navigation", tags: [], viewBox: "0 0 24 24" } as const;
