...
export const NavigationOffMetadata = { id: "navigation-off", baseId: "navigation-off", variant: "default", name: "Navigation Off", category: "navigation", tags: [], viewBox: "0 0 24 24" } as const;
