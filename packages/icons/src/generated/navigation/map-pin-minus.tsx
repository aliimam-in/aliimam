...
export const MapPinMinusMetadata = { id: "map-pin-minus", baseId: "map-pin-minus", variant: "default", name: "Map Pin Minus", category: "navigation", tags: [], viewBox: "0 0 24 24" } as const;
