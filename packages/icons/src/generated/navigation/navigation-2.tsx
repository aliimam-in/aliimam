...
export const Navigation2Metadata = { id: "navigation-2", baseId: "navigation-2", variant: "default", name: "Navigation 2", category: "navigation", tags: [], viewBox: "0 0 24 24" } as const;
