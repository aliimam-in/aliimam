...
export const MapPinPlusMetadata = { id: "map-pin-plus", baseId: "map-pin-plus", variant: "default", name: "Map Pin Plus", category: "navigation", tags: [], viewBox: "0 0 24 24" } as const;
