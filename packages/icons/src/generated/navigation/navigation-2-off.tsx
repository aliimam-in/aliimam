...
export const Navigation2OffMetadata = { id: "navigation-2-off", baseId: "navigation-2-off", variant: "default", name: "Navigation 2 Off", category: "navigation", tags: [], viewBox: "0 0 24 24" } as const;
