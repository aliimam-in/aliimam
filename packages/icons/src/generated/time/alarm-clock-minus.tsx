...
export const AlarmClockMinusMetadata = { id: "alarm-clock-minus", baseId: "alarm-clock-minus", variant: "default", name: "Alarm Clock Minus", category: "time", tags: [], viewBox: "0 0 24 24" } as const;
