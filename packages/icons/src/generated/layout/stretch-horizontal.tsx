...
export const StretchHorizontalMetadata = { id: "stretch-horizontal", baseId: "stretch-horizontal", variant: "default", name: "Stretch Horizontal", category: "layout", tags: [], viewBox: "0 0 24 24" } as const;
