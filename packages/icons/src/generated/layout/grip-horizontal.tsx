...
export const GripHorizontalMetadata = { id: "grip-horizontal", baseId: "grip-horizontal", variant: "default", name: "Grip Horizontal", category: "layout", tags: [], viewBox: "0 0 24 24" } as const;
