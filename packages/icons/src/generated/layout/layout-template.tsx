...
export const LayoutTemplateMetadata = { id: "layout-template", baseId: "layout-template", variant: "default", name: "Layout Template", category: "layout", tags: [], viewBox: "0 0 24 24" } as const;
