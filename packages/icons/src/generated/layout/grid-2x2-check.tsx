...
export const Grid2x2CheckMetadata = { id: "grid-2x2-check", baseId: "grid-2x2-check", variant: "default", name: "Grid 2x2 Check", category: "layout", tags: [], viewBox: "0 0 24 24" } as const;
