...
export const GalleryVerticalMetadata = { id: "gallery-vertical", baseId: "gallery-vertical", variant: "default", name: "Gallery Vertical", category: "layout", tags: [], viewBox: "0 0 24 24" } as const;
