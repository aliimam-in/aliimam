...
export const BetweenVerticalStartMetadata = { id: "between-vertical-start", baseId: "between-vertical-start", variant: "default", name: "Between Vertical Start", category: "layout", tags: [], viewBox: "0 0 24 24" } as const;
