...
export const BetweenHorizontalEndMetadata = { id: "between-horizontal-end", baseId: "between-horizontal-end", variant: "default", name: "Between Horizontal End", category: "layout", tags: [], viewBox: "0 0 24 24" } as const;
