...
export const SeparatorVerticalMetadata = { id: "separator-vertical", baseId: "separator-vertical", variant: "default", name: "Separator Vertical", category: "layout", tags: [], viewBox: "0 0 24 24" } as const;
