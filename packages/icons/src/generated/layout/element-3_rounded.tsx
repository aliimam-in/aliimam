...
export interface Element3RoundedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const Element3Rounded = React.forwardRef<SVGSVGElement, Element3RoundedProps>(
...
Element3Rounded.displayName = "Element3Rounded";
export const Element3RoundedMetadata = { 
  id: "element-3_rounded", 
  baseId: "element-3", 
  variant: "rounded", 
  name: "Element 3", 
  category: "layout", 
...
export default Element3Rounded;
