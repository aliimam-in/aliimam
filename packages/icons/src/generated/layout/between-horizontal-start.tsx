...
export const BetweenHorizontalStartMetadata = { id: "between-horizontal-start", baseId: "between-horizontal-start", variant: "default", name: "Between Horizontal Start", category: "layout", tags: [], viewBox: "0 0 24 24" } as const;
