...
export const CalendarCheckMetadata = { id: "calendar-check", baseId: "calendar-check", variant: "default", name: "Calendar Check", category: "calendar", tags: [], viewBox: "0 0 24 24" } as const;
