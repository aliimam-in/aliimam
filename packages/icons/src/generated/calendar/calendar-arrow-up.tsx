...
export const CalendarArrowUpMetadata = { id: "calendar-arrow-up", baseId: "calendar-arrow-up", variant: "default", name: "Calendar Arrow Up", category: "calendar", tags: [], viewBox: "0 0 24 24" } as const;
