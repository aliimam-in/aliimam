...
export const EvChargerMetadata = { id: "ev-charger", baseId: "ev-charger", variant: "default", name: "Ev Charger", category: "transportation", tags: [], viewBox: "0 0 24 24" } as const;
