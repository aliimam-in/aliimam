...
export const PlaneLandingMetadata = { id: "plane-landing", baseId: "plane-landing", variant: "default", name: "Plane Landing", category: "transportation", tags: [], viewBox: "0 0 24 24" } as const;
