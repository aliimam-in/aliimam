...
export const TrainFrontTunnelMetadata = { id: "train-front-tunnel", baseId: "train-front-tunnel", variant: "default", name: "Train Front Tunnel", category: "transportation", tags: [], viewBox: "0 0 24 24" } as const;
