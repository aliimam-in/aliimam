...
export const PlaneTakeoffMetadata = { id: "plane-takeoff", baseId: "plane-takeoff", variant: "default", name: "Plane Takeoff", category: "transportation", tags: [], viewBox: "0 0 24 24" } as const;
