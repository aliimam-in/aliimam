...
export const TramFrontMetadata = { id: "tram-front", baseId: "tram-front", variant: "default", name: "Tram Front", category: "transportation", tags: [], viewBox: "0 0 24 24" } as const;
