...
export const TrainTrackMetadata = { id: "train-track", baseId: "train-track", variant: "default", name: "Train Track", category: "transportation", tags: [], viewBox: "0 0 24 24" } as const;
