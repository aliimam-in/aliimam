...
export const CarTaxiFrontMetadata = { id: "car-taxi-front", baseId: "car-taxi-front", variant: "default", name: "Car Taxi Front", category: "transportation", tags: [], viewBox: "0 0 24 24" } as const;
