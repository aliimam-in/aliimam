...
export const EqualApproximatelyMetadata = { id: "equal-approximately", baseId: "equal-approximately", variant: "default", name: "Equal Approximately", category: "math", tags: [], viewBox: "0 0 24 24" } as const;
