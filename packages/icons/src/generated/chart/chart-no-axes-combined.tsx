...
export const ChartNoAxesCombinedMetadata = { id: "chart-no-axes-combined", baseId: "chart-no-axes-combined", variant: "default", name: "Chart No Axes Combined", category: "chart", tags: [], viewBox: "0 0 24 24" } as const;
