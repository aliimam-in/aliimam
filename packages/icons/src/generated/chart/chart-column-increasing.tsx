...
export const ChartColumnIncreasingMetadata = { id: "chart-column-increasing", baseId: "chart-column-increasing", variant: "default", name: "Chart Column Increasing", category: "chart", tags: [], viewBox: "0 0 24 24" } as const;
