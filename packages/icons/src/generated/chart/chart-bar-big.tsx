...
export const ChartBarBigMetadata = { id: "chart-bar-big", baseId: "chart-bar-big", variant: "default", name: "Chart Bar Big", category: "chart", tags: [], viewBox: "0 0 24 24" } as const;
