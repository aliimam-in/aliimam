...
export const ShieldCheckMetadata = { id: "shield-check", baseId: "shield-check", variant: "default", name: "Shield Check", category: "shield", tags: [], viewBox: "0 0 24 24" } as const;
