...
export const CaseSensitiveMetadata = { id: "case-sensitive", baseId: "case-sensitive", variant: "default", name: "Case Sensitive", category: "letter", tags: [], viewBox: "0 0 24 24" } as const;
