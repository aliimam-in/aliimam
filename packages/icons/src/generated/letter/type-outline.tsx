...
export const TypeOutlineMetadata = { id: "type-outline", baseId: "type-outline", variant: "default", name: "Type Outline", category: "letter", tags: [], viewBox: "0 0 24 24" } as const;
