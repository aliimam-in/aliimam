...
export const TreeDeciduousMetadata = { id: "tree-deciduous", baseId: "tree-deciduous", variant: "default", name: "Tree Deciduous", category: "nature", tags: [], viewBox: "0 0 24 24" } as const;
