...
export interface LeafyGreenProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const LeafyGreen = React.forwardRef<SVGSVGElement, LeafyGreenProps>(
...
export const LeafyGreenMetadata = { id: "leafy-green", baseId: "leafy-green", variant: "default", name: "Leafy Green", category: "nature", tags: [], viewBox: "0 0 24 24" } as const;
