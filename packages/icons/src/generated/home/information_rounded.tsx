...
export interface InformationRoundedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const InformationRounded = React.forwardRef<SVGSVGElement, InformationRoundedProps>(
...
InformationRounded.displayName = "InformationRounded";
export const InformationRoundedMetadata = { 
  id: "information_rounded", 
  baseId: "information", 
  variant: "rounded", 
  name: "Information", 
  category: "home", 
...
export default InformationRounded;
