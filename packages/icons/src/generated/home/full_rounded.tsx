...
export interface FullRoundedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const FullRounded = React.forwardRef<SVGSVGElement, FullRoundedProps>(
...
FullRounded.displayName = "FullRounded";
export const FullRoundedMetadata = { 
  id: "full_rounded", 
  baseId: "full", 
  variant: "rounded", 
  name: "Full", 
