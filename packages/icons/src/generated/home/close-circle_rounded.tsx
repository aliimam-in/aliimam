...
export interface CloseCircleRoundedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CloseCircleRounded = React.forwardRef<SVGSVGElement, CloseCircleRoundedProps>(
...
CloseCircleRounded.displayName = "CloseCircleRounded";
export const CloseCircleRoundedMetadata = { 
  id: "close-circle_rounded", 
  baseId: "close-circle", 
  variant: "rounded", 
  name: "Close Circle", 
  category: "home", 
