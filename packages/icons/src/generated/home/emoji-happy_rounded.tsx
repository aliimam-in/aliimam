...
export interface EmojiHappyRoundedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const EmojiHappyRounded = React.forwardRef<SVGSVGElement, EmojiHappyRoundedProps>(
...
EmojiHappyRounded.displayName = "EmojiHappyRounded";
export const EmojiHappyRoundedMetadata = { 
  id: "emoji-happy_rounded", 
  baseId: "emoji-happy", 
  variant: "rounded", 
  name: "Emoji Happy", 
  category: "home", 
...
export default EmojiHappyRounded;
