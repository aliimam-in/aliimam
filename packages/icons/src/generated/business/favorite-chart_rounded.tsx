...
export interface FavoriteChartRoundedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const FavoriteChartRounded = React.forwardRef<SVGSVGElement, FavoriteChartRoundedProps>(
...
export default FavoriteChartRounded;
