...
export const FolderMinusMetadata = { id: "folder-minus", baseId: "folder-minus", variant: "default", name: "Folder Minus", category: "folder", tags: [], viewBox: "0 0 24 24" } as const;
