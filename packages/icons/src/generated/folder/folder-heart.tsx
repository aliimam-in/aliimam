...
export const FolderHeartMetadata = { id: "folder-heart", baseId: "folder-heart", variant: "default", name: "Folder Heart", category: "folder", tags: [], viewBox: "0 0 24 24" } as const;
