...
export const FolderClockMetadata = { id: "folder-clock", baseId: "folder-clock", variant: "default", name: "Folder Clock", category: "folder", tags: [], viewBox: "0 0 24 24" } as const;
