...
export const FolderClosedMetadata = { id: "folder-closed", baseId: "folder-closed", variant: "default", name: "Folder Closed", category: "folder", tags: [], viewBox: "0 0 24 24" } as const;
