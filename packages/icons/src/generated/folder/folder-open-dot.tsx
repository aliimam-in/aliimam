...
export const FolderOpenDotMetadata = { id: "folder-open-dot", baseId: "folder-open-dot", variant: "default", name: "Folder Open Dot", category: "folder", tags: [], viewBox: "0 0 24 24" } as const;
