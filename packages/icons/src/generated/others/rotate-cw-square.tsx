...
export const RotateCwSquareMetadata = { id: "rotate-cw-square", baseId: "rotate-cw-square", variant: "default", name: "Rotate Cw Square", category: "others", tags: [], viewBox: "0 0 24 24" } as const;
