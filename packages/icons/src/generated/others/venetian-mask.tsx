...
export const VenetianMaskMetadata = { id: "venetian-mask", baseId: "venetian-mask", variant: "default", name: "Venetian Mask", category: "others", tags: [], viewBox: "0 0 24 24" } as const;
