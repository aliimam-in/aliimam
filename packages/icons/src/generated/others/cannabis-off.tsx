/**
 * Auto-generated logo component: Cannabis Off (default)
 * Category: others
...
export interface CannabisOffLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const CannabisOffLogo = React.forwardRef<SVGSVGElement, CannabisOffLogoProps>(
...
CannabisOffLogo.displayName = "CannabisOffLogo";

export const CannabisOffLogoMetadata = {
  id: "cannabis-off",
  baseId: "cannabis-off",
  variant: "default",
  name: "Cannabis Off",
...
export default CannabisOffLogo;
