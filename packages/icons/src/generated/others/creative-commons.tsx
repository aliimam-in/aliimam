...
export const CreativeCommonsMetadata = { id: "creative-commons", baseId: "creative-commons", variant: "default", name: "Creative Commons", category: "others", tags: [], viewBox: "0 0 24 24" } as const;
