...
export const CassetteTapeMetadata = { id: "cassette-tape", baseId: "cassette-tape", variant: "default", name: "Cassette Tape", category: "others", tags: [], viewBox: "0 0 24 24" } as const;
