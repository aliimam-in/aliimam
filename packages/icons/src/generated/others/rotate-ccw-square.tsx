...
export const RotateCcwSquareMetadata = { id: "rotate-ccw-square", baseId: "rotate-ccw-square", variant: "default", name: "Rotate Ccw Square", category: "others", tags: [], viewBox: "0 0 24 24" } as const;
