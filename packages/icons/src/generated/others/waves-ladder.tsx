...
export const WavesLadderMetadata = { id: "waves-ladder", baseId: "waves-ladder", variant: "default", name: "Waves Ladder", category: "others", tags: [], viewBox: "0 0 24 24" } as const;
