...
export const TowerControlMetadata = { id: "tower-control", baseId: "tower-control", variant: "default", name: "Tower Control", category: "others", tags: [], viewBox: "0 0 24 24" } as const;
