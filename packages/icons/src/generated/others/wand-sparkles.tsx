...
export const WandSparklesMetadata = { id: "wand-sparkles", baseId: "wand-sparkles", variant: "default", name: "Wand Sparkles", category: "others", tags: [], viewBox: "0 0 24 24" } as const;
