...
export const SoapDispenserDropletMetadata = { id: "soap-dispenser-droplet", baseId: "soap-dispenser-droplet", variant: "default", name: "Soap Dispenser Droplet", category: "others", tags: [], viewBox: "0 0 24 24" } as const;
