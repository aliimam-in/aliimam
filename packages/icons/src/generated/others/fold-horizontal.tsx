...
export const FoldHorizontalMetadata = { id: "fold-horizontal", baseId: "fold-horizontal", variant: "default", name: "Fold Horizontal", category: "others", tags: [], viewBox: "0 0 24 24" } as const;
