...
export const ReceiptJapaneseYenMetadata = { id: "receipt-japanese-yen", baseId: "receipt-japanese-yen", variant: "default", name: "Receipt Japanese Yen", category: "others", tags: [], viewBox: "0 0 24 24" } as const;
