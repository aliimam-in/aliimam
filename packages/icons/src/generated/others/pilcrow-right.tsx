...
export const PilcrowRightMetadata = { id: "pilcrow-right", baseId: "pilcrow-right", variant: "default", name: "Pilcrow Right", category: "others", tags: [], viewBox: "0 0 24 24" } as const;
