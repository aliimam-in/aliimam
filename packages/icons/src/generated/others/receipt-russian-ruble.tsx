...
export const ReceiptRussianRubleMetadata = { id: "receipt-russian-ruble", baseId: "receipt-russian-ruble", variant: "default", name: "Receipt Russian Ruble", category: "others", tags: [], viewBox: "0 0 24 24" } as const;
