...
export const ReceiptEuroMetadata = { id: "receipt-euro", baseId: "receipt-euro", variant: "default", name: "Receipt Euro", category: "others", tags: [], viewBox: "0 0 24 24" } as const;
