...
export const PictureInPicture2Metadata = { id: "picture-in-picture-2", baseId: "picture-in-picture-2", variant: "default", name: "Picture In Picture 2", category: "others", tags: [], viewBox: "0 0 24 24" } as const;
