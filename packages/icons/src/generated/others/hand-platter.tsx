...
export const HandPlatterMetadata = { id: "hand-platter", baseId: "hand-platter", variant: "default", name: "Hand Platter", category: "others", tags: [], viewBox: "0 0 24 24" } as const;
