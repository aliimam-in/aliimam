...
export const SmartphoneChargingMetadata = { id: "smartphone-charging", baseId: "smartphone-charging", variant: "default", name: "Smartphone Charging", category: "others", tags: [], viewBox: "0 0 24 24" } as const;
