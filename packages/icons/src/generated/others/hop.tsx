/**
 * Auto-generated logo component: Hop (default)
 * Category: others
...
export interface HopLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const HopLogo = React.forwardRef<SVGSVGElement, HopLogoProps>(
...
HopLogo.displayName = "HopLogo";

export const HopLogoMetadata = {
  id: "hop",
  baseId: "hop",
  variant: "default",
  name: "Hop",
