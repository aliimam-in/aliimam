...
export const TicketCheckMetadata = { id: "ticket-check", baseId: "ticket-check", variant: "default", name: "Ticket Check", category: "others", tags: [], viewBox: "0 0 24 24" } as const;
