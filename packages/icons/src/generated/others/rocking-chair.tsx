...
export const RockingChairMetadata = { id: "rocking-chair", baseId: "rocking-chair", variant: "default", name: "Rocking Chair", category: "others", tags: [], viewBox: "0 0 24 24" } as const;
