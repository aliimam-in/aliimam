...
export const IterationCcwMetadata = { id: "iteration-ccw", baseId: "iteration-ccw", variant: "default", name: "Iteration Ccw", category: "others", tags: [], viewBox: "0 0 24 24" } as const;
