...
export const VectorSquareMetadata = { id: "vector-square", baseId: "vector-square", variant: "default", name: "Vector Square", category: "others", tags: [], viewBox: "0 0 24 24" } as const;
