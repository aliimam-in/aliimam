...
export const PackageMinusMetadata = { id: "package-minus", baseId: "package-minus", variant: "default", name: "Package Minus", category: "others", tags: [], viewBox: "0 0 24 24" } as const;
