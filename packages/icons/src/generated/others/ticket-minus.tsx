...
export const TicketMinusMetadata = { id: "ticket-minus", baseId: "ticket-minus", variant: "default", name: "Ticket Minus", category: "others", tags: [], viewBox: "0 0 24 24" } as const;
