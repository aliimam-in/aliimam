...
export const FishingHookMetadata = { id: "fishing-hook", baseId: "fishing-hook", variant: "default", name: "Fishing Hook", category: "others", tags: [], viewBox: "0 0 24 24" } as const;
