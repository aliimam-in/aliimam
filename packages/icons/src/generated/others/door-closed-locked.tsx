...
export const DoorClosedLockedMetadata = { id: "door-closed-locked", baseId: "door-closed-locked", variant: "default", name: "Door Closed Locked", category: "others", tags: [], viewBox: "0 0 24 24" } as const;
