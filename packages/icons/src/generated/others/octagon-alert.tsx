...
export const OctagonAlertMetadata = { id: "octagon-alert", baseId: "octagon-alert", variant: "default", name: "Octagon Alert", category: "others", tags: [], viewBox: "0 0 24 24" } as const;
