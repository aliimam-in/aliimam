/**
 * Auto-generated logo component: Cannabis (default)
 * Category: others
...
export interface CannabisLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const CannabisLogo = React.forwardRef<SVGSVGElement, CannabisLogoProps>(
...
CannabisLogo.displayName = "CannabisLogo";

export const CannabisLogoMetadata = {
  id: "cannabis",
  baseId: "cannabis",
  variant: "default",
  name: "Cannabis",
