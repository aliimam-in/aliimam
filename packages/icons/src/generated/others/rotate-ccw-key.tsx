...
export const RotateCcwKeyMetadata = { id: "rotate-ccw-key", baseId: "rotate-ccw-key", variant: "default", name: "Rotate Ccw Key", category: "others", tags: [], viewBox: "0 0 24 24" } as const;
