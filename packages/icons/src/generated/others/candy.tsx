/**
 * Auto-generated logo component: Candy (default)
 * Category: others
...
export interface CandyLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const CandyLogo = React.forwardRef<SVGSVGElement, CandyLogoProps>(
...
CandyLogo.displayName = "CandyLogo";

export const CandyLogoMetadata = {
  id: "candy",
  baseId: "candy",
  variant: "default",
  name: "Candy",
