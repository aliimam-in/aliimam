...
export const MirrorRoundMetadata = { id: "mirror-round", baseId: "mirror-round", variant: "default", name: "Mirror Round", category: "others", tags: [], viewBox: "0 0 24 24" } as const;
