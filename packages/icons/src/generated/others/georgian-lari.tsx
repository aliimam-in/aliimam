...
export const GeorgianLariMetadata = { id: "georgian-lari", baseId: "georgian-lari", variant: "default", name: "Georgian Lari", category: "others", tags: [], viewBox: "0 0 24 24" } as const;
