...
export const TicketPercentMetadata = { id: "ticket-percent", baseId: "ticket-percent", variant: "default", name: "Ticket Percent", category: "others", tags: [], viewBox: "0 0 24 24" } as const;
