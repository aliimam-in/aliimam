...
export const WavesArrowUpMetadata = { id: "waves-arrow-up", baseId: "waves-arrow-up", variant: "default", name: "Waves Arrow Up", category: "others", tags: [], viewBox: "0 0 24 24" } as const;
