...
export const GraduationCapMetadata = { id: "graduation-cap", baseId: "graduation-cap", variant: "default", name: "Graduation Cap", category: "others", tags: [], viewBox: "0 0 24 24" } as const;
