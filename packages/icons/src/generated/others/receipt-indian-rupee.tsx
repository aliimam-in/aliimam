...
export const ReceiptIndianRupeeMetadata = { id: "receipt-indian-rupee", baseId: "receipt-indian-rupee", variant: "default", name: "Receipt Indian Rupee", category: "others", tags: [], viewBox: "0 0 24 24" } as const;
