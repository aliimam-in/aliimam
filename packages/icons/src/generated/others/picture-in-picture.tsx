...
export const PictureInPictureMetadata = { id: "picture-in-picture", baseId: "picture-in-picture", variant: "default", name: "Picture In Picture", category: "others", tags: [], viewBox: "0 0 24 24" } as const;
