...
export const CirclePowerMetadata = { id: "circle-power", baseId: "circle-power", variant: "default", name: "Circle Power", category: "circle", tags: [], viewBox: "0 0 24 24" } as const;
