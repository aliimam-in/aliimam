...
export const CircleArrowDownMetadata = { id: "circle-arrow-down", baseId: "circle-arrow-down", variant: "default", name: "Circle Arrow Down", category: "circle", tags: [], viewBox: "0 0 24 24" } as const;
