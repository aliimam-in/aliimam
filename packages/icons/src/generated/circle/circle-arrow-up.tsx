...
export const CircleArrowUpMetadata = { id: "circle-arrow-up", baseId: "circle-arrow-up", variant: "default", name: "Circle Arrow Up", category: "circle", tags: [], viewBox: "0 0 24 24" } as const;
