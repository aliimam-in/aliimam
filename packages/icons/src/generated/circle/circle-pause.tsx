...
export const CirclePauseMetadata = { id: "circle-pause", baseId: "circle-pause", variant: "default", name: "Circle Pause", category: "circle", tags: [], viewBox: "0 0 24 24" } as const;
