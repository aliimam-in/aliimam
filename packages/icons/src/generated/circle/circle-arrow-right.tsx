...
export const CircleArrowRightMetadata = { id: "circle-arrow-right", baseId: "circle-arrow-right", variant: "default", name: "Circle Arrow Right", category: "circle", tags: [], viewBox: "0 0 24 24" } as const;
