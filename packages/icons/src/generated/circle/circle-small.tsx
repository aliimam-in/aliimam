...
export const CircleSmallMetadata = { id: "circle-small", baseId: "circle-small", variant: "default", name: "Circle Small", category: "circle", tags: [], viewBox: "0 0 24 24" } as const;
