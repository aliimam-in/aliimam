...
export const CircleSlash2Metadata = { id: "circle-slash-2", baseId: "circle-slash-2", variant: "default", name: "Circle Slash 2", category: "circle", tags: [], viewBox: "0 0 24 24" } as const;
