...
export const CircleDollarSignMetadata = { id: "circle-dollar-sign", baseId: "circle-dollar-sign", variant: "default", name: "Circle Dollar Sign", category: "circle", tags: [], viewBox: "0 0 24 24" } as const;
