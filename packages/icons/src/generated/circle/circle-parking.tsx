...
export const CircleParkingMetadata = { id: "circle-parking", baseId: "circle-parking", variant: "default", name: "Circle Parking", category: "circle", tags: [], viewBox: "0 0 24 24" } as const;
