...
export const RemoveFormattingMetadata = { id: "remove-formatting", baseId: "remove-formatting", variant: "default", name: "Remove Formatting", category: "text", tags: [], viewBox: "0 0 24 24" } as const;
