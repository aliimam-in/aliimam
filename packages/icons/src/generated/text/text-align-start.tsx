...
export const TextAlignStartMetadata = { id: "text-align-start", baseId: "text-align-start", variant: "default", name: "Text Align Start", category: "text", tags: [], viewBox: "0 0 24 24" } as const;
