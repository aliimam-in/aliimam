...
export const ZodiacAquariusMetadata = { id: "zodiac-aquarius", baseId: "zodiac-aquarius", variant: "default", name: "Zodiac Aquarius", category: "zodiac", tags: [], viewBox: "0 0 24 24" } as const;
