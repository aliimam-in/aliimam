...
export const MessageSquareWarningMetadata = { id: "message-square-warning", baseId: "message-square-warning", variant: "default", name: "Message Square Warning", category: "message", tags: [], viewBox: "0 0 24 24" } as const;
