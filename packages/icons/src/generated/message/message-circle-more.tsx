...
export const MessageCircleMoreMetadata = { id: "message-circle-more", baseId: "message-circle-more", variant: "default", name: "Message Circle More", category: "message", tags: [], viewBox: "0 0 24 24" } as const;
