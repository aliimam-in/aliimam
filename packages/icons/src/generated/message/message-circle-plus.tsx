...
export const MessageCirclePlusMetadata = { id: "message-circle-plus", baseId: "message-circle-plus", variant: "default", name: "Message Circle Plus", category: "message", tags: [], viewBox: "0 0 24 24" } as const;
