...
export const MessageSquareXMetadata = { id: "message-square-x", baseId: "message-square-x", variant: "default", name: "Message Square X", category: "message", tags: [], viewBox: "0 0 24 24" } as const;
