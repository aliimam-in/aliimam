...
export const MessageSquareReplyMetadata = { id: "message-square-reply", baseId: "message-square-reply", variant: "default", name: "Message Square Reply", category: "message", tags: [], viewBox: "0 0 24 24" } as const;
