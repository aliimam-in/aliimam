...
export const MessageCircleCheckMetadata = { id: "message-circle-check", baseId: "message-circle-check", variant: "default", name: "Message Circle Check", category: "message", tags: [], viewBox: "0 0 24 24" } as const;
