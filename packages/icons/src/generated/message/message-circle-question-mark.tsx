...
export const MessageCircleQuestionMarkMetadata = { id: "message-circle-question-mark", baseId: "message-circle-question-mark", variant: "default", name: "Message Circle Question Mark", category: "message", tags: [], viewBox: "0 0 24 24" } as const;
