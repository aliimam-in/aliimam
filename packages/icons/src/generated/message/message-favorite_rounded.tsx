...
export interface MessageFavoriteRoundedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const MessageFavoriteRounded = React.forwardRef<SVGSVGElement, MessageFavoriteRoundedProps>(
...
MessageFavoriteRounded.displayName = "MessageFavoriteRounded";
export const MessageFavoriteRoundedMetadata = { 
  id: "message-favorite_rounded", 
  baseId: "message-favorite", 
  variant: "rounded", 
...
export default MessageFavoriteRounded;
