...
export const MessageCircleXMetadata = { id: "message-circle-x", baseId: "message-circle-x", variant: "default", name: "Message Circle X", category: "message", tags: [], viewBox: "0 0 24 24" } as const;
