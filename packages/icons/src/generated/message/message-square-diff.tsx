...
export const MessageSquareDiffMetadata = { id: "message-square-diff", baseId: "message-square-diff", variant: "default", name: "Message Square Diff", category: "message", tags: [], viewBox: "0 0 24 24" } as const;
