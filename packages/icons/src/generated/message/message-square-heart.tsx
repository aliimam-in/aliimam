...
export const MessageSquareHeartMetadata = { id: "message-square-heart", baseId: "message-square-heart", variant: "default", name: "Message Square Heart", category: "message", tags: [], viewBox: "0 0 24 24" } as const;
