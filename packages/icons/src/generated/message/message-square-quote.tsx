...
export const MessageSquareQuoteMetadata = { id: "message-square-quote", baseId: "message-square-quote", variant: "default", name: "Message Square Quote", category: "message", tags: [], viewBox: "0 0 24 24" } as const;
