...
export const MessageCircleCodeMetadata = { id: "message-circle-code", baseId: "message-circle-code", variant: "default", name: "Message Circle Code", category: "message", tags: [], viewBox: "0 0 24 24" } as const;
