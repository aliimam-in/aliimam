...
export const MessageCircleReplyMetadata = { id: "message-circle-reply", baseId: "message-circle-reply", variant: "default", name: "Message Circle Reply", category: "message", tags: [], viewBox: "0 0 24 24" } as const;
