...
export const MessageCircleOffMetadata = { id: "message-circle-off", baseId: "message-circle-off", variant: "default", name: "Message Circle Off", category: "message", tags: [], viewBox: "0 0 24 24" } as const;
