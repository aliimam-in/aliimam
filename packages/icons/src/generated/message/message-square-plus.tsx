...
export const MessageSquarePlusMetadata = { id: "message-square-plus", baseId: "message-square-plus", variant: "default", name: "Message Square Plus", category: "message", tags: [], viewBox: "0 0 24 24" } as const;
