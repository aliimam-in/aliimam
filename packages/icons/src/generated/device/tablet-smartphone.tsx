...
export const TabletSmartphoneMetadata = { id: "tablet-smartphone", baseId: "tablet-smartphone", variant: "default", name: "Tablet Smartphone", category: "device", tags: [], viewBox: "0 0 24 24" } as const;
