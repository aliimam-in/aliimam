...
export const WashingMachineMetadata = { id: "washing-machine", baseId: "washing-machine", variant: "default", name: "Washing Machine", category: "device", tags: [], viewBox: "0 0 24 24" } as const;
