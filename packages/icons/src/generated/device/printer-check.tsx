...
export const PrinterCheckMetadata = { id: "printer-check", baseId: "printer-check", variant: "default", name: "Printer Check", category: "device", tags: [], viewBox: "0 0 24 24" } as const;
