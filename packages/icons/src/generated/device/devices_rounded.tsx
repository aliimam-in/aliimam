...
export interface DevicesRoundedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const DevicesRounded = React.forwardRef<SVGSVGElement, DevicesRoundedProps>(
  ({ size = 24, className = '', strokeWidth = 1, ...props }, ref) => (
    <svg 
      ...
      {...props}
    >
      <path d="M17.0099 12.73C17.6009 12.73 18.0799 12.2509 18.0799 11.66C18.0799 11.069 17.6009 10.59 17.0099 10.59C16.419 10.59 15.9399 11.069 15.9399 11.66C15.9399 12.2509 16.419 12.73 17.0099 12.73Z" stroke="#292D32" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
...
<path d="M9 15.7V20" stroke="#292D32" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
...
<path d="M17.0101 12.73C17.601 12.73 18.08 12.2509 18.08 11.66C18.08 11.069 17.601 10.59 17.0101 10.59C16.4191 10.59 15.9401 11.069 15.9401 11.66C15.9401 12.2509 16.4191 12.73 17.0101 12.73Z" stroke="#292D32" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
...
<path d="M19.15 17.01C19.15 18.19 18.19 19.15 17.01 19.15C15.83 19.15 14.87 18.19 14.87 17.01C14.87 16.52 15.04 16.06 15.32 15.7C15.71 15.2 16.32 14.87 17.01 14.87C17.55 14.87 18.04 15.07 18.41 15.39C18.86 15.79 19.15 16.37 19.15 17.01Z" stroke="#292D32" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M17.0101 12.73C17.601 12.73 18.08 12.2509 18.08 11.66C18.08 11.069 17.601 10.59 17.0101 10.59C16.4191 10.59 15.9401 11.069 15.9401 11.66C15.9401 12.2509 16.4191 12.73 17.0101 12.73Z" stroke="#292D32" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  )
);
DevicesRounded.displayName = "DevicesRounded";
export const DevicesRoundedMetadata = { 
  id: "devices_rounded", 
  baseId: "devices", 
  variant: "rounded", 
  name: "Devices", 
