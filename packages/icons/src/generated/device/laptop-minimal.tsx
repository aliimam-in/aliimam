...
export const LaptopMinimalMetadata = { id: "laptop-minimal", baseId: "laptop-minimal", variant: "default", name: "Laptop Minimal", category: "device", tags: [], viewBox: "0 0 24 24" } as const;
