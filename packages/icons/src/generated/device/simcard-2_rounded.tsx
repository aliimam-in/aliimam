...
export const Simcard2Rounded = React.forwardRef<SVGSVGElement, Simcard2RoundedProps>(
  ({ size = 24, className = '', strokeWidth = 1, ...props }, ref) => (
    <svg 
      ...
      {...props}
    >
      <path d="M16 12.69V18.08C16 20.42 14.44 21.97 12.11 21.97H5.89C3.56 21.97 2 20.42 2 18.08V10.31C2 7.96998 3.56 6.41998 5.89 6.41998H9.72C10.75 6.41998 11.74 6.82998 12.47 7.55998L14.86 9.93998C15.59 10.67 16 11.66 16 12.69Z" stroke="#292D32" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
