...
export const LaptopMinimalCheckMetadata = { id: "laptop-minimal-check", baseId: "laptop-minimal-check", variant: "default", name: "Laptop Minimal Check", category: "device", tags: [], viewBox: "0 0 24 24" } as const;
