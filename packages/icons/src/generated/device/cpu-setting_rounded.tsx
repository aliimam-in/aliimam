...
export interface CpuSettingRoundedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CpuSettingRounded = React.forwardRef<SVGSVGElement, CpuSettingRoundedProps>(
...
<path d="M16.71 18.59C17.5881 18.59 18.3 17.8781 18.3 17C18.3 16.1218 17.5881 15.41 16.71 15.41C15.8319 15.41 15.12 16.1218 15.12 17C15.12 17.8781 15.8319 18.59 16.71 18.59Z" stroke="#292D32" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
...
CpuSettingRounded.displayName = "CpuSettingRounded";
export const CpuSettingRoundedMetadata = { 
  id: "cpu-setting_rounded", 
  baseId: "cpu-setting", 
  variant: "rounded", 
  name: "Cpu Setting", 
  category: "device", 
...
export default CpuSettingRounded;
