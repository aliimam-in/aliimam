...
export interface Battery3FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const Battery3Filled = React.forwardRef<SVGSVGElement, Battery3FilledProps>(
...
Battery3Filled.displayName = "Battery3Filled";
export const Battery3FilledMetadata = { 
  id: "battery-3_filled", 
  baseId: "battery-3", 
  variant: "filled", 
  name: "Battery 3", 
