...
export const BluetoothOffMetadata = { id: "bluetooth-off", baseId: "bluetooth-off", variant: "default", name: "Bluetooth Off", category: "app", tags: [], viewBox: "0 0 24 24" } as const;
