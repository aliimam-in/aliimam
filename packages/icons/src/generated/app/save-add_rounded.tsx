...
export interface SaveAddRoundedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const SaveAddRounded = React.forwardRef<SVGSVGElement, SaveAddRoundedProps>(
...
SaveAddRounded.displayName = "SaveAddRounded";
export const SaveAddRoundedMetadata = { 
  id: "save-add_rounded", 
  baseId: "save-add", 
  variant: "rounded", 
  name: "Save Add", 
