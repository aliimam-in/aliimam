...
export interface Setting2RoundedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const Setting2Rounded = React.forwardRef<SVGSVGElement, Setting2RoundedProps>(
...
Setting2Rounded.displayName = "Setting2Rounded";
export const Setting2RoundedMetadata = { 
  id: "setting-2_rounded", 
  baseId: "setting-2", 
  variant: "rounded", 
  name: "Setting 2", 
  category: "app", 
...
export default Setting2Rounded;
