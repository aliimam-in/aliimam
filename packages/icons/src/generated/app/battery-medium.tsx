...
export const BatteryMediumMetadata = { id: "battery-medium", baseId: "battery-medium", variant: "default", name: "Battery Medium", category: "app", tags: [], viewBox: "0 0 24 24" } as const;
