...
export interface CategoryRoundedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CategoryRounded = React.forwardRef<SVGSVGElement, CategoryRoundedProps>(
...
CategoryRounded.displayName = "CategoryRounded";
export const CategoryRoundedMetadata = { 
  id: "category_rounded", 
  baseId: "category", 
  variant: "rounded", 
  name: "Category", 
