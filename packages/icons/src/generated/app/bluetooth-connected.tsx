...
export const BluetoothConnectedMetadata = { id: "bluetooth-connected", baseId: "bluetooth-connected", variant: "default", name: "Bluetooth Connected", category: "app", tags: [], viewBox: "0 0 24 24" } as const;
