...
export const BookmarkMinusMetadata = { id: "bookmark-minus", baseId: "bookmark-minus", variant: "default", name: "Bookmark Minus", category: "book", tags: [], viewBox: "0 0 24 24" } as const;
