...
export const BookOpenCheckMetadata = { id: "book-open-check", baseId: "book-open-check", variant: "default", name: "Book Open Check", category: "book", tags: [], viewBox: "0 0 24 24" } as const;
