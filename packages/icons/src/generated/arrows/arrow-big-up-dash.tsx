...
export const ArrowBigUpDashMetadata = { id: "arrow-big-up-dash", baseId: "arrow-big-up-dash", variant: "default", name: "Arrow Big Up Dash", category: "arrows", tags: [], viewBox: "0 0 24 24" } as const;
