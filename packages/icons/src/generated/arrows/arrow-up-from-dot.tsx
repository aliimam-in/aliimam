...
export const ArrowUpFromDotMetadata = { id: "arrow-up-from-dot", baseId: "arrow-up-from-dot", variant: "default", name: "Arrow Up From Dot", category: "arrows", tags: [], viewBox: "0 0 24 24" } as const;
