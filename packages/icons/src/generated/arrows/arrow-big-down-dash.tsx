...
export const ArrowBigDownDashMetadata = { id: "arrow-big-down-dash", baseId: "arrow-big-down-dash", variant: "default", name: "Arrow Big Down Dash", category: "arrows", tags: [], viewBox: "0 0 24 24" } as const;
