...
export const ArrowRightLeftMetadata = { id: "arrow-right-left", baseId: "arrow-right-left", variant: "default", name: "Arrow Right Left", category: "arrows", tags: [], viewBox: "0 0 24 24" } as const;
