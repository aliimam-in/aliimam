...
export const DecimalsArrowRightMetadata = { id: "decimals-arrow-right", baseId: "decimals-arrow-right", variant: "default", name: "Decimals Arrow Right", category: "arrows", tags: [], viewBox: "0 0 24 24" } as const;
