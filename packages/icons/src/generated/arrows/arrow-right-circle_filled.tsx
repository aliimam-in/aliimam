...
export interface ArrowRightCircleFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ArrowRightCircleFilled = React.forwardRef<SVGSVGElement, ArrowRightCircleFilledProps>(
...
export const ArrowRightCircleFilledMetadata = { id: "arrow-right-circle_filled", baseId: "arrow-right-circle", variant: "filled", name: "Arrow Right Circle", category: "arrows", tags: [], viewBox: "0 0 24 24" } as const;
