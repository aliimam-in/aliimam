...
export const ArrowDownSquareFilledMetadata = { id: "arrow-down-square_filled", baseId: "arrow-down-square", variant: "filled", name: "Arrow Down Square", category: "arrows", tags: [], viewBox: "0 0 24 24" } as const;
