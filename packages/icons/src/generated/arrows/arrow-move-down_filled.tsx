...
export const ArrowMoveDownFilledMetadata = { id: "arrow-move-down_filled", baseId: "arrow-move-down", variant: "filled", name: "Arrow Move Down", category: "arrows", tags: [], viewBox: "0 0 24 24" } as const;
