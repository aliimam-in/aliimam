...
export const ArrowBadgeDownFilledMetadata = { id: "arrow-badge-down_filled", baseId: "arrow-badge-down", variant: "filled", name: "Arrow Badge Down", category: "arrows", tags: [], viewBox: "0 0 24 24" } as const;
