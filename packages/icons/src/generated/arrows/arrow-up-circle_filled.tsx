...
export interface ArrowUpCircleFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ArrowUpCircleFilled = React.forwardRef<SVGSVGElement, ArrowUpCircleFilledProps>(
...
export const ArrowUpCircleFilledMetadata = { id: "arrow-up-circle_filled", baseId: "arrow-up-circle", variant: "filled", name: "Arrow Up Circle", category: "arrows", tags: [], viewBox: "0 0 24 24" } as const;
