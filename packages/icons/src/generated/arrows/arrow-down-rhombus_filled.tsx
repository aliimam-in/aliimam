...
export const ArrowDownRhombusFilledMetadata = { id: "arrow-down-rhombus_filled", baseId: "arrow-down-rhombus", variant: "filled", name: "Arrow Down Rhombus", category: "arrows", tags: [], viewBox: "0 0 24 24" } as const;
