...
export interface ArrowAutofitContentFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ArrowAutofitContentFilled = React.forwardRef<SVGSVGElement, ArrowAutofitContentFilledProps>(
...
ArrowAutofitContentFilled.displayName = "ArrowAutofitContentFilled";
export const ArrowAutofitContentFilledMetadata = { id: "arrow-autofit-content_filled", baseId: "arrow-autofit-content", variant: "filled", name: "Arrow Autofit Content", category: "arrows", tags: [], viewBox: "0 0 24 24" } as const;
