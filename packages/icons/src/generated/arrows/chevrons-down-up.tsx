...
export const ChevronsDownUpMetadata = { id: "chevrons-down-up", baseId: "chevrons-down-up", variant: "default", name: "Chevrons Down Up", category: "arrows", tags: [], viewBox: "0 0 24 24" } as const;
