...
export const ArrowBigDownLinesFilledMetadata = { id: "arrow-big-down-lines_filled", baseId: "arrow-big-down-lines", variant: "filled", name: "Arrow Big Down Lines", category: "arrows", tags: [], viewBox: "0 0 24 24" } as const;
