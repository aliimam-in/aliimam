...
export const ArrowDownCircleFilledMetadata = { id: "arrow-down-circle_filled", baseId: "arrow-down-circle", variant: "filled", name: "Arrow Down Circle", category: "arrows", tags: [], viewBox: "0 0 24 24" } as const;
