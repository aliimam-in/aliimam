...
export const ArrowUpToLineMetadata = { id: "arrow-up-to-line", baseId: "arrow-up-to-line", variant: "default", name: "Arrow Up To Line", category: "arrows", tags: [], viewBox: "0 0 24 24" } as const;
