...
export interface ArrowAutofitWidthFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ArrowAutofitWidthFilled = React.forwardRef<SVGSVGElement, ArrowAutofitWidthFilledProps>(
...
ArrowAutofitWidthFilled.displayName = "ArrowAutofitWidthFilled";
export const ArrowAutofitWidthFilledMetadata = { id: "arrow-autofit-width_filled", baseId: "arrow-autofit-width", variant: "filled", name: "Arrow Autofit Width", category: "arrows", tags: [], viewBox: "0 0 24 24" } as const;
