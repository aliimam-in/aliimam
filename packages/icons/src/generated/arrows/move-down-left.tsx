...
export const MoveDownLeftMetadata = { id: "move-down-left", baseId: "move-down-left", variant: "default", name: "Move Down Left", category: "arrows", tags: [], viewBox: "0 0 24 24" } as const;
