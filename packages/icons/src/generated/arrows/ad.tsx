...
export interface AdProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const Ad = React.forwardRef<SVGSVGElement, AdProps>(
...
Ad.displayName = "Ad";
export const AdMetadata = { id: "ad", baseId: "ad", variant: "default", name: "Ad", category: "arrows", tags: [], viewBox: "0 0 24 24" } as const;
export default Ad;
