...
export const ArrowUpSquareFilledMetadata = { id: "arrow-up-square_filled", baseId: "arrow-up-square", variant: "filled", name: "Arrow Up Square", category: "arrows", tags: [], viewBox: "0 0 24 24" } as const;
