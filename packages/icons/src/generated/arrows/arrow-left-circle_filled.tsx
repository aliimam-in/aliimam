...
export interface ArrowLeftCircleFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ArrowLeftCircleFilled = React.forwardRef<SVGSVGElement, ArrowLeftCircleFilledProps>(
...
export const ArrowLeftCircleFilledMetadata = { id: "arrow-left-circle_filled", baseId: "arrow-left-circle", variant: "filled", name: "Arrow Left Circle", category: "arrows", tags: [], viewBox: "0 0 24 24" } as const;
