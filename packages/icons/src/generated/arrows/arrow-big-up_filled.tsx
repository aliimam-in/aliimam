...
export const ArrowBigUpFilledMetadata = { id: "arrow-big-up_filled", baseId: "arrow-big-up", variant: "filled", name: "Arrow Big Up", category: "arrows", tags: [], viewBox: "0 0 24 24" } as const;
