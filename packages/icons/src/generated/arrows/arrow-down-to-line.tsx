...
export const ArrowDownToLineMetadata = { id: "arrow-down-to-line", baseId: "arrow-down-to-line", variant: "default", name: "Arrow Down To Line", category: "arrows", tags: [], viewBox: "0 0 24 24" } as const;
