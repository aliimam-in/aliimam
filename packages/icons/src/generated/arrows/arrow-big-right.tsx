...
export const ArrowBigRightMetadata = { id: "arrow-big-right", baseId: "arrow-big-right", variant: "default", name: "Arrow Big Right", category: "arrows", tags: [], viewBox: "0 0 24 24" } as const;
