...
export const ArrowBadgeUpFilledMetadata = { id: "arrow-badge-up_filled", baseId: "arrow-badge-up", variant: "filled", name: "Arrow Badge Up", category: "arrows", tags: [], viewBox: "0 0 24 24" } as const;
