...
export const ArrowBadgeRightFilledMetadata = { id: "arrow-badge-right_filled", baseId: "arrow-badge-right", variant: "filled", name: "Arrow Badge Right", category: "arrows", tags: [], viewBox: "0 0 24 24" } as const;
