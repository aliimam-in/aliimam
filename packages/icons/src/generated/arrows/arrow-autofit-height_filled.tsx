...
export interface ArrowAutofitHeightFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ArrowAutofitHeightFilled = React.forwardRef<SVGSVGElement, ArrowAutofitHeightFilledProps>(
...
ArrowAutofitHeightFilled.displayName = "ArrowAutofitHeightFilled";
export const ArrowAutofitHeightFilledMetadata = { id: "arrow-autofit-height_filled", baseId: "arrow-autofit-height", variant: "filled", name: "Arrow Autofit Height", category: "arrows", tags: [], viewBox: "0 0 24 24" } as const;
