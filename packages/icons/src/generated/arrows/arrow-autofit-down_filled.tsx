...
export interface ArrowAutofitDownFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ArrowAutofitDownFilled = React.forwardRef<SVGSVGElement, ArrowAutofitDownFilledProps>(
...
ArrowAutofitDownFilled.displayName = "ArrowAutofitDownFilled";
export const ArrowAutofitDownFilledMetadata = { id: "arrow-autofit-down_filled", baseId: "arrow-autofit-down", variant: "filled", name: "Arrow Autofit Down", category: "arrows", tags: [], viewBox: "0 0 24 24" } as const;
