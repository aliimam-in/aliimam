...
export const ArrowUpRhombusFilledMetadata = { id: "arrow-up-rhombus_filled", baseId: "arrow-up-rhombus", variant: "filled", name: "Arrow Up Rhombus", category: "arrows", tags: [], viewBox: "0 0 24 24" } as const;
