...
export const ArrowBigLeftLineFilledMetadata = { id: "arrow-big-left-line_filled", baseId: "arrow-big-left-line", variant: "filled", name: "Arrow Big Left Line", category: "arrows", tags: [], viewBox: "0 0 24 24" } as const;
