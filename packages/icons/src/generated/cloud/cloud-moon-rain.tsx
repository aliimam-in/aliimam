...
export const CloudMoonRainMetadata = { id: "cloud-moon-rain", baseId: "cloud-moon-rain", variant: "default", name: "Cloud Moon Rain", category: "cloud", tags: [], viewBox: "0 0 24 24" } as const;
