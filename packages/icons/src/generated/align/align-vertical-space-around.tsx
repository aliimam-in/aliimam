...
export const AlignVerticalSpaceAroundMetadata = { id: "align-vertical-space-around", baseId: "align-vertical-space-around", variant: "default", name: "Align Vertical Space Around", category: "align", tags: [], viewBox: "0 0 24 24" } as const;
