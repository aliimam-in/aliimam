...
export const AlignHorizontalJustifyCenterMetadata = { id: "align-horizontal-justify-center", baseId: "align-horizontal-justify-center", variant: "default", name: "Align Horizontal Justify Center", category: "align", tags: [], viewBox: "0 0 24 24" } as const;
