...
export const AlignHorizontalSpaceAroundMetadata = { id: "align-horizontal-space-around", baseId: "align-horizontal-space-around", variant: "default", name: "Align Horizontal Space Around", category: "align", tags: [], viewBox: "0 0 24 24" } as const;
