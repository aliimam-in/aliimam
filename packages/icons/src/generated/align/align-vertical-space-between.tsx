...
export const AlignVerticalSpaceBetweenMetadata = { id: "align-vertical-space-between", baseId: "align-vertical-space-between", variant: "default", name: "Align Vertical Space Between", category: "align", tags: [], viewBox: "0 0 24 24" } as const;
