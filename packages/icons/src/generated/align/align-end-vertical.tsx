...
export const AlignEndVerticalMetadata = { id: "align-end-vertical", baseId: "align-end-vertical", variant: "default", name: "Align End Vertical", category: "align", tags: [], viewBox: "0 0 24 24" } as const;
