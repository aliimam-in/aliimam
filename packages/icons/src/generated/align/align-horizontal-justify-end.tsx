...
export const AlignHorizontalJustifyEndMetadata = { id: "align-horizontal-justify-end", baseId: "align-horizontal-justify-end", variant: "default", name: "Align Horizontal Justify End", category: "align", tags: [], viewBox: "0 0 24 24" } as const;
