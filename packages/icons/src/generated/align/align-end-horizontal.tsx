...
export const AlignEndHorizontalMetadata = { id: "align-end-horizontal", baseId: "align-end-horizontal", variant: "default", name: "Align End Horizontal", category: "align", tags: [], viewBox: "0 0 24 24" } as const;
