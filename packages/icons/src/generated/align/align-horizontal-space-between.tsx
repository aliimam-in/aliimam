...
export const AlignHorizontalSpaceBetweenMetadata = { id: "align-horizontal-space-between", baseId: "align-horizontal-space-between", variant: "default", name: "Align Horizontal Space Between", category: "align", tags: [], viewBox: "0 0 24 24" } as const;
