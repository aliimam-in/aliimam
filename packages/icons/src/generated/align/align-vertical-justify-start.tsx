...
export const AlignVerticalJustifyStartMetadata = { id: "align-vertical-justify-start", baseId: "align-vertical-justify-start", variant: "default", name: "Align Vertical Justify Start", category: "align", tags: [], viewBox: "0 0 24 24" } as const;
