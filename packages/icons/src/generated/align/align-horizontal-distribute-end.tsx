...
export const AlignHorizontalDistributeEndMetadata = { id: "align-horizontal-distribute-end", baseId: "align-horizontal-distribute-end", variant: "default", name: "Align Horizontal Distribute End", category: "align", tags: [], viewBox: "0 0 24 24" } as const;
