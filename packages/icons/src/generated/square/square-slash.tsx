...
export const SquareSlashMetadata = { id: "square-slash", baseId: "square-slash", variant: "default", name: "Square Slash", category: "square", tags: [], viewBox: "0 0 24 24" } as const;
