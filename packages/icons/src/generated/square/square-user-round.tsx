...
export const SquareUserRoundMetadata = { id: "square-user-round", baseId: "square-user-round", variant: "default", name: "Square User Round", category: "square", tags: [], viewBox: "0 0 24 24" } as const;
