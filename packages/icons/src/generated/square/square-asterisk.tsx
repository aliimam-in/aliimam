...
export const SquareAsteriskMetadata = { id: "square-asterisk", baseId: "square-asterisk", variant: "default", name: "Square Asterisk", category: "square", tags: [], viewBox: "0 0 24 24" } as const;
