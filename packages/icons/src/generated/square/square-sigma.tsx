...
export const SquareSigmaMetadata = { id: "square-sigma", baseId: "square-sigma", variant: "default", name: "Square Sigma", category: "square", tags: [], viewBox: "0 0 24 24" } as const;
