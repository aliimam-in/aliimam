...
export const SquareArrowOutDownRightMetadata = { id: "square-arrow-out-down-right", baseId: "square-arrow-out-down-right", variant: "default", name: "Square Arrow Out Down Right", category: "square", tags: [], viewBox: "0 0 24 24" } as const;
