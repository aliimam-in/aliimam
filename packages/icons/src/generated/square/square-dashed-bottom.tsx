...
export const SquareDashedBottomMetadata = { id: "square-dashed-bottom", baseId: "square-dashed-bottom", variant: "default", name: "Square Dashed Bottom", category: "square", tags: [], viewBox: "0 0 24 24" } as const;
