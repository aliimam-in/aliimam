...
export const SquareParkingMetadata = { id: "square-parking", baseId: "square-parking", variant: "default", name: "Square Parking", category: "square", tags: [], viewBox: "0 0 24 24" } as const;
