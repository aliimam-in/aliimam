...
export const SquaresSubtractMetadata = { id: "squares-subtract", baseId: "squares-subtract", variant: "default", name: "Squares Subtract", category: "square", tags: [], viewBox: "0 0 24 24" } as const;
