...
export const SquareChevronUpMetadata = { id: "square-chevron-up", baseId: "square-chevron-up", variant: "default", name: "Square Chevron Up", category: "square", tags: [], viewBox: "0 0 24 24" } as const;
