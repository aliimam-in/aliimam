...
export const SquaresUniteMetadata = { id: "squares-unite", baseId: "squares-unite", variant: "default", name: "Squares Unite", category: "square", tags: [], viewBox: "0 0 24 24" } as const;
