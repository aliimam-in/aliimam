...
export const SquareArrowRightMetadata = { id: "square-arrow-right", baseId: "square-arrow-right", variant: "default", name: "Square Arrow Right", category: "square", tags: [], viewBox: "0 0 24 24" } as const;
