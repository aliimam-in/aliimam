...
export const SquareMinusMetadata = { id: "square-minus", baseId: "square-minus", variant: "default", name: "Square Minus", category: "square", tags: [], viewBox: "0 0 24 24" } as const;
