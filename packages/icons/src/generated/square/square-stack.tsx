...
export const SquareStackMetadata = { id: "square-stack", baseId: "square-stack", variant: "default", name: "Square Stack", category: "square", tags: [], viewBox: "0 0 24 24" } as const;
