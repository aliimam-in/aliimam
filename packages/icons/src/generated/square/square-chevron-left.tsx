...
export const SquareChevronLeftMetadata = { id: "square-chevron-left", baseId: "square-chevron-left", variant: "default", name: "Square Chevron Left", category: "square", tags: [], viewBox: "0 0 24 24" } as const;
