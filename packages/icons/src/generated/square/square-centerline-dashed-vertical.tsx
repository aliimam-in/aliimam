...
export const SquareCenterlineDashedVerticalMetadata = { id: "square-centerline-dashed-vertical", baseId: "square-centerline-dashed-vertical", variant: "default", name: "Square Centerline Dashed Vertical", category: "square", tags: [], viewBox: "0 0 24 24" } as const;
