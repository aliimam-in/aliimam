...
export const SquareDivideMetadata = { id: "square-divide", baseId: "square-divide", variant: "default", name: "Square Divide", category: "square", tags: [], viewBox: "0 0 24 24" } as const;
