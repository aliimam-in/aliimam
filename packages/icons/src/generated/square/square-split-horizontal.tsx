...
export const SquareSplitHorizontalMetadata = { id: "square-split-horizontal", baseId: "square-split-horizontal", variant: "default", name: "Square Split Horizontal", category: "square", tags: [], viewBox: "0 0 24 24" } as const;
