...
export const SquareScissorsMetadata = { id: "square-scissors", baseId: "square-scissors", variant: "default", name: "Square Scissors", category: "square", tags: [], viewBox: "0 0 24 24" } as const;
