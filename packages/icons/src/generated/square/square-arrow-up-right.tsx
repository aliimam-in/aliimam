...
export const SquareArrowUpRightMetadata = { id: "square-arrow-up-right", baseId: "square-arrow-up-right", variant: "default", name: "Square Arrow Up Right", category: "square", tags: [], viewBox: "0 0 24 24" } as const;
