...
export const SquaresIntersectMetadata = { id: "squares-intersect", baseId: "squares-intersect", variant: "default", name: "Squares Intersect", category: "square", tags: [], viewBox: "0 0 24 24" } as const;
