...
export const SquareDashedMousePointerMetadata = { id: "square-dashed-mouse-pointer", baseId: "square-dashed-mouse-pointer", variant: "default", name: "Square Dashed Mouse Pointer", category: "square", tags: [], viewBox: "0 0 24 24" } as const;
