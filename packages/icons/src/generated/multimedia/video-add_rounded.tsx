...
export interface VideoAddRoundedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const VideoAddRounded = React.forwardRef<SVGSVGElement, VideoAddRoundedProps>(
...
<path d="M18.5 16.84V20.2" stroke="#292D32" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  )
);
VideoAddRounded.displayName = "VideoAddRounded";
export const VideoAddRoundedMetadata = { 
  id: "video-add_rounded", 
  baseId: "video-add", 
  variant: "rounded", 
  name: "Video Add", 
  category: "multimedia", 
...
export default VideoAddRounded;
