...
export const MegaphoneOffMetadata = { id: "megaphone-off", baseId: "megaphone-off", variant: "default", name: "Megaphone Off", category: "multimedia", tags: [], viewBox: "0 0 24 24" } as const;
