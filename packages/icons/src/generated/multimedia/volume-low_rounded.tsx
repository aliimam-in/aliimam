...
export interface VolumeLowRoundedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const VolumeLowRounded = React.forwardRef<SVGSVGElement, VolumeLowRoundedProps>(
...
VolumeLowRounded.displayName = "VolumeLowRounded";
export const VolumeLowRoundedMetadata = { 
  id: "volume-low_rounded", 
  baseId: "volume-low", 
  variant: "rounded", 
  name: "Volume Low", 
  category: "multimedia", 
...
export default VolumeLowRounded;
