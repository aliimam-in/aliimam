...
export interface VideoRemoveRoundedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const VideoRemoveRounded = React.forwardRef<SVGSVGElement, VideoRemoveRoundedProps>(
...
<path d="M19.7001 19.68L17.3201 17.3" stroke="#292D32" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M19.68 17.32L17.3 19.7" stroke="#292D32" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  )
);
VideoRemoveRounded.displayName = "VideoRemoveRounded";
export const VideoRemoveRoundedMetadata = { 
  id: "video-remove_rounded", 
  baseId: "video-remove", 
  variant: "rounded", 
  name: "Video Remove", 
  category: "multimedia", 
...
export default VideoRemoveRounded;
