...
export interface VideoTickRoundedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const VideoTickRounded = React.forwardRef<SVGSVGElement, VideoTickRoundedProps>(
...
<path d="M16.75 18.5L17.86 19.61L20.26 17.39" stroke="#292D32" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  )
);
VideoTickRounded.displayName = "VideoTickRounded";
export const VideoTickRoundedMetadata = { 
  id: "video-tick_rounded", 
  baseId: "video-tick", 
  variant: "rounded", 
  name: "Video Tick", 
  category: "multimedia", 
...
export default VideoTickRounded;
