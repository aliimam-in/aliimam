...
export const ClapperboardMetadata = { id: "clapperboard", baseId: "clapperboard", variant: "default", name: "Clapperboard", category: "multimedia", tags: [], viewBox: "0 0 24 24" } as const;
