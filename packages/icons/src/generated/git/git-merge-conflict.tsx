...
export const GitMergeConflictMetadata = { id: "git-merge-conflict", baseId: "git-merge-conflict", variant: "default", name: "Git Merge Conflict", category: "git", tags: [], viewBox: "0 0 24 24" } as const;
