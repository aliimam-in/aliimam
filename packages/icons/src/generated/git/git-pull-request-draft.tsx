...
export const GitPullRequestDraftMetadata = { id: "git-pull-request-draft", baseId: "git-pull-request-draft", variant: "default", name: "Git Pull Request Draft", category: "git", tags: [], viewBox: "0 0 24 24" } as const;
