/**
 * Auto-generated logo component: Radiation (default)
 * Category: mix
...
export interface RadiationLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const RadiationLogo = React.forwardRef<SVGSVGElement, RadiationLogoProps>(
...
RadiationLogo.displayName = "RadiationLogo";

export const RadiationLogoMetadata = {
  id: "radiation",
  baseId: "radiation",
  variant: "default",
  name: "Radiation",
