/**
 * Auto-generated logo component: Panda (default)
 * Category: mix
...
export interface PandaLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const PandaLogo = React.forwardRef<SVGSVGElement, PandaLogoProps>(
...
export const PandaLogoMetadata = {
  id: "panda",
  baseId: "panda",
  variant: "default",
  name: "Panda",
