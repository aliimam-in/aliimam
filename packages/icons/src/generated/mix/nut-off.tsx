/**
 * Auto-generated logo component: Nut Off (default)
 * Category: mix
...
export interface NutOffLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const NutOffLogo = React.forwardRef<SVGSVGElement, NutOffLogoProps>(
...
NutOffLogo.displayName = "NutOffLogo";

export const NutOffLogoMetadata = {
  id: "nut-off",
  baseId: "nut-off",
  variant: "default",
  name: "Nut Off",
