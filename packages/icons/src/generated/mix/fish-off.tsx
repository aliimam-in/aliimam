/**
 * Auto-generated logo component: Fish Off (default)
 * Category: mix
...
export interface FishOffLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const FishOffLogo = React.forwardRef<SVGSVGElement, FishOffLogoProps>(
...
FishOffLogo.displayName = "FishOffLogo";

export const FishOffLogoMetadata = {
  id: "fish-off",
  baseId: "fish-off",
  variant: "default",
  name: "Fish Off",
