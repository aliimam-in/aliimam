/**
 * Auto-generated logo component: Shovel (default)
 * Category: mix
...
export interface ShovelLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const ShovelLogo = React.forwardRef<SVGSVGElement, ShovelLogoProps>(
...
ShovelLogo.displayName = "ShovelLogo";

export const ShovelLogoMetadata = {
  id: "shovel",
  baseId: "shovel",
  variant: "default",
  name: "Shovel",
