...
export interface AirplaneSquareRoundedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const AirplaneSquareRounded = React.forwardRef<SVGSVGElement, AirplaneSquareRoundedProps>(
...
export default AirplaneSquareRounded;
