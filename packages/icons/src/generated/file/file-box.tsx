...
export interface FileBoxProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const FileBox = React.forwardRef<SVGSVGElement, FileBoxProps>(
...
export const FileBoxMetadata = { id: "file-box", baseId: "file-box", variant: "default", name: "File Box", category: "file", tags: [], viewBox: "0 0 24 24" } as const;
