...
export const FileChartPieMetadata = { id: "file-chart-pie", baseId: "file-chart-pie", variant: "default", name: "File Chart Pie", category: "file", tags: [], viewBox: "0 0 24 24" } as const;
