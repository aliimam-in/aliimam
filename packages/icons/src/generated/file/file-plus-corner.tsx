...
export const FilePlusCornerMetadata = { id: "file-plus-corner", baseId: "file-plus-corner", variant: "default", name: "File Plus Corner", category: "file", tags: [], viewBox: "0 0 24 24" } as const;
