...
export const FileHeadphoneMetadata = { id: "file-headphone", baseId: "file-headphone", variant: "default", name: "File Headphone", category: "file", tags: [], viewBox: "0 0 24 24" } as const;
