...
export interface ShopAddRoundedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ShopAddRounded = React.forwardRef<SVGSVGElement, ShopAddRoundedProps>(
...
ShopAddRounded.displayName = "ShopAddRounded";
export const ShopAddRoundedMetadata = { 
  id: "shop-add_rounded", 
  baseId: "shop-add", 
  variant: "rounded", 
  name: "Shop Add", 
