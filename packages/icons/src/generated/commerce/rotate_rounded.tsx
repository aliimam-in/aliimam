...
export interface RotateRoundedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const RotateRounded = React.forwardRef<SVGSVGElement, RotateRoundedProps>(
...
RotateRounded.displayName = "RotateRounded";
export const RotateRoundedMetadata = { 
  id: "rotate_rounded", 
  baseId: "rotate", 
  variant: "rounded", 
  name: "Rotate", 
