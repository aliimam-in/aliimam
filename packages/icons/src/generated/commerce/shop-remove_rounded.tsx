...
export interface ShopRemoveRoundedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ShopRemoveRounded = React.forwardRef<SVGSVGElement, ShopRemoveRoundedProps>(
...
ShopRemoveRounded.displayName = "ShopRemoveRounded";
export const ShopRemoveRoundedMetadata = { 
  id: "shop-remove_rounded", 
  baseId: "shop-remove", 
  variant: "rounded", 
  name: "Shop Remove", 
  category: "commerce", 
...
export default ShopRemoveRounded;
