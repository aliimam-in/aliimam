...
export interface BoxTimeRoundedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const BoxTimeRounded = React.forwardRef<SVGSVGElement, BoxTimeRoundedProps>(
...
BoxTimeRounded.displayName = "BoxTimeRounded";
export const BoxTimeRoundedMetadata = { 
  id: "box-time_rounded", 
  baseId: "box-time", 
  variant: "rounded", 
  name: "Box Time", 
