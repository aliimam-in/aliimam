...
export interface OmegaCircle1RoundedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const OmegaCircle1Rounded = React.forwardRef<SVGSVGElement, OmegaCircle1RoundedProps>(
...
OmegaCircle1Rounded.displayName = "OmegaCircle1Rounded";
export const OmegaCircle1RoundedMetadata = { 
  id: "omega-circle-1_rounded", 
  baseId: "omega-circle-1", 
  variant: "rounded", 
  name: "Omega Circle 1", 
  category: "design", 
  tags: [], 
...
export default OmegaCircle1Rounded;
