...
export interface ZoomOutAreaFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ZoomOutAreaFilled = React.forwardRef<SVGSVGElement, ZoomOutAreaFilledProps>(
...
ZoomOutAreaFilled.displayName = "ZoomOutAreaFilled";
export const ZoomOutAreaFilledMetadata = { 
  id: "zoom-out-area_filled", 
  baseId: "zoom-out-area", 
  variant: "filled", 
  name: "Zoom Out Area", 
  category: "design", 
  tags: [], 
