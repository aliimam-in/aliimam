...
export interface OmegaSquare1RoundedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const OmegaSquare1Rounded = React.forwardRef<SVGSVGElement, OmegaSquare1RoundedProps>(
...
OmegaSquare1Rounded.displayName = "OmegaSquare1Rounded";
export const OmegaSquare1RoundedMetadata = { 
  id: "omega-square-1_rounded", 
  baseId: "omega-square-1", 
  variant: "rounded", 
  name: "Omega Square 1", 
  category: "design", 
  tags: [], 
...
export default OmegaSquare1Rounded;
