...
export const DraftingCompassMetadata = { id: "drafting-compass", baseId: "drafting-compass", variant: "default", name: "Drafting Compass", category: "design", tags: [], viewBox: "0 0 24 24" } as const;
