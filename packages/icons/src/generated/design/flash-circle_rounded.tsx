...
export interface FlashCircleRoundedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const FlashCircleRounded = React.forwardRef<SVGSVGElement, FlashCircleRoundedProps>(
...
FlashCircleRounded.displayName = "FlashCircleRounded";
export const FlashCircleRoundedMetadata = { 
  id: "flash-circle_rounded", 
  baseId: "flash-circle", 
  variant: "rounded", 
  name: "Flash Circle", 
  category: "design", 
...
export default FlashCircleRounded;
