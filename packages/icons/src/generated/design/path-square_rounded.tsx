...
export interface PathSquareRoundedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const PathSquareRounded = React.forwardRef<SVGSVGElement, PathSquareRoundedProps>(
...
PathSquareRounded.displayName = "PathSquareRounded";
export const PathSquareRoundedMetadata = { 
  id: "path-square_rounded", 
  baseId: "path-square", 
  variant: "rounded", 
  name: "Path Square", 
  category: "design", 
...
export default PathSquareRounded;
