...
export const ArchiveRestoreMetadata = { id: "archive-restore", baseId: "archive-restore", variant: "default", name: "Archive Restore", category: "design", tags: [], viewBox: "0 0 24 24" } as const;
