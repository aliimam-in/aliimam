...
export const PaintbrushVerticalMetadata = { id: "paintbrush-vertical", baseId: "paintbrush-vertical", variant: "default", name: "Paintbrush Vertical", category: "design", tags: [], viewBox: "0 0 24 24" } as const;
