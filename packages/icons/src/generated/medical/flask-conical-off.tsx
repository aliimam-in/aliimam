...
export const FlaskConicalOffMetadata = { id: "flask-conical-off", baseId: "flask-conical-off", variant: "default", name: "Flask Conical Off", category: "medical", tags: [], viewBox: "0 0 24 24" } as const;
