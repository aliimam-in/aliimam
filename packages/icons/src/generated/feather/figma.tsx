...
export interface FigmaLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const FigmaLogo = React.forwardRef<SVGSVGElement, FigmaLogoProps>(
...
export const FigmaLogoMetadata = {
  id: "figma",
  baseId: "figma",
  variant: "default",
  name: "Figma",
