...
export const ClockArrowDownMetadata = { id: "clock-arrow-down", baseId: "clock-arrow-down", variant: "default", name: "Clock Arrow Down", category: "clock", tags: [], viewBox: "0 0 24 24" } as const;
