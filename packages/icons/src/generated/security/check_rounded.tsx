...
export interface CheckRoundedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CheckRounded = React.forwardRef<SVGSVGElement, CheckRoundedProps>(
...
CheckRounded.displayName = "CheckRounded";
export const CheckRoundedMetadata = { 
  id: "check_rounded", 
  baseId: "check", 
  variant: "rounded", 
  name: "Check", 
