...
export interface EyeSlashRoundedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const EyeSlashRounded = React.forwardRef<SVGSVGElement, EyeSlashRoundedProps>(
...
EyeSlashRounded.displayName = "EyeSlashRounded";
export const EyeSlashRoundedMetadata = { 
  id: "eye-slash_rounded", 
  baseId: "eye-slash", 
  variant: "rounded", 
  name: "Eye Slash", 
  category: "security", 
...
export default EyeSlashRounded;
