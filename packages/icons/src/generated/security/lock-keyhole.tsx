...
export const LockKeyholeMetadata = { id: "lock-keyhole", baseId: "lock-keyhole", variant: "default", name: "Lock Keyhole", category: "security", tags: [], viewBox: "0 0 24 24" } as const;
