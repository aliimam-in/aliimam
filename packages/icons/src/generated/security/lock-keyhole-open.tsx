...
export const LockKeyholeOpenMetadata = { id: "lock-keyhole-open", baseId: "lock-keyhole-open", variant: "default", name: "Lock Keyhole Open", category: "security", tags: [], viewBox: "0 0 24 24" } as const;
