...
export interface TheGraphGrtRoundedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const TheGraphGrtRounded = React.forwardRef<SVGSVGElement, TheGraphGrtRoundedProps>(
...
TheGraphGrtRounded.displayName = "TheGraphGrtRounded";
export const TheGraphGrtRoundedMetadata = { 
  id: "the-graph-grt_rounded", 
  baseId: "the-graph-grt", 
  variant: "rounded", 
  name: "The Graph Grt", 
  category: "brand", 
  tags: [], 
...
export default TheGraphGrtRounded;
