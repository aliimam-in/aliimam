...
export interface OceanProtocolOceanRoundedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const OceanProtocolOceanRounded = React.forwardRef<SVGSVGElement, OceanProtocolOceanRoundedProps>(
...
OceanProtocolOceanRounded.displayName = "OceanProtocolOceanRounded";
export const OceanProtocolOceanRoundedMetadata = { 
  id: "ocean-protocol-ocean_rounded", 
  baseId: "ocean-protocol-ocean", 
  variant: "rounded", 
...
export default OceanProtocolOceanRounded;
