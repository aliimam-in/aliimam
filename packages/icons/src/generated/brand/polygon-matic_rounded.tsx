...
export const PolygonMaticRounded = React.forwardRef<SVGSVGElement, PolygonMaticRoundedProps>(
  ({ size = 24, className = '', strokeWidth = 1, ...props }, ref) => (
    <svg 
      ...
      {...props}
    >
      <path d="M12 12.1L7.5 14.7L3 12.1V6.89999L7.5 4.29999L12 6.89999V8.49999" stroke="#17191C" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
