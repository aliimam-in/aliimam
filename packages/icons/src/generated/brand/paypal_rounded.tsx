...
export interface PaypalRoundedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const PaypalRounded = React.forwardRef<SVGSVGElement, PaypalRoundedProps>(
...
PaypalRounded.displayName = "PaypalRounded";
export const PaypalRoundedMetadata = { 
  id: "paypal_rounded", 
  baseId: "paypal", 
  variant: "rounded", 
  name: "Paypal", 
