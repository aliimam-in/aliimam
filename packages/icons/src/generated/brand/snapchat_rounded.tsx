...
export interface SnapchatRoundedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const SnapchatRounded = React.forwardRef<SVGSVGElement, SnapchatRoundedProps>(
...
SnapchatRounded.displayName = "SnapchatRounded";
export const SnapchatRoundedMetadata = { 
  id: "snapchat_rounded", 
  baseId: "snapchat", 
  variant: "rounded", 
  name: "Snapchat", 
...
export default SnapchatRounded;
