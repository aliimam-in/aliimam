...
export interface HarmonyOneRoundedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const HarmonyOneRounded = React.forwardRef<SVGSVGElement, HarmonyOneRoundedProps>(
...
<path d="M10 12.1C10.6 12 11.3 12 12 12C12.7 12 13.4 12 14 11.9" stroke="#17191C" strokeWidth="1.5" strokeMiterlimit="10"/>
    </svg>
  )
);
HarmonyOneRounded.displayName = "HarmonyOneRounded";
export const HarmonyOneRoundedMetadata = { 
  id: "harmony-one_rounded", 
  baseId: "harmony-one", 
  variant: "rounded", 
  name: "Harmony One", 
  category: "brand", 
...
export default HarmonyOneRounded;
