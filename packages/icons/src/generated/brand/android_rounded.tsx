...
export interface AndroidRoundedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const AndroidRounded = React.forwardRef<SVGSVGElement, AndroidRoundedProps>(
...
AndroidRounded.displayName = "AndroidRounded";
export const AndroidRoundedMetadata = { 
  id: "android_rounded", 
  baseId: "android", 
  variant: "rounded", 
  name: "Android", 
