...
export const NemXemRounded = React.forwardRef<SVGSVGElement, NemXemRoundedProps>(
  ({ size = 24, className = '', strokeWidth = 1, ...props }, ref) => (
    <svg 
      ...
      {...props}
    >
      <path d="M2 4.99998C2 4.99998 12 -1.00002 22 4.99998C22 4.99998 22 16 12 22C12 22 2 17 2 4.99998Z" stroke="#17191C" strokeWidth="1.5" strokeMiterlimit="10"/>
<path d="M2.1001 7.09999C5.2001 17.1 12.0001 9.99999 12.0001 9.99999C11.0001 3.99999 16.1001 2.89999 16.1001 2.89999L16.7001 2.79999" stroke="#17191C" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
