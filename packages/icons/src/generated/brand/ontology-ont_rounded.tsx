...
export const OntologyOntRounded = React.forwardRef<SVGSVGElement, OntologyOntRoundedProps>(
  ({ size = 24, className = '', strokeWidth = 1, ...props }, ref) => (
    <svg 
      ...
      {...props}
    >
      <path d="M17.9 19.7C16.2 21.2 13.9 22.1 11.4 22C6.19995 21.9 2.19995 17.4 2.19995 12.2V5.19997C2.19995 4.79997 2.69995 4.49997 3.09995 4.79997L17.9 19.7Z" stroke="#17191C" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
