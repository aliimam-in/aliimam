...
export interface FishOffProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const FishOff = React.forwardRef<SVGSVGElement, FishOffProps>(
...
export const FishOffMetadata = { id: "fish-off", baseId: "fish-off", variant: "default", name: "Fish Off", category: "animal", tags: [], viewBox: "0 0 24 24" } as const;
