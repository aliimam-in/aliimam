...
export interface EditRoundedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const EditRounded = React.forwardRef<SVGSVGElement, EditRoundedProps>(
...
export const EditRoundedMetadata = { 
  id: "edit_rounded", 
  baseId: "edit", 
  variant: "rounded", 
  name: "Edit", 
