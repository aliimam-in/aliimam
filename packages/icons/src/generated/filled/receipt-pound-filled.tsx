/**
 * Auto-generated logo component: Receipt Pound Filled (default)
 * Category: filled
...
export interface ReceiptPoundFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const ReceiptPoundFilledLogo = React.forwardRef<SVGSVGElement, ReceiptPoundFilledLogoProps>(
...
ReceiptPoundFilledLogo.displayName = "ReceiptPoundFilledLogo";

export const ReceiptPoundFilledLogoMetadata = {
  id: "receipt-pound-filled",
  baseId: "receipt-pound-filled",
  variant: "default",
...
export default ReceiptPoundFilledLogo;
