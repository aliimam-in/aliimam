/**
 * Auto-generated logo component: Calendar Week Filled (default)
 * Category: filled
...
export interface CalendarWeekFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const CalendarWeekFilledLogo = React.forwardRef<SVGSVGElement, CalendarWeekFilledLogoProps>(
...
CalendarWeekFilledLogo.displayName = "CalendarWeekFilledLogo";

export const CalendarWeekFilledLogoMetadata = {
  id: "calendar-week-filled",
  baseId: "calendar-week-filled",
  variant: "default",
...
export default CalendarWeekFilledLogo;
