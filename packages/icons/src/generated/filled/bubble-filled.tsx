/**
 * Auto-generated logo component: Bubble Filled (default)
 * Category: filled
...
export interface BubbleFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const BubbleFilledLogo = React.forwardRef<SVGSVGElement, BubbleFilledLogoProps>(
...
BubbleFilledLogo.displayName = "BubbleFilledLogo";

export const BubbleFilledLogoMetadata = {
  id: "bubble-filled",
  baseId: "bubble-filled",
  variant: "default",
  name: "Bubble Filled",
  category: "filled",
  tags: [],
...
export default BubbleFilledLogo;
