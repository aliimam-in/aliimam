/**
 * Auto-generated logo component: Cherry Filled (default)
 * Category: filled
...
export interface CherryFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const CherryFilledLogo = React.forwardRef<SVGSVGElement, CherryFilledLogoProps>(
...
CherryFilledLogo.displayName = "CherryFilledLogo";

export const CherryFilledLogoMetadata = {
  id: "cherry-filled",
  baseId: "cherry-filled",
  variant: "default",
  name: "Cherry Filled",
  category: "filled",
  tags: [],
...
export default CherryFilledLogo;
