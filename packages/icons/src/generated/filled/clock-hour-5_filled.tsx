...
export const ClockHour5FilledMetadata = { id: "clock-hour-5_filled", baseId: "clock-hour-5", variant: "filled", name: "Clock Hour 5", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
