...
export interface GardenCartFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const GardenCartFilled = React.forwardRef<SVGSVGElement, GardenCartFilledProps>(
...
GardenCartFilled.displayName = "GardenCartFilled";
export const GardenCartFilledMetadata = { id: "garden-cart_filled", baseId: "garden-cart", variant: "filled", name: "Garden Cart", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
