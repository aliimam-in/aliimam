...
export interface ChargingPileFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ChargingPileFilled = React.forwardRef<SVGSVGElement, ChargingPileFilledProps>(
...
ChargingPileFilled.displayName = "ChargingPileFilled";
export const ChargingPileFilledMetadata = { id: "charging-pile_filled", baseId: "charging-pile", variant: "filled", name: "Charging Pile", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
