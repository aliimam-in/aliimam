...
export const ClipboardFilledMetadata = { id: "clipboard_filled", baseId: "clipboard", variant: "filled", name: "Clipboard", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
