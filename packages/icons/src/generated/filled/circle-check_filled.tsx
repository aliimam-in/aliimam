...
export const CircleCheckFilledMetadata = { id: "circle-check_filled", baseId: "circle-check", variant: "filled", name: "Circle Check", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
