...
export const DirectionsFilledMetadata = { id: "directions_filled", baseId: "directions", variant: "filled", name: "Directions", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
