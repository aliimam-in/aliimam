/**
 * Auto-generated logo component: Keyframes Filled (default)
 * Category: filled
...
export interface KeyframesFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const KeyframesFilledLogo = React.forwardRef<SVGSVGElement, KeyframesFilledLogoProps>(
...
KeyframesFilledLogo.displayName = "KeyframesFilledLogo";

export const KeyframesFilledLogoMetadata = {
  id: "keyframes-filled",
  baseId: "keyframes-filled",
  variant: "default",
...
export default KeyframesFilledLogo;
