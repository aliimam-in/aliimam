/**
 * Auto-generated logo component: Laurel Wreath Filled (default)
 * Category: filled
...
export interface LaurelWreathFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const LaurelWreathFilledLogo = React.forwardRef<SVGSVGElement, LaurelWreathFilledLogoProps>(
...
LaurelWreathFilledLogo.displayName = "LaurelWreathFilledLogo";

export const LaurelWreathFilledLogoMetadata = {
  id: "laurel-wreath-filled",
  baseId: "laurel-wreath-filled",
  variant: "default",
...
export default LaurelWreathFilledLogo;
