...
export const BrandWindowsFilledMetadata = { id: "brand-windows_filled", baseId: "brand-windows", variant: "filled", name: "Brand Windows", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
