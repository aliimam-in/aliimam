/**
 * Auto-generated logo component: Bug Filled (default)
 * Category: filled
...
export interface BugFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const BugFilledLogo = React.forwardRef<SVGSVGElement, BugFilledLogoProps>(
...
BugFilledLogo.displayName = "BugFilledLogo";

export const BugFilledLogoMetadata = {
  id: "bug-filled",
  baseId: "bug-filled",
  variant: "default",
  name: "Bug Filled",
