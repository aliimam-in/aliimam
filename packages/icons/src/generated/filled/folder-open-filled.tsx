/**
 * Auto-generated logo component: Folder Open Filled (default)
 * Category: filled
...
export interface FolderOpenFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const FolderOpenFilledLogo = React.forwardRef<SVGSVGElement, FolderOpenFilledLogoProps>(
...
FolderOpenFilledLogo.displayName = "FolderOpenFilledLogo";

export const FolderOpenFilledLogoMetadata = {
  id: "folder-open-filled",
  baseId: "folder-open-filled",
  variant: "default",
...
export default FolderOpenFilledLogo;
