...
export const PhoneCheckFilledMetadata = { id: "phone-check_filled", baseId: "phone-check", variant: "filled", name: "Phone Check", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
