/**
 * Auto-generated logo component: Lungs Filled (default)
 * Category: filled
...
export interface LungsFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const LungsFilledLogo = React.forwardRef<SVGSVGElement, LungsFilledLogoProps>(
...
LungsFilledLogo.displayName = "LungsFilledLogo";

export const LungsFilledLogoMetadata = {
  id: "lungs-filled",
  baseId: "lungs-filled",
  variant: "default",
  name: "Lungs Filled",
...
export default LungsFilledLogo;
