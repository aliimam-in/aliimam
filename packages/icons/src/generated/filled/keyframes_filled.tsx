...
export const KeyframesFilledMetadata = { id: "keyframes_filled", baseId: "keyframes", variant: "filled", name: "Keyframes", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
