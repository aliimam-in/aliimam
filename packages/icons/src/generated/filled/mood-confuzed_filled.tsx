...
export const MoodConfuzedFilledMetadata = { id: "mood-confuzed_filled", baseId: "mood-confuzed", variant: "filled", name: "Mood Confuzed", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
