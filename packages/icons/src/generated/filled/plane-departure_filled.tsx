...
export const PlaneDepartureFilledMetadata = { id: "plane-departure_filled", baseId: "plane-departure", variant: "filled", name: "Plane Departure", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
