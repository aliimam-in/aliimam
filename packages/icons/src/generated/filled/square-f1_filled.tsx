...
export const SquareF1FilledMetadata = { id: "square-f1_filled", baseId: "square-f1", variant: "filled", name: "Square F1", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
