/**
 * Auto-generated logo component: Satellite Filled (default)
 * Category: filled
...
export interface SatelliteFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const SatelliteFilledLogo = React.forwardRef<SVGSVGElement, SatelliteFilledLogoProps>(
...
SatelliteFilledLogo.displayName = "SatelliteFilledLogo";

export const SatelliteFilledLogoMetadata = {
  id: "satellite-filled",
  baseId: "satellite-filled",
  variant: "default",
  name: "Satellite Filled",
  category: "filled",
  tags: [],
  viewBox: "0 0 24 24",
} as const;

export default SatelliteFilledLogo;
