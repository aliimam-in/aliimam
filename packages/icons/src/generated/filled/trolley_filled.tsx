...
export interface TrolleyFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const TrolleyFilled = React.forwardRef<SVGSVGElement, TrolleyFilledProps>(
...
TrolleyFilled.displayName = "TrolleyFilled";
export const TrolleyFilledMetadata = { id: "trolley_filled", baseId: "trolley", variant: "filled", name: "Trolley", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
