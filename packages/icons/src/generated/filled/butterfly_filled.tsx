...
export interface ButterflyFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ButterflyFilled = React.forwardRef<SVGSVGElement, ButterflyFilledProps>(
...
ButterflyFilled.displayName = "ButterflyFilled";
export const ButterflyFilledMetadata = { id: "butterfly_filled", baseId: "butterfly", variant: "filled", name: "Butterfly", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
