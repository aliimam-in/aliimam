/**
 * Auto-generated logo component: Cards Filled (default)
 * Category: filled
...
export interface CardsFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const CardsFilledLogo = React.forwardRef<SVGSVGElement, CardsFilledLogoProps>(
...
CardsFilledLogo.displayName = "CardsFilledLogo";

export const CardsFilledLogoMetadata = {
  id: "cards-filled",
  baseId: "cards-filled",
  variant: "default",
  name: "Cards Filled",
...
export default CardsFilledLogo;
