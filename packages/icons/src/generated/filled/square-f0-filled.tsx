/**
 * Auto-generated logo component: Square F0 Filled (default)
 * Category: filled
...
export interface SquareF0FilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const SquareF0FilledLogo = React.forwardRef<SVGSVGElement, SquareF0FilledLogoProps>(
...
SquareF0FilledLogo.displayName = "SquareF0FilledLogo";

export const SquareF0FilledLogoMetadata = {
  id: "square-f0-filled",
  baseId: "square-f0-filled",
  variant: "default",
...
export default SquareF0FilledLogo;
