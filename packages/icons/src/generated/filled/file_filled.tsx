...
export interface FileFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const FileFilled = React.forwardRef<SVGSVGElement, FileFilledProps>(
...
export const FileFilledMetadata = { id: "file_filled", baseId: "file", variant: "filled", name: "File", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
