...
export interface KeyboardFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const KeyboardFilled = React.forwardRef<SVGSVGElement, KeyboardFilledProps>(
...
KeyboardFilled.displayName = "KeyboardFilled";
export const KeyboardFilledMetadata = { id: "keyboard_filled", baseId: "keyboard", variant: "filled", name: "Keyboard", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
