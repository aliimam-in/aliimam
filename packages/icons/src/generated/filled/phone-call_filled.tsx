...
export const PhoneCallFilledMetadata = { id: "phone-call_filled", baseId: "phone-call", variant: "filled", name: "Phone Call", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
