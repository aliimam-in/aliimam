/**
 * Auto-generated logo component: Square F5 Filled (default)
 * Category: filled
...
export interface SquareF5FilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const SquareF5FilledLogo = React.forwardRef<SVGSVGElement, SquareF5FilledLogoProps>(
...
SquareF5FilledLogo.displayName = "SquareF5FilledLogo";

export const SquareF5FilledLogoMetadata = {
  id: "square-f5-filled",
  baseId: "square-f5-filled",
  variant: "default",
...
export default SquareF5FilledLogo;
