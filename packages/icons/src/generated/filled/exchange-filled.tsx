/**
 * Auto-generated logo component: Exchange Filled (default)
 * Category: filled
...
export interface ExchangeFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const ExchangeFilledLogo = React.forwardRef<SVGSVGElement, ExchangeFilledLogoProps>(
...
ExchangeFilledLogo.displayName = "ExchangeFilledLogo";

export const ExchangeFilledLogoMetadata = {
  id: "exchange-filled",
  baseId: "exchange-filled",
  variant: "default",
...
export default ExchangeFilledLogo;
