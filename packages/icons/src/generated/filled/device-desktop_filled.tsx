...
export const DeviceDesktopFilledMetadata = { id: "device-desktop_filled", baseId: "device-desktop", variant: "filled", name: "Device Desktop", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
