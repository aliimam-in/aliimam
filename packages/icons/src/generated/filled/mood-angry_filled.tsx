...
export const MoodAngryFilledMetadata = { id: "mood-angry_filled", baseId: "mood-angry", variant: "filled", name: "Mood Angry", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
