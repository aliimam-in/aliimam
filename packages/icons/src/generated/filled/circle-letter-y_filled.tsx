...
export const CircleLetterYFilledMetadata = { id: "circle-letter-y_filled", baseId: "circle-letter-y", variant: "filled", name: "Circle Letter Y", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
