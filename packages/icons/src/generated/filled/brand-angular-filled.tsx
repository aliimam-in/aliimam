/**
 * Auto-generated logo component: Brand Angular Filled (default)
 * Category: filled
...
export interface BrandAngularFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const BrandAngularFilledLogo = React.forwardRef<SVGSVGElement, BrandAngularFilledLogoProps>(
...
BrandAngularFilledLogo.displayName = "BrandAngularFilledLogo";

export const BrandAngularFilledLogoMetadata = {
  id: "brand-angular-filled",
  baseId: "brand-angular-filled",
  variant: "default",
...
export default BrandAngularFilledLogo;
