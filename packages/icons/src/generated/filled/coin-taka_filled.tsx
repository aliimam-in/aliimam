...
export interface CoinTakaFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CoinTakaFilled = React.forwardRef<SVGSVGElement, CoinTakaFilledProps>(
...
CoinTakaFilled.displayName = "CoinTakaFilled";
export const CoinTakaFilledMetadata = { id: "coin-taka_filled", baseId: "coin-taka", variant: "filled", name: "Coin Taka", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
