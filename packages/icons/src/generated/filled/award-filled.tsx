/**
 * Auto-generated logo component: Award Filled (default)
 * Category: filled
...
export interface AwardFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const AwardFilledLogo = React.forwardRef<SVGSVGElement, AwardFilledLogoProps>(
...
AwardFilledLogo.displayName = "AwardFilledLogo";

export const AwardFilledLogoMetadata = {
  id: "award-filled",
  baseId: "award-filled",
  variant: "default",
  name: "Award Filled",
...
export default AwardFilledLogo;
