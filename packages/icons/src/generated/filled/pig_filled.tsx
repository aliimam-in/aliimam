...
export interface PigFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const PigFilled = React.forwardRef<SVGSVGElement, PigFilledProps>(
...
PigFilled.displayName = "PigFilled";
export const PigFilledMetadata = { id: "pig_filled", baseId: "pig", variant: "filled", name: "Pig", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
