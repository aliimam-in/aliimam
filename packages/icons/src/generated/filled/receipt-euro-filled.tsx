/**
 * Auto-generated logo component: Receipt Euro Filled (default)
 * Category: filled
...
export interface ReceiptEuroFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const ReceiptEuroFilledLogo = React.forwardRef<SVGSVGElement, ReceiptEuroFilledLogoProps>(
...
ReceiptEuroFilledLogo.displayName = "ReceiptEuroFilledLogo";

export const ReceiptEuroFilledLogoMetadata = {
  id: "receipt-euro-filled",
  baseId: "receipt-euro-filled",
  variant: "default",
...
export default ReceiptEuroFilledLogo;
