...
export const SquareLetterBFilledMetadata = { id: "square-letter-b_filled", baseId: "square-letter-b", variant: "filled", name: "Square Letter B", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
