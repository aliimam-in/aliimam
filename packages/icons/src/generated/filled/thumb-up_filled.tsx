...
export interface ThumbUpFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ThumbUpFilled = React.forwardRef<SVGSVGElement, ThumbUpFilledProps>(
...
export const ThumbUpFilledMetadata = { id: "thumb-up_filled", baseId: "thumb-up", variant: "filled", name: "Thumb Up", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
