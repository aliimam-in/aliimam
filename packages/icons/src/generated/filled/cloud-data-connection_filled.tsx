...
export const CloudDataConnectionFilledMetadata = { id: "cloud-data-connection_filled", baseId: "cloud-data-connection", variant: "filled", name: "Cloud Data Connection", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
