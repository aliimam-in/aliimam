...
export interface EscalatorDownFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const EscalatorDownFilled = React.forwardRef<SVGSVGElement, EscalatorDownFilledProps>(
...
EscalatorDownFilled.displayName = "EscalatorDownFilled";
export const EscalatorDownFilledMetadata = { id: "escalator-down_filled", baseId: "escalator-down", variant: "filled", name: "Escalator Down", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
