...
export interface BrandDribbbleFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const BrandDribbbleFilled = React.forwardRef<SVGSVGElement, BrandDribbbleFilledProps>(
...
BrandDribbbleFilled.displayName = "BrandDribbbleFilled";
export const BrandDribbbleFilledMetadata = { id: "brand-dribbble_filled", baseId: "brand-dribbble", variant: "filled", name: "Brand Dribbble", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
export default BrandDribbbleFilled;
