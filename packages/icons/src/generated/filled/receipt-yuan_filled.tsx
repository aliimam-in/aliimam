...
export interface ReceiptYuanFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ReceiptYuanFilled = React.forwardRef<SVGSVGElement, ReceiptYuanFilledProps>(
...
ReceiptYuanFilled.displayName = "ReceiptYuanFilled";
export const ReceiptYuanFilledMetadata = { id: "receipt-yuan_filled", baseId: "receipt-yuan", variant: "filled", name: "Receipt Yuan", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
export default ReceiptYuanFilled;
