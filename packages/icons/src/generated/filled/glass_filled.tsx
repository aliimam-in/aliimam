...
export interface GlassFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const GlassFilled = React.forwardRef<SVGSVGElement, GlassFilledProps>(
...
GlassFilled.displayName = "GlassFilled";
export const GlassFilledMetadata = { id: "glass_filled", baseId: "glass", variant: "filled", name: "Glass", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
