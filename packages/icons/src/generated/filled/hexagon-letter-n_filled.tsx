...
export const HexagonLetterNFilledMetadata = { id: "hexagon-letter-n_filled", baseId: "hexagon-letter-n", variant: "filled", name: "Hexagon Letter N", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
