...
export const CircleNumber8FilledMetadata = { id: "circle-number-8_filled", baseId: "circle-number-8", variant: "filled", name: "Circle Number 8", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
