...
export const ToggleRightFilledMetadata = { id: "toggle-right_filled", baseId: "toggle-right", variant: "filled", name: "Toggle Right", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
