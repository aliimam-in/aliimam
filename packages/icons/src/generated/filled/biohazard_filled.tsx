...
export interface BiohazardFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const BiohazardFilled = React.forwardRef<SVGSVGElement, BiohazardFilledProps>(
...
BiohazardFilled.displayName = "BiohazardFilled";
export const BiohazardFilledMetadata = { id: "biohazard_filled", baseId: "biohazard", variant: "filled", name: "Biohazard", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
export default BiohazardFilled;
