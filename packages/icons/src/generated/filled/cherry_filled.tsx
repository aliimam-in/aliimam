...
export interface CherryFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CherryFilled = React.forwardRef<SVGSVGElement, CherryFilledProps>(
...
CherryFilled.displayName = "CherryFilled";
export const CherryFilledMetadata = { id: "cherry_filled", baseId: "cherry", variant: "filled", name: "Cherry", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
