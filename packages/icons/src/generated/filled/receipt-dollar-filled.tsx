/**
 * Auto-generated logo component: Receipt Dollar Filled (default)
 * Category: filled
...
export interface ReceiptDollarFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const ReceiptDollarFilledLogo = React.forwardRef<SVGSVGElement, ReceiptDollarFilledLogoProps>(
...
ReceiptDollarFilledLogo.displayName = "ReceiptDollarFilledLogo";

export const ReceiptDollarFilledLogoMetadata = {
  id: "receipt-dollar-filled",
  baseId: "receipt-dollar-filled",
  variant: "default",
...
export default ReceiptDollarFilledLogo;
