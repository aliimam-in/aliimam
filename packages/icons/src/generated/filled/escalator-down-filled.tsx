/**
 * Auto-generated logo component: Escalator Down Filled (default)
 * Category: filled
...
export interface EscalatorDownFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const EscalatorDownFilledLogo = React.forwardRef<SVGSVGElement, EscalatorDownFilledLogoProps>(
...
EscalatorDownFilledLogo.displayName = "EscalatorDownFilledLogo";

export const EscalatorDownFilledLogoMetadata = {
  id: "escalator-down-filled",
  baseId: "escalator-down-filled",
  variant: "default",
...
export default EscalatorDownFilledLogo;
