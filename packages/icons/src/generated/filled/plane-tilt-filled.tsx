/**
 * Auto-generated logo component: Plane Tilt Filled (default)
 * Category: filled
...
export interface PlaneTiltFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const PlaneTiltFilledLogo = React.forwardRef<SVGSVGElement, PlaneTiltFilledLogoProps>(
...
PlaneTiltFilledLogo.displayName = "PlaneTiltFilledLogo";

export const PlaneTiltFilledLogoMetadata = {
  id: "plane-tilt-filled",
  baseId: "plane-tilt-filled",
  variant: "default",
...
export default PlaneTiltFilledLogo;
