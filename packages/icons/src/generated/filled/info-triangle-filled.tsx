/**
 * Auto-generated logo component: Info Triangle Filled (default)
 * Category: filled
...
export interface InfoTriangleFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const InfoTriangleFilledLogo = React.forwardRef<SVGSVGElement, InfoTriangleFilledLogoProps>(
...
InfoTriangleFilledLogo.displayName = "InfoTriangleFilledLogo";

export const InfoTriangleFilledLogoMetadata = {
  id: "info-triangle-filled",
  baseId: "info-triangle-filled",
  variant: "default",
...
export default InfoTriangleFilledLogo;
