...
export interface BookFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const BookFilled = React.forwardRef<SVGSVGElement, BookFilledProps>(
...
export const BookFilledMetadata = { id: "book_filled", baseId: "book", variant: "filled", name: "Book", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
