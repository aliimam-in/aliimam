/**
 * Auto-generated logo component: Lego Filled (default)
 * Category: filled
...
export interface LegoFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const LegoFilledLogo = React.forwardRef<SVGSVGElement, LegoFilledLogoProps>(
...
LegoFilledLogo.displayName = "LegoFilledLogo";

export const LegoFilledLogoMetadata = {
  id: "lego-filled",
  baseId: "lego-filled",
  variant: "default",
  name: "Lego Filled",
