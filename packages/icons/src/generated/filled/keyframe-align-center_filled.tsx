/**
 * Auto-generated logo component: Keyframe Align Center (filled)
 * Category: filled
...
export interface KeyframeAlignCenterFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const KeyframeAlignCenterFilledLogo = React.forwardRef<SVGSVGElement, KeyframeAlignCenterFilledLogoProps>(
...
KeyframeAlignCenterFilledLogo.displayName = "KeyframeAlignCenterFilledLogo";

export const KeyframeAlignCenterFilledLogoMetadata = {
  id: "keyframe-align-center_filled",
  baseId: "keyframe-align-center",
  variant: "filled",
...
export default KeyframeAlignCenterFilledLogo;
