...
export interface TableFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const TableFilled = React.forwardRef<SVGSVGElement, TableFilledProps>(
...
export const TableFilledMetadata = { 
  id: "table_filled", 
  baseId: "table", 
  variant: "filled", 
  name: "Table", 
