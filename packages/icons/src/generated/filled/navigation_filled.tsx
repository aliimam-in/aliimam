...
export const NavigationFilledMetadata = { id: "navigation_filled", baseId: "navigation", variant: "filled", name: "Navigation", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
