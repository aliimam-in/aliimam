...
export const BrandGoogleFilledMetadata = { id: "brand-google_filled", baseId: "brand-google", variant: "filled", name: "Brand Google", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
