...
export const LayoutAlignBottomFilledMetadata = { id: "layout-align-bottom_filled", baseId: "layout-align-bottom", variant: "filled", name: "Layout Align Bottom", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
