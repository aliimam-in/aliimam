...
export interface ReceiptFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ReceiptFilled = React.forwardRef<SVGSVGElement, ReceiptFilledProps>(
...
export const ReceiptFilledMetadata = { id: "receipt_filled", baseId: "receipt", variant: "filled", name: "Receipt", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
