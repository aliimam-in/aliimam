...
export const SquareLetterDFilledMetadata = { id: "square-letter-d_filled", baseId: "square-letter-d", variant: "filled", name: "Square Letter D", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
