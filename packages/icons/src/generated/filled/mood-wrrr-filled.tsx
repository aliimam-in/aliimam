/**
 * Auto-generated logo component: Mood Wrrr Filled (default)
 * Category: filled
...
export interface MoodWrrrFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const MoodWrrrFilledLogo = React.forwardRef<SVGSVGElement, MoodWrrrFilledLogoProps>(
...
MoodWrrrFilledLogo.displayName = "MoodWrrrFilledLogo";

export const MoodWrrrFilledLogoMetadata = {
  id: "mood-wrrr-filled",
  baseId: "mood-wrrr-filled",
  variant: "default",
...
export default MoodWrrrFilledLogo;
