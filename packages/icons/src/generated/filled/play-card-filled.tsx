/**
 * Auto-generated logo component: Play Card Filled (default)
 * Category: filled
...
export interface PlayCardFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const PlayCardFilledLogo = React.forwardRef<SVGSVGElement, PlayCardFilledLogoProps>(
...
PlayCardFilledLogo.displayName = "PlayCardFilledLogo";

export const PlayCardFilledLogoMetadata = {
  id: "play-card-filled",
  baseId: "play-card-filled",
  variant: "default",
  name: "Play Card Filled",
  category: "filled",
  tags: [],
  viewBox: "0 0 24 24",
} as const;

export default PlayCardFilledLogo;
