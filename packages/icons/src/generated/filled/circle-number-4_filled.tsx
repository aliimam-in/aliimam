...
export const CircleNumber4FilledMetadata = { id: "circle-number-4_filled", baseId: "circle-number-4", variant: "filled", name: "Circle Number 4", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
