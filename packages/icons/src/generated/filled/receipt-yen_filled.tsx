...
export interface ReceiptYenFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ReceiptYenFilled = React.forwardRef<SVGSVGElement, ReceiptYenFilledProps>(
...
ReceiptYenFilled.displayName = "ReceiptYenFilled";
export const ReceiptYenFilledMetadata = { id: "receipt-yen_filled", baseId: "receipt-yen", variant: "filled", name: "Receipt Yen", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
export default ReceiptYenFilled;
