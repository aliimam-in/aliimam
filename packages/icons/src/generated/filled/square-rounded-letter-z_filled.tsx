...
export const SquareRoundedLetterZFilledMetadata = { id: "square-rounded-letter-z_filled", baseId: "square-rounded-letter-z", variant: "filled", name: "Square Rounded Letter Z", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
