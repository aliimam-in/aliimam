...
export interface ReceiptEuroFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ReceiptEuroFilled = React.forwardRef<SVGSVGElement, ReceiptEuroFilledProps>(
...
ReceiptEuroFilled.displayName = "ReceiptEuroFilled";
export const ReceiptEuroFilledMetadata = { id: "receipt-euro_filled", baseId: "receipt-euro", variant: "filled", name: "Receipt Euro", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
