...
export const CircleDotFilledMetadata = { id: "circle-dot_filled", baseId: "circle-dot", variant: "filled", name: "Circle Dot", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
