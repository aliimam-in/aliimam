...
export const LayoutNavbarExpandFilledMetadata = { id: "layout-navbar-expand_filled", baseId: "layout-navbar-expand", variant: "filled", name: "Layout Navbar Expand", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
