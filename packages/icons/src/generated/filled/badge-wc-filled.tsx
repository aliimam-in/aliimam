/**
 * Auto-generated logo component: Badge Wc Filled (default)
 * Category: filled
...
export interface BadgeWcFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const BadgeWcFilledLogo = React.forwardRef<SVGSVGElement, BadgeWcFilledLogoProps>(
...
BadgeWcFilledLogo.displayName = "BadgeWcFilledLogo";

export const BadgeWcFilledLogoMetadata = {
  id: "badge-wc-filled",
  baseId: "badge-wc-filled",
  variant: "default",
...
export default BadgeWcFilledLogo;
