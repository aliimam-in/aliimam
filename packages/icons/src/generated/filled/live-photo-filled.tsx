/**
 * Auto-generated logo component: Live Photo Filled (default)
 * Category: filled
...
export interface LivePhotoFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const LivePhotoFilledLogo = React.forwardRef<SVGSVGElement, LivePhotoFilledLogoProps>(
...
LivePhotoFilledLogo.displayName = "LivePhotoFilledLogo";

export const LivePhotoFilledLogoMetadata = {
  id: "live-photo-filled",
  baseId: "live-photo-filled",
  variant: "default",
...
export default LivePhotoFilledLogo;
