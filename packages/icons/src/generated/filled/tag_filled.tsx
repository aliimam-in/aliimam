...
export interface TagFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const TagFilled = React.forwardRef<SVGSVGElement, TagFilledProps>(
...
export const TagFilledMetadata = { id: "tag_filled", baseId: "tag", variant: "filled", name: "Tag", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
