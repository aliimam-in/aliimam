/**
 * Auto-generated logo component: Direction Arrows Filled (default)
 * Category: filled
...
export interface DirectionArrowsFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const DirectionArrowsFilledLogo = React.forwardRef<SVGSVGElement, DirectionArrowsFilledLogoProps>(
...
DirectionArrowsFilledLogo.displayName = "DirectionArrowsFilledLogo";

export const DirectionArrowsFilledLogoMetadata = {
  id: "direction-arrows-filled",
  baseId: "direction-arrows-filled",
  variant: "default",
...
export default DirectionArrowsFilledLogo;
