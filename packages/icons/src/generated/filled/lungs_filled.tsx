...
export interface LungsFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const LungsFilled = React.forwardRef<SVGSVGElement, LungsFilledProps>(
...
LungsFilled.displayName = "LungsFilled";
export const LungsFilledMetadata = { id: "lungs_filled", baseId: "lungs", variant: "filled", name: "Lungs", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
