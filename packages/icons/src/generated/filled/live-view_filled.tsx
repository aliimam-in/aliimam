...
export interface LiveViewFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const LiveViewFilled = React.forwardRef<SVGSVGElement, LiveViewFilledProps>(
...
LiveViewFilled.displayName = "LiveViewFilled";
export const LiveViewFilledMetadata = { id: "live-view_filled", baseId: "live-view", variant: "filled", name: "Live View", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
