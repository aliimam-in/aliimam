...
export interface MeepleFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const MeepleFilled = React.forwardRef<SVGSVGElement, MeepleFilledProps>(
...
MeepleFilled.displayName = "MeepleFilled";
export const MeepleFilledMetadata = { id: "meeple_filled", baseId: "meeple", variant: "filled", name: "Meeple", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
export default MeepleFilled;
