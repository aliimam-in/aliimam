...
export interface InfoCircleFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const InfoCircleFilled = React.forwardRef<SVGSVGElement, InfoCircleFilledProps>(
...
export const InfoCircleFilledMetadata = { id: "info-circle_filled", baseId: "info-circle", variant: "filled", name: "Info Circle", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
