...
export interface AlarmSnoozeFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const AlarmSnoozeFilled = React.forwardRef<SVGSVGElement, AlarmSnoozeFilledProps>(
...
AlarmSnoozeFilled.displayName = "AlarmSnoozeFilled";
export const AlarmSnoozeFilledMetadata = { id: "alarm-snooze_filled", baseId: "alarm-snooze", variant: "filled", name: "Alarm Snooze", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
