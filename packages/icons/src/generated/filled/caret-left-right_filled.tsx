...
export interface CaretLeftRightFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CaretLeftRightFilled = React.forwardRef<SVGSVGElement, CaretLeftRightFilledProps>(
...
CaretLeftRightFilled.displayName = "CaretLeftRightFilled";
export const CaretLeftRightFilledMetadata = { id: "caret-left-right_filled", baseId: "caret-left-right", variant: "filled", name: "Caret Left Right", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
export default CaretLeftRightFilled;
