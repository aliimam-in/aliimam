/**
 * Auto-generated logo component: Garden Cart Filled (default)
 * Category: filled
...
export interface GardenCartFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const GardenCartFilledLogo = React.forwardRef<SVGSVGElement, GardenCartFilledLogoProps>(
...
GardenCartFilledLogo.displayName = "GardenCartFilledLogo";

export const GardenCartFilledLogoMetadata = {
  id: "garden-cart-filled",
  baseId: "garden-cart-filled",
  variant: "default",
...
export default GardenCartFilledLogo;
