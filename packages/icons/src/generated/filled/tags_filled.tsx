...
export interface TagsFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const TagsFilled = React.forwardRef<SVGSVGElement, TagsFilledProps>(
...
export const TagsFilledMetadata = { id: "tags_filled", baseId: "tags", variant: "filled", name: "Tags", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
