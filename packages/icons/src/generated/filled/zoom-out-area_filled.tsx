...
export const ZoomOutAreaFilledMetadata = { id: "zoom-out-area_filled", baseId: "zoom-out-area", variant: "filled", name: "Zoom Out Area", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
