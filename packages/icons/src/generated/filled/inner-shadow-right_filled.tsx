...
export const InnerShadowRightFilledMetadata = { id: "inner-shadow-right_filled", baseId: "inner-shadow-right", variant: "filled", name: "Inner Shadow Right", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
