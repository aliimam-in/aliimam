/**
 * Auto-generated logo component: Device Vision Pro Filled (default)
 * Category: filled
...
export interface DeviceVisionProFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const DeviceVisionProFilledLogo = React.forwardRef<SVGSVGElement, DeviceVisionProFilledLogoProps>(
...
DeviceVisionProFilledLogo.displayName = "DeviceVisionProFilledLogo";

export const DeviceVisionProFilledLogoMetadata = {
  id: "device-vision-pro-filled",
  baseId: "device-vision-pro-filled",
  variant: "default",
...
export default DeviceVisionProFilledLogo;
