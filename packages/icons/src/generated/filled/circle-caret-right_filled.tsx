...
export const CircleCaretRightFilledMetadata = { id: "circle-caret-right_filled", baseId: "circle-caret-right", variant: "filled", name: "Circle Caret Right", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
