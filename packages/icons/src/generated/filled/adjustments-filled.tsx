/**
 * Auto-generated logo component: Adjustments Filled (default)
 * Category: filled
...
export interface AdjustmentsFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const AdjustmentsFilledLogo = React.forwardRef<SVGSVGElement, AdjustmentsFilledLogoProps>(
...
AdjustmentsFilledLogo.displayName = "AdjustmentsFilledLogo";

export const AdjustmentsFilledLogoMetadata = {
  id: "adjustments-filled",
  baseId: "adjustments-filled",
  variant: "default",
...
export default AdjustmentsFilledLogo;
