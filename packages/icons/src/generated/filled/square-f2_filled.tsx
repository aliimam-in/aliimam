...
export const SquareF2FilledMetadata = { id: "square-f2_filled", baseId: "square-f2", variant: "filled", name: "Square F2", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
