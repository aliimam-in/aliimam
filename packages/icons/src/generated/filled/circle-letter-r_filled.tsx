...
export const CircleLetterRFilledMetadata = { id: "circle-letter-r_filled", baseId: "circle-letter-r", variant: "filled", name: "Circle Letter R", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
