...
export const CircleLetterLFilledMetadata = { id: "circle-letter-l_filled", baseId: "circle-letter-l", variant: "filled", name: "Circle Letter L", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
