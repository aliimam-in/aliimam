/**
 * Auto-generated logo component: Hexagon Number 3 (filled)
 * Category: filled
...
export interface HexagonNumber3FilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const HexagonNumber3FilledLogo = React.forwardRef<SVGSVGElement, HexagonNumber3FilledLogoProps>(
...
HexagonNumber3FilledLogo.displayName = "HexagonNumber3FilledLogo";

export const HexagonNumber3FilledLogoMetadata = {
  id: "hexagon-number-3_filled",
  baseId: "hexagon-number-3",
  variant: "filled",
...
export default HexagonNumber3FilledLogo;
