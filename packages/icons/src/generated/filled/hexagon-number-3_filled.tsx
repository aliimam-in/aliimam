...
export interface HexagonNumber3FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const HexagonNumber3Filled = React.forwardRef<SVGSVGElement, HexagonNumber3FilledProps>(
...
HexagonNumber3Filled.displayName = "HexagonNumber3Filled";
export const HexagonNumber3FilledMetadata = { id: "hexagon-number-3_filled", baseId: "hexagon-number-3", variant: "filled", name: "Hexagon Number 3", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
