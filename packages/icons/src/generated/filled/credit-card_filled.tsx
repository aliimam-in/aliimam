...
export const CreditCardFilledMetadata = { id: "credit-card_filled", baseId: "credit-card", variant: "filled", name: "Credit Card", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
