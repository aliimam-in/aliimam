...
export const SignRightFilledMetadata = { id: "sign-right_filled", baseId: "sign-right", variant: "filled", name: "Sign Right", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
