...
export const LayoutGridFilledMetadata = { id: "layout-grid_filled", baseId: "layout-grid", variant: "filled", name: "Layout Grid", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
