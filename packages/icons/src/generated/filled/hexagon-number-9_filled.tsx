...
export interface HexagonNumber9FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const HexagonNumber9Filled = React.forwardRef<SVGSVGElement, HexagonNumber9FilledProps>(
...
HexagonNumber9Filled.displayName = "HexagonNumber9Filled";
export const HexagonNumber9FilledMetadata = { id: "hexagon-number-9_filled", baseId: "hexagon-number-9", variant: "filled", name: "Hexagon Number 9", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
