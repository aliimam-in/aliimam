/**
 * Auto-generated logo component: Glass Filled (default)
 * Category: filled
...
export interface GlassFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const GlassFilledLogo = React.forwardRef<SVGSVGElement, GlassFilledLogoProps>(
...
GlassFilledLogo.displayName = "GlassFilledLogo";

export const GlassFilledLogoMetadata = {
  id: "glass-filled",
  baseId: "glass-filled",
  variant: "default",
  name: "Glass Filled",
...
export default GlassFilledLogo;
