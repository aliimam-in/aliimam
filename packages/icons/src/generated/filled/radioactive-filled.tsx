/**
 * Auto-generated logo component: Radioactive Filled (default)
 * Category: filled
...
export interface RadioactiveFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const RadioactiveFilledLogo = React.forwardRef<SVGSVGElement, RadioactiveFilledLogoProps>(
...
RadioactiveFilledLogo.displayName = "RadioactiveFilledLogo";

export const RadioactiveFilledLogoMetadata = {
  id: "radioactive-filled",
  baseId: "radioactive-filled",
  variant: "default",
...
export default RadioactiveFilledLogo;
