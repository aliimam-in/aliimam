...
export interface ZoomCodeFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ZoomCodeFilled = React.forwardRef<SVGSVGElement, ZoomCodeFilledProps>(
...
ZoomCodeFilled.displayName = "ZoomCodeFilled";
export const ZoomCodeFilledMetadata = { id: "zoom-code_filled", baseId: "zoom-code", variant: "filled", name: "Zoom Code", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
