...
export const Contrast2FilledMetadata = { id: "contrast-2_filled", baseId: "contrast-2", variant: "filled", name: "Contrast 2", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
