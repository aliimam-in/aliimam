/**
 * Auto-generated logo component: Badge Tm Filled (default)
 * Category: filled
...
export interface BadgeTmFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const BadgeTmFilledLogo = React.forwardRef<SVGSVGElement, BadgeTmFilledLogoProps>(
...
BadgeTmFilledLogo.displayName = "BadgeTmFilledLogo";

export const BadgeTmFilledLogoMetadata = {
  id: "badge-tm-filled",
  baseId: "badge-tm-filled",
  variant: "default",
...
export default BadgeTmFilledLogo;
