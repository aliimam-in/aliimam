...
export const SquareLetterLFilledMetadata = { id: "square-letter-l_filled", baseId: "square-letter-l", variant: "filled", name: "Square Letter L", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
