/**
 * Auto-generated logo component: Analyze Filled (default)
 * Category: filled
...
export interface AnalyzeFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const AnalyzeFilledLogo = React.forwardRef<SVGSVGElement, AnalyzeFilledLogoProps>(
...
AnalyzeFilledLogo.displayName = "AnalyzeFilledLogo";

export const AnalyzeFilledLogoMetadata = {
  id: "analyze-filled",
  baseId: "analyze-filled",
  variant: "default",
  name: "Analyze Filled",
  category: "filled",
  tags: [],
...
export default AnalyzeFilledLogo;
