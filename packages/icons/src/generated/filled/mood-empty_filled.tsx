...
export const MoodEmptyFilledMetadata = { id: "mood-empty_filled", baseId: "mood-empty", variant: "filled", name: "Mood Empty", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
