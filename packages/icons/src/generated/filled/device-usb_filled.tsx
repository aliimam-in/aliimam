...
export const DeviceUsbFilledMetadata = { id: "device-usb_filled", baseId: "device-usb", variant: "filled", name: "Device Usb", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
