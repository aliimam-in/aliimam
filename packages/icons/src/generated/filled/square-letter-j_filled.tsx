...
export const SquareLetterJFilledMetadata = { id: "square-letter-j_filled", baseId: "square-letter-j", variant: "filled", name: "Square Letter J", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
