...
export const CapsuleHorizontalFilledMetadata = { id: "capsule-horizontal_filled", baseId: "capsule-horizontal", variant: "filled", name: "Capsule Horizontal", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
