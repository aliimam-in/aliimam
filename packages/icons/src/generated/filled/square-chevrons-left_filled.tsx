...
export const SquareChevronsLeftFilledMetadata = { id: "square-chevrons-left_filled", baseId: "square-chevrons-left", variant: "filled", name: "Square Chevrons Left", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
