...
export const SquareChevronsUpFilledMetadata = { id: "square-chevrons-up_filled", baseId: "square-chevrons-up", variant: "filled", name: "Square Chevrons Up", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
