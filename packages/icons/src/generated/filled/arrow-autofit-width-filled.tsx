/**
 * Auto-generated logo component: Arrow Autofit Width Filled (default)
 * Category: filled
...
export interface ArrowAutofitWidthFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const ArrowAutofitWidthFilledLogo = React.forwardRef<SVGSVGElement, ArrowAutofitWidthFilledLogoProps>(
...
ArrowAutofitWidthFilledLogo.displayName = "ArrowAutofitWidthFilledLogo";

export const ArrowAutofitWidthFilledLogoMetadata = {
  id: "arrow-autofit-width-filled",
  baseId: "arrow-autofit-width-filled",
  variant: "default",
...
export default ArrowAutofitWidthFilledLogo;
