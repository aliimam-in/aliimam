...
export interface CompassFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CompassFilled = React.forwardRef<SVGSVGElement, CompassFilledProps>(
...
export const CompassFilledMetadata = { id: "compass_filled", baseId: "compass", variant: "filled", name: "Compass", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
