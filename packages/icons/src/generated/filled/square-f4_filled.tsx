...
export const SquareF4FilledMetadata = { id: "square-f4_filled", baseId: "square-f4", variant: "filled", name: "Square F4", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
