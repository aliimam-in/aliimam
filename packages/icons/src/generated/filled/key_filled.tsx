...
export interface KeyFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const KeyFilled = React.forwardRef<SVGSVGElement, KeyFilledProps>(
...
export const KeyFilledMetadata = { id: "key_filled", baseId: "key", variant: "filled", name: "Key", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
