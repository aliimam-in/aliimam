/**
 * Auto-generated logo component: Badge 8k Filled (default)
 * Category: filled
...
export interface Badge8kFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const Badge8kFilledLogo = React.forwardRef<SVGSVGElement, Badge8kFilledLogoProps>(
...
Badge8kFilledLogo.displayName = "Badge8kFilledLogo";

export const Badge8kFilledLogoMetadata = {
  id: "badge-8k-filled",
  baseId: "badge-8k-filled",
  variant: "default",
...
export default Badge8kFilledLogo;
