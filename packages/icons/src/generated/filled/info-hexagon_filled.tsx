...
export interface InfoHexagonFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const InfoHexagonFilled = React.forwardRef<SVGSVGElement, InfoHexagonFilledProps>(
...
InfoHexagonFilled.displayName = "InfoHexagonFilled";
export const InfoHexagonFilledMetadata = { id: "info-hexagon_filled", baseId: "info-hexagon", variant: "filled", name: "Info Hexagon", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
