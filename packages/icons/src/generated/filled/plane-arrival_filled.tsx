...
export const PlaneArrivalFilledMetadata = { id: "plane-arrival_filled", baseId: "plane-arrival", variant: "filled", name: "Plane Arrival", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
