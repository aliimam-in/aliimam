...
export interface BinocularsFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const BinocularsFilled = React.forwardRef<SVGSVGElement, BinocularsFilledProps>(
...
BinocularsFilled.displayName = "BinocularsFilled";
export const BinocularsFilledMetadata = { id: "binoculars_filled", baseId: "binoculars", variant: "filled", name: "Binoculars", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
