...
export interface BottleFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const BottleFilled = React.forwardRef<SVGSVGElement, BottleFilledProps>(
...
export const BottleFilledMetadata = { id: "bottle_filled", baseId: "bottle", variant: "filled", name: "Bottle", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
