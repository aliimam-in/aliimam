/**
 * Auto-generated logo component: Cannabis Filled (default)
 * Category: filled
...
export interface CannabisFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const CannabisFilledLogo = React.forwardRef<SVGSVGElement, CannabisFilledLogoProps>(
...
CannabisFilledLogo.displayName = "CannabisFilledLogo";

export const CannabisFilledLogoMetadata = {
  id: "cannabis-filled",
  baseId: "cannabis-filled",
  variant: "default",
...
export default CannabisFilledLogo;
