/**
 * Auto-generated logo component: Stack 3 Filled (default)
 * Category: filled
...
export interface Stack3FilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const Stack3FilledLogo = React.forwardRef<SVGSVGElement, Stack3FilledLogoProps>(
...
Stack3FilledLogo.displayName = "Stack3FilledLogo";

export const Stack3FilledLogoMetadata = {
  id: "stack-3-filled",
  baseId: "stack-3-filled",
  variant: "default",
  name: "Stack 3 Filled",
  category: "filled",
  tags: [],
...
export default Stack3FilledLogo;
