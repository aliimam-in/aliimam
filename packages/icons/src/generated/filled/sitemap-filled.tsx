/**
 * Auto-generated logo component: Sitemap Filled (default)
 * Category: filled
...
export interface SitemapFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const SitemapFilledLogo = React.forwardRef<SVGSVGElement, SitemapFilledLogoProps>(
...
SitemapFilledLogo.displayName = "SitemapFilledLogo";

export const SitemapFilledLogoMetadata = {
  id: "sitemap-filled",
  baseId: "sitemap-filled",
  variant: "default",
  name: "Sitemap Filled",
  category: "filled",
  tags: [],
...
export default SitemapFilledLogo;
