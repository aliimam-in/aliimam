...
export interface EggFriedFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const EggFriedFilled = React.forwardRef<SVGSVGElement, EggFriedFilledProps>(
...
EggFriedFilled.displayName = "EggFriedFilled";
export const EggFriedFilledMetadata = { id: "egg-fried_filled", baseId: "egg-fried", variant: "filled", name: "Egg Fried", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
