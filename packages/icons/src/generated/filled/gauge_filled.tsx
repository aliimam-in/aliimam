...
export interface GaugeFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const GaugeFilled = React.forwardRef<SVGSVGElement, GaugeFilledProps>(
...
GaugeFilled.displayName = "GaugeFilled";
export const GaugeFilledMetadata = { id: "gauge_filled", baseId: "gauge", variant: "filled", name: "Gauge", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
