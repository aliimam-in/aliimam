...
export interface FaceMaskFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const FaceMaskFilled = React.forwardRef<SVGSVGElement, FaceMaskFilledProps>(
...
FaceMaskFilled.displayName = "FaceMaskFilled";
export const FaceMaskFilledMetadata = { id: "face-mask_filled", baseId: "face-mask", variant: "filled", name: "Face Mask", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
