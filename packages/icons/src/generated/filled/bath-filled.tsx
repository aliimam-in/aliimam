/**
 * Auto-generated logo component: Bath Filled (default)
 * Category: filled
...
export interface BathFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const BathFilledLogo = React.forwardRef<SVGSVGElement, BathFilledLogoProps>(
...
BathFilledLogo.displayName = "BathFilledLogo";

export const BathFilledLogoMetadata = {
  id: "bath-filled",
  baseId: "bath-filled",
  variant: "default",
  name: "Bath Filled",
