/**
 * Auto-generated logo component: Salad Filled (default)
 * Category: filled
...
export interface SaladFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const SaladFilledLogo = React.forwardRef<SVGSVGElement, SaladFilledLogoProps>(
...
SaladFilledLogo.displayName = "SaladFilledLogo";

export const SaladFilledLogoMetadata = {
  id: "salad-filled",
  baseId: "salad-filled",
  variant: "default",
  name: "Salad Filled",
...
export default SaladFilledLogo;
