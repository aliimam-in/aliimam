...
export interface ChartDonutFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ChartDonutFilled = React.forwardRef<SVGSVGElement, ChartDonutFilledProps>(
...
ChartDonutFilled.displayName = "ChartDonutFilled";
export const ChartDonutFilledMetadata = { id: "chart-donut_filled", baseId: "chart-donut", variant: "filled", name: "Chart Donut", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
