/**
 * Auto-generated logo component: Chef Hat Filled (default)
 * Category: filled
...
export interface ChefHatFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const ChefHatFilledLogo = React.forwardRef<SVGSVGElement, ChefHatFilledLogoProps>(
...
ChefHatFilledLogo.displayName = "ChefHatFilledLogo";

export const ChefHatFilledLogoMetadata = {
  id: "chef-hat-filled",
  baseId: "chef-hat-filled",
  variant: "default",
...
export default ChefHatFilledLogo;
