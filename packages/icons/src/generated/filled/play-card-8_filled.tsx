...
export const PlayCard8FilledMetadata = { id: "play-card-8_filled", baseId: "play-card-8", variant: "filled", name: "Play Card 8", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
