...
export interface LifebuoyFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const LifebuoyFilled = React.forwardRef<SVGSVGElement, LifebuoyFilledProps>(
...
LifebuoyFilled.displayName = "LifebuoyFilled";
export const LifebuoyFilledMetadata = { id: "lifebuoy_filled", baseId: "lifebuoy", variant: "filled", name: "Lifebuoy", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
