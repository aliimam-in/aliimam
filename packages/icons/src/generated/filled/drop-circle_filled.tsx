...
export const DropCircleFilledMetadata = { id: "drop-circle_filled", baseId: "drop-circle", variant: "filled", name: "Drop Circle", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
