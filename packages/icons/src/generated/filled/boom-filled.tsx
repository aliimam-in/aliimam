/**
 * Auto-generated logo component: Boom Filled (default)
 * Category: filled
...
export interface BoomFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const BoomFilledLogo = React.forwardRef<SVGSVGElement, BoomFilledLogoProps>(
...
BoomFilledLogo.displayName = "BoomFilledLogo";

export const BoomFilledLogoMetadata = {
  id: "boom-filled",
  baseId: "boom-filled",
  variant: "default",
  name: "Boom Filled",
