/**
 * Auto-generated logo component: Rollercoaster Filled (default)
 * Category: filled
...
export interface RollercoasterFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const RollercoasterFilledLogo = React.forwardRef<SVGSVGElement, RollercoasterFilledLogoProps>(
...
RollercoasterFilledLogo.displayName = "RollercoasterFilledLogo";

export const RollercoasterFilledLogoMetadata = {
  id: "rollercoaster-filled",
  baseId: "rollercoaster-filled",
  variant: "default",
...
export default RollercoasterFilledLogo;
