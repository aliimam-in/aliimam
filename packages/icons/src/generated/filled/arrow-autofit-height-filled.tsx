/**
 * Auto-generated logo component: Arrow Autofit Height Filled (default)
 * Category: filled
...
export interface ArrowAutofitHeightFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const ArrowAutofitHeightFilledLogo = React.forwardRef<SVGSVGElement, ArrowAutofitHeightFilledLogoProps>(
...
ArrowAutofitHeightFilledLogo.displayName = "ArrowAutofitHeightFilledLogo";

export const ArrowAutofitHeightFilledLogoMetadata = {
  id: "arrow-autofit-height-filled",
  baseId: "arrow-autofit-height-filled",
  variant: "default",
...
export default ArrowAutofitHeightFilledLogo;
