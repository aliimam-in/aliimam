/**
 * Auto-generated logo component: Pizza Filled (default)
 * Category: filled
...
export interface PizzaFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const PizzaFilledLogo = React.forwardRef<SVGSVGElement, PizzaFilledLogoProps>(
...
PizzaFilledLogo.displayName = "PizzaFilledLogo";

export const PizzaFilledLogoMetadata = {
  id: "pizza-filled",
  baseId: "pizza-filled",
  variant: "default",
  name: "Pizza Filled",
...
export default PizzaFilledLogo;
