...
export const EggCrackedFilledMetadata = { id: "egg-cracked_filled", baseId: "egg-cracked", variant: "filled", name: "Egg Cracked", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
