/**
 * Auto-generated logo component: Shirt Filled (default)
 * Category: filled
...
export interface ShirtFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const ShirtFilledLogo = React.forwardRef<SVGSVGElement, ShirtFilledLogoProps>(
...
ShirtFilledLogo.displayName = "ShirtFilledLogo";

export const ShirtFilledLogoMetadata = {
  id: "shirt-filled",
  baseId: "shirt-filled",
  variant: "default",
  name: "Shirt Filled",
...
export default ShirtFilledLogo;
