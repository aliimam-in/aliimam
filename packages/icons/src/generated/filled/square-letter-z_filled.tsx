...
export const SquareLetterZFilledMetadata = { id: "square-letter-z_filled", baseId: "square-letter-z", variant: "filled", name: "Square Letter Z", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
