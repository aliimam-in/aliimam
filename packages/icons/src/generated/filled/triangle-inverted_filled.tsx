...
export const TriangleInvertedFilledMetadata = { id: "triangle-inverted_filled", baseId: "triangle-inverted", variant: "filled", name: "Triangle Inverted", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
