...
export const VideoFilled = React.forwardRef<SVGSVGElement, VideoFilledProps>(
...
export const VideoFilledMetadata = { id: "video_filled", baseId: "video", variant: "filled", name: "Video", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
