...
export const CircleArrowDownLeftFilledMetadata = { id: "circle-arrow-down-left_filled", baseId: "circle-arrow-down-left", variant: "filled", name: "Circle Arrow Down Left", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
