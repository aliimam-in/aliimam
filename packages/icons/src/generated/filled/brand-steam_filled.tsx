...
export const BrandSteamFilledMetadata = { id: "brand-steam_filled", baseId: "brand-steam", variant: "filled", name: "Brand Steam", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
