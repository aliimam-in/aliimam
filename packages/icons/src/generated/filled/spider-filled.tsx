/**
 * Auto-generated logo component: Spider Filled (default)
 * Category: filled
...
export interface SpiderFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const SpiderFilledLogo = React.forwardRef<SVGSVGElement, SpiderFilledLogoProps>(
...
SpiderFilledLogo.displayName = "SpiderFilledLogo";

export const SpiderFilledLogoMetadata = {
  id: "spider-filled",
  baseId: "spider-filled",
  variant: "default",
  name: "Spider Filled",
  category: "filled",
  tags: [],
...
export default SpiderFilledLogo;
