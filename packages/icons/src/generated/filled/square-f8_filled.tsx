...
export interface SquareF8FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const SquareF8Filled = React.forwardRef<SVGSVGElement, SquareF8FilledProps>(
...
SquareF8Filled.displayName = "SquareF8Filled";
export const SquareF8FilledMetadata = { id: "square-f8_filled", baseId: "square-f8", variant: "filled", name: "Square F8", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
export default SquareF8Filled;
