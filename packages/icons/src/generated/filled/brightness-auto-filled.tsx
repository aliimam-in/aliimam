/**
 * Auto-generated logo component: Brightness Auto Filled (default)
 * Category: filled
...
export interface BrightnessAutoFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const BrightnessAutoFilledLogo = React.forwardRef<SVGSVGElement, BrightnessAutoFilledLogoProps>(
...
BrightnessAutoFilledLogo.displayName = "BrightnessAutoFilledLogo";

export const BrightnessAutoFilledLogoMetadata = {
  id: "brightness-auto-filled",
  baseId: "brightness-auto-filled",
  variant: "default",
...
export default BrightnessAutoFilledLogo;
