/**
 * Auto-generated logo component: Cookie Man Filled (default)
 * Category: filled
...
export interface CookieManFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const CookieManFilledLogo = React.forwardRef<SVGSVGElement, CookieManFilledLogoProps>(
...
CookieManFilledLogo.displayName = "CookieManFilledLogo";

export const CookieManFilledLogoMetadata = {
  id: "cookie-man-filled",
  baseId: "cookie-man-filled",
  variant: "default",
...
export default CookieManFilledLogo;
