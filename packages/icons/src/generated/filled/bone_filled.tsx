...
export interface BoneFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const BoneFilled = React.forwardRef<SVGSVGElement, BoneFilledProps>(
...
BoneFilled.displayName = "BoneFilled";
export const BoneFilledMetadata = { id: "bone_filled", baseId: "bone", variant: "filled", name: "Bone", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
