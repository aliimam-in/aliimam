/**
 * Auto-generated logo component: Cookie Filled (default)
 * Category: filled
...
export interface CookieFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const CookieFilledLogo = React.forwardRef<SVGSVGElement, CookieFilledLogoProps>(
...
CookieFilledLogo.displayName = "CookieFilledLogo";

export const CookieFilledLogoMetadata = {
  id: "cookie-filled",
  baseId: "cookie-filled",
  variant: "default",
  name: "Cookie Filled",
  category: "filled",
  tags: [],
...
export default CookieFilledLogo;
