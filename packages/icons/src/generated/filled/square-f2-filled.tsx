/**
 * Auto-generated logo component: Square F2 Filled (default)
 * Category: filled
...
export interface SquareF2FilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const SquareF2FilledLogo = React.forwardRef<SVGSVGElement, SquareF2FilledLogoProps>(
...
SquareF2FilledLogo.displayName = "SquareF2FilledLogo";

export const SquareF2FilledLogoMetadata = {
  id: "square-f2-filled",
  baseId: "square-f2-filled",
  variant: "default",
...
export default SquareF2FilledLogo;
