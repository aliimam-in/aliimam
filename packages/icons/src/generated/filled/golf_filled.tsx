...
export interface GolfFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const GolfFilled = React.forwardRef<SVGSVGElement, GolfFilledProps>(
...
GolfFilled.displayName = "GolfFilled";
export const GolfFilledMetadata = { id: "golf_filled", baseId: "golf", variant: "filled", name: "Golf", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
