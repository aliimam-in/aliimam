...
export interface DeviceVisionProFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const DeviceVisionProFilled = React.forwardRef<SVGSVGElement, DeviceVisionProFilledProps>(
...
DeviceVisionProFilled.displayName = "DeviceVisionProFilled";
export const DeviceVisionProFilledMetadata = { id: "device-vision-pro_filled", baseId: "device-vision-pro", variant: "filled", name: "Device Vision Pro", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
