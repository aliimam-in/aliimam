...
export interface ThumbDownFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ThumbDownFilled = React.forwardRef<SVGSVGElement, ThumbDownFilledProps>(
...
export const ThumbDownFilledMetadata = { id: "thumb-down_filled", baseId: "thumb-down", variant: "filled", name: "Thumb Down", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
