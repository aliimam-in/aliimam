...
export interface SquareF6FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const SquareF6Filled = React.forwardRef<SVGSVGElement, SquareF6FilledProps>(
...
SquareF6Filled.displayName = "SquareF6Filled";
export const SquareF6FilledMetadata = { id: "square-f6_filled", baseId: "square-f6", variant: "filled", name: "Square F6", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
