/**
 * Auto-generated logo component: Bone Filled (default)
 * Category: filled
...
export interface BoneFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const BoneFilledLogo = React.forwardRef<SVGSVGElement, BoneFilledLogoProps>(
...
BoneFilledLogo.displayName = "BoneFilledLogo";

export const BoneFilledLogoMetadata = {
  id: "bone-filled",
  baseId: "bone-filled",
  variant: "default",
  name: "Bone Filled",
