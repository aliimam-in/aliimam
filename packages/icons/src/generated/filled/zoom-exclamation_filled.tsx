...
export const ZoomExclamationFilledMetadata = { id: "zoom-exclamation_filled", baseId: "zoom-exclamation", variant: "filled", name: "Zoom Exclamation", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
