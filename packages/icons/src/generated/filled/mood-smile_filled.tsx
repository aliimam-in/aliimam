...
export const MoodSmileFilledMetadata = { id: "mood-smile_filled", baseId: "mood-smile", variant: "filled", name: "Mood Smile", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
