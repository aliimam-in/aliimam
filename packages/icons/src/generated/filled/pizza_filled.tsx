...
export interface PizzaFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const PizzaFilled = React.forwardRef<SVGSVGElement, PizzaFilledProps>(
...
PizzaFilled.displayName = "PizzaFilled";
export const PizzaFilledMetadata = { id: "pizza_filled", baseId: "pizza", variant: "filled", name: "Pizza", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
