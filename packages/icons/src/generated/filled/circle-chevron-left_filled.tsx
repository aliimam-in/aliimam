...
export const CircleChevronLeftFilledMetadata = { id: "circle-chevron-left_filled", baseId: "circle-chevron-left", variant: "filled", name: "Circle Chevron Left", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
