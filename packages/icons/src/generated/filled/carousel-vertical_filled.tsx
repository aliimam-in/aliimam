...
export const CarouselVerticalFilledMetadata = { id: "carousel-vertical_filled", baseId: "carousel-vertical", variant: "filled", name: "Carousel Vertical", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
