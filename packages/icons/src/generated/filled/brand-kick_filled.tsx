...
export const BrandKickFilledMetadata = { id: "brand-kick_filled", baseId: "brand-kick", variant: "filled", name: "Brand Kick", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
