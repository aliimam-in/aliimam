...
export const PlayCardAFilledMetadata = { id: "play-card-a_filled", baseId: "play-card-a", variant: "filled", name: "Play Card A", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
