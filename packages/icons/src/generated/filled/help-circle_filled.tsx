...
export interface HelpCircleFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const HelpCircleFilled = React.forwardRef<SVGSVGElement, HelpCircleFilledProps>(
...
export const HelpCircleFilledMetadata = { id: "help-circle_filled", baseId: "help-circle", variant: "filled", name: "Help Circle", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
