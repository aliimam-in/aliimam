...
export interface DropletHalf2FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const DropletHalf2Filled = React.forwardRef<SVGSVGElement, DropletHalf2FilledProps>(
...
DropletHalf2Filled.displayName = "DropletHalf2Filled";
export const DropletHalf2FilledMetadata = { id: "droplet-half-2_filled", baseId: "droplet-half-2", variant: "filled", name: "Droplet Half 2", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
