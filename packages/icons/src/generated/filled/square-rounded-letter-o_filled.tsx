...
export const SquareRoundedLetterOFilledMetadata = { id: "square-rounded-letter-o_filled", baseId: "square-rounded-letter-o", variant: "filled", name: "Square Rounded Letter O", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
