...
export const SquareRoundedLetterGFilledMetadata = { id: "square-rounded-letter-g_filled", baseId: "square-rounded-letter-g", variant: "filled", name: "Square Rounded Letter G", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
