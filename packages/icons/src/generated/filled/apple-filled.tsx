/**
 * Auto-generated logo component: Apple Filled (default)
 * Category: filled
...
export interface AppleFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const AppleFilledLogo = React.forwardRef<SVGSVGElement, AppleFilledLogoProps>(
...
AppleFilledLogo.displayName = "AppleFilledLogo";

export const AppleFilledLogoMetadata = {
  id: "apple-filled",
  baseId: "apple-filled",
  variant: "default",
  name: "Apple Filled",
...
export default AppleFilledLogo;
