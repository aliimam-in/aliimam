...
export const SquareLetterWFilledMetadata = { id: "square-letter-w_filled", baseId: "square-letter-w", variant: "filled", name: "Square Letter W", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
