...
export const CircleLetterPFilledMetadata = { id: "circle-letter-p_filled", baseId: "circle-letter-p", variant: "filled", name: "Circle Letter P", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
