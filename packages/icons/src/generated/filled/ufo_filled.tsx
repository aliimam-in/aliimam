...
export interface UfoFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const UfoFilled = React.forwardRef<SVGSVGElement, UfoFilledProps>(
...
UfoFilled.displayName = "UfoFilled";
export const UfoFilledMetadata = { id: "ufo_filled", baseId: "ufo", variant: "filled", name: "Ufo", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
export default UfoFilled;
