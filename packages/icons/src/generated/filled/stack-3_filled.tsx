...
export interface Stack3FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const Stack3Filled = React.forwardRef<SVGSVGElement, Stack3FilledProps>(
...
Stack3Filled.displayName = "Stack3Filled";
export const Stack3FilledMetadata = { id: "stack-3_filled", baseId: "stack-3", variant: "filled", name: "Stack 3", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
