...
export interface SunriseFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const SunriseFilled = React.forwardRef<SVGSVGElement, SunriseFilledProps>(
...
SunriseFilled.displayName = "SunriseFilled";
export const SunriseFilledMetadata = { id: "sunrise_filled", baseId: "sunrise", variant: "filled", name: "Sunrise", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
