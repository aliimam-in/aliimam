...
export interface CalendarWeekFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CalendarWeekFilled = React.forwardRef<SVGSVGElement, CalendarWeekFilledProps>(
...
CalendarWeekFilled.displayName = "CalendarWeekFilled";
export const CalendarWeekFilledMetadata = { id: "calendar-week_filled", baseId: "calendar-week", variant: "filled", name: "Calendar Week", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
