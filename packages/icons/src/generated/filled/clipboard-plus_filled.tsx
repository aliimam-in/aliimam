...
export const ClipboardPlusFilledMetadata = { id: "clipboard-plus_filled", baseId: "clipboard-plus", variant: "filled", name: "Clipboard Plus", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
