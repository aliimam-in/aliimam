...
export const CircleLetterSFilledMetadata = { id: "circle-letter-s_filled", baseId: "circle-letter-s", variant: "filled", name: "Circle Letter S", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
