...
export const SquareMinusFilledMetadata = { id: "square-minus_filled", baseId: "square-minus", variant: "filled", name: "Square Minus", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
