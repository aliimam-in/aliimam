/**
 * Auto-generated logo component: Bottle Filled (default)
 * Category: filled
...
export interface BottleFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const BottleFilledLogo = React.forwardRef<SVGSVGElement, BottleFilledLogoProps>(
...
BottleFilledLogo.displayName = "BottleFilledLogo";

export const BottleFilledLogoMetadata = {
  id: "bottle-filled",
  baseId: "bottle-filled",
  variant: "default",
  name: "Bottle Filled",
  category: "filled",
  tags: [],
...
export default BottleFilledLogo;
