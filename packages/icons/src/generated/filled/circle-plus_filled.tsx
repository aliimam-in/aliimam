...
export const CirclePlusFilledMetadata = { id: "circle-plus_filled", baseId: "circle-plus", variant: "filled", name: "Circle Plus", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
