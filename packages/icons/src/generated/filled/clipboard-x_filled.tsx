...
export interface ClipboardXFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ClipboardXFilled = React.forwardRef<SVGSVGElement, ClipboardXFilledProps>(
...
ClipboardXFilled.displayName = "ClipboardXFilled";
export const ClipboardXFilledMetadata = { id: "clipboard-x_filled", baseId: "clipboard-x", variant: "filled", name: "Clipboard X", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
