/**
 * Auto-generated logo component: Brand Apple Filled (default)
 * Category: filled
...
export interface BrandAppleFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const BrandAppleFilledLogo = React.forwardRef<SVGSVGElement, BrandAppleFilledLogoProps>(
...
BrandAppleFilledLogo.displayName = "BrandAppleFilledLogo";

export const BrandAppleFilledLogoMetadata = {
  id: "brand-apple-filled",
  baseId: "brand-apple-filled",
  variant: "default",
...
export default BrandAppleFilledLogo;
