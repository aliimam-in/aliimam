...
export const SquareRoundedLetterLFilledMetadata = { id: "square-rounded-letter-l_filled", baseId: "square-rounded-letter-l", variant: "filled", name: "Square Rounded Letter L", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
