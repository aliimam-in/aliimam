...
export const PlayCard10FilledMetadata = { id: "play-card-10_filled", baseId: "play-card-10", variant: "filled", name: "Play Card 10", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
