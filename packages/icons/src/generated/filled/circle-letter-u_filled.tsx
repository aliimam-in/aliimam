...
export const CircleLetterUFilledMetadata = { id: "circle-letter-u_filled", baseId: "circle-letter-u", variant: "filled", name: "Circle Letter U", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
