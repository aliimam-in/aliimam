...
export interface MountainFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const MountainFilled = React.forwardRef<SVGSVGElement, MountainFilledProps>(
...
MountainFilled.displayName = "MountainFilled";
export const MountainFilledMetadata = { id: "mountain_filled", baseId: "mountain", variant: "filled", name: "Mountain", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
