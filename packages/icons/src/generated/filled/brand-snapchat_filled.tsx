...
export interface BrandSnapchatFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const BrandSnapchatFilled = React.forwardRef<SVGSVGElement, BrandSnapchatFilledProps>(
...
BrandSnapchatFilled.displayName = "BrandSnapchatFilled";
export const BrandSnapchatFilledMetadata = { id: "brand-snapchat_filled", baseId: "brand-snapchat", variant: "filled", name: "Brand Snapchat", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
export default BrandSnapchatFilled;
