/**
 * Auto-generated logo component: Fish Bone Filled (default)
 * Category: filled
...
export interface FishBoneFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const FishBoneFilledLogo = React.forwardRef<SVGSVGElement, FishBoneFilledLogoProps>(
...
FishBoneFilledLogo.displayName = "FishBoneFilledLogo";

export const FishBoneFilledLogoMetadata = {
  id: "fish-bone-filled",
  baseId: "fish-bone-filled",
  variant: "default",
...
export default FishBoneFilledLogo;
