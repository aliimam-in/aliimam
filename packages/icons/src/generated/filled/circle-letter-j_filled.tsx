...
export const CircleLetterJFilledMetadata = { id: "circle-letter-j_filled", baseId: "circle-letter-j", variant: "filled", name: "Circle Letter J", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
