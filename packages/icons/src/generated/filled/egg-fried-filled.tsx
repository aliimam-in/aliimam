/**
 * Auto-generated logo component: Egg Fried Filled (default)
 * Category: filled
...
export interface EggFriedFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const EggFriedFilledLogo = React.forwardRef<SVGSVGElement, EggFriedFilledLogoProps>(
...
EggFriedFilledLogo.displayName = "EggFriedFilledLogo";

export const EggFriedFilledLogoMetadata = {
  id: "egg-fried-filled",
  baseId: "egg-fried-filled",
  variant: "default",
...
export default EggFriedFilledLogo;
