/**
 * Auto-generated logo component: Confetti Filled (default)
 * Category: filled
...
export interface ConfettiFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const ConfettiFilledLogo = React.forwardRef<SVGSVGElement, ConfettiFilledLogoProps>(
...
ConfettiFilledLogo.displayName = "ConfettiFilledLogo";

export const ConfettiFilledLogoMetadata = {
  id: "confetti-filled",
  baseId: "confetti-filled",
  variant: "default",
...
export default ConfettiFilledLogo;
