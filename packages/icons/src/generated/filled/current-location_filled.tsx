...
export const CurrentLocationFilledMetadata = { id: "current-location_filled", baseId: "current-location", variant: "filled", name: "Current Location", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
