...
export interface SpiderFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const SpiderFilled = React.forwardRef<SVGSVGElement, SpiderFilledProps>(
...
SpiderFilled.displayName = "SpiderFilled";
export const SpiderFilledMetadata = { id: "spider_filled", baseId: "spider", variant: "filled", name: "Spider", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
