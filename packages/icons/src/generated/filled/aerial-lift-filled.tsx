/**
 * Auto-generated logo component: Aerial Lift Filled (default)
 * Category: filled
...
export interface AerialLiftFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const AerialLiftFilledLogo = React.forwardRef<SVGSVGElement, AerialLiftFilledLogoProps>(
...
AerialLiftFilledLogo.displayName = "AerialLiftFilledLogo";

export const AerialLiftFilledLogoMetadata = {
  id: "aerial-lift-filled",
  baseId: "aerial-lift-filled",
  variant: "default",
...
export default AerialLiftFilledLogo;
