...
export interface WritingSignFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const WritingSignFilled = React.forwardRef<SVGSVGElement, WritingSignFilledProps>(
...
WritingSignFilled.displayName = "WritingSignFilled";
export const WritingSignFilledMetadata = { id: "writing-sign_filled", baseId: "writing-sign", variant: "filled", name: "Writing Sign", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
export default WritingSignFilled;
