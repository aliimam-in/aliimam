/**
 * Auto-generated logo component: Bell Ringing 2 Filled (default)
 * Category: filled
...
export interface BellRinging2FilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const BellRinging2FilledLogo = React.forwardRef<SVGSVGElement, BellRinging2FilledLogoProps>(
...
BellRinging2FilledLogo.displayName = "BellRinging2FilledLogo";

export const BellRinging2FilledLogoMetadata = {
  id: "bell-ringing-2-filled",
  baseId: "bell-ringing-2-filled",
  variant: "default",
...
export default BellRinging2FilledLogo;
