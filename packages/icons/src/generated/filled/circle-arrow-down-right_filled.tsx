...
export const CircleArrowDownRightFilledMetadata = { id: "circle-arrow-down-right_filled", baseId: "circle-arrow-down-right", variant: "filled", name: "Circle Arrow Down Right", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
