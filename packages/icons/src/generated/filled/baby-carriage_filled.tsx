...
export interface BabyCarriageFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const BabyCarriageFilled = React.forwardRef<SVGSVGElement, BabyCarriageFilledProps>(
...
BabyCarriageFilled.displayName = "BabyCarriageFilled";
export const BabyCarriageFilledMetadata = { id: "baby-carriage_filled", baseId: "baby-carriage", variant: "filled", name: "Baby Carriage", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
