/**
 * Auto-generated logo component: Assembly Filled (default)
 * Category: filled
...
export interface AssemblyFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const AssemblyFilledLogo = React.forwardRef<SVGSVGElement, AssemblyFilledLogoProps>(
...
AssemblyFilledLogo.displayName = "AssemblyFilledLogo";

export const AssemblyFilledLogoMetadata = {
  id: "assembly-filled",
  baseId: "assembly-filled",
  variant: "default",
...
export default AssemblyFilledLogo;
