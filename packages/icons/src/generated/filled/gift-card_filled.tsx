...
export interface GiftCardFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const GiftCardFilled = React.forwardRef<SVGSVGElement, GiftCardFilledProps>(
...
GiftCardFilled.displayName = "GiftCardFilled";
export const GiftCardFilledMetadata = { id: "gift-card_filled", baseId: "gift-card", variant: "filled", name: "Gift Card", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
