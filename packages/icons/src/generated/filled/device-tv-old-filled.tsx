/**
 * Auto-generated logo component: Device Tv Old Filled (default)
 * Category: filled
...
export interface DeviceTvOldFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const DeviceTvOldFilledLogo = React.forwardRef<SVGSVGElement, DeviceTvOldFilledLogoProps>(
...
DeviceTvOldFilledLogo.displayName = "DeviceTvOldFilledLogo";

export const DeviceTvOldFilledLogoMetadata = {
  id: "device-tv-old-filled",
  baseId: "device-tv-old-filled",
  variant: "default",
...
export default DeviceTvOldFilledLogo;
