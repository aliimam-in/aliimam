...
export interface LaurelWreath2FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const LaurelWreath2Filled = React.forwardRef<SVGSVGElement, LaurelWreath2FilledProps>(
...
LaurelWreath2Filled.displayName = "LaurelWreath2Filled";
export const LaurelWreath2FilledMetadata = { id: "laurel-wreath-2_filled", baseId: "laurel-wreath-2", variant: "filled", name: "Laurel Wreath 2", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
export default LaurelWreath2Filled;
