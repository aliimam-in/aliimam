...
export interface RollercoasterFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const RollercoasterFilled = React.forwardRef<SVGSVGElement, RollercoasterFilledProps>(
...
RollercoasterFilled.displayName = "RollercoasterFilled";
export const RollercoasterFilledMetadata = { id: "rollercoaster_filled", baseId: "rollercoaster", variant: "filled", name: "Rollercoaster", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
