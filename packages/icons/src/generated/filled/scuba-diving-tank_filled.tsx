...
export const ScubaDivingTankFilledMetadata = { id: "scuba-diving-tank_filled", baseId: "scuba-diving-tank", variant: "filled", name: "Scuba Diving Tank", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
