...
export const AlignBoxBottomLeftFilledMetadata = { id: "align-box-bottom-left_filled", baseId: "align-box-bottom-left", variant: "filled", name: "Align Box Bottom Left", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
