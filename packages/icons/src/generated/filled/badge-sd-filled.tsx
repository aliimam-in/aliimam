/**
 * Auto-generated logo component: Badge Sd Filled (default)
 * Category: filled
...
export interface BadgeSdFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const BadgeSdFilledLogo = React.forwardRef<SVGSVGElement, BadgeSdFilledLogoProps>(
...
BadgeSdFilledLogo.displayName = "BadgeSdFilledLogo";

export const BadgeSdFilledLogoMetadata = {
  id: "badge-sd-filled",
  baseId: "badge-sd-filled",
  variant: "default",
...
export default BadgeSdFilledLogo;
