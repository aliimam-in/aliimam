/**
 * Auto-generated logo component: Alarm Snooze Filled (default)
 * Category: filled
...
export interface AlarmSnoozeFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const AlarmSnoozeFilledLogo = React.forwardRef<SVGSVGElement, AlarmSnoozeFilledLogoProps>(
...
AlarmSnoozeFilledLogo.displayName = "AlarmSnoozeFilledLogo";

export const AlarmSnoozeFilledLogoMetadata = {
  id: "alarm-snooze-filled",
  baseId: "alarm-snooze-filled",
  variant: "default",
...
export default AlarmSnoozeFilledLogo;
