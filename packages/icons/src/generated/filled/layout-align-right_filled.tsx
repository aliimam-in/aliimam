...
export const LayoutAlignRightFilledMetadata = { id: "layout-align-right_filled", baseId: "layout-align-right", variant: "filled", name: "Layout Align Right", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
