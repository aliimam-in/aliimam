/**
 * Auto-generated logo component: Car Crane Filled (default)
 * Category: filled
...
export interface CarCraneFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const CarCraneFilledLogo = React.forwardRef<SVGSVGElement, CarCraneFilledLogoProps>(
...
CarCraneFilledLogo.displayName = "CarCraneFilledLogo";

export const CarCraneFilledLogoMetadata = {
  id: "car-crane-filled",
  baseId: "car-crane-filled",
  variant: "default",
...
export default CarCraneFilledLogo;
