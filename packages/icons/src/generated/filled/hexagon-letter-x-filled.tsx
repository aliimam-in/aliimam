/**
 * Auto-generated logo component: Hexagon Letter X Filled (default)
 * Category: filled
...
export interface HexagonLetterXFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const HexagonLetterXFilledLogo = React.forwardRef<SVGSVGElement, HexagonLetterXFilledLogoProps>(
...
HexagonLetterXFilledLogo.displayName = "HexagonLetterXFilledLogo";

export const HexagonLetterXFilledLogoMetadata = {
  id: "hexagon-letter-x-filled",
  baseId: "hexagon-letter-x-filled",
  variant: "default",
...
export default HexagonLetterXFilledLogo;
