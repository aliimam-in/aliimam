...
export const CodeCircle2FilledMetadata = { id: "code-circle-2_filled", baseId: "code-circle-2", variant: "filled", name: "Code Circle 2", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
