...
export interface ReceiptPoundFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ReceiptPoundFilled = React.forwardRef<SVGSVGElement, ReceiptPoundFilledProps>(
...
ReceiptPoundFilled.displayName = "ReceiptPoundFilled";
export const ReceiptPoundFilledMetadata = { id: "receipt-pound_filled", baseId: "receipt-pound", variant: "filled", name: "Receipt Pound", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
