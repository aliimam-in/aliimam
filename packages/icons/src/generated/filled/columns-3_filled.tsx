...
export const Columns3FilledMetadata = { id: "columns-3_filled", baseId: "columns-3", variant: "filled", name: "Columns 3", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
