...
export interface GiftFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const GiftFilled = React.forwardRef<SVGSVGElement, GiftFilledProps>(
...
export const GiftFilledMetadata = { id: "gift_filled", baseId: "gift", variant: "filled", name: "Gift", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
