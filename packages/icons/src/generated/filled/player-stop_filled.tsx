...
export const PlayerStopFilledMetadata = { id: "player-stop_filled", baseId: "player-stop", variant: "filled", name: "Player Stop", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
