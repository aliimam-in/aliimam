...
export const CropLandscapeFilledMetadata = { id: "crop-landscape_filled", baseId: "crop-landscape", variant: "filled", name: "Crop Landscape", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
