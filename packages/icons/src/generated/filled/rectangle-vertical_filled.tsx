...
export const RectangleVerticalFilledMetadata = { id: "rectangle-vertical_filled", baseId: "rectangle-vertical", variant: "filled", name: "Rectangle Vertical", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
