...
export const HexagonLetterZFilledMetadata = { id: "hexagon-letter-z_filled", baseId: "hexagon-letter-z", variant: "filled", name: "Hexagon Letter Z", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
