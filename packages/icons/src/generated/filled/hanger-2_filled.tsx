...
export interface Hanger2FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const Hanger2Filled = React.forwardRef<SVGSVGElement, Hanger2FilledProps>(
...
Hanger2Filled.displayName = "Hanger2Filled";
export const Hanger2FilledMetadata = { id: "hanger-2_filled", baseId: "hanger-2", variant: "filled", name: "Hanger 2", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
