/**
 * Auto-generated logo component: Badge Vr Filled (default)
 * Category: filled
...
export interface BadgeVrFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const BadgeVrFilledLogo = React.forwardRef<SVGSVGElement, BadgeVrFilledLogoProps>(
...
BadgeVrFilledLogo.displayName = "BadgeVrFilledLogo";

export const BadgeVrFilledLogoMetadata = {
  id: "badge-vr-filled",
  baseId: "badge-vr-filled",
  variant: "default",
...
export default BadgeVrFilledLogo;
