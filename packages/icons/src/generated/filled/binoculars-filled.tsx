/**
 * Auto-generated logo component: Binoculars Filled (default)
 * Category: filled
...
export interface BinocularsFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const BinocularsFilledLogo = React.forwardRef<SVGSVGElement, BinocularsFilledLogoProps>(
...
BinocularsFilledLogo.displayName = "BinocularsFilledLogo";

export const BinocularsFilledLogoMetadata = {
  id: "binoculars-filled",
  baseId: "binoculars-filled",
  variant: "default",
...
export default BinocularsFilledLogo;
