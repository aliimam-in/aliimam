/**
 * Auto-generated logo component: Icons Filled (default)
 * Category: filled
...
export interface IconsFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const IconsFilledLogo = React.forwardRef<SVGSVGElement, IconsFilledLogoProps>(
...
IconsFilledLogo.displayName = "IconsFilledLogo";

export const IconsFilledLogoMetadata = {
  id: "icons-filled",
  baseId: "icons-filled",
  variant: "default",
  name: "Icons Filled",
...
export default IconsFilledLogo;
