...
export interface AlienFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const AlienFilled = React.forwardRef<SVGSVGElement, AlienFilledProps>(
...
export const AlienFilledMetadata = { id: "alien_filled", baseId: "alien", variant: "filled", name: "Alien", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
