...
export const ChartFunnelFilledMetadata = { id: "chart-funnel_filled", baseId: "chart-funnel", variant: "filled", name: "Chart Funnel", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
