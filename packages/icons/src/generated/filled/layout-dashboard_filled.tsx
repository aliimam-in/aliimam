...
export const LayoutDashboardFilledMetadata = { id: "layout-dashboard_filled", baseId: "layout-dashboard", variant: "filled", name: "Layout Dashboard", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
