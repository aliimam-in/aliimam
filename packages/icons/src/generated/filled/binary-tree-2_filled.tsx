...
export const BinaryTree2FilledMetadata = { id: "binary-tree-2_filled", baseId: "binary-tree-2", variant: "filled", name: "Binary Tree 2", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
