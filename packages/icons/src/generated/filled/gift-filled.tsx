/**
 * Auto-generated logo component: Gift Filled (default)
 * Category: filled
...
export interface GiftFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const GiftFilledLogo = React.forwardRef<SVGSVGElement, GiftFilledLogoProps>(
...
GiftFilledLogo.displayName = "GiftFilledLogo";

export const GiftFilledLogoMetadata = {
  id: "gift-filled",
  baseId: "gift-filled",
  variant: "default",
  name: "Gift Filled",
