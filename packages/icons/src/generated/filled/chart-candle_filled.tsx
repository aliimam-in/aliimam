...
export const ChartCandleFilledMetadata = { id: "chart-candle_filled", baseId: "chart-candle", variant: "filled", name: "Chart Candle", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
