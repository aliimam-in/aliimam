/**
 * Auto-generated logo component: Chart Candle (filled)
 * Category: filled
...
export interface ChartCandleFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const ChartCandleFilledLogo = React.forwardRef<SVGSVGElement, ChartCandleFilledLogoProps>(
...
ChartCandleFilledLogo.displayName = "ChartCandleFilledLogo";

export const ChartCandleFilledLogoMetadata = {
...
export default ChartCandleFilledLogo;
