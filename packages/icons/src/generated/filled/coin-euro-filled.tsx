/**
 * Auto-generated logo component: Coin Euro Filled (default)
 * Category: filled
...
export interface CoinEuroFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const CoinEuroFilledLogo = React.forwardRef<SVGSVGElement, CoinEuroFilledLogoProps>(
...
CoinEuroFilledLogo.displayName = "CoinEuroFilledLogo";

export const CoinEuroFilledLogoMetadata = {
  id: "coin-euro-filled",
  baseId: "coin-euro-filled",
  variant: "default",
...
export default CoinEuroFilledLogo;
