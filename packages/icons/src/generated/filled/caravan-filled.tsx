/**
 * Auto-generated logo component: Caravan Filled (default)
 * Category: filled
...
export interface CaravanFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const CaravanFilledLogo = React.forwardRef<SVGSVGElement, CaravanFilledLogoProps>(
...
CaravanFilledLogo.displayName = "CaravanFilledLogo";

export const CaravanFilledLogoMetadata = {
  id: "caravan-filled",
  baseId: "caravan-filled",
  variant: "default",
  name: "Caravan Filled",
  category: "filled",
  tags: [],
...
export default CaravanFilledLogo;
