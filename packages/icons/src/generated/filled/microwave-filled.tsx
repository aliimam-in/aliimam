/**
 * Auto-generated logo component: Microwave Filled (default)
 * Category: filled
...
export interface MicrowaveFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const MicrowaveFilledLogo = React.forwardRef<SVGSVGElement, MicrowaveFilledLogoProps>(
...
MicrowaveFilledLogo.displayName = "MicrowaveFilledLogo";

export const MicrowaveFilledLogoMetadata = {
  id: "microwave-filled",
  baseId: "microwave-filled",
  variant: "default",
...
export default MicrowaveFilledLogo;
