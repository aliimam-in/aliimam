/**
 * Auto-generated logo component: Chart Grid Dots Filled (default)
 * Category: filled
...
export interface ChartGridDotsFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const ChartGridDotsFilledLogo = React.forwardRef<SVGSVGElement, ChartGridDotsFilledLogoProps>(
...
ChartGridDotsFilledLogo.displayName = "ChartGridDotsFilledLogo";

export const ChartGridDotsFilledLogoMetadata = {
  id: "chart-grid-dots-filled",
  baseId: "chart-grid-dots-filled",
  variant: "default",
...
export default ChartGridDotsFilledLogo;
