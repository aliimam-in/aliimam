/**
 * Auto-generated logo component: Coin Taka Filled (default)
 * Category: filled
...
export interface CoinTakaFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const CoinTakaFilledLogo = React.forwardRef<SVGSVGElement, CoinTakaFilledLogoProps>(
...
CoinTakaFilledLogo.displayName = "CoinTakaFilledLogo";

export const CoinTakaFilledLogoMetadata = {
  id: "coin-taka-filled",
  baseId: "coin-taka-filled",
  variant: "default",
...
export default CoinTakaFilledLogo;
