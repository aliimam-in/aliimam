...
export interface Sparkles2FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const Sparkles2Filled = React.forwardRef<SVGSVGElement, Sparkles2FilledProps>(
...
Sparkles2Filled.displayName = "Sparkles2Filled";
export const Sparkles2FilledMetadata = { id: "sparkles-2_filled", baseId: "sparkles-2", variant: "filled", name: "Sparkles 2", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
export default Sparkles2Filled;
