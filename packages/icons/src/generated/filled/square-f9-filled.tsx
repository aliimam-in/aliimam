/**
 * Auto-generated logo component: Square F9 Filled (default)
 * Category: filled
...
export interface SquareF9FilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const SquareF9FilledLogo = React.forwardRef<SVGSVGElement, SquareF9FilledLogoProps>(
...
SquareF9FilledLogo.displayName = "SquareF9FilledLogo";

export const SquareF9FilledLogoMetadata = {
  id: "square-f9-filled",
  baseId: "square-f9-filled",
  variant: "default",
...
export default SquareF9FilledLogo;
