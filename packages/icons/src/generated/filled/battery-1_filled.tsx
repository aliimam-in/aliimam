...
export const Battery1FilledMetadata = { id: "battery-1_filled", baseId: "battery-1", variant: "filled", name: "Battery 1", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
