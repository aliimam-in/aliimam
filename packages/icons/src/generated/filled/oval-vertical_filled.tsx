...
export const OvalVerticalFilledMetadata = { id: "oval-vertical_filled", baseId: "oval-vertical", variant: "filled", name: "Oval Vertical", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
