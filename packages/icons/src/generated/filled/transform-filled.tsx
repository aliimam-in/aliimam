/**
 * Auto-generated logo component: Transform Filled (default)
 * Category: filled
...
export interface TransformFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const TransformFilledLogo = React.forwardRef<SVGSVGElement, TransformFilledLogoProps>(
...
TransformFilledLogo.displayName = "TransformFilledLogo";

export const TransformFilledLogoMetadata = {
  id: "transform-filled",
  baseId: "transform-filled",
  variant: "default",
...
export default TransformFilledLogo;
