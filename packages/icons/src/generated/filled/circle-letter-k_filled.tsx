...
export const CircleLetterKFilledMetadata = { id: "circle-letter-k_filled", baseId: "circle-letter-k", variant: "filled", name: "Circle Letter K", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
