...
export interface PawFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const PawFilled = React.forwardRef<SVGSVGElement, PawFilledProps>(
...
PawFilled.displayName = "PawFilled";
export const PawFilledMetadata = { id: "paw_filled", baseId: "paw", variant: "filled", name: "Paw", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
