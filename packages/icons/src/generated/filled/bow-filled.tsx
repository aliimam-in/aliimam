/**
 * Auto-generated logo component: Bow Filled (default)
 * Category: filled
...
export interface BowFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const BowFilledLogo = React.forwardRef<SVGSVGElement, BowFilledLogoProps>(
...
BowFilledLogo.displayName = "BowFilledLogo";

export const BowFilledLogoMetadata = {
  id: "bow-filled",
  baseId: "bow-filled",
  variant: "default",
  name: "Bow Filled",
