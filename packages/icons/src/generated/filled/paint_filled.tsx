...
export interface PaintFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const PaintFilled = React.forwardRef<SVGSVGElement, PaintFilledProps>(
...
PaintFilled.displayName = "PaintFilled";
export const PaintFilledMetadata = { id: "paint_filled", baseId: "paint", variant: "filled", name: "Paint", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
