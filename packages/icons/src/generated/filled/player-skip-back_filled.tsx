...
export const PlayerSkipBackFilledMetadata = { id: "player-skip-back_filled", baseId: "player-skip-back", variant: "filled", name: "Player Skip Back", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
