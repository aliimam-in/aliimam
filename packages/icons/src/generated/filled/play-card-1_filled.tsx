...
export const PlayCard1FilledMetadata = { id: "play-card-1_filled", baseId: "play-card-1", variant: "filled", name: "Play Card 1", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
