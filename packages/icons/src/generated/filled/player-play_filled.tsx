...
export const PlayerPlayFilledMetadata = { id: "player-play_filled", baseId: "player-play", variant: "filled", name: "Player Play", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
