...
export interface ZeppelinFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ZeppelinFilled = React.forwardRef<SVGSVGElement, ZeppelinFilledProps>(
...
ZeppelinFilled.displayName = "ZeppelinFilled";
export const ZeppelinFilledMetadata = { id: "zeppelin_filled", baseId: "zeppelin", variant: "filled", name: "Zeppelin", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
