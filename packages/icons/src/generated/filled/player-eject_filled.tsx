...
export const PlayerEjectFilledMetadata = { id: "player-eject_filled", baseId: "player-eject", variant: "filled", name: "Player Eject", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
