...
export const FileTextFilledMetadata = { id: "file-text_filled", baseId: "file-text", variant: "filled", name: "File Text", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
