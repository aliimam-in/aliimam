/**
 * Auto-generated logo component: Receipt Yen Filled (default)
 * Category: filled
...
export interface ReceiptYenFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const ReceiptYenFilledLogo = React.forwardRef<SVGSVGElement, ReceiptYenFilledLogoProps>(
...
ReceiptYenFilledLogo.displayName = "ReceiptYenFilledLogo";

export const ReceiptYenFilledLogoMetadata = {
  id: "receipt-yen-filled",
  baseId: "receipt-yen-filled",
  variant: "default",
...
export default ReceiptYenFilledLogo;
