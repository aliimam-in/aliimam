...
export const CircleCaretUpFilledMetadata = { id: "circle-caret-up_filled", baseId: "circle-caret-up", variant: "filled", name: "Circle Caret Up", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
