...
export const CaretLeftFilledMetadata = { id: "caret-left_filled", baseId: "caret-left", variant: "filled", name: "Caret Left", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
