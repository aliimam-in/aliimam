/**
 * Auto-generated logo component: Woman Filled (default)
 * Category: filled
...
export interface WomanFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const WomanFilledLogo = React.forwardRef<SVGSVGElement, WomanFilledLogoProps>(
...
WomanFilledLogo.displayName = "WomanFilledLogo";

export const WomanFilledLogoMetadata = {
  id: "woman-filled",
  baseId: "woman-filled",
  variant: "default",
  name: "Woman Filled",
...
export default WomanFilledLogo;
