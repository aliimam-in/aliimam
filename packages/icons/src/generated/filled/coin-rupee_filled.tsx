...
export interface CoinRupeeFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CoinRupeeFilled = React.forwardRef<SVGSVGElement, CoinRupeeFilledProps>(
...
CoinRupeeFilled.displayName = "CoinRupeeFilled";
export const CoinRupeeFilledMetadata = { id: "coin-rupee_filled", baseId: "coin-rupee", variant: "filled", name: "Coin Rupee", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
