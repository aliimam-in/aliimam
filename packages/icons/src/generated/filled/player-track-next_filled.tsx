...
export const PlayerTrackNextFilledMetadata = { id: "player-track-next_filled", baseId: "player-track-next", variant: "filled", name: "Player Track Next", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
