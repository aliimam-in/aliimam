...
export const DeviceGamepadFilledMetadata = { id: "device-gamepad_filled", baseId: "device-gamepad", variant: "filled", name: "Device Gamepad", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
