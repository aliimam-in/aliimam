...
export interface BrandAppleFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const BrandAppleFilled = React.forwardRef<SVGSVGElement, BrandAppleFilledProps>(
...
BrandAppleFilled.displayName = "BrandAppleFilled";
export const BrandAppleFilledMetadata = { id: "brand-apple_filled", baseId: "brand-apple", variant: "filled", name: "Brand Apple", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
export default BrandAppleFilled;
