/**
 * Auto-generated logo component: Blender Filled (default)
 * Category: filled
...
export interface BlenderFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const BlenderFilledLogo = React.forwardRef<SVGSVGElement, BlenderFilledLogoProps>(
...
BlenderFilledLogo.displayName = "BlenderFilledLogo";

export const BlenderFilledLogoMetadata = {
  id: "blender-filled",
  baseId: "blender-filled",
  variant: "default",
  name: "Blender Filled",
  category: "filled",
  tags: [],
...
export default BlenderFilledLogo;
