...
export const ClipboardListFilledMetadata = { id: "clipboard-list_filled", baseId: "clipboard-list", variant: "filled", name: "Clipboard List", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
