...
export const AlertCircleFilledMetadata = { id: "alert-circle_filled", baseId: "alert-circle", variant: "filled", name: "Alert Circle", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
