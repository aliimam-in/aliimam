...
export const TestPipe2FilledMetadata = { id: "test-pipe-2_filled", baseId: "test-pipe-2", variant: "filled", name: "Test Pipe 2", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
