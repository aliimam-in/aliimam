...
export interface ChessKingFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ChessKingFilled = React.forwardRef<SVGSVGElement, ChessKingFilledProps>(
...
ChessKingFilled.displayName = "ChessKingFilled";
export const ChessKingFilledMetadata = { id: "chess-king_filled", baseId: "chess-king", variant: "filled", name: "Chess King", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
