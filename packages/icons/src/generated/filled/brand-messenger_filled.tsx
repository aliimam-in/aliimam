...
export interface BrandMessengerFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const BrandMessengerFilled = React.forwardRef<SVGSVGElement, BrandMessengerFilledProps>(
...
BrandMessengerFilled.displayName = "BrandMessengerFilled";
export const BrandMessengerFilledMetadata = { id: "brand-messenger_filled", baseId: "brand-messenger", variant: "filled", name: "Brand Messenger", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
export default BrandMessengerFilled;
