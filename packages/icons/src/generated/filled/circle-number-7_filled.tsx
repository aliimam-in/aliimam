...
export const CircleNumber7FilledMetadata = { id: "circle-number-7_filled", baseId: "circle-number-7", variant: "filled", name: "Circle Number 7", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
