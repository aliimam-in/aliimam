/**
 * Auto-generated logo component: Pig Filled (default)
 * Category: filled
...
export interface PigFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const PigFilledLogo = React.forwardRef<SVGSVGElement, PigFilledLogoProps>(
...
PigFilledLogo.displayName = "PigFilledLogo";

export const PigFilledLogoMetadata = {
  id: "pig-filled",
  baseId: "pig-filled",
  variant: "default",
  name: "Pig Filled",
