/**
 * Auto-generated logo component: Brand Stripe Filled (default)
 * Category: filled
...
export interface BrandStripeFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const BrandStripeFilledLogo = React.forwardRef<SVGSVGElement, BrandStripeFilledLogoProps>(
...
BrandStripeFilledLogo.displayName = "BrandStripeFilledLogo";

export const BrandStripeFilledLogoMetadata = {
  id: "brand-stripe-filled",
  baseId: "brand-stripe-filled",
  variant: "default",
...
export default BrandStripeFilledLogo;
