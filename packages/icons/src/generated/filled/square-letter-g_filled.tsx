...
export const SquareLetterGFilledMetadata = { id: "square-letter-g_filled", baseId: "square-letter-g", variant: "filled", name: "Square Letter G", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
