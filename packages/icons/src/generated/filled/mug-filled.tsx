/**
 * Auto-generated logo component: Mug Filled (default)
 * Category: filled
...
export interface MugFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const MugFilledLogo = React.forwardRef<SVGSVGElement, MugFilledLogoProps>(
...
MugFilledLogo.displayName = "MugFilledLogo";

export const MugFilledLogoMetadata = {
  id: "mug-filled",
  baseId: "mug-filled",
  variant: "default",
  name: "Mug Filled",
