...
export const CircleCaretDownFilledMetadata = { id: "circle-caret-down_filled", baseId: "circle-caret-down", variant: "filled", name: "Circle Caret Down", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
