...
export const RelationOneToManyFilledMetadata = { id: "relation-one-to-many_filled", baseId: "relation-one-to-many", variant: "filled", name: "Relation One To Many", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
