...
export interface MugFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const MugFilled = React.forwardRef<SVGSVGElement, MugFilledProps>(
...
MugFilled.displayName = "MugFilled";
export const MugFilledMetadata = { id: "mug_filled", baseId: "mug", variant: "filled", name: "Mug", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
