...
export const SquareChevronLeftFilledMetadata = { id: "square-chevron-left_filled", baseId: "square-chevron-left", variant: "filled", name: "Square Chevron Left", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
