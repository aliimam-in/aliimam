...
export const BounceLeftFilledMetadata = { id: "bounce-left_filled", baseId: "bounce-left", variant: "filled", name: "Bounce Left", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
