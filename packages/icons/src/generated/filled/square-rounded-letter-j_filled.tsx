...
export const SquareRoundedLetterJFilledMetadata = { id: "square-rounded-letter-j_filled", baseId: "square-rounded-letter-j", variant: "filled", name: "Square Rounded Letter J", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
