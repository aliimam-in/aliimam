...
export const LayoutBottombarFilledMetadata = { id: "layout-bottombar_filled", baseId: "layout-bottombar", variant: "filled", name: "Layout Bottombar", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
