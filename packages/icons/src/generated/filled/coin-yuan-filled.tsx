/**
 * Auto-generated logo component: Coin Yuan Filled (default)
 * Category: filled
...
export interface CoinYuanFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const CoinYuanFilledLogo = React.forwardRef<SVGSVGElement, CoinYuanFilledLogoProps>(
...
CoinYuanFilledLogo.displayName = "CoinYuanFilledLogo";

export const CoinYuanFilledLogoMetadata = {
  id: "coin-yuan-filled",
  baseId: "coin-yuan-filled",
  variant: "default",
...
export default CoinYuanFilledLogo;
