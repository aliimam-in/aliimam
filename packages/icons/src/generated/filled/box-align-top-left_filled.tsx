...
export interface BoxAlignTopLeftFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const BoxAlignTopLeftFilled = React.forwardRef<SVGSVGElement, BoxAlignTopLeftFilledProps>(
...
BoxAlignTopLeftFilled.displayName = "BoxAlignTopLeftFilled";
export const BoxAlignTopLeftFilledMetadata = { 
