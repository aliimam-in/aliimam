/**
 * Auto-generated logo component: Box Align Top Left (filled)
 * Category: filled
...
export interface BoxAlignTopLeftFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const BoxAlignTopLeftFilledLogo = React.forwardRef<SVGSVGElement, BoxAlignTopLeftFilledLogoProps>(
...
BoxAlignTopLeftFilledLogo.displayName = "BoxAlignTopLeftFilledLogo";

export const BoxAlignTopLeftFilledLogoMetadata = {
  id: "box-align-top-left_filled",
  baseId: "box-align-top-left",
  variant: "filled",
...
export default BoxAlignTopLeftFilledLogo;
