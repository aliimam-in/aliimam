...
export const SquareLetterNFilledMetadata = { id: "square-letter-n_filled", baseId: "square-letter-n", variant: "filled", name: "Square Letter N", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
