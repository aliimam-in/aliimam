...
export const FileHorizontalFilledMetadata = { id: "file-horizontal_filled", baseId: "file-horizontal", variant: "filled", name: "File Horizontal", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
