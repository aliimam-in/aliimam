/**
 * Auto-generated logo component: Receipt Filled (default)
 * Category: filled
...
export interface ReceiptFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const ReceiptFilledLogo = React.forwardRef<SVGSVGElement, ReceiptFilledLogoProps>(
...
ReceiptFilledLogo.displayName = "ReceiptFilledLogo";

export const ReceiptFilledLogoMetadata = {
  id: "receipt-filled",
  baseId: "receipt-filled",
  variant: "default",
  name: "Receipt Filled",
  category: "filled",
  tags: [],
...
export default ReceiptFilledLogo;
