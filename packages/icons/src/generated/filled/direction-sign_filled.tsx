...
export interface DirectionSignFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const DirectionSignFilled = React.forwardRef<SVGSVGElement, DirectionSignFilledProps>(
...
DirectionSignFilled.displayName = "DirectionSignFilled";
export const DirectionSignFilledMetadata = { id: "direction-sign_filled", baseId: "direction-sign", variant: "filled", name: "Direction Sign", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
