/**
 * Auto-generated logo component: Bubble Text Filled (default)
 * Category: filled
...
export interface BubbleTextFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const BubbleTextFilledLogo = React.forwardRef<SVGSVGElement, BubbleTextFilledLogoProps>(
...
BubbleTextFilledLogo.displayName = "BubbleTextFilledLogo";

export const BubbleTextFilledLogoMetadata = {
  id: "bubble-text-filled",
  baseId: "bubble-text-filled",
  variant: "default",
...
export default BubbleTextFilledLogo;
