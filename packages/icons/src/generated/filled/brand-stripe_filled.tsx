...
export interface BrandStripeFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const BrandStripeFilled = React.forwardRef<SVGSVGElement, BrandStripeFilledProps>(
...
BrandStripeFilled.displayName = "BrandStripeFilled";
export const BrandStripeFilledMetadata = { id: "brand-stripe_filled", baseId: "brand-stripe", variant: "filled", name: "Brand Stripe", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
