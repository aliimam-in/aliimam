/**
 * Auto-generated logo component: Play Card Star Filled (default)
 * Category: filled
...
export interface PlayCardStarFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const PlayCardStarFilledLogo = React.forwardRef<SVGSVGElement, PlayCardStarFilledLogoProps>(
...
PlayCardStarFilledLogo.displayName = "PlayCardStarFilledLogo";

export const PlayCardStarFilledLogoMetadata = {
  id: "play-card-star-filled",
  baseId: "play-card-star-filled",
  variant: "default",
...
export default PlayCardStarFilledLogo;
