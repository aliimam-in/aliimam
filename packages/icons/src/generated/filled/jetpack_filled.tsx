...
export interface JetpackFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const JetpackFilled = React.forwardRef<SVGSVGElement, JetpackFilledProps>(
...
JetpackFilled.displayName = "JetpackFilled";
export const JetpackFilledMetadata = { id: "jetpack_filled", baseId: "jetpack", variant: "filled", name: "Jetpack", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
