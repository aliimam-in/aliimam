...
export const FilePencilFilledMetadata = { id: "file-pencil_filled", baseId: "file-pencil", variant: "filled", name: "File Pencil", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
