...
export interface LaurelWreath1FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const LaurelWreath1Filled = React.forwardRef<SVGSVGElement, LaurelWreath1FilledProps>(
...
LaurelWreath1Filled.displayName = "LaurelWreath1Filled";
export const LaurelWreath1FilledMetadata = { id: "laurel-wreath-1_filled", baseId: "laurel-wreath-1", variant: "filled", name: "Laurel Wreath 1", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
export default LaurelWreath1Filled;
