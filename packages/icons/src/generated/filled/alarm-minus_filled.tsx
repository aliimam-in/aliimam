...
export const AlarmMinusFilledMetadata = { id: "alarm-minus_filled", baseId: "alarm-minus", variant: "filled", name: "Alarm Minus", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
