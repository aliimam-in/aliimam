...
export const SquareArrowLeftFilledMetadata = { id: "square-arrow-left_filled", baseId: "square-arrow-left", variant: "filled", name: "Square Arrow Left", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
