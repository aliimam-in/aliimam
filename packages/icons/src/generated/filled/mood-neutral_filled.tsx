...
export const MoodNeutralFilledMetadata = { id: "mood-neutral_filled", baseId: "mood-neutral", variant: "filled", name: "Mood Neutral", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
