...
export const InnerShadowBottomRightFilledMetadata = { id: "inner-shadow-bottom-right_filled", baseId: "inner-shadow-bottom-right", variant: "filled", name: "Inner Shadow Bottom Right", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
