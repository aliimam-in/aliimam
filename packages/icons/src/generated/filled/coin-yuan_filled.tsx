...
export interface CoinYuanFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CoinYuanFilled = React.forwardRef<SVGSVGElement, CoinYuanFilledProps>(
...
CoinYuanFilled.displayName = "CoinYuanFilled";
export const CoinYuanFilledMetadata = { id: "coin-yuan_filled", baseId: "coin-yuan", variant: "filled", name: "Coin Yuan", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
