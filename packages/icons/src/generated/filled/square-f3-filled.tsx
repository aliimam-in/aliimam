/**
 * Auto-generated logo component: Square F3 Filled (default)
 * Category: filled
...
export interface SquareF3FilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const SquareF3FilledLogo = React.forwardRef<SVGSVGElement, SquareF3FilledLogoProps>(
...
SquareF3FilledLogo.displayName = "SquareF3FilledLogo";

export const SquareF3FilledLogoMetadata = {
  id: "square-f3-filled",
  baseId: "square-f3-filled",
  variant: "default",
...
export default SquareF3FilledLogo;
