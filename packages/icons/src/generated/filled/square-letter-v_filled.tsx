...
export const SquareLetterVFilledMetadata = { id: "square-letter-v_filled", baseId: "square-letter-v", variant: "filled", name: "Square Letter V", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
