...
export interface NurseFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const NurseFilled = React.forwardRef<SVGSVGElement, NurseFilledProps>(
...
NurseFilled.displayName = "NurseFilled";
export const NurseFilledMetadata = { id: "nurse_filled", baseId: "nurse", variant: "filled", name: "Nurse", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
