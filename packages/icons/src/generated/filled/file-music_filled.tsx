...
export const FileMusicFilledMetadata = { id: "file-music_filled", baseId: "file-music", variant: "filled", name: "File Music", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
