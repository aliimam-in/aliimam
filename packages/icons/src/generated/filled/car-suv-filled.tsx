/**
 * Auto-generated logo component: Car Suv Filled (default)
 * Category: filled
...
export interface CarSuvFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const CarSuvFilledLogo = React.forwardRef<SVGSVGElement, CarSuvFilledLogoProps>(
...
CarSuvFilledLogo.displayName = "CarSuvFilledLogo";

export const CarSuvFilledLogoMetadata = {
  id: "car-suv-filled",
  baseId: "car-suv-filled",
  variant: "default",
  name: "Car Suv Filled",
  category: "filled",
  tags: [],
...
export default CarSuvFilledLogo;
