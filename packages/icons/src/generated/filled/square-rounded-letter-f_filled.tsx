...
export const SquareRoundedLetterFFilledMetadata = { id: "square-rounded-letter-f_filled", baseId: "square-rounded-letter-f", variant: "filled", name: "Square Rounded Letter F", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
