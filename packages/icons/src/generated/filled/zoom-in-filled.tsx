/**
 * Auto-generated logo component: Zoom In Filled (default)
 * Category: filled
...
export interface ZoomInFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const ZoomInFilledLogo = React.forwardRef<SVGSVGElement, ZoomInFilledLogoProps>(
...
ZoomInFilledLogo.displayName = "ZoomInFilledLogo";

export const ZoomInFilledLogoMetadata = {
  id: "zoom-in-filled",
  baseId: "zoom-in-filled",
  variant: "default",
  name: "Zoom In Filled",
  category: "filled",
  tags: [],
...
export default ZoomInFilledLogo;
