...
export const MicrophoneFilledMetadata = { id: "microphone_filled", baseId: "microphone", variant: "filled", name: "Microphone", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
