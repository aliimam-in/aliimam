/**
 * Auto-generated logo component: Brand Vimeo Filled (default)
 * Category: filled
...
export interface BrandVimeoFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const BrandVimeoFilledLogo = React.forwardRef<SVGSVGElement, BrandVimeoFilledLogoProps>(
...
BrandVimeoFilledLogo.displayName = "BrandVimeoFilledLogo";

export const BrandVimeoFilledLogoMetadata = {
  id: "brand-vimeo-filled",
  baseId: "brand-vimeo-filled",
  variant: "default",
...
export default BrandVimeoFilledLogo;
