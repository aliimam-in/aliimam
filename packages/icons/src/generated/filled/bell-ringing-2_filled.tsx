...
export interface BellRinging2FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const BellRinging2Filled = React.forwardRef<SVGSVGElement, BellRinging2FilledProps>(
...
BellRinging2Filled.displayName = "BellRinging2Filled";
export const BellRinging2FilledMetadata = { id: "bell-ringing-2_filled", baseId: "bell-ringing-2", variant: "filled", name: "Bell Ringing 2", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
