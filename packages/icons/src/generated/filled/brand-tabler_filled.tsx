...
export const BrandTablerFilledMetadata = { id: "brand-tabler_filled", baseId: "brand-tabler", variant: "filled", name: "Brand Tabler", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
