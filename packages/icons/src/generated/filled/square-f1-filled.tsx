/**
 * Auto-generated logo component: Square F1 Filled (default)
 * Category: filled
...
export interface SquareF1FilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const SquareF1FilledLogo = React.forwardRef<SVGSVGElement, SquareF1FilledLogoProps>(
...
SquareF1FilledLogo.displayName = "SquareF1FilledLogo";

export const SquareF1FilledLogoMetadata = {
  id: "square-f1-filled",
  baseId: "square-f1-filled",
  variant: "default",
...
export default SquareF1FilledLogo;
