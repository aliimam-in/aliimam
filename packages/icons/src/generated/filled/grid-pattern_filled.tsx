...
export const GridPatternFilledMetadata = { id: "grid-pattern_filled", baseId: "grid-pattern", variant: "filled", name: "Grid Pattern", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
