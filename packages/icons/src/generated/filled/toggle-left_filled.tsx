...
export const ToggleLeftFilledMetadata = { id: "toggle-left_filled", baseId: "toggle-left", variant: "filled", name: "Toggle Left", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
