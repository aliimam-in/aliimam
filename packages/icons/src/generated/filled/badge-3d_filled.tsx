...
export interface Badge3dFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const Badge3dFilled = React.forwardRef<SVGSVGElement, Badge3dFilledProps>(
...
Badge3dFilled.displayName = "Badge3dFilled";
export const Badge3dFilledMetadata = { id: "badge-3d_filled", baseId: "badge-3d", variant: "filled", name: "Badge 3d", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
