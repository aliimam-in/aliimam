/**
 * Auto-generated logo component: Paw Filled (default)
 * Category: filled
...
export interface PawFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const PawFilledLogo = React.forwardRef<SVGSVGElement, PawFilledLogoProps>(
...
PawFilledLogo.displayName = "PawFilledLogo";

export const PawFilledLogoMetadata = {
  id: "paw-filled",
  baseId: "paw-filled",
  variant: "default",
  name: "Paw Filled",
