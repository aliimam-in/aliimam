...
export interface SaladFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const SaladFilled = React.forwardRef<SVGSVGElement, SaladFilledProps>(
...
SaladFilled.displayName = "SaladFilled";
export const SaladFilledMetadata = { id: "salad_filled", baseId: "salad", variant: "filled", name: "Salad", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
export default SaladFilled;
