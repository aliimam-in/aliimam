/**
 * Auto-generated logo component: Paint Filled (default)
 * Category: filled
...
export interface PaintFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const PaintFilledLogo = React.forwardRef<SVGSVGElement, PaintFilledLogoProps>(
...
PaintFilledLogo.displayName = "PaintFilledLogo";

export const PaintFilledLogoMetadata = {
  id: "paint-filled",
  baseId: "paint-filled",
  variant: "default",
  name: "Paint Filled",
...
export default PaintFilledLogo;
