...
export interface FlowerFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const FlowerFilled = React.forwardRef<SVGSVGElement, FlowerFilledProps>(
...
export const FlowerFilledMetadata = { id: "flower_filled", baseId: "flower", variant: "filled", name: "Flower", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
