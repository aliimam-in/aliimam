...
export interface LaurelWreath3FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const LaurelWreath3Filled = React.forwardRef<SVGSVGElement, LaurelWreath3FilledProps>(
...
LaurelWreath3Filled.displayName = "LaurelWreath3Filled";
export const LaurelWreath3FilledMetadata = { id: "laurel-wreath-3_filled", baseId: "laurel-wreath-3", variant: "filled", name: "Laurel Wreath 3", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
export default LaurelWreath3Filled;
