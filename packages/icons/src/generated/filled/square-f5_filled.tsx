...
export interface SquareF5FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const SquareF5Filled = React.forwardRef<SVGSVGElement, SquareF5FilledProps>(
...
SquareF5Filled.displayName = "SquareF5Filled";
export const SquareF5FilledMetadata = { id: "square-f5_filled", baseId: "square-f5", variant: "filled", name: "Square F5", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
export default SquareF5Filled;
