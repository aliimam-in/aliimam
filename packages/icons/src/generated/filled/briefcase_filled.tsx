...
export interface BriefcaseFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const BriefcaseFilled = React.forwardRef<SVGSVGElement, BriefcaseFilledProps>(
...
BriefcaseFilled.displayName = "BriefcaseFilled";
export const BriefcaseFilledMetadata = { id: "briefcase_filled", baseId: "briefcase", variant: "filled", name: "Briefcase", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
