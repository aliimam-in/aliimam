/**
 * Auto-generated logo component: Droplet Half 2 Filled (default)
 * Category: filled
...
export interface DropletHalf2FilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const DropletHalf2FilledLogo = React.forwardRef<SVGSVGElement, DropletHalf2FilledLogoProps>(
...
DropletHalf2FilledLogo.displayName = "DropletHalf2FilledLogo";

export const DropletHalf2FilledLogoMetadata = {
  id: "droplet-half-2-filled",
  baseId: "droplet-half-2-filled",
  variant: "default",
...
export default DropletHalf2FilledLogo;
