...
export const BrandFacebookFilledMetadata = { id: "brand-facebook_filled", baseId: "brand-facebook", variant: "filled", name: "Brand Facebook", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
