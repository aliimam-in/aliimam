...
export const PlayerSkipForwardFilledMetadata = { id: "player-skip-forward_filled", baseId: "player-skip-forward", variant: "filled", name: "Player Skip Forward", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
