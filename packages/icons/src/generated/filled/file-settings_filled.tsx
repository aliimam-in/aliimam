...
export const FileSettingsFilledMetadata = { id: "file-settings_filled", baseId: "file-settings", variant: "filled", name: "File Settings", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
