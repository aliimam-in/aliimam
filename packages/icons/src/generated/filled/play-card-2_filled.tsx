...
export const PlayCard2FilledMetadata = { id: "play-card-2_filled", baseId: "play-card-2", variant: "filled", name: "Play Card 2", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
