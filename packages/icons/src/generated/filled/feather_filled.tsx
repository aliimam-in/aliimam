...
export interface FeatherFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const FeatherFilled = React.forwardRef<SVGSVGElement, FeatherFilledProps>(
...
FeatherFilled.displayName = "FeatherFilled";
export const FeatherFilledMetadata = { id: "feather_filled", baseId: "feather", variant: "filled", name: "Feather", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
