...
export interface Stack2FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const Stack2Filled = React.forwardRef<SVGSVGElement, Stack2FilledProps>(
...
Stack2Filled.displayName = "Stack2Filled";
export const Stack2FilledMetadata = { id: "stack-2_filled", baseId: "stack-2", variant: "filled", name: "Stack 2", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
