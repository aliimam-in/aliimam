/**
 * Auto-generated logo component: Message Circle Filled (default)
 * Category: filled
...
export interface MessageCircleFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const MessageCircleFilledLogo = React.forwardRef<SVGSVGElement, MessageCircleFilledLogoProps>(
...
MessageCircleFilledLogo.displayName = "MessageCircleFilledLogo";

export const MessageCircleFilledLogoMetadata = {
  id: "message-circle-filled",
  baseId: "message-circle-filled",
  variant: "default",
...
export default MessageCircleFilledLogo;
