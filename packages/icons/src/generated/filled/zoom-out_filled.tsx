...
export interface ZoomOutFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ZoomOutFilled = React.forwardRef<SVGSVGElement, ZoomOutFilledProps>(
...
export const ZoomOutFilledMetadata = { id: "zoom-out_filled", baseId: "zoom-out", variant: "filled", name: "Zoom Out", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
