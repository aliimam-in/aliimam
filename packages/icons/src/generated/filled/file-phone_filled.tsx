...
export const FilePhoneFilledMetadata = { id: "file-phone_filled", baseId: "file-phone", variant: "filled", name: "File Phone", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
