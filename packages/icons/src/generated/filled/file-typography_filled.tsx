...
export const FileTypographyFilledMetadata = { id: "file-typography_filled", baseId: "file-typography", variant: "filled", name: "File Typography", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
