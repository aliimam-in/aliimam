...
export const ChessKnightFilledMetadata = { id: "chess-knight_filled", baseId: "chess-knight", variant: "filled", name: "Chess Knight", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
