...
export interface BrandPaypalFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const BrandPaypalFilled = React.forwardRef<SVGSVGElement, BrandPaypalFilledProps>(
...
BrandPaypalFilled.displayName = "BrandPaypalFilled";
export const BrandPaypalFilledMetadata = { id: "brand-paypal_filled", baseId: "brand-paypal", variant: "filled", name: "Brand Paypal", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
