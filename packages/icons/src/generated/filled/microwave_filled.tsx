...
export interface MicrowaveFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const MicrowaveFilled = React.forwardRef<SVGSVGElement, MicrowaveFilledProps>(
...
MicrowaveFilled.displayName = "MicrowaveFilled";
export const MicrowaveFilledMetadata = { id: "microwave_filled", baseId: "microwave", variant: "filled", name: "Microwave", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
export default MicrowaveFilled;
