...
export interface AppleFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const AppleFilled = React.forwardRef<SVGSVGElement, AppleFilledProps>(
...
export const AppleFilledMetadata = { id: "apple_filled", baseId: "apple", variant: "filled", name: "Apple", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
