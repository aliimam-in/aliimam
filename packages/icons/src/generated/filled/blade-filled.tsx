/**
 * Auto-generated logo component: Blade Filled (default)
 * Category: filled
...
export interface BladeFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const BladeFilledLogo = React.forwardRef<SVGSVGElement, BladeFilledLogoProps>(
...
BladeFilledLogo.displayName = "BladeFilledLogo";

export const BladeFilledLogoMetadata = {
  id: "blade-filled",
  baseId: "blade-filled",
  variant: "default",
  name: "Blade Filled",
...
export default BladeFilledLogo;
