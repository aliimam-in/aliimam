...
export const BuildingBroadcastTowerFilledMetadata = { id: "building-broadcast-tower_filled", baseId: "building-broadcast-tower", variant: "filled", name: "Building Broadcast Tower", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
