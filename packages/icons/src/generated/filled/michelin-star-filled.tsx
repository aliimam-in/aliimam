/**
 * Auto-generated logo component: Michelin Star Filled (default)
 * Category: filled
...
export interface MichelinStarFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const MichelinStarFilledLogo = React.forwardRef<SVGSVGElement, MichelinStarFilledLogoProps>(
...
MichelinStarFilledLogo.displayName = "MichelinStarFilledLogo";

export const MichelinStarFilledLogoMetadata = {
  id: "michelin-star-filled",
  baseId: "michelin-star-filled",
  variant: "default",
...
export default MichelinStarFilledLogo;
