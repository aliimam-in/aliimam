/**
 * Auto-generated logo component: Baby Carriage Filled (default)
 * Category: filled
...
export interface BabyCarriageFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const BabyCarriageFilledLogo = React.forwardRef<SVGSVGElement, BabyCarriageFilledLogoProps>(
...
BabyCarriageFilledLogo.displayName = "BabyCarriageFilledLogo";

export const BabyCarriageFilledLogoMetadata = {
  id: "baby-carriage-filled",
  baseId: "baby-carriage-filled",
  variant: "default",
...
export default BabyCarriageFilledLogo;
