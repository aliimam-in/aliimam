/**
 * Auto-generated logo component: Receipt Rupee Filled (default)
 * Category: filled
...
export interface ReceiptRupeeFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const ReceiptRupeeFilledLogo = React.forwardRef<SVGSVGElement, ReceiptRupeeFilledLogoProps>(
...
ReceiptRupeeFilledLogo.displayName = "ReceiptRupeeFilledLogo";

export const ReceiptRupeeFilledLogoMetadata = {
  id: "receipt-rupee-filled",
  baseId: "receipt-rupee-filled",
  variant: "default",
...
export default ReceiptRupeeFilledLogo;
