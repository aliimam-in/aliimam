/**
 * Auto-generated logo component: Palette Filled (default)
 * Category: filled
...
export interface PaletteFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const PaletteFilledLogo = React.forwardRef<SVGSVGElement, PaletteFilledLogoProps>(
...
PaletteFilledLogo.displayName = "PaletteFilledLogo";

export const PaletteFilledLogoMetadata = {
  id: "palette-filled",
  baseId: "palette-filled",
  variant: "default",
  name: "Palette Filled",
  category: "filled",
  tags: [],
...
export default PaletteFilledLogo;
