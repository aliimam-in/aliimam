...
export const MotorbikeFilledMetadata = { id: "motorbike_filled", baseId: "motorbike", variant: "filled", name: "Motorbike", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
