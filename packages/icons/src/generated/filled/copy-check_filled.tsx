...
export interface CopyCheckFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CopyCheckFilled = React.forwardRef<SVGSVGElement, CopyCheckFilledProps>(
...
CopyCheckFilled.displayName = "CopyCheckFilled";
export const CopyCheckFilledMetadata = { id: "copy-check_filled", baseId: "copy-check", variant: "filled", name: "Copy Check", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
