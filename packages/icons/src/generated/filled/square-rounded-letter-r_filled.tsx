...
export const SquareRoundedLetterRFilledMetadata = { id: "square-rounded-letter-r_filled", baseId: "square-rounded-letter-r", variant: "filled", name: "Square Rounded Letter R", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
