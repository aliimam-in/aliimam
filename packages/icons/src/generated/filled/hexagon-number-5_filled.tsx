...
export interface HexagonNumber5FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const HexagonNumber5Filled = React.forwardRef<SVGSVGElement, HexagonNumber5FilledProps>(
...
HexagonNumber5Filled.displayName = "HexagonNumber5Filled";
export const HexagonNumber5FilledMetadata = { id: "hexagon-number-5_filled", baseId: "hexagon-number-5", variant: "filled", name: "Hexagon Number 5", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
