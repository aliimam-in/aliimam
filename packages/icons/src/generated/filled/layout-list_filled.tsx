...
export const LayoutListFilledMetadata = { id: "layout-list_filled", baseId: "layout-list", variant: "filled", name: "Layout List", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
