/**
 * Auto-generated logo component: Meeple Filled (default)
 * Category: filled
...
export interface MeepleFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const MeepleFilledLogo = React.forwardRef<SVGSVGElement, MeepleFilledLogoProps>(
...
MeepleFilledLogo.displayName = "MeepleFilledLogo";

export const MeepleFilledLogoMetadata = {
  id: "meeple-filled",
  baseId: "meeple-filled",
  variant: "default",
  name: "Meeple Filled",
  category: "filled",
  tags: [],
...
export default MeepleFilledLogo;
