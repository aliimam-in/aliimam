...
export const LayoutNavbarCollapseFilledMetadata = { id: "layout-navbar-collapse_filled", baseId: "layout-navbar-collapse", variant: "filled", name: "Layout Navbar Collapse", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
