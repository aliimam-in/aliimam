/**
 * Auto-generated logo component: Laurel Wreath 2 Filled (default)
 * Category: filled
...
export interface LaurelWreath2FilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const LaurelWreath2FilledLogo = React.forwardRef<SVGSVGElement, LaurelWreath2FilledLogoProps>(
...
LaurelWreath2FilledLogo.displayName = "LaurelWreath2FilledLogo";

export const LaurelWreath2FilledLogoMetadata = {
  id: "laurel-wreath-2-filled",
  baseId: "laurel-wreath-2-filled",
  variant: "default",
...
export default LaurelWreath2FilledLogo;
