/**
 * Auto-generated logo component: Info Hexagon Filled (default)
 * Category: filled
...
export interface InfoHexagonFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const InfoHexagonFilledLogo = React.forwardRef<SVGSVGElement, InfoHexagonFilledLogoProps>(
...
InfoHexagonFilledLogo.displayName = "InfoHexagonFilledLogo";

export const InfoHexagonFilledLogoMetadata = {
  id: "info-hexagon-filled",
  baseId: "info-hexagon-filled",
  variant: "default",
...
export default InfoHexagonFilledLogo;
