...
export const BinaryTreeFilledMetadata = { id: "binary-tree_filled", baseId: "binary-tree", variant: "filled", name: "Binary Tree", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
