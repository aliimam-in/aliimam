...
export interface RosetteDiscountFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const RosetteDiscountFilled = React.forwardRef<SVGSVGElement, RosetteDiscountFilledProps>(
...
RosetteDiscountFilled.displayName = "RosetteDiscountFilled";
export const RosetteDiscountFilledMetadata = { id: "rosette-discount_filled", baseId: "rosette-discount", variant: "filled", name: "Rosette Discount", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
