...
export interface ExchangeFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ExchangeFilled = React.forwardRef<SVGSVGElement, ExchangeFilledProps>(
...
ExchangeFilled.displayName = "ExchangeFilled";
export const ExchangeFilledMetadata = { id: "exchange_filled", baseId: "exchange", variant: "filled", name: "Exchange", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
