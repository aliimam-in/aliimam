...
export const BatteryVerticalFilledMetadata = { id: "battery-vertical_filled", baseId: "battery-vertical", variant: "filled", name: "Battery Vertical", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
