/**
 * Auto-generated logo component: Zeppelin Filled (default)
 * Category: filled
...
export interface ZeppelinFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const ZeppelinFilledLogo = React.forwardRef<SVGSVGElement, ZeppelinFilledLogoProps>(
...
ZeppelinFilledLogo.displayName = "ZeppelinFilledLogo";

export const ZeppelinFilledLogoMetadata = {
  id: "zeppelin-filled",
  baseId: "zeppelin-filled",
  variant: "default",
...
export default ZeppelinFilledLogo;
