/**
 * Auto-generated logo component: Help Hexagon Filled (default)
 * Category: filled
...
export interface HelpHexagonFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const HelpHexagonFilledLogo = React.forwardRef<SVGSVGElement, HelpHexagonFilledLogoProps>(
...
HelpHexagonFilledLogo.displayName = "HelpHexagonFilledLogo";

export const HelpHexagonFilledLogoMetadata = {
  id: "help-hexagon-filled",
  baseId: "help-hexagon-filled",
  variant: "default",
...
export default HelpHexagonFilledLogo;
