...
export const AirBalloonFilledMetadata = { id: "air-balloon_filled", baseId: "air-balloon", variant: "filled", name: "Air Balloon", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
