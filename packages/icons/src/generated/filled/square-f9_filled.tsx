...
export interface SquareF9FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const SquareF9Filled = React.forwardRef<SVGSVGElement, SquareF9FilledProps>(
...
SquareF9Filled.displayName = "SquareF9Filled";
export const SquareF9FilledMetadata = { id: "square-f9_filled", baseId: "square-f9", variant: "filled", name: "Square F9", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
