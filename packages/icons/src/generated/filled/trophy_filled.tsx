...
export interface TrophyFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const TrophyFilled = React.forwardRef<SVGSVGElement, TrophyFilledProps>(
...
export const TrophyFilledMetadata = { id: "trophy_filled", baseId: "trophy", variant: "filled", name: "Trophy", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
