...
export const ZoomQuestionFilledMetadata = { id: "zoom-question_filled", baseId: "zoom-question", variant: "filled", name: "Zoom Question", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
