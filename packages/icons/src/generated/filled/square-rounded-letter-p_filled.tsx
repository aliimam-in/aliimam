...
export const SquareRoundedLetterPFilledMetadata = { id: "square-rounded-letter-p_filled", baseId: "square-rounded-letter-p", variant: "filled", name: "Square Rounded Letter P", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
