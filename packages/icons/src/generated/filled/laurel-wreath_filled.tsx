...
export interface LaurelWreathFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const LaurelWreathFilled = React.forwardRef<SVGSVGElement, LaurelWreathFilledProps>(
...
LaurelWreathFilled.displayName = "LaurelWreathFilled";
export const LaurelWreathFilledMetadata = { id: "laurel-wreath_filled", baseId: "laurel-wreath", variant: "filled", name: "Laurel Wreath", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
export default LaurelWreathFilled;
