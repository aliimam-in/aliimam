...
export const SquareArrowUpFilledMetadata = { id: "square-arrow-up_filled", baseId: "square-arrow-up", variant: "filled", name: "Square Arrow Up", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
