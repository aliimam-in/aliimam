...
export const ChartDots2FilledMetadata = { id: "chart-dots-2_filled", baseId: "chart-dots-2", variant: "filled", name: "Chart Dots 2", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
