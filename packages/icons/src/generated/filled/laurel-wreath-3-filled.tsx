/**
 * Auto-generated logo component: Laurel Wreath 3 Filled (default)
 * Category: filled
...
export interface LaurelWreath3FilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const LaurelWreath3FilledLogo = React.forwardRef<SVGSVGElement, LaurelWreath3FilledLogoProps>(
...
LaurelWreath3FilledLogo.displayName = "LaurelWreath3FilledLogo";

export const LaurelWreath3FilledLogoMetadata = {
  id: "laurel-wreath-3-filled",
  baseId: "laurel-wreath-3-filled",
  variant: "default",
...
export default LaurelWreath3FilledLogo;
