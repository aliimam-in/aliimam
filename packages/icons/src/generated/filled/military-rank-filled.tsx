/**
 * Auto-generated logo component: Military Rank Filled (default)
 * Category: filled
...
export interface MilitaryRankFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const MilitaryRankFilledLogo = React.forwardRef<SVGSVGElement, MilitaryRankFilledLogoProps>(
...
MilitaryRankFilledLogo.displayName = "MilitaryRankFilledLogo";

export const MilitaryRankFilledLogoMetadata = {
  id: "military-rank-filled",
  baseId: "military-rank-filled",
  variant: "default",
...
export default MilitaryRankFilledLogo;
