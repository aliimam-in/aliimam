...
export interface BadgeArFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const BadgeArFilled = React.forwardRef<SVGSVGElement, BadgeArFilledProps>(
...
BadgeArFilled.displayName = "BadgeArFilled";
export const BadgeArFilledMetadata = { id: "badge-ar_filled", baseId: "badge-ar", variant: "filled", name: "Badge Ar", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
