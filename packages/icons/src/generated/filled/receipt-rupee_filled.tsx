...
export interface ReceiptRupeeFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ReceiptRupeeFilled = React.forwardRef<SVGSVGElement, ReceiptRupeeFilledProps>(
...
ReceiptRupeeFilled.displayName = "ReceiptRupeeFilled";
export const ReceiptRupeeFilledMetadata = { id: "receipt-rupee_filled", baseId: "receipt-rupee", variant: "filled", name: "Receipt Rupee", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
export default ReceiptRupeeFilled;
