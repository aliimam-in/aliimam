...
export const CircleRectangleFilledMetadata = { id: "circle-rectangle_filled", baseId: "circle-rectangle", variant: "filled", name: "Circle Rectangle", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
