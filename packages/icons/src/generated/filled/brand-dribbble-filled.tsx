/**
 * Auto-generated logo component: Brand Dribbble Filled (default)
 * Category: filled
...
export interface BrandDribbbleFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const BrandDribbbleFilledLogo = React.forwardRef<SVGSVGElement, BrandDribbbleFilledLogoProps>(
...
BrandDribbbleFilledLogo.displayName = "BrandDribbbleFilledLogo";

export const BrandDribbbleFilledLogoMetadata = {
  id: "brand-dribbble-filled",
  baseId: "brand-dribbble-filled",
  variant: "default",
...
export default BrandDribbbleFilledLogo;
