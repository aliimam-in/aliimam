...
export const SquareLetterSFilledMetadata = { id: "square-letter-s_filled", baseId: "square-letter-s", variant: "filled", name: "Square Letter S", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
