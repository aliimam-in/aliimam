...
export const SquareRoundedLetterYFilledMetadata = { id: "square-rounded-letter-y_filled", baseId: "square-rounded-letter-y", variant: "filled", name: "Square Rounded Letter Y", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
