...
export interface BoxAlignLeftFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const BoxAlignLeftFilled = React.forwardRef<SVGSVGElement, BoxAlignLeftFilledProps>(
...
BoxAlignLeftFilled.displayName = "BoxAlignLeftFilled";
export const BoxAlignLeftFilledMetadata = { 
