/**
 * Auto-generated logo component: Box Align Left (filled)
 * Category: filled
...
export interface BoxAlignLeftFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const BoxAlignLeftFilledLogo = React.forwardRef<SVGSVGElement, BoxAlignLeftFilledLogoProps>(
...
BoxAlignLeftFilledLogo.displayName = "BoxAlignLeftFilledLogo";

export const BoxAlignLeftFilledLogoMetadata = {
  id: "box-align-left_filled",
  baseId: "box-align-left",
  variant: "filled",
  name: "Box Align Left",
  category: "filled",
  tags: [],
...
export default BoxAlignLeftFilledLogo;
