...
export const SquareLetterUFilledMetadata = { id: "square-letter-u_filled", baseId: "square-letter-u", variant: "filled", name: "Square Letter U", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
