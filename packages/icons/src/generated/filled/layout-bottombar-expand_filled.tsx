...
export const LayoutBottombarExpandFilledMetadata = { id: "layout-bottombar-expand_filled", baseId: "layout-bottombar-expand", variant: "filled", name: "Layout Bottombar Expand", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
