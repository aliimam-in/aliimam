...
export const MilitaryRankFilledMetadata = { id: "military-rank_filled", baseId: "military-rank", variant: "filled", name: "Military Rank", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
