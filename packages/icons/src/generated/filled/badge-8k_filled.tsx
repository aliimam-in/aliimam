...
export interface Badge8kFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const Badge8kFilled = React.forwardRef<SVGSVGElement, Badge8kFilledProps>(
...
Badge8kFilled.displayName = "Badge8kFilled";
export const Badge8kFilledMetadata = { id: "badge-8k_filled", baseId: "badge-8k", variant: "filled", name: "Badge 8k", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
