/**
 * Auto-generated logo component: Carambola Filled (default)
 * Category: filled
...
export interface CarambolaFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const CarambolaFilledLogo = React.forwardRef<SVGSVGElement, CarambolaFilledLogoProps>(
...
CarambolaFilledLogo.displayName = "CarambolaFilledLogo";

export const CarambolaFilledLogoMetadata = {
  id: "carambola-filled",
  baseId: "carambola-filled",
  variant: "default",
...
export default CarambolaFilledLogo;
