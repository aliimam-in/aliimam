...
export const TriangleSquareCircleFilledMetadata = { id: "triangle-square-circle_filled", baseId: "triangle-square-circle", variant: "filled", name: "Triangle Square Circle", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
