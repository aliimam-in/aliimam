...
export interface CookieManFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CookieManFilled = React.forwardRef<SVGSVGElement, CookieManFilledProps>(
...
CookieManFilled.displayName = "CookieManFilled";
export const CookieManFilledMetadata = { id: "cookie-man_filled", baseId: "cookie-man", variant: "filled", name: "Cookie Man", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
