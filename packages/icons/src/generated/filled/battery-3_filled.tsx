...
export const Battery3FilledMetadata = { id: "battery-3_filled", baseId: "battery-3", variant: "filled", name: "Battery 3", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
