/**
 * Auto-generated logo component: Box Align Right (filled)
 * Category: filled
...
export interface BoxAlignRightFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const BoxAlignRightFilledLogo = React.forwardRef<SVGSVGElement, BoxAlignRightFilledLogoProps>(
...
BoxAlignRightFilledLogo.displayName = "BoxAlignRightFilledLogo";

export const BoxAlignRightFilledLogoMetadata = {
  id: "box-align-right_filled",
  baseId: "box-align-right",
  variant: "filled",
...
export default BoxAlignRightFilledLogo;
