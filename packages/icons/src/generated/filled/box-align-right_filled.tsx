...
export interface BoxAlignRightFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const BoxAlignRightFilled = React.forwardRef<SVGSVGElement, BoxAlignRightFilledProps>(
...
BoxAlignRightFilled.displayName = "BoxAlignRightFilled";
export const BoxAlignRightFilledMetadata = { 
