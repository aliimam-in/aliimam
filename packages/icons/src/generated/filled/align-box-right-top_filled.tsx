...
export const AlignBoxRightTopFilledMetadata = { id: "align-box-right-top_filled", baseId: "align-box-right-top", variant: "filled", name: "Align Box Right Top", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
