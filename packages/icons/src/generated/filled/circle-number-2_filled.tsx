...
export const CircleNumber2FilledMetadata = { id: "circle-number-2_filled", baseId: "circle-number-2", variant: "filled", name: "Circle Number 2", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
