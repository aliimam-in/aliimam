/**
 * Auto-generated logo component: Gift Card Filled (default)
 * Category: filled
...
export interface GiftCardFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const GiftCardFilledLogo = React.forwardRef<SVGSVGElement, GiftCardFilledLogoProps>(
...
GiftCardFilledLogo.displayName = "GiftCardFilledLogo";

export const GiftCardFilledLogoMetadata = {
  id: "gift-card-filled",
  baseId: "gift-card-filled",
  variant: "default",
...
export default GiftCardFilledLogo;
