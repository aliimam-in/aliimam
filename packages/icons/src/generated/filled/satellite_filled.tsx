...
export interface SatelliteFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const SatelliteFilled = React.forwardRef<SVGSVGElement, SatelliteFilledProps>(
...
SatelliteFilled.displayName = "SatelliteFilled";
export const SatelliteFilledMetadata = { id: "satellite_filled", baseId: "satellite", variant: "filled", name: "Satellite", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
