...
export const AdjustmentsFilledMetadata = { id: "adjustments_filled", baseId: "adjustments", variant: "filled", name: "Adjustments", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
