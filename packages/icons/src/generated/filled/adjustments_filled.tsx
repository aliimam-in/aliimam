...
export interface AdjustmentsFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const AdjustmentsFilled = React.forwardRef<SVGSVGElement, AdjustmentsFilledProps>(
...
AdjustmentsFilled.displayName = "AdjustmentsFilled";
export const AdjustmentsFilledMetadata = { 
