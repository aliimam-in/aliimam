/**
 * Auto-generated logo component: Sparkles 2 Filled (default)
 * Category: filled
...
export interface Sparkles2FilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const Sparkles2FilledLogo = React.forwardRef<SVGSVGElement, Sparkles2FilledLogoProps>(
...
Sparkles2FilledLogo.displayName = "Sparkles2FilledLogo";

export const Sparkles2FilledLogoMetadata = {
  id: "sparkles-2-filled",
  baseId: "sparkles-2-filled",
  variant: "default",
  name: "Sparkles 2 Filled",
  category: "filled",
  tags: [],
  viewBox: "0 0 24 24",
} as const;

export default Sparkles2FilledLogo;
