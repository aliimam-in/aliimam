/**
 * Auto-generated logo component: Dumpling Filled (default)
 * Category: filled
...
export interface DumplingFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const DumplingFilledLogo = React.forwardRef<SVGSVGElement, DumplingFilledLogoProps>(
...
DumplingFilledLogo.displayName = "DumplingFilledLogo";

export const DumplingFilledLogoMetadata = {
  id: "dumpling-filled",
  baseId: "dumpling-filled",
  variant: "default",
...
export default DumplingFilledLogo;
