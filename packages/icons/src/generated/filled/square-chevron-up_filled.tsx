...
export const SquareChevronUpFilledMetadata = { id: "square-chevron-up_filled", baseId: "square-chevron-up", variant: "filled", name: "Square Chevron Up", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
