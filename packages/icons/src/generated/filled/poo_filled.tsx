...
export interface PooFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const PooFilled = React.forwardRef<SVGSVGElement, PooFilledProps>(
...
PooFilled.displayName = "PooFilled";
export const PooFilledMetadata = { id: "poo_filled", baseId: "poo", variant: "filled", name: "Poo", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
export default PooFilled;
