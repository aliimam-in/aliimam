...
export const CircleNumber1FilledMetadata = { id: "circle-number-1_filled", baseId: "circle-number-1", variant: "filled", name: "Circle Number 1", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
