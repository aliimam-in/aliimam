...
export interface AdCircleFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const AdCircleFilled = React.forwardRef<SVGSVGElement, AdCircleFilledProps>(
...
AdCircleFilled.displayName = "AdCircleFilled";
export const AdCircleFilledMetadata = { id: "ad-circle_filled", baseId: "ad-circle", variant: "filled", name: "Ad Circle", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
