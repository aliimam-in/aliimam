/**
 * Auto-generated logo component: Square F6 Filled (default)
 * Category: filled
...
export interface SquareF6FilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const SquareF6FilledLogo = React.forwardRef<SVGSVGElement, SquareF6FilledLogoProps>(
...
SquareF6FilledLogo.displayName = "SquareF6FilledLogo";

export const SquareF6FilledLogoMetadata = {
  id: "square-f6-filled",
  baseId: "square-f6-filled",
  variant: "default",
...
export default SquareF6FilledLogo;
