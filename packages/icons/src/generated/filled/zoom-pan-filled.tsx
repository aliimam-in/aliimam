/**
 * Auto-generated logo component: Zoom Pan Filled (default)
 * Category: filled
...
export interface ZoomPanFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const ZoomPanFilledLogo = React.forwardRef<SVGSVGElement, ZoomPanFilledLogoProps>(
...
ZoomPanFilledLogo.displayName = "ZoomPanFilledLogo";

export const ZoomPanFilledLogoMetadata = {
  id: "zoom-pan-filled",
  baseId: "zoom-pan-filled",
  variant: "default",
...
export default ZoomPanFilledLogo;
