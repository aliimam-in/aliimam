...
export const JewishStarFilledMetadata = { id: "jewish-star_filled", baseId: "jewish-star", variant: "filled", name: "Jewish Star", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
