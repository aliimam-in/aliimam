...
export interface LassoPolygonFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const LassoPolygonFilled = React.forwardRef<SVGSVGElement, LassoPolygonFilledProps>(
...
LassoPolygonFilled.displayName = "LassoPolygonFilled";
export const LassoPolygonFilledMetadata = { id: "lasso-polygon_filled", baseId: "lasso-polygon", variant: "filled", name: "Lasso Polygon", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
