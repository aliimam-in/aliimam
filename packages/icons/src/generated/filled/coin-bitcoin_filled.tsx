...
export interface CoinBitcoinFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CoinBitcoinFilled = React.forwardRef<SVGSVGElement, CoinBitcoinFilledProps>(
...
CoinBitcoinFilled.displayName = "CoinBitcoinFilled";
export const CoinBitcoinFilledMetadata = { id: "coin-bitcoin_filled", baseId: "coin-bitcoin", variant: "filled", name: "Coin Bitcoin", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
