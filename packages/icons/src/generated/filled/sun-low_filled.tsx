...
export interface SunLowFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const SunLowFilled = React.forwardRef<SVGSVGElement, SunLowFilledProps>(
...
SunLowFilled.displayName = "SunLowFilled";
export const SunLowFilledMetadata = { id: "sun-low_filled", baseId: "sun-low", variant: "filled", name: "Sun Low", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
