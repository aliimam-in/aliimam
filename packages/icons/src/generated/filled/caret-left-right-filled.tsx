/**
 * Auto-generated logo component: Caret Left Right Filled (default)
 * Category: filled
...
export interface CaretLeftRightFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const CaretLeftRightFilledLogo = React.forwardRef<SVGSVGElement, CaretLeftRightFilledLogoProps>(
...
CaretLeftRightFilledLogo.displayName = "CaretLeftRightFilledLogo";

export const CaretLeftRightFilledLogoMetadata = {
  id: "caret-left-right-filled",
  baseId: "caret-left-right-filled",
  variant: "default",
...
export default CaretLeftRightFilledLogo;
