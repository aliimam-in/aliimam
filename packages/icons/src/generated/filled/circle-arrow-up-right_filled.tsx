...
export const CircleArrowUpRightFilledMetadata = { id: "circle-arrow-up-right_filled", baseId: "circle-arrow-up-right", variant: "filled", name: "Circle Arrow Up Right", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
