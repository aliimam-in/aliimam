...
export interface AssetFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const AssetFilled = React.forwardRef<SVGSVGElement, AssetFilledProps>(
...
AssetFilled.displayName = "AssetFilled";
export const AssetFilledMetadata = { id: "asset_filled", baseId: "asset", variant: "filled", name: "Asset", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
