...
export interface ReceiptDollarFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ReceiptDollarFilled = React.forwardRef<SVGSVGElement, ReceiptDollarFilledProps>(
...
ReceiptDollarFilled.displayName = "ReceiptDollarFilled";
export const ReceiptDollarFilledMetadata = { id: "receipt-dollar_filled", baseId: "receipt-dollar", variant: "filled", name: "Receipt Dollar", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
