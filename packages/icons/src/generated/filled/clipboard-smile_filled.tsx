...
export const ClipboardSmileFilledMetadata = { id: "clipboard-smile_filled", baseId: "clipboard-smile", variant: "filled", name: "Clipboard Smile", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
