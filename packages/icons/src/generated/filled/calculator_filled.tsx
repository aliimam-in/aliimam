...
export const CalculatorFilledMetadata = { id: "calculator_filled", baseId: "calculator", variant: "filled", name: "Calculator", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
