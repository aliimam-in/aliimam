...
export const Ironing3FilledMetadata = { id: "ironing-3_filled", baseId: "ironing-3", variant: "filled", name: "Ironing 3", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
