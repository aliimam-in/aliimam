...
export const PlayCard6FilledMetadata = { id: "play-card-6_filled", baseId: "play-card-6", variant: "filled", name: "Play Card 6", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
