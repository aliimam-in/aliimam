/**
 * Auto-generated logo component: Alarm Filled (default)
 * Category: filled
...
export interface AlarmFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const AlarmFilledLogo = React.forwardRef<SVGSVGElement, AlarmFilledLogoProps>(
...
AlarmFilledLogo.displayName = "AlarmFilledLogo";

export const AlarmFilledLogoMetadata = {
  id: "alarm-filled",
  baseId: "alarm-filled",
  variant: "default",
  name: "Alarm Filled",
...
export default AlarmFilledLogo;
