...
export const SquareChevronRightFilledMetadata = { id: "square-chevron-right_filled", baseId: "square-chevron-right", variant: "filled", name: "Square Chevron Right", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
