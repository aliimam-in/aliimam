/**
 * Auto-generated logo component: Alien Filled (default)
 * Category: filled
...
export interface AlienFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const AlienFilledLogo = React.forwardRef<SVGSVGElement, AlienFilledLogoProps>(
...
AlienFilledLogo.displayName = "AlienFilledLogo";

export const AlienFilledLogoMetadata = {
  id: "alien-filled",
  baseId: "alien-filled",
  variant: "default",
  name: "Alien Filled",
...
export default AlienFilledLogo;
