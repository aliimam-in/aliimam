...
export const ClockHour7FilledMetadata = { id: "clock-hour-7_filled", baseId: "clock-hour-7", variant: "filled", name: "Clock Hour 7", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
