...
export interface CarFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CarFilled = React.forwardRef<SVGSVGElement, CarFilledProps>(
...
export const CarFilledMetadata = { id: "car_filled", baseId: "car", variant: "filled", name: "Car", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
