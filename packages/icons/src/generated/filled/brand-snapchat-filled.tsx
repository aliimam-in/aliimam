/**
 * Auto-generated logo component: Brand Snapchat Filled (default)
 * Category: filled
...
export interface BrandSnapchatFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const BrandSnapchatFilledLogo = React.forwardRef<SVGSVGElement, BrandSnapchatFilledLogoProps>(
...
BrandSnapchatFilledLogo.displayName = "BrandSnapchatFilledLogo";

export const BrandSnapchatFilledLogoMetadata = {
  id: "brand-snapchat-filled",
  baseId: "brand-snapchat-filled",
  variant: "default",
...
export default BrandSnapchatFilledLogo;
