/**
 * Auto-generated logo component: Ad Circle Filled (default)
 * Category: filled
...
export interface AdCircleFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const AdCircleFilledLogo = React.forwardRef<SVGSVGElement, AdCircleFilledLogoProps>(
...
AdCircleFilledLogo.displayName = "AdCircleFilledLogo";

export const AdCircleFilledLogoMetadata = {
  id: "ad-circle-filled",
  baseId: "ad-circle-filled",
  variant: "default",
...
export default AdCircleFilledLogo;
