...
export interface BugFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const BugFilled = React.forwardRef<SVGSVGElement, BugFilledProps>(
...
export const BugFilledMetadata = { id: "bug_filled", baseId: "bug", variant: "filled", name: "Bug", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
