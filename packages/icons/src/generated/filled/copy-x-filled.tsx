/**
 * Auto-generated logo component: Copy X Filled (default)
 * Category: filled
...
export interface CopyXFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const CopyXFilledLogo = React.forwardRef<SVGSVGElement, CopyXFilledLogoProps>(
...
CopyXFilledLogo.displayName = "CopyXFilledLogo";

export const CopyXFilledLogoMetadata = {
  id: "copy-x-filled",
  baseId: "copy-x-filled",
  variant: "default",
  name: "Copy X Filled",
  category: "filled",
  tags: [],
...
export default CopyXFilledLogo;
