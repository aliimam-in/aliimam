/**
 * Auto-generated logo component: Sun High Filled (default)
 * Category: filled
...
export interface SunHighFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const SunHighFilledLogo = React.forwardRef<SVGSVGElement, SunHighFilledLogoProps>(
...
SunHighFilledLogo.displayName = "SunHighFilledLogo";

export const SunHighFilledLogoMetadata = {
  id: "sun-high-filled",
  baseId: "sun-high-filled",
  variant: "default",
...
export default SunHighFilledLogo;
