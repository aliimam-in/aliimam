...
export const LayoutSidebarFilledMetadata = { id: "layout-sidebar_filled", baseId: "layout-sidebar", variant: "filled", name: "Layout Sidebar", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
