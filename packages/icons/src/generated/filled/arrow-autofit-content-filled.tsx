/**
 * Auto-generated logo component: Arrow Autofit Content Filled (default)
 * Category: filled
...
export interface ArrowAutofitContentFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const ArrowAutofitContentFilledLogo = React.forwardRef<SVGSVGElement, ArrowAutofitContentFilledLogoProps>(
...
ArrowAutofitContentFilledLogo.displayName = "ArrowAutofitContentFilledLogo";

export const ArrowAutofitContentFilledLogoMetadata = {
  id: "arrow-autofit-content-filled",
  baseId: "arrow-autofit-content-filled",
  variant: "default",
...
export default ArrowAutofitContentFilledLogo;
