...
export interface HexagonNumber8FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const HexagonNumber8Filled = React.forwardRef<SVGSVGElement, HexagonNumber8FilledProps>(
...
HexagonNumber8Filled.displayName = "HexagonNumber8Filled";
export const HexagonNumber8FilledMetadata = { id: "hexagon-number-8_filled", baseId: "hexagon-number-8", variant: "filled", name: "Hexagon Number 8", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
