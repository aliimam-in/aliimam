...
export const SquareDotFilledMetadata = { id: "square-dot_filled", baseId: "square-dot", variant: "filled", name: "Square Dot", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
