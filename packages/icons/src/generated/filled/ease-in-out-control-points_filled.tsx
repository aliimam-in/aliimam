...
export const EaseInOutControlPointsFilledMetadata = { id: "ease-in-out-control-points_filled", baseId: "ease-in-out-control-points", variant: "filled", name: "Ease In Out Control Points", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
