/**
 * Auto-generated logo component: Help Circle Filled (default)
 * Category: filled
...
export interface HelpCircleFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const HelpCircleFilledLogo = React.forwardRef<SVGSVGElement, HelpCircleFilledLogoProps>(
...
HelpCircleFilledLogo.displayName = "HelpCircleFilledLogo";

export const HelpCircleFilledLogoMetadata = {
  id: "help-circle-filled",
  baseId: "help-circle-filled",
  variant: "default",
...
export default HelpCircleFilledLogo;
