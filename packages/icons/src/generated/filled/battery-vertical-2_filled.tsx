...
export const BatteryVertical2FilledMetadata = { id: "battery-vertical-2_filled", baseId: "battery-vertical-2", variant: "filled", name: "Battery Vertical 2", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
