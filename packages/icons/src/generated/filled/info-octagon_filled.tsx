...
export interface InfoOctagonFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const InfoOctagonFilled = React.forwardRef<SVGSVGElement, InfoOctagonFilledProps>(
...
export const InfoOctagonFilledMetadata = { id: "info-octagon_filled", baseId: "info-octagon", variant: "filled", name: "Info Octagon", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
