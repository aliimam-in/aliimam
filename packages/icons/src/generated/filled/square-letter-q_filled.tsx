...
export const SquareLetterQFilledMetadata = { id: "square-letter-q_filled", baseId: "square-letter-q", variant: "filled", name: "Square Letter Q", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
