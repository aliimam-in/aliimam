/**
 * Auto-generated logo component: Stars Filled (default)
 * Category: filled
...
export interface StarsFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const StarsFilledLogo = React.forwardRef<SVGSVGElement, StarsFilledLogoProps>(
...
StarsFilledLogo.displayName = "StarsFilledLogo";

export const StarsFilledLogoMetadata = {
  id: "stars-filled",
  baseId: "stars-filled",
  variant: "default",
  name: "Stars Filled",
...
export default StarsFilledLogo;
