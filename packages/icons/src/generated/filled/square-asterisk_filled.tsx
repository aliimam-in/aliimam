...
export const SquareAsteriskFilledMetadata = { id: "square-asterisk_filled", baseId: "square-asterisk", variant: "filled", name: "Square Asterisk", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
