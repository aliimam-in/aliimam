/**
 * Auto-generated logo component: Pin Filled (default)
 * Category: filled
...
export interface PinFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const PinFilledLogo = React.forwardRef<SVGSVGElement, PinFilledLogoProps>(
...
PinFilledLogo.displayName = "PinFilledLogo";

export const PinFilledLogoMetadata = {
  id: "pin-filled",
  baseId: "pin-filled",
  variant: "default",
  name: "Pin Filled",
