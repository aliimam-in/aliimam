...
export const DeviceTabletFilledMetadata = { id: "device-tablet_filled", baseId: "device-tablet", variant: "filled", name: "Device Tablet", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
