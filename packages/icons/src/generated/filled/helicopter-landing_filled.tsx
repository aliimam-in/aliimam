...
export const HelicopterLandingFilledMetadata = { id: "helicopter-landing_filled", baseId: "helicopter-landing", variant: "filled", name: "Helicopter Landing", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
