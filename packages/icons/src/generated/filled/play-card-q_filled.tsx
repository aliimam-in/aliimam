...
export const PlayCardQFilledMetadata = { id: "play-card-q_filled", baseId: "play-card-q", variant: "filled", name: "Play Card Q", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
