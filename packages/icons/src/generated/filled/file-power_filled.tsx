...
export const FilePowerFilledMetadata = { id: "file-power_filled", baseId: "file-power", variant: "filled", name: "File Power", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
