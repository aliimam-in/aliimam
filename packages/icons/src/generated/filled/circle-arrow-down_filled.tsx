...
export const CircleArrowDownFilledMetadata = { id: "circle-arrow-down_filled", baseId: "circle-arrow-down", variant: "filled", name: "Circle Arrow Down", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
