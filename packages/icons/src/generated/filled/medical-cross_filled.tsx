...
export const MedicalCrossFilledMetadata = { id: "medical-cross_filled", baseId: "medical-cross", variant: "filled", name: "Medical Cross", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
