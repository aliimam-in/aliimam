...
export interface MedicalCrossFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const MedicalCrossFilled = React.forwardRef<SVGSVGElement, MedicalCrossFilledProps>(
...
MedicalCrossFilled.displayName = "MedicalCrossFilled";
export const MedicalCrossFilledMetadata = { 
