/**
 * Auto-generated logo component: Ufo Filled (default)
 * Category: filled
...
export interface UfoFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const UfoFilledLogo = React.forwardRef<SVGSVGElement, UfoFilledLogoProps>(
...
UfoFilledLogo.displayName = "UfoFilledLogo";

export const UfoFilledLogoMetadata = {
  id: "ufo-filled",
  baseId: "ufo-filled",
  variant: "default",
  name: "Ufo Filled",
