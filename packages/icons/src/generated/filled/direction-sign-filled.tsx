/**
 * Auto-generated logo component: Direction Sign Filled (default)
 * Category: filled
...
export interface DirectionSignFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const DirectionSignFilledLogo = React.forwardRef<SVGSVGElement, DirectionSignFilledLogoProps>(
...
DirectionSignFilledLogo.displayName = "DirectionSignFilledLogo";

export const DirectionSignFilledLogoMetadata = {
  id: "direction-sign-filled",
  baseId: "direction-sign-filled",
  variant: "default",
...
export default DirectionSignFilledLogo;
