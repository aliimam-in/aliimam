...
export const SquareArrowDownFilledMetadata = { id: "square-arrow-down_filled", baseId: "square-arrow-down", variant: "filled", name: "Square Arrow Down", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
