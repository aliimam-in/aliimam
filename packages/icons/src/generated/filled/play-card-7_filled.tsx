...
export const PlayCard7FilledMetadata = { id: "play-card-7_filled", baseId: "play-card-7", variant: "filled", name: "Play Card 7", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
