/**
 * Auto-generated logo component: Car Filled (default)
 * Category: filled
...
export interface CarFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const CarFilledLogo = React.forwardRef<SVGSVGElement, CarFilledLogoProps>(
...
CarFilledLogo.displayName = "CarFilledLogo";

export const CarFilledLogoMetadata = {
  id: "car-filled",
  baseId: "car-filled",
  variant: "default",
  name: "Car Filled",
