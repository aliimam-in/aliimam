...
export interface AwardFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const AwardFilled = React.forwardRef<SVGSVGElement, AwardFilledProps>(
...
AwardFilled.displayName = "AwardFilled";
export const AwardFilledMetadata = { id: "award_filled", baseId: "award", variant: "filled", name: "Award", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
