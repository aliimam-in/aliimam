...
export interface InfoTriangleFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const InfoTriangleFilled = React.forwardRef<SVGSVGElement, InfoTriangleFilledProps>(
...
InfoTriangleFilled.displayName = "InfoTriangleFilled";
export const InfoTriangleFilledMetadata = { id: "info-triangle_filled", baseId: "info-triangle", variant: "filled", name: "Info Triangle", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
