...
export const InnerShadowBottomFilledMetadata = { id: "inner-shadow-bottom_filled", baseId: "inner-shadow-bottom", variant: "filled", name: "Inner Shadow Bottom", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
