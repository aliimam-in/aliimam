/**
 * Auto-generated logo component: Section Filled (default)
 * Category: filled
...
export interface SectionFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const SectionFilledLogo = React.forwardRef<SVGSVGElement, SectionFilledLogoProps>(
...
SectionFilledLogo.displayName = "SectionFilledLogo";

export const SectionFilledLogoMetadata = {
  id: "section-filled",
  baseId: "section-filled",
  variant: "default",
  name: "Section Filled",
  category: "filled",
  tags: [],
...
export default SectionFilledLogo;
