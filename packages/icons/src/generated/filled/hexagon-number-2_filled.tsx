...
export interface HexagonNumber2FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const HexagonNumber2Filled = React.forwardRef<SVGSVGElement, HexagonNumber2FilledProps>(
...
HexagonNumber2Filled.displayName = "HexagonNumber2Filled";
export const HexagonNumber2FilledMetadata = { id: "hexagon-number-2_filled", baseId: "hexagon-number-2", variant: "filled", name: "Hexagon Number 2", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
