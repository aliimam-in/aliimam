...
export const SquareNumber1FilledMetadata = { id: "square-number-1_filled", baseId: "square-number-1", variant: "filled", name: "Square Number 1", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
