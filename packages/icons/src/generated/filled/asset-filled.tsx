/**
 * Auto-generated logo component: Asset Filled (default)
 * Category: filled
...
export interface AssetFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const AssetFilledLogo = React.forwardRef<SVGSVGElement, AssetFilledLogoProps>(
...
AssetFilledLogo.displayName = "AssetFilledLogo";

export const AssetFilledLogoMetadata = {
  id: "asset-filled",
  baseId: "asset-filled",
  variant: "default",
  name: "Asset Filled",
...
export default AssetFilledLogo;
