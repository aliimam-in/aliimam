/**
 * Auto-generated logo component: Polaroid Filled (default)
 * Category: filled
...
export interface PolaroidFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const PolaroidFilledLogo = React.forwardRef<SVGSVGElement, PolaroidFilledLogoProps>(
...
PolaroidFilledLogo.displayName = "PolaroidFilledLogo";

export const PolaroidFilledLogoMetadata = {
  id: "polaroid-filled",
  baseId: "polaroid-filled",
  variant: "default",
...
export default PolaroidFilledLogo;
