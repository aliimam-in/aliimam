/**
 * Auto-generated logo component: Live View Filled (default)
 * Category: filled
...
export interface LiveViewFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const LiveViewFilledLogo = React.forwardRef<SVGSVGElement, LiveViewFilledLogoProps>(
...
LiveViewFilledLogo.displayName = "LiveViewFilledLogo";

export const LiveViewFilledLogoMetadata = {
  id: "live-view-filled",
  baseId: "live-view-filled",
  variant: "default",
...
export default LiveViewFilledLogo;
