...
export interface CaptureFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CaptureFilled = React.forwardRef<SVGSVGElement, CaptureFilledProps>(
...
CaptureFilled.displayName = "CaptureFilled";
export const CaptureFilledMetadata = { id: "capture_filled", baseId: "capture", variant: "filled", name: "Capture", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
