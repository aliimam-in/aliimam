/**
 * Auto-generated logo component: Brand Paypal Filled (default)
 * Category: filled
...
export interface BrandPaypalFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const BrandPaypalFilledLogo = React.forwardRef<SVGSVGElement, BrandPaypalFilledLogoProps>(
...
BrandPaypalFilledLogo.displayName = "BrandPaypalFilledLogo";

export const BrandPaypalFilledLogoMetadata = {
  id: "brand-paypal-filled",
  baseId: "brand-paypal-filled",
  variant: "default",
...
export default BrandPaypalFilledLogo;
