...
export interface LivePhotoFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const LivePhotoFilled = React.forwardRef<SVGSVGElement, LivePhotoFilledProps>(
...
LivePhotoFilled.displayName = "LivePhotoFilled";
export const LivePhotoFilledMetadata = { 
...
export default LivePhotoFilled;
