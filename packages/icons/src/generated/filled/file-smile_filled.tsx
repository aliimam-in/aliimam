...
export const FileSmileFilledMetadata = { id: "file-smile_filled", baseId: "file-smile", variant: "filled", name: "File Smile", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
