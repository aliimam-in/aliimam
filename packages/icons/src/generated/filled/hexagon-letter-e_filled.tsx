...
export const HexagonLetterEFilledMetadata = { id: "hexagon-letter-e_filled", baseId: "hexagon-letter-e", variant: "filled", name: "Hexagon Letter E", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
