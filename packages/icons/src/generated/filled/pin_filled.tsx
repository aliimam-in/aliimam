...
export interface PinFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const PinFilled = React.forwardRef<SVGSVGElement, PinFilledProps>(
...
export const PinFilledMetadata = { id: "pin_filled", baseId: "pin", variant: "filled", name: "Pin", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
