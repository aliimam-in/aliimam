...
export const CircleNumber3FilledMetadata = { id: "circle-number-3_filled", baseId: "circle-number-3", variant: "filled", name: "Circle Number 3", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
