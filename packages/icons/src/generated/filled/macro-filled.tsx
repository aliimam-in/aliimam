/**
 * Auto-generated logo component: Macro Filled (default)
 * Category: filled
...
export interface MacroFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const MacroFilledLogo = React.forwardRef<SVGSVGElement, MacroFilledLogoProps>(
...
MacroFilledLogo.displayName = "MacroFilledLogo";

export const MacroFilledLogoMetadata = {
  id: "macro-filled",
  baseId: "macro-filled",
  variant: "default",
  name: "Macro Filled",
...
export default MacroFilledLogo;
