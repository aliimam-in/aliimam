...
export interface FishBoneFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const FishBoneFilled = React.forwardRef<SVGSVGElement, FishBoneFilledProps>(
...
FishBoneFilled.displayName = "FishBoneFilled";
export const FishBoneFilledMetadata = { id: "fish-bone_filled", baseId: "fish-bone", variant: "filled", name: "Fish Bone", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
