...
export interface PaletteFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const PaletteFilled = React.forwardRef<SVGSVGElement, PaletteFilledProps>(
...
PaletteFilled.displayName = "PaletteFilled";
export const PaletteFilledMetadata = { id: "palette_filled", baseId: "palette", variant: "filled", name: "Palette", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
