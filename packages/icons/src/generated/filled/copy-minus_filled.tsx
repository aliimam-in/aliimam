...
export const CopyMinusFilledMetadata = { id: "copy-minus_filled", baseId: "copy-minus", variant: "filled", name: "Copy Minus", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
