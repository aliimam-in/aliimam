...
export const BrandOperaFilledMetadata = { id: "brand-opera_filled", baseId: "brand-opera", variant: "filled", name: "Brand Opera", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
