...
export const RelationManyToManyFilledMetadata = { id: "relation-many-to-many_filled", baseId: "relation-many-to-many", variant: "filled", name: "Relation Many To Many", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
