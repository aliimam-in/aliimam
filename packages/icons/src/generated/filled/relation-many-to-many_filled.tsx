...
export interface RelationManyToManyFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const RelationManyToManyFilled = React.forwardRef<SVGSVGElement, RelationManyToManyFilledProps>(
...
RelationManyToManyFilled.displayName = "RelationManyToManyFilled";
export const RelationManyToManyFilledMetadata = { 
  id: "relation-many-to-many_filled", 
  baseId: "relation-many-to-many", 
  variant: "filled", 
