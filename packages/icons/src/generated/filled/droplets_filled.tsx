...
export interface DropletsFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const DropletsFilled = React.forwardRef<SVGSVGElement, DropletsFilledProps>(
...
DropletsFilled.displayName = "DropletsFilled";
export const DropletsFilledMetadata = { id: "droplets_filled", baseId: "droplets", variant: "filled", name: "Droplets", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
