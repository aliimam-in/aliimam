...
export const TimelineEventFilledMetadata = { id: "timeline-event_filled", baseId: "timeline-event", variant: "filled", name: "Timeline Event", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
