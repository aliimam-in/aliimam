/**
 * Auto-generated logo component: Writing Sign Filled (default)
 * Category: filled
...
export interface WritingSignFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const WritingSignFilledLogo = React.forwardRef<SVGSVGElement, WritingSignFilledLogoProps>(
...
WritingSignFilledLogo.displayName = "WritingSignFilledLogo";

export const WritingSignFilledLogoMetadata = {
  id: "writing-sign-filled",
  baseId: "writing-sign-filled",
  variant: "default",
  name: "Writing Sign Filled",
  category: "filled",
  tags: [],
  viewBox: "0 0 24 24",
} as const;

export default WritingSignFilledLogo;
