...
export interface DeviceTvOldFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const DeviceTvOldFilled = React.forwardRef<SVGSVGElement, DeviceTvOldFilledProps>(
...
DeviceTvOldFilled.displayName = "DeviceTvOldFilled";
export const DeviceTvOldFilledMetadata = { id: "device-tv-old_filled", baseId: "device-tv-old", variant: "filled", name: "Device Tv Old", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
