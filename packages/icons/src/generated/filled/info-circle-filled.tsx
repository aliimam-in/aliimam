/**
 * Auto-generated logo component: Info Circle Filled (default)
 * Category: filled
...
export interface InfoCircleFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const InfoCircleFilledLogo = React.forwardRef<SVGSVGElement, InfoCircleFilledLogoProps>(
...
InfoCircleFilledLogo.displayName = "InfoCircleFilledLogo";

export const InfoCircleFilledLogoMetadata = {
  id: "info-circle-filled",
  baseId: "info-circle-filled",
  variant: "default",
...
export default InfoCircleFilledLogo;
