/**
 * Auto-generated logo component: Chart Donut Filled (default)
 * Category: filled
...
export interface ChartDonutFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const ChartDonutFilledLogo = React.forwardRef<SVGSVGElement, ChartDonutFilledLogoProps>(
...
ChartDonutFilledLogo.displayName = "ChartDonutFilledLogo";

export const ChartDonutFilledLogoMetadata = {
  id: "chart-donut-filled",
  baseId: "chart-donut-filled",
  variant: "default",
...
export default ChartDonutFilledLogo;
