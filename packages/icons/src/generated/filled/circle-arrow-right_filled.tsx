...
export const CircleArrowRightFilledMetadata = { id: "circle-arrow-right_filled", baseId: "circle-arrow-right", variant: "filled", name: "Circle Arrow Right", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
