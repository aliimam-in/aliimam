...
export interface LeafFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const LeafFilled = React.forwardRef<SVGSVGElement, LeafFilledProps>(
...
LeafFilled.displayName = "LeafFilled";
export const LeafFilledMetadata = { id: "leaf_filled", baseId: "leaf", variant: "filled", name: "Leaf", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
