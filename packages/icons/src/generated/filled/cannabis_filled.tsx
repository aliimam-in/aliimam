...
export interface CannabisFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CannabisFilled = React.forwardRef<SVGSVGElement, CannabisFilledProps>(
...
CannabisFilled.displayName = "CannabisFilled";
export const CannabisFilledMetadata = { id: "cannabis_filled", baseId: "cannabis", variant: "filled", name: "Cannabis", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
export default CannabisFilled;
