...
export interface CloudComputingFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CloudComputingFilled = React.forwardRef<SVGSVGElement, CloudComputingFilledProps>(
...
CloudComputingFilled.displayName = "CloudComputingFilled";
export const CloudComputingFilledMetadata = { id: "cloud-computing_filled", baseId: "cloud-computing", variant: "filled", name: "Cloud Computing", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
