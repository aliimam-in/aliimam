...
export const LayoutDistributeVerticalFilledMetadata = { id: "layout-distribute-vertical_filled", baseId: "layout-distribute-vertical", variant: "filled", name: "Layout Distribute Vertical", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
