...
export const CircleChevronRightFilledMetadata = { id: "circle-chevron-right_filled", baseId: "circle-chevron-right", variant: "filled", name: "Circle Chevron Right", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
