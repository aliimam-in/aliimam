/**
 * Auto-generated logo component: Receipt Yuan Filled (default)
 * Category: filled
...
export interface ReceiptYuanFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const ReceiptYuanFilledLogo = React.forwardRef<SVGSVGElement, ReceiptYuanFilledLogoProps>(
...
ReceiptYuanFilledLogo.displayName = "ReceiptYuanFilledLogo";

export const ReceiptYuanFilledLogoMetadata = {
  id: "receipt-yuan-filled",
  baseId: "receipt-yuan-filled",
  variant: "default",
...
export default ReceiptYuanFilledLogo;
