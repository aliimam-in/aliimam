...
export interface DumplingFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const DumplingFilled = React.forwardRef<SVGSVGElement, DumplingFilledProps>(
...
DumplingFilled.displayName = "DumplingFilled";
export const DumplingFilledMetadata = { id: "dumpling_filled", baseId: "dumpling", variant: "filled", name: "Dumpling", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
