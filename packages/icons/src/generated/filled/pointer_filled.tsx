...
export interface PointerFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const PointerFilled = React.forwardRef<SVGSVGElement, PointerFilledProps>(
...
export const PointerFilledMetadata = { id: "pointer_filled", baseId: "pointer", variant: "filled", name: "Pointer", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
