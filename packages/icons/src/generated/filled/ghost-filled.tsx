/**
 * Auto-generated logo component: Ghost Filled (default)
 * Category: filled
...
export interface GhostFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const GhostFilledLogo = React.forwardRef<SVGSVGElement, GhostFilledLogoProps>(
...
GhostFilledLogo.displayName = "GhostFilledLogo";

export const GhostFilledLogoMetadata = {
  id: "ghost-filled",
  baseId: "ghost-filled",
  variant: "default",
  name: "Ghost Filled",
...
export default GhostFilledLogo;
