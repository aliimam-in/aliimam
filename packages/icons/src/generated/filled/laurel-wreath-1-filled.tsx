/**
 * Auto-generated logo component: Laurel Wreath 1 Filled (default)
 * Category: filled
...
export interface LaurelWreath1FilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const LaurelWreath1FilledLogo = React.forwardRef<SVGSVGElement, LaurelWreath1FilledLogoProps>(
...
LaurelWreath1FilledLogo.displayName = "LaurelWreath1FilledLogo";

export const LaurelWreath1FilledLogoMetadata = {
  id: "laurel-wreath-1-filled",
  baseId: "laurel-wreath-1-filled",
  variant: "default",
...
export default LaurelWreath1FilledLogo;
