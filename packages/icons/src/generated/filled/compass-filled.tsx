/**
 * Auto-generated logo component: Compass Filled (default)
 * Category: filled
...
export interface CompassFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const CompassFilledLogo = React.forwardRef<SVGSVGElement, CompassFilledLogoProps>(
...
CompassFilledLogo.displayName = "CompassFilledLogo";

export const CompassFilledLogoMetadata = {
  id: "compass-filled",
  baseId: "compass-filled",
  variant: "default",
  name: "Compass Filled",
  category: "filled",
  tags: [],
...
export default CompassFilledLogo;
