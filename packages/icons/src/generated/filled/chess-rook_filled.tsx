...
export interface ChessRookFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ChessRookFilled = React.forwardRef<SVGSVGElement, ChessRookFilledProps>(
...
ChessRookFilled.displayName = "ChessRookFilled";
export const ChessRookFilledMetadata = { id: "chess-rook_filled", baseId: "chess-rook", variant: "filled", name: "Chess Rook", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
