/**
 * Auto-generated logo component: Thumb Down Filled (default)
 * Category: filled
...
export interface ThumbDownFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const ThumbDownFilledLogo = React.forwardRef<SVGSVGElement, ThumbDownFilledLogoProps>(
...
ThumbDownFilledLogo.displayName = "ThumbDownFilledLogo";

export const ThumbDownFilledLogoMetadata = {
  id: "thumb-down-filled",
  baseId: "thumb-down-filled",
  variant: "default",
...
export default ThumbDownFilledLogo;
