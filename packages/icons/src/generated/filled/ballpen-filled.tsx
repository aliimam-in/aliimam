/**
 * Auto-generated logo component: Ballpen Filled (default)
 * Category: filled
...
export interface BallpenFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const BallpenFilledLogo = React.forwardRef<SVGSVGElement, BallpenFilledLogoProps>(
...
BallpenFilledLogo.displayName = "BallpenFilledLogo";

export const BallpenFilledLogoMetadata = {
  id: "ballpen-filled",
  baseId: "ballpen-filled",
  variant: "default",
  name: "Ballpen Filled",
  category: "filled",
  tags: [],
...
export default BallpenFilledLogo;
