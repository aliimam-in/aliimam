...
export const CircleLetterBFilledMetadata = { id: "circle-letter-b_filled", baseId: "circle-letter-b", variant: "filled", name: "Circle Letter B", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
