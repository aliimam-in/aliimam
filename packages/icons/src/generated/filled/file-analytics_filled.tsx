...
export const FileAnalyticsFilledMetadata = { id: "file-analytics_filled", baseId: "file-analytics", variant: "filled", name: "File Analytics", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
