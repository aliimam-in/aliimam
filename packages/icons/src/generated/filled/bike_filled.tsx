...
export interface BikeFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const BikeFilled = React.forwardRef<SVGSVGElement, BikeFilledProps>(
...
BikeFilled.displayName = "BikeFilled";
export const BikeFilledMetadata = { id: "bike_filled", baseId: "bike", variant: "filled", name: "Bike", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
