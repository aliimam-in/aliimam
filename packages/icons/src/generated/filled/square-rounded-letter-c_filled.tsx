...
export const SquareRoundedLetterCFilledMetadata = { id: "square-rounded-letter-c_filled", baseId: "square-rounded-letter-c", variant: "filled", name: "Square Rounded Letter C", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
