...
export const CircleChevronsDownFilledMetadata = { id: "circle-chevrons-down_filled", baseId: "circle-chevrons-down", variant: "filled", name: "Circle Chevrons Down", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
