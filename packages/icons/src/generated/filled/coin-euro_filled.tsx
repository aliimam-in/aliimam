...
export interface CoinEuroFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CoinEuroFilled = React.forwardRef<SVGSVGElement, CoinEuroFilledProps>(
...
CoinEuroFilled.displayName = "CoinEuroFilled";
export const CoinEuroFilledMetadata = { id: "coin-euro_filled", baseId: "coin-euro", variant: "filled", name: "Coin Euro", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
