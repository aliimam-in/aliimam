...
export interface BrightnessDownFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const BrightnessDownFilled = React.forwardRef<SVGSVGElement, BrightnessDownFilledProps>(
...
BrightnessDownFilled.displayName = "BrightnessDownFilled";
export const BrightnessDownFilledMetadata = { 
