/**
 * Auto-generated logo component: Brightness Down (filled)
 * Category: filled
...
export interface BrightnessDownFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const BrightnessDownFilledLogo = React.forwardRef<SVGSVGElement, BrightnessDownFilledLogoProps>(
...
BrightnessDownFilledLogo.displayName = "BrightnessDownFilledLogo";

export const BrightnessDownFilledLogoMetadata = {
  id: "brightness-down_filled",
  baseId: "brightness-down",
  variant: "filled",
...
export default BrightnessDownFilledLogo;
