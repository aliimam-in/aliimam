...
export interface HexagonNumber6FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const HexagonNumber6Filled = React.forwardRef<SVGSVGElement, HexagonNumber6FilledProps>(
...
HexagonNumber6Filled.displayName = "HexagonNumber6Filled";
export const HexagonNumber6FilledMetadata = { id: "hexagon-number-6_filled", baseId: "hexagon-number-6", variant: "filled", name: "Hexagon Number 6", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
