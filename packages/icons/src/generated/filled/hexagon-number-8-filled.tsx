/**
 * Auto-generated logo component: Hexagon Number 8 Filled (default)
 * Category: filled
...
export interface HexagonNumber8FilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const HexagonNumber8FilledLogo = React.forwardRef<SVGSVGElement, HexagonNumber8FilledLogoProps>(
...
HexagonNumber8FilledLogo.displayName = "HexagonNumber8FilledLogo";

export const HexagonNumber8FilledLogoMetadata = {
  id: "hexagon-number-8-filled",
  baseId: "hexagon-number-8-filled",
  variant: "default",
...
export default HexagonNumber8FilledLogo;
