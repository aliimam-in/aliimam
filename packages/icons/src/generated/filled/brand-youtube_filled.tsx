...
export const BrandYoutubeFilledMetadata = { id: "brand-youtube_filled", baseId: "brand-youtube", variant: "filled", name: "Brand Youtube", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
