...
export interface HelpHexagonFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const HelpHexagonFilled = React.forwardRef<SVGSVGElement, HelpHexagonFilledProps>(
...
HelpHexagonFilled.displayName = "HelpHexagonFilled";
export const HelpHexagonFilledMetadata = { id: "help-hexagon_filled", baseId: "help-hexagon", variant: "filled", name: "Help Hexagon", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
