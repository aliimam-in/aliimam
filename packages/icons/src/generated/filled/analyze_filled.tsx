...
export interface AnalyzeFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const AnalyzeFilled = React.forwardRef<SVGSVGElement, AnalyzeFilledProps>(
...
AnalyzeFilled.displayName = "AnalyzeFilled";
export const AnalyzeFilledMetadata = { id: "analyze_filled", baseId: "analyze", variant: "filled", name: "Analyze", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
