...
export const SquareLetterCFilledMetadata = { id: "square-letter-c_filled", baseId: "square-letter-c", variant: "filled", name: "Square Letter C", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
