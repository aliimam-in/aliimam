...
export interface OctagonPlusFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const OctagonPlusFilled = React.forwardRef<SVGSVGElement, OctagonPlusFilledProps>(
...
OctagonPlusFilled.displayName = "OctagonPlusFilled";
export const OctagonPlusFilledMetadata = { id: "octagon-plus_filled", baseId: "octagon-plus", variant: "filled", name: "Octagon Plus", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
