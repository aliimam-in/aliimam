/**
 * Auto-generated logo component: Feather Filled (default)
 * Category: filled
...
export interface FeatherFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const FeatherFilledLogo = React.forwardRef<SVGSVGElement, FeatherFilledLogoProps>(
...
FeatherFilledLogo.displayName = "FeatherFilledLogo";

export const FeatherFilledLogoMetadata = {
  id: "feather-filled",
  baseId: "feather-filled",
  variant: "default",
  name: "Feather Filled",
  category: "filled",
  tags: [],
...
export default FeatherFilledLogo;
