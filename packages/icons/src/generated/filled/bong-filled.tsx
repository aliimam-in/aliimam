/**
 * Auto-generated logo component: Bong Filled (default)
 * Category: filled
...
export interface BongFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const BongFilledLogo = React.forwardRef<SVGSVGElement, BongFilledLogoProps>(
...
BongFilledLogo.displayName = "BongFilledLogo";

export const BongFilledLogoMetadata = {
  id: "bong-filled",
  baseId: "bong-filled",
  variant: "default",
  name: "Bong Filled",
