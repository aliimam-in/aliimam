/**
 * Auto-generated logo component: Biohazard Filled (default)
 * Category: filled
...
export interface BiohazardFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const BiohazardFilledLogo = React.forwardRef<SVGSVGElement, BiohazardFilledLogoProps>(
...
BiohazardFilledLogo.displayName = "BiohazardFilledLogo";

export const BiohazardFilledLogoMetadata = {
  id: "biohazard-filled",
  baseId: "biohazard-filled",
  variant: "default",
...
export default BiohazardFilledLogo;
