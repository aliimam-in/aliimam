...
export interface Ghost3FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const Ghost3Filled = React.forwardRef<SVGSVGElement, Ghost3FilledProps>(
...
Ghost3Filled.displayName = "Ghost3Filled";
export const Ghost3FilledMetadata = { id: "ghost-3_filled", baseId: "ghost-3", variant: "filled", name: "Ghost 3", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
