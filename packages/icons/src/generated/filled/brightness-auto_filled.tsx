...
export interface BrightnessAutoFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const BrightnessAutoFilled = React.forwardRef<SVGSVGElement, BrightnessAutoFilledProps>(
...
BrightnessAutoFilled.displayName = "BrightnessAutoFilled";
export const BrightnessAutoFilledMetadata = { id: "brightness-auto_filled", baseId: "brightness-auto", variant: "filled", name: "Brightness Auto", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
