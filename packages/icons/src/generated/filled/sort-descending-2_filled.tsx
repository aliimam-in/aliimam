...
export const SortDescending2FilledMetadata = { id: "sort-descending-2_filled", baseId: "sort-descending-2", variant: "filled", name: "Sort Descending 2", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
