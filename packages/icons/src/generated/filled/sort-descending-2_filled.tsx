/**
 * Auto-generated logo component: Sort Descending 2 (filled)
 * Category: filled
...
export interface SortDescending2FilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const SortDescending2FilledLogo = React.forwardRef<SVGSVGElement, SortDescending2FilledLogoProps>(
...
SortDescending2FilledLogo.displayName = "SortDescending2FilledLogo";

export const SortDescending2FilledLogoMetadata = {
...
export default SortDescending2FilledLogo;
