...
export const TemperatureMinusFilledMetadata = { id: "temperature-minus_filled", baseId: "temperature-minus", variant: "filled", name: "Temperature Minus", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
