...
export const ChartAreaFilledMetadata = { id: "chart-area_filled", baseId: "chart-area", variant: "filled", name: "Chart Area", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
