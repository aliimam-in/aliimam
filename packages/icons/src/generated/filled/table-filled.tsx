/**
 * Auto-generated logo component: Table Filled (default)
 * Category: filled
...
export interface TableFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const TableFilledLogo = React.forwardRef<SVGSVGElement, TableFilledLogoProps>(
...
TableFilledLogo.displayName = "TableFilledLogo";

export const TableFilledLogoMetadata = {
  id: "table-filled",
  baseId: "table-filled",
  variant: "default",
  name: "Table Filled",
...
export default TableFilledLogo;
