...
export const CashBanknoteFilledMetadata = { id: "cash-banknote_filled", baseId: "cash-banknote", variant: "filled", name: "Cash Banknote", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
