...
export const CircleLetterFFilledMetadata = { id: "circle-letter-f_filled", baseId: "circle-letter-f", variant: "filled", name: "Circle Letter F", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
