...
export const ClockHour12FilledMetadata = { id: "clock-hour-12_filled", baseId: "clock-hour-12", variant: "filled", name: "Clock Hour 12", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
