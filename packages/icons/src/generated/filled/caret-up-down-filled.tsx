/**
 * Auto-generated logo component: Caret Up Down Filled (default)
 * Category: filled
...
export interface CaretUpDownFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const CaretUpDownFilledLogo = React.forwardRef<SVGSVGElement, CaretUpDownFilledLogoProps>(
...
CaretUpDownFilledLogo.displayName = "CaretUpDownFilledLogo";

export const CaretUpDownFilledLogoMetadata = {
  id: "caret-up-down-filled",
  baseId: "caret-up-down-filled",
  variant: "default",
...
export default CaretUpDownFilledLogo;
