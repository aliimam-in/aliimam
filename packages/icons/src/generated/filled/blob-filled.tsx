/**
 * Auto-generated logo component: Blob Filled (default)
 * Category: filled
...
export interface BlobFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const BlobFilledLogo = React.forwardRef<SVGSVGElement, BlobFilledLogoProps>(
...
BlobFilledLogo.displayName = "BlobFilledLogo";

export const BlobFilledLogoMetadata = {
  id: "blob-filled",
  baseId: "blob-filled",
  variant: "default",
  name: "Blob Filled",
