/**
 * Auto-generated logo component: Copy Plus Filled (default)
 * Category: filled
...
export interface CopyPlusFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const CopyPlusFilledLogo = React.forwardRef<SVGSVGElement, CopyPlusFilledLogoProps>(
...
CopyPlusFilledLogo.displayName = "CopyPlusFilledLogo";

export const CopyPlusFilledLogoMetadata = {
  id: "copy-plus-filled",
  baseId: "copy-plus-filled",
  variant: "default",
...
export default CopyPlusFilledLogo;
