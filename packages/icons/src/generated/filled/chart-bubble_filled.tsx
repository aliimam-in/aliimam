...
export const ChartBubbleFilledMetadata = { id: "chart-bubble_filled", baseId: "chart-bubble", variant: "filled", name: "Chart Bubble", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
