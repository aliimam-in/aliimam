...
export const InnerShadowTopLeftFilledMetadata = { id: "inner-shadow-top-left_filled", baseId: "inner-shadow-top-left", variant: "filled", name: "Inner Shadow Top Left", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
