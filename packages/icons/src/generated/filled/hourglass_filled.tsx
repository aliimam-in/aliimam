...
export const HourglassFilledMetadata = { id: "hourglass_filled", baseId: "hourglass", variant: "filled", name: "Hourglass", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
