...
export interface SquareF0FilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const SquareF0Filled = React.forwardRef<SVGSVGElement, SquareF0FilledProps>(
...
SquareF0Filled.displayName = "SquareF0Filled";
export const SquareF0FilledMetadata = { id: "square-f0_filled", baseId: "square-f0", variant: "filled", name: "Square F0", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
