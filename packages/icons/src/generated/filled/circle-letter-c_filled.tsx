...
export const CircleLetterCFilledMetadata = { id: "circle-letter-c_filled", baseId: "circle-letter-c", variant: "filled", name: "Circle Letter C", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
