...
export interface CardsFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CardsFilled = React.forwardRef<SVGSVGElement, CardsFilledProps>(
...
CardsFilled.displayName = "CardsFilled";
export const CardsFilledMetadata = { id: "cards_filled", baseId: "cards", variant: "filled", name: "Cards", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
