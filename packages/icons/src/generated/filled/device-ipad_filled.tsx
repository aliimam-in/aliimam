...
export const DeviceIpadFilledMetadata = { id: "device-ipad_filled", baseId: "device-ipad", variant: "filled", name: "Device Ipad", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
