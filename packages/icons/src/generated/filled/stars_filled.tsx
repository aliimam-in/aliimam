...
export interface StarsFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const StarsFilled = React.forwardRef<SVGSVGElement, StarsFilledProps>(
...
StarsFilled.displayName = "StarsFilled";
export const StarsFilledMetadata = { 
  id: "stars_filled", 
  baseId: "stars", 
  variant: "filled", 
  name: "Stars", 
