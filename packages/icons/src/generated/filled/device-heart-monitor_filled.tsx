...
export interface DeviceHeartMonitorFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const DeviceHeartMonitorFilled = React.forwardRef<SVGSVGElement, DeviceHeartMonitorFilledProps>(
...
DeviceHeartMonitorFilled.displayName = "DeviceHeartMonitorFilled";
export const DeviceHeartMonitorFilledMetadata = { id: "device-heart-monitor_filled", baseId: "device-heart-monitor", variant: "filled", name: "Device Heart Monitor", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
