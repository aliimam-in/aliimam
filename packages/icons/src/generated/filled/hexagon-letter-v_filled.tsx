...
export const HexagonLetterVFilledMetadata = { id: "hexagon-letter-v_filled", baseId: "hexagon-letter-v", variant: "filled", name: "Hexagon Letter V", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
