...
export interface PlayCardFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const PlayCardFilled = React.forwardRef<SVGSVGElement, PlayCardFilledProps>(
...
PlayCardFilled.displayName = "PlayCardFilled";
export const PlayCardFilledMetadata = { id: "play-card_filled", baseId: "play-card", variant: "filled", name: "Play Card", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
export default PlayCardFilled;
