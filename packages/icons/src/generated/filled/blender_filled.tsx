...
export interface BlenderFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const BlenderFilled = React.forwardRef<SVGSVGElement, BlenderFilledProps>(
...
BlenderFilled.displayName = "BlenderFilled";
export const BlenderFilledMetadata = { id: "blender_filled", baseId: "blender", variant: "filled", name: "Blender", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
