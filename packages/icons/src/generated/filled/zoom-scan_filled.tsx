...
export const ZoomScanFilledMetadata = { id: "zoom-scan_filled", baseId: "zoom-scan", variant: "filled", name: "Zoom Scan", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
