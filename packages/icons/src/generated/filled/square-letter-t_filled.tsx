...
export const SquareLetterTFilledMetadata = { id: "square-letter-t_filled", baseId: "square-letter-t", variant: "filled", name: "Square Letter T", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
