...
export const LayoutNavbarFilledMetadata = { id: "layout-navbar_filled", baseId: "layout-navbar", variant: "filled", name: "Layout Navbar", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
