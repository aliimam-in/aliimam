/**
 * Auto-generated logo component: Square Rounded Arrow Left Filled (default)
 * Category: filled
...
export interface SquareRoundedArrowLeftFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const SquareRoundedArrowLeftFilledLogo = React.forwardRef<SVGSVGElement, SquareRoundedArrowLeftFilledLogoProps>(
...
SquareRoundedArrowLeftFilledLogo.displayName = "SquareRoundedArrowLeftFilledLogo";

export const SquareRoundedArrowLeftFilledLogoMetadata = {
  id: "square-rounded-arrow-left-filled",
  baseId: "square-rounded-arrow-left-filled",
  variant: "default",
...
export default SquareRoundedArrowLeftFilledLogo;
