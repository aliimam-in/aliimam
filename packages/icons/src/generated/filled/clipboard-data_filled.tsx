...
export const ClipboardDataFilledMetadata = { id: "clipboard-data_filled", baseId: "clipboard-data", variant: "filled", name: "Clipboard Data", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
