/**
 * Auto-generated logo component: Badge 3d Filled (default)
 * Category: filled
...
export interface Badge3dFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const Badge3dFilledLogo = React.forwardRef<SVGSVGElement, Badge3dFilledLogoProps>(
...
Badge3dFilledLogo.displayName = "Badge3dFilledLogo";

export const Badge3dFilledLogoMetadata = {
  id: "badge-3d-filled",
  baseId: "badge-3d-filled",
  variant: "default",
...
export default Badge3dFilledLogo;
