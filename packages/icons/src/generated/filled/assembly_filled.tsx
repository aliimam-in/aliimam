...
export interface AssemblyFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const AssemblyFilled = React.forwardRef<SVGSVGElement, AssemblyFilledProps>(
...
AssemblyFilled.displayName = "AssemblyFilled";
export const AssemblyFilledMetadata = { id: "assembly_filled", baseId: "assembly", variant: "filled", name: "Assembly", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
