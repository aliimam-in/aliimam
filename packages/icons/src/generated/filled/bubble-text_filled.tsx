...
export interface BubbleTextFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const BubbleTextFilled = React.forwardRef<SVGSVGElement, BubbleTextFilledProps>(
...
BubbleTextFilled.displayName = "BubbleTextFilled";
export const BubbleTextFilledMetadata = { id: "bubble-text_filled", baseId: "bubble-text", variant: "filled", name: "Bubble Text", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
