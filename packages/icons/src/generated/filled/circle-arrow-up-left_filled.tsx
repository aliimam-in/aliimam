...
export const CircleArrowUpLeftFilledMetadata = { id: "circle-arrow-up-left_filled", baseId: "circle-arrow-up-left", variant: "filled", name: "Circle Arrow Up Left", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
