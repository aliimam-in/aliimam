...
export interface CarambolaFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CarambolaFilled = React.forwardRef<SVGSVGElement, CarambolaFilledProps>(
...
CarambolaFilled.displayName = "CarambolaFilled";
export const CarambolaFilledMetadata = { id: "carambola_filled", baseId: "carambola", variant: "filled", name: "Carambola", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
