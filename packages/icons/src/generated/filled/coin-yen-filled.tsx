/**
 * Auto-generated logo component: Coin Yen Filled (default)
 * Category: filled
...
export interface CoinYenFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const CoinYenFilledLogo = React.forwardRef<SVGSVGElement, CoinYenFilledLogoProps>(
...
CoinYenFilledLogo.displayName = "CoinYenFilledLogo";

export const CoinYenFilledLogoMetadata = {
  id: "coin-yen-filled",
  baseId: "coin-yen-filled",
  variant: "default",
...
export default CoinYenFilledLogo;
