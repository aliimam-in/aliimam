...
export const FileStarFilledMetadata = { id: "file-star_filled", baseId: "file-star", variant: "filled", name: "File Star", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
