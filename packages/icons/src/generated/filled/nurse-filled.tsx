/**
 * Auto-generated logo component: Nurse Filled (default)
 * Category: filled
...
export interface NurseFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const NurseFilledLogo = React.forwardRef<SVGSVGElement, NurseFilledLogoProps>(
...
NurseFilledLogo.displayName = "NurseFilledLogo";

export const NurseFilledLogoMetadata = {
  id: "nurse-filled",
  baseId: "nurse-filled",
  variant: "default",
  name: "Nurse Filled",
...
export default NurseFilledLogo;
