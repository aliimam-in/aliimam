...
export const HexagonNumber1FilledMetadata = { id: "hexagon-number-1_filled", baseId: "hexagon-number-1", variant: "filled", name: "Hexagon Number 1", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
