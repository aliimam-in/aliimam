...
export const BrandTumblrFilledMetadata = { id: "brand-tumblr_filled", baseId: "brand-tumblr", variant: "filled", name: "Brand Tumblr", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
