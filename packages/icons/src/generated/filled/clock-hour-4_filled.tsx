...
export const ClockHour4FilledMetadata = { id: "clock-hour-4_filled", baseId: "clock-hour-4", variant: "filled", name: "Clock Hour 4", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
