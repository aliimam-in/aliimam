...
export const ClockHour6FilledMetadata = { id: "clock-hour-6_filled", baseId: "clock-hour-6", variant: "filled", name: "Clock Hour 6", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
