...
export interface CarCraneFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CarCraneFilled = React.forwardRef<SVGSVGElement, CarCraneFilledProps>(
...
CarCraneFilled.displayName = "CarCraneFilled";
export const CarCraneFilledMetadata = { id: "car-crane_filled", baseId: "car-crane", variant: "filled", name: "Car Crane", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
