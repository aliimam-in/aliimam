...
export interface HelpOctagonFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const HelpOctagonFilled = React.forwardRef<SVGSVGElement, HelpOctagonFilledProps>(
...
HelpOctagonFilled.displayName = "HelpOctagonFilled";
export const HelpOctagonFilledMetadata = { id: "help-octagon_filled", baseId: "help-octagon", variant: "filled", name: "Help Octagon", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
