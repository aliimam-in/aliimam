...
export interface BrandVimeoFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const BrandVimeoFilled = React.forwardRef<SVGSVGElement, BrandVimeoFilledProps>(
...
BrandVimeoFilled.displayName = "BrandVimeoFilled";
export const BrandVimeoFilledMetadata = { id: "brand-vimeo_filled", baseId: "brand-vimeo", variant: "filled", name: "Brand Vimeo", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
export default BrandVimeoFilled;
