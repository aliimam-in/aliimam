...
export const CircleLetterOFilledMetadata = { id: "circle-letter-o_filled", baseId: "circle-letter-o", variant: "filled", name: "Circle Letter O", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
