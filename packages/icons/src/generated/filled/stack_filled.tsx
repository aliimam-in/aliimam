...
export interface StackFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const StackFilled = React.forwardRef<SVGSVGElement, StackFilledProps>(
...
StackFilled.displayName = "StackFilled";
export const StackFilledMetadata = { id: "stack_filled", baseId: "stack", variant: "filled", name: "Stack", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
