...
export const VideoPlusFilledMetadata = { id: "video-plus_filled", baseId: "video-plus", variant: "filled", name: "Video Plus", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
