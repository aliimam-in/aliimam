...
export const BrandBitbucketFilledMetadata = { id: "brand-bitbucket_filled", baseId: "brand-bitbucket", variant: "filled", name: "Brand Bitbucket", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
