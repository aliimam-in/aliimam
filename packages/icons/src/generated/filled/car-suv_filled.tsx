...
export interface CarSuvFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CarSuvFilled = React.forwardRef<SVGSVGElement, CarSuvFilledProps>(
...
CarSuvFilled.displayName = "CarSuvFilled";
export const CarSuvFilledMetadata = { id: "car-suv_filled", baseId: "car-suv", variant: "filled", name: "Car Suv", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
