...
export interface MessageCircleFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const MessageCircleFilled = React.forwardRef<SVGSVGElement, MessageCircleFilledProps>(
...
MessageCircleFilled.displayName = "MessageCircleFilled";
export const MessageCircleFilledMetadata = { id: "message-circle_filled", baseId: "message-circle", variant: "filled", name: "Message Circle", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
