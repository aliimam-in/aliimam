...
export const SquareNumber7FilledMetadata = { id: "square-number-7_filled", baseId: "square-number-7", variant: "filled", name: "Square Number 7", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
