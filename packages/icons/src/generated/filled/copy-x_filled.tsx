...
export interface CopyXFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CopyXFilled = React.forwardRef<SVGSVGElement, CopyXFilledProps>(
...
CopyXFilled.displayName = "CopyXFilled";
export const CopyXFilledMetadata = { id: "copy-x_filled", baseId: "copy-x", variant: "filled", name: "Copy X", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
export default CopyXFilled;
