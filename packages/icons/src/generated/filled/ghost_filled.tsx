...
export interface GhostFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const GhostFilled = React.forwardRef<SVGSVGElement, GhostFilledProps>(
...
export const GhostFilledMetadata = { id: "ghost_filled", baseId: "ghost", variant: "filled", name: "Ghost", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
