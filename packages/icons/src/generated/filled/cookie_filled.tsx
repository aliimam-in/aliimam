...
export interface CookieFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CookieFilled = React.forwardRef<SVGSVGElement, CookieFilledProps>(
...
CookieFilled.displayName = "CookieFilled";
export const CookieFilledMetadata = { id: "cookie_filled", baseId: "cookie", variant: "filled", name: "Cookie", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
