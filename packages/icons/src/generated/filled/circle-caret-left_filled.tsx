...
export const CircleCaretLeftFilledMetadata = { id: "circle-caret-left_filled", baseId: "circle-caret-left", variant: "filled", name: "Circle Caret Left", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
