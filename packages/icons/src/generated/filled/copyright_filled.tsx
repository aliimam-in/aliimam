...
export const CopyrightFilledMetadata = { id: "copyright_filled", baseId: "copyright", variant: "filled", name: "Copyright", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
