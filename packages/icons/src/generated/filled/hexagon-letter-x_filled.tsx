...
export const HexagonLetterXFilledMetadata = { id: "hexagon-letter-x_filled", baseId: "hexagon-letter-x", variant: "filled", name: "Hexagon Letter X", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
