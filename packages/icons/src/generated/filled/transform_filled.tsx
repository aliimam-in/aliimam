...
export interface TransformFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const TransformFilled = React.forwardRef<SVGSVGElement, TransformFilledProps>(
...
export const TransformFilledMetadata = { id: "transform_filled", baseId: "transform", variant: "filled", name: "Transform", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
