...
export interface MichelinStarFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const MichelinStarFilled = React.forwardRef<SVGSVGElement, MichelinStarFilledProps>(
...
MichelinStarFilled.displayName = "MichelinStarFilled";
export const MichelinStarFilledMetadata = { id: "michelin-star_filled", baseId: "michelin-star", variant: "filled", name: "Michelin Star", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
export default MichelinStarFilled;
