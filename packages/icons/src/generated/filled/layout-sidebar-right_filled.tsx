...
export const LayoutSidebarRightFilledMetadata = { id: "layout-sidebar-right_filled", baseId: "layout-sidebar-right", variant: "filled", name: "Layout Sidebar Right", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
