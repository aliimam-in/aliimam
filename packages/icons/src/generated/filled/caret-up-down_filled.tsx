...
export interface CaretUpDownFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CaretUpDownFilled = React.forwardRef<SVGSVGElement, CaretUpDownFilledProps>(
...
CaretUpDownFilled.displayName = "CaretUpDownFilled";
export const CaretUpDownFilledMetadata = { id: "caret-up-down_filled", baseId: "caret-up-down", variant: "filled", name: "Caret Up Down", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
export default CaretUpDownFilled;
