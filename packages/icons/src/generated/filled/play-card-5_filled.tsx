...
export const PlayCard5FilledMetadata = { id: "play-card-5_filled", baseId: "play-card-5", variant: "filled", name: "Play Card 5", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
