...
export interface BowFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const BowFilled = React.forwardRef<SVGSVGElement, BowFilledProps>(
...
BowFilled.displayName = "BowFilled";
export const BowFilledMetadata = { id: "bow_filled", baseId: "bow", variant: "filled", name: "Bow", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
export default BowFilled;
