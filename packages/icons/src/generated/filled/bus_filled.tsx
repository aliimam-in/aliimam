...
export interface BusFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const BusFilled = React.forwardRef<SVGSVGElement, BusFilledProps>(
...
BusFilled.displayName = "BusFilled";
export const BusFilledMetadata = { id: "bus_filled", baseId: "bus", variant: "filled", name: "Bus", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
