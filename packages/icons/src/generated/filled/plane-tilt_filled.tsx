...
export interface PlaneTiltFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const PlaneTiltFilled = React.forwardRef<SVGSVGElement, PlaneTiltFilledProps>(
...
PlaneTiltFilled.displayName = "PlaneTiltFilled";
export const PlaneTiltFilledMetadata = { id: "plane-tilt_filled", baseId: "plane-tilt", variant: "filled", name: "Plane Tilt", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
