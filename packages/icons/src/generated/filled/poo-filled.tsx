/**
 * Auto-generated logo component: Poo Filled (default)
 * Category: filled
...
export interface PooFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const PooFilledLogo = React.forwardRef<SVGSVGElement, PooFilledLogoProps>(
...
PooFilledLogo.displayName = "PooFilledLogo";

export const PooFilledLogoMetadata = {
  id: "poo-filled",
  baseId: "poo-filled",
  variant: "default",
  name: "Poo Filled",
