...
export const DeviceRemoteFilledMetadata = { id: "device-remote_filled", baseId: "device-remote", variant: "filled", name: "Device Remote", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
