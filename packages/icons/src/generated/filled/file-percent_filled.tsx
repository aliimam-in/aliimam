...
export const FilePercentFilledMetadata = { id: "file-percent_filled", baseId: "file-percent", variant: "filled", name: "File Percent", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
