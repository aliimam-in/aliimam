...
export const Columns1FilledMetadata = { id: "columns-1_filled", baseId: "columns-1", variant: "filled", name: "Columns 1", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
