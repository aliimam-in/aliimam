...
export const SquareLetterRFilledMetadata = { id: "square-letter-r_filled", baseId: "square-letter-r", variant: "filled", name: "Square Letter R", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
