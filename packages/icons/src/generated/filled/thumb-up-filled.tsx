/**
 * Auto-generated logo component: Thumb Up Filled (default)
 * Category: filled
...
export interface ThumbUpFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const ThumbUpFilledLogo = React.forwardRef<SVGSVGElement, ThumbUpFilledLogoProps>(
...
ThumbUpFilledLogo.displayName = "ThumbUpFilledLogo";

export const ThumbUpFilledLogoMetadata = {
  id: "thumb-up-filled",
  baseId: "thumb-up-filled",
  variant: "default",
...
export default ThumbUpFilledLogo;
