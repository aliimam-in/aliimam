...
export interface ChartGridDotsFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ChartGridDotsFilled = React.forwardRef<SVGSVGElement, ChartGridDotsFilledProps>(
...
ChartGridDotsFilled.displayName = "ChartGridDotsFilled";
export const ChartGridDotsFilledMetadata = { id: "chart-grid-dots_filled", baseId: "chart-grid-dots", variant: "filled", name: "Chart Grid Dots", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
