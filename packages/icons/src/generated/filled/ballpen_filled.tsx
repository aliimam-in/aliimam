...
export interface BallpenFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const BallpenFilled = React.forwardRef<SVGSVGElement, BallpenFilledProps>(
...
BallpenFilled.displayName = "BallpenFilled";
export const BallpenFilledMetadata = { id: "ballpen_filled", baseId: "ballpen", variant: "filled", name: "Ballpen", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
