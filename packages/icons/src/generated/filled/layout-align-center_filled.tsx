...
export const LayoutAlignCenterFilledMetadata = { id: "layout-align-center_filled", baseId: "layout-align-center", variant: "filled", name: "Layout Align Center", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
