/**
 * Auto-generated logo component: Square F8 Filled (default)
 * Category: filled
...
export interface SquareF8FilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const SquareF8FilledLogo = React.forwardRef<SVGSVGElement, SquareF8FilledLogoProps>(
...
SquareF8FilledLogo.displayName = "SquareF8FilledLogo";

export const SquareF8FilledLogoMetadata = {
  id: "square-f8-filled",
  baseId: "square-f8-filled",
  variant: "default",
...
export default SquareF8FilledLogo;
