...
export const SquareLetterYFilledMetadata = { id: "square-letter-y_filled", baseId: "square-letter-y", variant: "filled", name: "Square Letter Y", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
