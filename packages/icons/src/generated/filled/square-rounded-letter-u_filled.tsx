...
export const SquareRoundedLetterUFilledMetadata = { id: "square-rounded-letter-u_filled", baseId: "square-rounded-letter-u", variant: "filled", name: "Square Rounded Letter U", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
