...
export interface SunsetFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const SunsetFilled = React.forwardRef<SVGSVGElement, SunsetFilledProps>(
...
SunsetFilled.displayName = "SunsetFilled";
export const SunsetFilledMetadata = { id: "sunset_filled", baseId: "sunset", variant: "filled", name: "Sunset", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
