...
export interface BasketFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const BasketFilled = React.forwardRef<SVGSVGElement, BasketFilledProps>(
...
export const BasketFilledMetadata = { id: "basket_filled", baseId: "basket", variant: "filled", name: "Basket", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
