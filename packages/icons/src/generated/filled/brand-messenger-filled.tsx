/**
 * Auto-generated logo component: Brand Messenger Filled (default)
 * Category: filled
...
export interface BrandMessengerFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const BrandMessengerFilledLogo = React.forwardRef<SVGSVGElement, BrandMessengerFilledLogoProps>(
...
BrandMessengerFilledLogo.displayName = "BrandMessengerFilledLogo";

export const BrandMessengerFilledLogoMetadata = {
  id: "brand-messenger-filled",
  baseId: "brand-messenger-filled",
  variant: "default",
...
export default BrandMessengerFilledLogo;
