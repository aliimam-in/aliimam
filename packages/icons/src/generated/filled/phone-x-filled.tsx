/**
 * Auto-generated logo component: Phone X Filled (default)
 * Category: filled
...
export interface PhoneXFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const PhoneXFilledLogo = React.forwardRef<SVGSVGElement, PhoneXFilledLogoProps>(
...
PhoneXFilledLogo.displayName = "PhoneXFilledLogo";

export const PhoneXFilledLogoMetadata = {
  id: "phone-x-filled",
  baseId: "phone-x-filled",
  variant: "default",
  name: "Phone X Filled",
  category: "filled",
  tags: [],
...
export default PhoneXFilledLogo;
