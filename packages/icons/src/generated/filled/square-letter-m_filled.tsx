...
export const SquareLetterMFilledMetadata = { id: "square-letter-m_filled", baseId: "square-letter-m", variant: "filled", name: "Square Letter M", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
