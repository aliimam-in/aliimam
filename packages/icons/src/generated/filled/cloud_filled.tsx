...
export interface CloudFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CloudFilled = React.forwardRef<SVGSVGElement, CloudFilledProps>(
...
export const CloudFilledMetadata = { id: "cloud_filled", baseId: "cloud", variant: "filled", name: "Cloud", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
