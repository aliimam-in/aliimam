...
export interface RadioactiveFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const RadioactiveFilled = React.forwardRef<SVGSVGElement, RadioactiveFilledProps>(
...
RadioactiveFilled.displayName = "RadioactiveFilled";
export const RadioactiveFilledMetadata = { id: "radioactive_filled", baseId: "radioactive", variant: "filled", name: "Radioactive", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
