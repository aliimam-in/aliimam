...
export const AlarmPlusFilledMetadata = { id: "alarm-plus_filled", baseId: "alarm-plus", variant: "filled", name: "Alarm Plus", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
