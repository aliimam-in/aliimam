...
export interface BackspaceFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const BackspaceFilled = React.forwardRef<SVGSVGElement, BackspaceFilledProps>(
...
BackspaceFilled.displayName = "BackspaceFilled";
export const BackspaceFilledMetadata = { id: "backspace_filled", baseId: "backspace", variant: "filled", name: "Backspace", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
