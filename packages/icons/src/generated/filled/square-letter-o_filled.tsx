...
export const SquareLetterOFilledMetadata = { id: "square-letter-o_filled", baseId: "square-letter-o", variant: "filled", name: "Square Letter O", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
