...
export interface BladeFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const BladeFilled = React.forwardRef<SVGSVGElement, BladeFilledProps>(
...
BladeFilled.displayName = "BladeFilled";
export const BladeFilledMetadata = { id: "blade_filled", baseId: "blade", variant: "filled", name: "Blade", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
export default BladeFilled;
