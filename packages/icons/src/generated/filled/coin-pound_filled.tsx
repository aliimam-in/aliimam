...
export interface CoinPoundFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CoinPoundFilled = React.forwardRef<SVGSVGElement, CoinPoundFilledProps>(
...
CoinPoundFilled.displayName = "CoinPoundFilled";
export const CoinPoundFilledMetadata = { id: "coin-pound_filled", baseId: "coin-pound", variant: "filled", name: "Coin Pound", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
