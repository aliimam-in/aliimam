...
export interface AdFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const AdFilled = React.forwardRef<SVGSVGElement, AdFilledProps>(
...
export const AdFilledMetadata = { id: "ad_filled", baseId: "ad", variant: "filled", name: "Ad", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
