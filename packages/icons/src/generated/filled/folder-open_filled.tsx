...
export interface FolderOpenFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const FolderOpenFilled = React.forwardRef<SVGSVGElement, FolderOpenFilledProps>(
...
export const FolderOpenFilledMetadata = { id: "folder-open_filled", baseId: "folder-open", variant: "filled", name: "Folder Open", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
