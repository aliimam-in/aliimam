/**
 * Auto-generated logo component: Flower Filled (default)
 * Category: filled
...
export interface FlowerFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const FlowerFilledLogo = React.forwardRef<SVGSVGElement, FlowerFilledLogoProps>(
...
FlowerFilledLogo.displayName = "FlowerFilledLogo";

export const FlowerFilledLogoMetadata = {
  id: "flower-filled",
  baseId: "flower-filled",
  variant: "default",
  name: "Flower Filled",
  category: "filled",
  tags: [],
...
export default FlowerFilledLogo;
