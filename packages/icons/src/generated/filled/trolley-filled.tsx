/**
 * Auto-generated logo component: Trolley Filled (default)
 * Category: filled
...
export interface TrolleyFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const TrolleyFilledLogo = React.forwardRef<SVGSVGElement, TrolleyFilledLogoProps>(
...
TrolleyFilledLogo.displayName = "TrolleyFilledLogo";

export const TrolleyFilledLogoMetadata = {
  id: "trolley-filled",
  baseId: "trolley-filled",
  variant: "default",
  name: "Trolley Filled",
  category: "filled",
  tags: [],
...
export default TrolleyFilledLogo;
