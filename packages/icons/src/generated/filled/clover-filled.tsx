/**
 * Auto-generated logo component: Clover Filled (default)
 * Category: filled
...
export interface CloverFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const CloverFilledLogo = React.forwardRef<SVGSVGElement, CloverFilledLogoProps>(
...
CloverFilledLogo.displayName = "CloverFilledLogo";

export const CloverFilledLogoMetadata = {
  id: "clover-filled",
  baseId: "clover-filled",
  variant: "default",
  name: "Clover Filled",
  category: "filled",
  tags: [],
...
export default CloverFilledLogo;
