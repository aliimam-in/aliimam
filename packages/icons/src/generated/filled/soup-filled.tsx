/**
 * Auto-generated logo component: Soup Filled (default)
 * Category: filled
...
export interface SoupFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const SoupFilledLogo = React.forwardRef<SVGSVGElement, SoupFilledLogoProps>(
...
SoupFilledLogo.displayName = "SoupFilledLogo";

export const SoupFilledLogoMetadata = {
  id: "soup-filled",
  baseId: "soup-filled",
  variant: "default",
  name: "Soup Filled",
