...
export const BookmarksFilledMetadata = { id: "bookmarks_filled", baseId: "bookmarks", variant: "filled", name: "Bookmarks", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
