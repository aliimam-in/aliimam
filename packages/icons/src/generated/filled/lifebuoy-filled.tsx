/**
 * Auto-generated logo component: Lifebuoy Filled (default)
 * Category: filled
...
export interface LifebuoyFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const LifebuoyFilledLogo = React.forwardRef<SVGSVGElement, LifebuoyFilledLogoProps>(
...
LifebuoyFilledLogo.displayName = "LifebuoyFilledLogo";

export const LifebuoyFilledLogoMetadata = {
  id: "lifebuoy-filled",
  baseId: "lifebuoy-filled",
  variant: "default",
...
export default LifebuoyFilledLogo;
