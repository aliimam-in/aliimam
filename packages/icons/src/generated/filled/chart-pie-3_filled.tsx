...
export const ChartPie3FilledMetadata = { id: "chart-pie-3_filled", baseId: "chart-pie-3", variant: "filled", name: "Chart Pie 3", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
