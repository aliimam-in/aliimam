/**
 * Auto-generated logo component: Replace Filled (default)
 * Category: filled
...
export interface ReplaceFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const ReplaceFilledLogo = React.forwardRef<SVGSVGElement, ReplaceFilledLogoProps>(
...
ReplaceFilledLogo.displayName = "ReplaceFilledLogo";

export const ReplaceFilledLogoMetadata = {
  id: "replace-filled",
  baseId: "replace-filled",
  variant: "default",
  name: "Replace Filled",
  category: "filled",
  tags: [],
...
export default ReplaceFilledLogo;
