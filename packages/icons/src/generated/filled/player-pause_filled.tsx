...
export const PlayerPauseFilledMetadata = { id: "player-pause_filled", baseId: "player-pause", variant: "filled", name: "Player Pause", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
