...
export const TemperaturePlusFilledMetadata = { id: "temperature-plus_filled", baseId: "temperature-plus", variant: "filled", name: "Temperature Plus", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
