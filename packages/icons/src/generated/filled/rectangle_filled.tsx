...
export const RectangleFilledMetadata = { id: "rectangle_filled", baseId: "rectangle", variant: "filled", name: "Rectangle", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
