...
export const MessageReportFilledMetadata = { id: "message-report_filled", baseId: "message-report", variant: "filled", name: "Message Report", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
