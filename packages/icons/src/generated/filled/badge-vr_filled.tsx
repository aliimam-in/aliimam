...
export interface BadgeVrFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const BadgeVrFilled = React.forwardRef<SVGSVGElement, BadgeVrFilledProps>(
...
BadgeVrFilled.displayName = "BadgeVrFilled";
export const BadgeVrFilledMetadata = { id: "badge-vr_filled", baseId: "badge-vr", variant: "filled", name: "Badge Vr", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
