...
export interface DialpadFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const DialpadFilled = React.forwardRef<SVGSVGElement, DialpadFilledProps>(
...
DialpadFilled.displayName = "DialpadFilled";
export const DialpadFilledMetadata = { id: "dialpad_filled", baseId: "dialpad", variant: "filled", name: "Dialpad", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
