...
export interface ZoomInFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ZoomInFilled = React.forwardRef<SVGSVGElement, ZoomInFilledProps>(
...
export const ZoomInFilledMetadata = { id: "zoom-in_filled", baseId: "zoom-in", variant: "filled", name: "Zoom In", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
