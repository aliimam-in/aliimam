/**
 * Auto-generated logo component: Ghost 2 Filled (default)
 * Category: filled
...
export interface Ghost2FilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const Ghost2FilledLogo = React.forwardRef<SVGSVGElement, Ghost2FilledLogoProps>(
...
Ghost2FilledLogo.displayName = "Ghost2FilledLogo";

export const Ghost2FilledLogoMetadata = {
  id: "ghost-2-filled",
  baseId: "ghost-2-filled",
  variant: "default",
  name: "Ghost 2 Filled",
  category: "filled",
  tags: [],
...
export default Ghost2FilledLogo;
