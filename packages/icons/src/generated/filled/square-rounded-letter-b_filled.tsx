...
export const SquareRoundedLetterBFilledMetadata = { id: "square-rounded-letter-b_filled", baseId: "square-rounded-letter-b", variant: "filled", name: "Square Rounded Letter B", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
