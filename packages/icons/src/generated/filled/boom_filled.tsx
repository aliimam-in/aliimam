...
export interface BoomFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const BoomFilled = React.forwardRef<SVGSVGElement, BoomFilledProps>(
...
BoomFilled.displayName = "BoomFilled";
export const BoomFilledMetadata = { id: "boom_filled", baseId: "boom", variant: "filled", name: "Boom", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
export default BoomFilled;
