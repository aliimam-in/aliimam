...
export interface AerialLiftFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const AerialLiftFilled = React.forwardRef<SVGSVGElement, AerialLiftFilledProps>(
...
AerialLiftFilled.displayName = "AerialLiftFilled";
export const AerialLiftFilledMetadata = { id: "aerial-lift_filled", baseId: "aerial-lift", variant: "filled", name: "Aerial Lift", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
