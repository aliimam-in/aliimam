/**
 * Auto-generated logo component: Square F4 Filled (default)
 * Category: filled
...
export interface SquareF4FilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const SquareF4FilledLogo = React.forwardRef<SVGSVGElement, SquareF4FilledLogoProps>(
...
SquareF4FilledLogo.displayName = "SquareF4FilledLogo";

export const SquareF4FilledLogoMetadata = {
  id: "square-f4-filled",
  baseId: "square-f4-filled",
  variant: "default",
...
export default SquareF4FilledLogo;
