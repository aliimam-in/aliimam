/**
 * Auto-generated logo component: Cloud Filled (default)
 * Category: filled
...
export interface CloudFilledLogoProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string;
  strokeWidth?: number;
}

export const CloudFilledLogo = React.forwardRef<SVGSVGElement, CloudFilledLogoProps>(
...
CloudFilledLogo.displayName = "CloudFilledLogo";

export const CloudFilledLogoMetadata = {
  id: "cloud-filled",
  baseId: "cloud-filled",
  variant: "default",
  name: "Cloud Filled",
...
export default CloudFilledLogo;
