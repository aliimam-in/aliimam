...
export const EaseInControlPointFilledMetadata = { id: "ease-in-control-point_filled", baseId: "ease-in-control-point", variant: "filled", name: "Ease In Control Point", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
