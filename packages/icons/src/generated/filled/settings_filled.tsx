...
export interface SettingsFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const SettingsFilled = React.forwardRef<SVGSVGElement, SettingsFilledProps>(
...
export const SettingsFilledMetadata = { id: "settings_filled", baseId: "settings", variant: "filled", name: "Settings", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
