...
export const AlertSquareFilledMetadata = { id: "alert-square_filled", baseId: "alert-square", variant: "filled", name: "Alert Square", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
