...
export const SquareRoundedLetterHFilledMetadata = { id: "square-rounded-letter-h_filled", baseId: "square-rounded-letter-h", variant: "filled", name: "Square Rounded Letter H", category: "filled", tags: [], viewBox: "0 0 24 24" } as const;
