...
export interface CallRoundedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CallRounded = React.forwardRef<SVGSVGElement, CallRoundedProps>(
...
CallRounded.displayName = "CallRounded";
export const CallRoundedMetadata = { 
  id: "call_rounded", 
  baseId: "call", 
  variant: "rounded", 
  name: "Call", 
