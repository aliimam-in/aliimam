...
export const PhoneMissedMetadata = { id: "phone-missed", baseId: "phone-missed", variant: "default", name: "Phone Missed", category: "communiccation", tags: [], viewBox: "0 0 24 24" } as const;
