...
export interface CallMinusRoundedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CallMinusRounded = React.forwardRef<SVGSVGElement, CallMinusRoundedProps>(
...
CallMinusRounded.displayName = "CallMinusRounded";
export const CallMinusRoundedMetadata = { 
  id: "call-minus_rounded", 
  baseId: "call-minus", 
  variant: "rounded", 
  name: "Call Minus", 
...
export default CallMinusRounded;
