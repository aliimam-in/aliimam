...
export interface CallSlashRoundedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const CallSlashRounded = React.forwardRef<SVGSVGElement, CallSlashRoundedProps>(
...
export default CallSlashRounded;
