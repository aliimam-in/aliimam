...
export const BellElectricMetadata = { id: "bell-electric", baseId: "bell-electric", variant: "default", name: "Bell Electric", category: "notification", tags: [], viewBox: "0 0 24 24" } as const;
