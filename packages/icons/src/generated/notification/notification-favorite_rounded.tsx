...
export interface NotificationFavoriteRoundedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const NotificationFavoriteRounded = React.forwardRef<SVGSVGElement, NotificationFavoriteRoundedProps>(
...
<path d="M6.80998 14.93C6.45998 13.83 6.86998 12.46 8.02998 12.09C8.63998 11.89 9.38998 12.06 9.81998 12.65C10.22 12.04 11 11.9 11.6 12.09C12.76 12.46 13.17 13.83 12.82 14.93C12.27 16.68 10.35 17.59 9.81998 17.59C9.27998 17.58 7.37998 16.69 6.80998 14.93Z" stroke="#292D32" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  )
);
NotificationFavoriteRounded.displayName = "NotificationFavoriteRounded";
export const NotificationFavoriteRoundedMetadata = { 
  id: "notification-favorite_rounded", 
  baseId: "notification-favorite", 
  variant: "rounded", 
...
export default NotificationFavoriteRounded;
