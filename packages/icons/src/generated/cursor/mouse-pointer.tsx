...
export const MousePointerMetadata = { id: "mouse-pointer", baseId: "mouse-pointer", variant: "default", name: "Mouse Pointer", category: "cursor", tags: [], viewBox: "0 0 24 24" } as const;
