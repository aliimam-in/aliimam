...
export const MousePointerBanMetadata = { id: "mouse-pointer-ban", baseId: "mouse-pointer-ban", variant: "default", name: "Mouse Pointer Ban", category: "cursor", tags: [], viewBox: "0 0 24 24" } as const;
