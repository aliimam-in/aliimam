...
export const MousePointer2OffMetadata = { id: "mouse-pointer-2-off", baseId: "mouse-pointer-2-off", variant: "default", name: "Mouse Pointer 2 Off", category: "cursor", tags: [], viewBox: "0 0 24 24" } as const;
