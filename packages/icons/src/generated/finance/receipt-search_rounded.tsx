...
export interface ReceiptSearchRoundedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const ReceiptSearchRounded = React.forwardRef<SVGSVGElement, ReceiptSearchRoundedProps>(
...
ReceiptSearchRounded.displayName = "ReceiptSearchRounded";
export const ReceiptSearchRoundedMetadata = { 
  id: "receipt-search_rounded", 
  baseId: "receipt-search", 
  variant: "rounded", 
  name: "Receipt Search", 
  category: "finance", 
  tags: [], 
...
export default ReceiptSearchRounded;
