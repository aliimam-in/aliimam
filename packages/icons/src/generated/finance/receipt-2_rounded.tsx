...
export interface Receipt2RoundedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const Receipt2Rounded = React.forwardRef<SVGSVGElement, Receipt2RoundedProps>(
...
Receipt2Rounded.displayName = "Receipt2Rounded";
export const Receipt2RoundedMetadata = { 
  id: "receipt-2_rounded", 
  baseId: "receipt-2", 
  variant: "rounded", 
  name: "Receipt 2", 
  category: "finance", 
...
export default Receipt2Rounded;
