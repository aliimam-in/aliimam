...
export const BanknoteArrowDownMetadata = { id: "banknote-arrow-down", baseId: "banknote-arrow-down", variant: "default", name: "Banknote Arrow Down", category: "finance", tags: [], viewBox: "0 0 24 24" } as const;
