...
export interface WalletMoneyRoundedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const WalletMoneyRounded = React.forwardRef<SVGSVGElement, WalletMoneyRoundedProps>(
...
<path d="M22 10.97V13.03C22 13.58 21.56 14.03 21 14.05H19.0399C17.9599 14.05 16.97 13.26 16.88 12.18C16.82 11.55 17.0599 10.96 17.4799 10.55C17.8499 10.17 18.36 9.95001 18.92 9.95001H21C21.56 9.97001 22 10.42 22 10.97Z" stroke="#292D32" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
...
WalletMoneyRounded.displayName = "WalletMoneyRounded";
export const WalletMoneyRoundedMetadata = { 
  id: "wallet-money_rounded", 
  baseId: "wallet-money", 
  variant: "rounded", 
  name: "Wallet Money", 
  category: "finance", 
...
export default WalletMoneyRounded;
