...
export const BanknoteArrowUpMetadata = { id: "banknote-arrow-up", baseId: "banknote-arrow-up", variant: "default", name: "Banknote Arrow Up", category: "finance", tags: [], viewBox: "0 0 24 24" } as const;
