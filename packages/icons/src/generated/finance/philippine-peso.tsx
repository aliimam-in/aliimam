...
export const PhilippinePesoMetadata = { id: "philippine-peso", baseId: "philippine-peso", variant: "default", name: "Philippine Peso", category: "finance", tags: [], viewBox: "0 0 24 24" } as const;
