...
export interface AwardRoundedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const AwardRounded = React.forwardRef<SVGSVGElement, AwardRoundedProps>(
...
AwardRounded.displayName = "AwardRounded";
export const AwardRoundedMetadata = { 
  id: "award_rounded", 
  baseId: "award", 
  variant: "rounded", 
  name: "Award", 
