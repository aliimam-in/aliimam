...
export interface BriefcaseRoundedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const BriefcaseRounded = React.forwardRef<SVGSVGElement, BriefcaseRoundedProps>(
...
BriefcaseRounded.displayName = "BriefcaseRounded";
export const BriefcaseRoundedMetadata = { 
  id: "briefcase_rounded", 
  baseId: "briefcase", 
  variant: "rounded", 
  name: "Briefcase", 
  category: "education", 
...
export default BriefcaseRounded;
