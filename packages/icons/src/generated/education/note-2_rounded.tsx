...
export interface Note2RoundedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const Note2Rounded = React.forwardRef<SVGSVGElement, Note2RoundedProps>(
