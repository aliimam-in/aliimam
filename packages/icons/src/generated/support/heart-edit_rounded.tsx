...
export interface HeartEditRoundedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const HeartEditRounded = React.forwardRef<SVGSVGElement, HeartEditRoundedProps>(
...
HeartEditRounded.displayName = "HeartEditRounded";
export const HeartEditRoundedMetadata = { 
  id: "heart-edit_rounded", 
  baseId: "heart-edit", 
  variant: "rounded", 
  name: "Heart Edit", 
  category: "support", 
...
export default HeartEditRounded;
