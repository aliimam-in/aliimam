...
export interface MedalStarRoundedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const MedalStarRounded = React.forwardRef<SVGSVGElement, MedalStarRoundedProps>(
...
MedalStarRounded.displayName = "MedalStarRounded";
export const MedalStarRoundedMetadata = { 
  id: "medal-star_rounded", 
  baseId: "medal-star", 
  variant: "rounded", 
  name: "Medal Star", 
  category: "support", 
...
export default MedalStarRounded;
