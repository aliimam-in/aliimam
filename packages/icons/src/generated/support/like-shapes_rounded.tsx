...
export interface LikeShapesRoundedProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  strokeWidth?: number;
}

export const LikeShapesRounded = React.forwardRef<SVGSVGElement, LikeShapesRoundedProps>(
...
export default LikeShapesRounded;
