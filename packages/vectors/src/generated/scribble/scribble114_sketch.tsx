...
export interface Scribble114SketchProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Scribble114Sketch = React.forwardRef<SVGSVGElement, Scribble114SketchProps>(
...
export default Scribble114Sketch;
