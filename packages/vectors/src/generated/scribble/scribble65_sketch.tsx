...
export interface Scribble65SketchProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Scribble65Sketch = React.forwardRef<SVGSVGElement, Scribble65SketchProps>(
...
export default Scribble65Sketch;
