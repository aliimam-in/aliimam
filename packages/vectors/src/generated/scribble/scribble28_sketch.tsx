...
export interface Scribble28SketchProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Scribble28Sketch = React.forwardRef<SVGSVGElement, Scribble28SketchProps>(
...
export default Scribble28Sketch;
