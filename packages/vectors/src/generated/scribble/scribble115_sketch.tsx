...
export interface Scribble115SketchProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Scribble115Sketch = React.forwardRef<SVGSVGElement, Scribble115SketchProps>(
...
export default Scribble115Sketch;
