...
export interface Scribble27SketchProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Scribble27Sketch = React.forwardRef<SVGSVGElement, Scribble27SketchProps>(
...
export default Scribble27Sketch;
