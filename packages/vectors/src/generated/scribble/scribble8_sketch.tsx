...
export interface Scribble8SketchProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Scribble8Sketch = React.forwardRef<SVGSVGElement, Scribble8SketchProps>(
...
export default Scribble8Sketch;
