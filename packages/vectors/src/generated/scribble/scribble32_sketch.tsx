...
export interface Scribble32SketchProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Scribble32Sketch = React.forwardRef<SVGSVGElement, Scribble32SketchProps>(
...
export default Scribble32Sketch;
