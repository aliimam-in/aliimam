...
export interface Scribble13SketchProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Scribble13Sketch = React.forwardRef<SVGSVGElement, Scribble13SketchProps>(
...
export default Scribble13Sketch;
