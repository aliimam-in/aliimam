...
export interface Scribble64SketchProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Scribble64Sketch = React.forwardRef<SVGSVGElement, Scribble64SketchProps>(
...
export default Scribble64Sketch;
