...
export interface Scribble92SketchProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Scribble92Sketch = React.forwardRef<SVGSVGElement, Scribble92SketchProps>(
...
export default Scribble92Sketch;
