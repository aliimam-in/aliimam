...
export interface Scribble76SketchProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Scribble76Sketch = React.forwardRef<SVGSVGElement, Scribble76SketchProps>(
...
export default Scribble76Sketch;
