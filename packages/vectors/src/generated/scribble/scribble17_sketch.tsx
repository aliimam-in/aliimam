...
export interface Scribble17SketchProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Scribble17Sketch = React.forwardRef<SVGSVGElement, Scribble17SketchProps>(
...
export default Scribble17Sketch;
