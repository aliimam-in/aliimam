...
export interface Scribble37SketchProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Scribble37Sketch = React.forwardRef<SVGSVGElement, Scribble37SketchProps>(
...
export default Scribble37Sketch;
