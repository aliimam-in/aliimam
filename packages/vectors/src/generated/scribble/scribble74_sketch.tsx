...
export interface Scribble74SketchProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Scribble74Sketch = React.forwardRef<SVGSVGElement, Scribble74SketchProps>(
...
export default Scribble74Sketch;
