...
export interface Scribble77SketchProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Scribble77Sketch = React.forwardRef<SVGSVGElement, Scribble77SketchProps>(
...
export default Scribble77Sketch;
