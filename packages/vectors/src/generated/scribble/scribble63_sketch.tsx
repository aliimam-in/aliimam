...
export interface Scribble63SketchProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Scribble63Sketch = React.forwardRef<SVGSVGElement, Scribble63SketchProps>(
...
export default Scribble63Sketch;
