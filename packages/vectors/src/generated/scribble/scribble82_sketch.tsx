...
export interface Scribble82SketchProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Scribble82Sketch = React.forwardRef<SVGSVGElement, Scribble82SketchProps>(
...
export default Scribble82Sketch;
