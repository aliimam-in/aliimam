...
export interface Scribble38SketchProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Scribble38Sketch = React.forwardRef<SVGSVGElement, Scribble38SketchProps>(
...
export default Scribble38Sketch;
