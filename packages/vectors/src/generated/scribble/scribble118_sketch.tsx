...
export interface Scribble118SketchProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Scribble118Sketch = React.forwardRef<SVGSVGElement, Scribble118SketchProps>(
...
export default Scribble118Sketch;
