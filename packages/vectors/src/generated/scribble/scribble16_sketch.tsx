...
export interface Scribble16SketchProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Scribble16Sketch = React.forwardRef<SVGSVGElement, Scribble16SketchProps>(
...
export default Scribble16Sketch;
