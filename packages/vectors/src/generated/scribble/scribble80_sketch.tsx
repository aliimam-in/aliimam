...
export interface Scribble80SketchProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Scribble80Sketch = React.forwardRef<SVGSVGElement, Scribble80SketchProps>(
...
export default Scribble80Sketch;
