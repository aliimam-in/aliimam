...
export interface Scribble127SketchProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Scribble127Sketch = React.forwardRef<SVGSVGElement, Scribble127SketchProps>(
...
export default Scribble127Sketch;
