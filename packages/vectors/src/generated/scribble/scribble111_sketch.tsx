...
export interface Scribble111SketchProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Scribble111Sketch = React.forwardRef<SVGSVGElement, Scribble111SketchProps>(
...
export default Scribble111Sketch;
