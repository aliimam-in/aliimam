...
export interface Scribble50SketchProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Scribble50Sketch = React.forwardRef<SVGSVGElement, Scribble50SketchProps>(
...
export default Scribble50Sketch;
