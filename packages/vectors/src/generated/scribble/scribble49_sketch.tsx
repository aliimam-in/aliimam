...
export interface Scribble49SketchProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Scribble49Sketch = React.forwardRef<SVGSVGElement, Scribble49SketchProps>(
...
export default Scribble49Sketch;
