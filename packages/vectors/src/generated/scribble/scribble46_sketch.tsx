...
export interface Scribble46SketchProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Scribble46Sketch = React.forwardRef<SVGSVGElement, Scribble46SketchProps>(
...
export default Scribble46Sketch;
