...
export interface Scribble113SketchProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Scribble113Sketch = React.forwardRef<SVGSVGElement, Scribble113SketchProps>(
...
export default Scribble113Sketch;
