...
export interface Scribble1SketchProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Scribble1Sketch = React.forwardRef<SVGSVGElement, Scribble1SketchProps>(
...
export default Scribble1Sketch;
