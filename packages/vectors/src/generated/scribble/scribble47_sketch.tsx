...
export interface Scribble47SketchProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Scribble47Sketch = React.forwardRef<SVGSVGElement, Scribble47SketchProps>(
...
export default Scribble47Sketch;
