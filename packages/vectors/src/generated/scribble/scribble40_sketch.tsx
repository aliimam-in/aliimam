...
export interface Scribble40SketchProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Scribble40Sketch = React.forwardRef<SVGSVGElement, Scribble40SketchProps>(
...
export default Scribble40Sketch;
