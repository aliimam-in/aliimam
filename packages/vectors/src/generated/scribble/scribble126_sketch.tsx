...
export interface Scribble126SketchProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Scribble126Sketch = React.forwardRef<SVGSVGElement, Scribble126SketchProps>(
...
export default Scribble126Sketch;
