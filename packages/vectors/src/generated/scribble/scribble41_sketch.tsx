...
export interface Scribble41SketchProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Scribble41Sketch = React.forwardRef<SVGSVGElement, Scribble41SketchProps>(
...
export default Scribble41Sketch;
