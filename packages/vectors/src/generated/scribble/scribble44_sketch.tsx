...
export interface Scribble44SketchProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Scribble44Sketch = React.forwardRef<SVGSVGElement, Scribble44SketchProps>(
...
export default Scribble44Sketch;
