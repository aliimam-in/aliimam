...
export interface Scribble79SketchProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Scribble79Sketch = React.forwardRef<SVGSVGElement, Scribble79SketchProps>(
...
export default Scribble79Sketch;
