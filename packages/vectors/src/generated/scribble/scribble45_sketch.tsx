...
export interface Scribble45SketchProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Scribble45Sketch = React.forwardRef<SVGSVGElement, Scribble45SketchProps>(
...
export default Scribble45Sketch;
