...
export interface Scribble58SketchProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Scribble58Sketch = React.forwardRef<SVGSVGElement, Scribble58SketchProps>(
...
export default Scribble58Sketch;
