...
export interface Scribble69SketchProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Scribble69Sketch = React.forwardRef<SVGSVGElement, Scribble69SketchProps>(
...
export default Scribble69Sketch;
