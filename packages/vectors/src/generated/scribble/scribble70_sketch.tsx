...
export interface Scribble70SketchProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Scribble70Sketch = React.forwardRef<SVGSVGElement, Scribble70SketchProps>(
...
export default Scribble70Sketch;
