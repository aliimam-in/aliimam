...
export interface Scribble4SketchProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Scribble4Sketch = React.forwardRef<SVGSVGElement, Scribble4SketchProps>(
...
export default Scribble4Sketch;
