...
export interface Scribble20SketchProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Scribble20Sketch = React.forwardRef<SVGSVGElement, Scribble20SketchProps>(
...
export default Scribble20Sketch;
