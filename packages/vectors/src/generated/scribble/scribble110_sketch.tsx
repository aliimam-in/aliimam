...
export interface Scribble110SketchProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Scribble110Sketch = React.forwardRef<SVGSVGElement, Scribble110SketchProps>(
...
export default Scribble110Sketch;
