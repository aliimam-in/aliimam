...
export interface Scribble30SketchProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Scribble30Sketch = React.forwardRef<SVGSVGElement, Scribble30SketchProps>(
...
export default Scribble30Sketch;
