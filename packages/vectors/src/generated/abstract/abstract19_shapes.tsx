...
export interface Abstract19ShapesProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Abstract19Shapes = React.forwardRef<SVGSVGElement, Abstract19ShapesProps>(
...
export default Abstract19Shapes;
