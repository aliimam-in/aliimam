...
export interface Abstract121ShapesProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Abstract121Shapes = React.forwardRef<SVGSVGElement, Abstract121ShapesProps>(
...
export default Abstract121Shapes;
