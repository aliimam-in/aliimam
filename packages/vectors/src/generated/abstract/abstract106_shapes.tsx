...
export interface Abstract106ShapesProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Abstract106Shapes = React.forwardRef<SVGSVGElement, Abstract106ShapesProps>(
...
export default Abstract106Shapes;
