...
export interface Abstract6ShapesProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Abstract6Shapes = React.forwardRef<SVGSVGElement, Abstract6ShapesProps>(
...
export default Abstract6Shapes;
