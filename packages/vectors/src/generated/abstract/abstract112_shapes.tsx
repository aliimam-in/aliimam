...
export interface Abstract112ShapesProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Abstract112Shapes = React.forwardRef<SVGSVGElement, Abstract112ShapesProps>(
...
export default Abstract112Shapes;
