...
export interface Abstract14ShapesProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Abstract14Shapes = React.forwardRef<SVGSVGElement, Abstract14ShapesProps>(
...
export default Abstract14Shapes;
