...
export interface Abstract24ShapesProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
  className?: string; 
}

export const Abstract24Shapes = React.forwardRef<SVGSVGElement, Abstract24ShapesProps>(
...
export default Abstract24Shapes;
