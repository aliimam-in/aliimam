...
export const Geometric48Shapes = React.forwardRef<SVGSVGElement, Geometric48ShapesProps>(
  ({ size = 24, className = '', ...props }, ref) => (
    <svg
      ...
      {...props}
    >
      <path d="M49.8625 240.034L7.09167 288.643C7.09167 165.463 53.2841 59.3916 178.175 59.3916C303.066 59.3916 349.258 165.463 349.258 288.643L306.487 240.034L263.716 288.643L220.946 240.034L178.175 288.643L135.404 240.034L92.6333 288.643L49.8625 240.034Z" fill="#F4ADB3"/>
    </svg>
  )
);
