...
export const Geometric18Shapes = React.forwardRef<SVGSVGElement, Geometric18ShapesProps>(
  ({ size = 24, className = '', ...props }, ref) => (
    <svg
      ...
      {...props}
    >
      <path d="M0 356.35H89.0874L0 0V356.35Z" fill="#43A363"/>
<path d="M178.175 356.35H267.262L178.175 0V356.35Z" fill="#43A363"/>
<path d="M89.0874 356.35H178.175L89.0874 0V356.35Z" fill="#43A363"/>
<path d="M267.262 356.35H356.35L267.262 0V356.35Z" fill="#43A363"/>
    </svg>
  )
);
