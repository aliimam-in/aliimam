...
export const Geometric11Shapes = React.forwardRef<SVGSVGElement, Geometric11ShapesProps>(
  ({ size = 24, className = '', ...props }, ref) => (
    <svg
      ...
      {...props}
    >
      <path d="M181.237 249.802C84.5247 249.802 6.12402 162.577 6.12402 162.577C6.12402 162.577 84.5247 75.3525 181.237 75.3525C277.949 75.3525 356.35 162.577 356.35 162.577C356.35 162.577 277.949 249.802 181.237 249.802Z" fill="#F5BD33"/>
    </svg>
  )
);
