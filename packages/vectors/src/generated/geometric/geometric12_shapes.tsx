...
export const Geometric12Shapes = React.forwardRef<SVGSVGElement, Geometric12ShapesProps>(
  ({ size = 24, className = '', ...props }, ref) => (
    <svg
      ...
      {...props}
    >
      <path d="M5.41852 11.8786V171.715C5.41852 267.126 82.764 344.471 178.174 344.471C273.585 344.471 350.93 267.126 350.93 171.715V11.8784C316.979 72.2118 252.336 112.965 178.174 112.965C104.013 112.965 39.3701 72.2119 5.41852 11.8786Z" fill="#E55733"/>
    </svg>
  )
);
